...
%  \ref{FLA_Gemm_nn:ws_blk_var6} in the \LaTeX source 
 
\label{FLA_Gemm_nn:ws_blk_var6} 
...
% The following command creates a label so that the figure can 
% be referenced by its number by inserting  
%  \ref{FLA_Gemm_nn:alg_blk_var6} in the \LaTeX source 
 
\label{FLA_Gemm_nn:alg_blk_var6} 
