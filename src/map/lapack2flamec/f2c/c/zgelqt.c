/* ../netlib/v3.9.0/zgelqt.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 on Linux or Unix systems, link with .../path/to/libf2c.a -lm or, if you install libf2c.a in a standard place, with -lf2c -lm -- in that order, at the end of the command line, as in cc *.o -lf2c -lm Source for libf2c is in /netlib/f2c/libf2c.zip, e.g., http://www.netlib.org/f2c/libf2c.zip */
 #include "FLA_f2c.h" /* > \brief \b ZGELQT */
 /* =========== DOCUMENTATION =========== */
 ...
 char buffer[256]; 
 snprintf(buffer, 256,"zgelqt inputs: m %d, n %d, mb %d, lda %d, ldt %d",*m, *n, *mb, *lda, *ldt);
 ...
 *info = -7;
 ...
 i__4 = *n - i__ + 1;
 i__5 = *m - i__ - ib + 1;
 zlarfb_("R", "N", "F", "R", &i__3, &i__4, &ib, &a[i__ + i__ * a_dim1], lda, &t[i__ * t_dim1 + 1], ldt, &a[i__ + ib + i__ * a_dim1], lda, &work[1], &i__5);
 }
 }
 AOCL_DTL_TRACE_EXIT(AOCL_DTL_LEVEL_TRACE_5);
 return 0;
