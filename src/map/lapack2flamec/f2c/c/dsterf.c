/* ../netlib/dsterf.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
L10:
    ...
    for (m = l1;
            ...
            ++m)
    {
        if ((d__3 = e[m], f2c_dabs(d__3)) <= sqrt((d__1 = d__[m], f2c_dabs(d__1))) * sqrt((d__2 = d__[m + 1], f2c_dabs(d__2))) * eps)
        {
            e[m] = 0.;
            goto L30;
        }
...
L50:
        if (l != lend)
        {
            ...
            for (m = l;
                    ...
                    ++m)
            {
                if ((d__2 = e[m], f2c_dabs(d__2)) <= eps2 * (d__1 = d__[m] * d__[m + 1], f2c_dabs(d__1)))
                {
                    goto L70;
                }
                /* L60: */
...
L100:
        ...
        for (m = l;
                ...
                --m)
        {
            if ((d__2 = e[m - 1], f2c_dabs(d__2)) <= eps2 * (d__1 = d__[m] * d__[m - 1], f2c_dabs(d__1)))
            {
                goto L120;
            }
            /* L110: */
