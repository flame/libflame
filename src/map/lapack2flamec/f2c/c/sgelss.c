/* ../netlib/v3.9.0/sgelss.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -7;
 ...
 mm = *n;
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n + lwork_sgeqrf__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n + lwork_sormqr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 if (*m >= *n) {
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n * 3 + lwork_sgebrd__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n * 3 + lwork_sormbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n * 3 + lwork_sorgbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m * *m + (*m << 2) + lwork_sgebrd__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m * *m + (*m << 2) + lwork_sormbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m * *m + (*m << 2) + lwork_sorgbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m + lwork_sormlq__; // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 else {
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m * 3 + lwork_sormbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m * 3 + lwork_sorgbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 maxwrk = max(maxwrk,bdspac);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n * *nrhs; // , expr subst  
 ...
 *rank = 0;
 ...
 i__1 = *lwork - iwork + 1;
 sgeqrf_(m, n, &a[a_offset], lda, &work[itau], &work[iwork], &i__1, info);
 ...
 i__1 = *n - 1;
 i__2 = *n - 1;
 slaset_("L", &i__1, &i__2, &c_b50, &c_b50, &a[a_dim1 + 2], lda);
 }
 }
 ie = 1;
 itauq = ie + *n;
 ...
 *rank = 0;
 ...
 slaset_("F", &c__1, nrhs, &c_b50, &c_b50, &b[i__ + b_dim1], ldb);
 }
 /* L10: */
 }
 ...
 i__2 = *lwork - iwork + 1;
 sgelqf_(m, n, &a[a_offset], lda, &work[itau], &work[iwork], &i__2, info);
 il = iwork;
 ...
 *rank = 0;
 ...
 i__1 = *n - *m;
 slaset_("F", &i__1, nrhs, &c_b50, &c_b50, &b[*m + 1 + b_dim1], ldb);
 iwork = itau + *m;
