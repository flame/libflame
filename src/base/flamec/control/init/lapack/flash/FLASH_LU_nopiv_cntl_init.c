...
TLS_CLASS_SPEC fla_lu_t*          flash_lu_nopiv_cntl_leaf = NULL;
TLS_CLASS_SPEC fla_lu_t*          flash_lu_nopiv_cntl = NULL;
TLS_CLASS_SPEC fla_blocksize_t*   flash_lu_nopiv_bsize = NULL;
