/* ../netlib/v3.9.0/sggrqf.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -11;
 ...
 /* Computing MAX */
 i__1 = lopt; i__2 = (integer) work[1]; // , expr subst  
 lopt = max(i__1,i__2);
