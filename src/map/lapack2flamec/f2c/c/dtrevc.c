/* ../netlib/dtrevc.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
L90:
                ...
                if (! over)
                {
                            ...
                            ++k)
                    {
                        /* Computing MAX */
                        d__3 = emax;
                        d__4 = (d__1 = vr[k + (is - 1) * vr_dim1] , abs(d__1)) + (d__2 = vr[k + is * vr_dim1], abs(d__2)); // , expr subst
                        emax = max(d__3,d__4);
                        /* L100: */
                    }
                    remax = 1. / emax;
                ...
                else
                {
                            ...
                            ++k)
                    {
                        /* Computing MAX */
                        d__3 = emax;
                        d__4 = (d__1 = vr[k + (ki - 1) * vr_dim1] , abs(d__1)) + (d__2 = vr[k + ki * vr_dim1], abs(d__2)); // , expr subst
                        emax = max(d__3,d__4);
                        /* L120: */
                    }
                    remax = 1. / emax;
            ...
            if (ip == 0)
            {
                        ...
                        ++j)
                {
                    ...
                    else
                    {
                        ...
                        work[j + 1 + *n] = x[1];
                        /* Computing MAX */
                        d__3 = (d__1 = work[j + *n], abs(d__1));
                        d__4 = (d__2 = work[j + 1 + *n], abs(d__2));
            ...
            else
            {
                        ...
                        ++j)
                {
                    ...
                    else
                    {
                        ...
                        work[j + 1 + n2] = x[3];
                        /* Computing MAX */
                        d__1 = abs(x[0]), d__2 = abs(x[2]), d__1 = max(d__1, d__2), d__2 = abs(x[1]), d__1 = max(d__1,d__2) ;
                        d__2 = abs(x[3]);
...
L200:
                ...
                if (! over)
                {
                            ...
                            ++k)
                    {
                        /* Computing MAX */
                        d__3 = emax;
                        d__4 = (d__1 = vl[k + is * vl_dim1], abs( d__1)) + (d__2 = vl[k + (is + 1) * vl_dim1], abs(d__2)); // , expr subst
                        emax = max(d__3,d__4);
                        /* L220: */
                    }
                    remax = 1. / emax;
                ...
                else
                {
                            ...
                            ++k)
                    {
                        /* Computing MAX */
                        d__3 = emax;
                        d__4 = (d__1 = vl[k + ki * vl_dim1], abs( d__1)) + (d__2 = vl[k + (ki + 1) * vl_dim1], abs(d__2)); // , expr subst
                        emax = max(d__3,d__4);
                        /* L240: */
                    }
                    remax = 1. / emax;
