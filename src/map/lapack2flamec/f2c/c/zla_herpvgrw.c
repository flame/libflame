/* ../netlib/zla_herpvgrw.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
        ...
        while(k < ncols && k > 0)
        {
            if (ipiv[k] > 0)
            {
                        ...
                        ++i__)
                {
                    /* Computing MAX */
                    i__2 = i__ + k * af_dim1;
                    d__3 = (d__1 = af[i__2].r, f2c_dabs(d__1)) + (d__2 = d_imag(& af[i__ + k * af_dim1]), f2c_dabs(d__2));
            ...
            else
            {
                        ...
                        ++i__)
                {
                    ...
                    d__3 = (d__1 = af[i__2].r, f2c_dabs(d__1)) + (d__2 = d_imag(& af[i__ + (k - 1) * af_dim1]), f2c_dabs(d__2));
                    d__4 = work[k - 1]; // , expr subst
                    work[k - 1] = max(d__3,d__4);
                }
                /* Computing MAX */
                i__1 = k + k * af_dim1;
                d__3 = (d__1 = af[i__1].r, f2c_dabs(d__1)) + (d__2 = d_imag(&af[k + k * af_dim1]), f2c_dabs(d__2));
                d__4 = work[k]; // , expr subst
                work[k] = max(d__3,d__4);
                k += -2;
            }
