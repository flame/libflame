/* ../netlib/v3.9.0/cggqrf.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -8;
 ...
 {
 /* Computing MAX */
 i__1 = max(1,*n); i__1 = max(i__1,*m); // , expr subst  
