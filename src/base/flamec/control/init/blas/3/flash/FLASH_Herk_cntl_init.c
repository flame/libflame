...
TLS_CLASS_SPEC fla_herk_t*         flash_herk_cntl_blas = NULL;
TLS_CLASS_SPEC fla_herk_t*         flash_herk_cntl_ip = NULL;
TLS_CLASS_SPEC fla_herk_t*         flash_herk_cntl_op = NULL;
TLS_CLASS_SPEC fla_herk_t*         flash_herk_cntl_mm = NULL;
TLS_CLASS_SPEC fla_blocksize_t*    flash_herk_bsize = NULL;
