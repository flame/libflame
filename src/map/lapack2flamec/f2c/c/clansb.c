/* ../netlib/clansb.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > \verbatim */
/* > */
/* > CLANSB = ( max(f2c_abs(A(i,j))), NORM = 'M' or 'm' */
/* > ( */
    ...
    else if (lsame_(norm, "I") || lsame_(norm, "O") || *(unsigned char *)norm == '1')
    {
        ...
        if (lsame_(uplo, "U"))
        {
                    ...
                    ++j)
            {
                ...
                work[j] = sum + c_f2c_abs(&ab[*k + 1 + j * ab_dim1]);
                /* L60: */
            }
            i__1 = *n;
            for (i__ = 1;
        ...
        else
        {
            ...
            for (j = 1;
                    ...
                    ++j)
            {
                sum = work[j] + c_f2c_abs(&ab[j * ab_dim1 + 1]);
                l = 1 - j;
                /* Computing MIN */
                i__3 = *n;
                i__2 = j + *k; // , expr subst
