/* ../netlib/sporfs.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int sporfs_(char *uplo, integer *n, integer *nrhs, real *a, integer *lda, real *af, integer *ldaf, real *b, integer *ldb, real *x, integer *ldx, real *ferr, real *berr, real *work, integer *iwork, integer *info)
{
    ...
    logical upper;
    extern /* Subroutine */
    int scopy_(integer *, real *, integer *, real *, integer *), saxpy_(integer *, real *, real *, integer *, real *, integer *), ssymv_(char *, integer *, real *, real *, integer *, real *, integer *, real *, real *, integer *), slacn2_( integer *, real *, real *, integer *, real *, integer *, integer * );
...
L20: /* Loop until stopping criterion is satisfied. */
        ...
        ssymv_(uplo, n, &c_b12, &a[a_offset], lda, &x[j * x_dim1 + 1], &c__1, &c_b14, &work[*n + 1], &c__1);
        ...
        if (upper)
        {
                    ...
                    ++k)
            {
                        ...
                        ++i__)
                {
                    ...
                    s += (r__1 = a[i__ + k * a_dim1], abs(r__1)) * (r__2 = x[ i__ + j * x_dim1], abs(r__2));
                    /* L40: */
                }
                work[k] = work[k] + (r__1 = a[k + k * a_dim1], abs(r__1)) * xk + s;
                /* L50: */
            }
        }
        else
        ...
        if (berr[j] > eps && berr[j] * 2.f <= lstres && count <= 5)
        {
            ...
            spotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &work[*n + 1], n, info);
