/* ../netlib/slaein.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
    ...
    else
    {
                ...
                ++its)
        {
                    ...
                    i__ += i__3)
            {
                ...
                w = (r__1 = b[i__ + i__ * b_dim1], abs(r__1)) + (r__2 = b[i__ + 1 + i__ * b_dim1], abs(r__2));
                if (w > *smlnum)
                {
                    if (w < 1.f)
                    {
                    ...
                    /* Computing MAX */
                    r__3 = (r__1 = vr[i__], abs(r__1)) + (r__2 = vi[i__], abs( r__2));
                    vmax = max(r__3,vmax);
                    vcrit = *bignum / vmax;
                }
                else
...
L280: /* Normalize eigenvector. */
                ...
                ++i__)
        {
            /* Computing MAX */
            r__3 = vnorm;
            r__4 = (r__1 = vr[i__], abs(r__1)) + (r__2 = vi[i__] , abs(r__2)); // , expr subst
            vnorm = max(r__3,r__4);
            /* L290: */
        }
        r__1 = 1.f / vnorm;
