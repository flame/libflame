...
TLS_CLASS_SPEC fla_syr2k_t*        flash_syr2k_cntl_blas = NULL;
TLS_CLASS_SPEC fla_syr2k_t*        flash_syr2k_cntl_ip = NULL;
TLS_CLASS_SPEC fla_syr2k_t*        flash_syr2k_cntl_op = NULL;
TLS_CLASS_SPEC fla_syr2k_t*        flash_syr2k_cntl_mm = NULL;
TLS_CLASS_SPEC fla_blocksize_t*    flash_syr2k_bsize = NULL;
