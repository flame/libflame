 ...
 *info = 0;
 ...
 /* Computing MAX */
 d__3 = (d__1 = h__[k + (k - 1) * h_dim1], f2c_abs(d__1)); d__4 = ( d__2 = h__[k - 1 + k * h_dim1], f2c_abs(d__2)); // , expr subst  
 ab = max(d__3,d__4);
 /* Computing MIN */
 d__3 = (d__1 = h__[k + (k - 1) * h_dim1], f2c_abs(d__1)); d__4 = ( d__2 = h__[k - 1 + k * h_dim1], f2c_abs(d__2)); // , expr subst  
 ba = min(d__3,d__4);
 /* Computing MAX */
 d__3 = (d__1 = h__[k + k * h_dim1], f2c_abs(d__1)); d__4 = (d__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], f2c_abs(d__2)); // , expr subst  
 aa = max(d__3,d__4);
 /* Computing MIN */
 d__3 = (d__1 = h__[k + k * h_dim1], f2c_abs(d__1)); d__4 = (d__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], f2c_abs(d__2)); // , expr subst  
 bb = min(d__3,d__4);
