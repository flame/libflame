 ...
 *nd = 0;
 /* Computing MAX */
 r__2 = smlnum; r__3 = ulp * (r__1 = a[kwtop + kwtop * a_dim1], f2c_abs( r__1)); // , expr subst  
 ...
 *ns = jw - qz_small_info__;
 ...
 /* Computing MAX */
 r__3 = (r__1 = s * qc[(kwbot - kwtop) * qc_dim1 + 1], f2c_abs( r__1)); r__4 = (r__2 = s * qc[(kwbot - kwtop + 1) * qc_dim1 + 1], f2c_abs(r__2)); // , expr subst  
 /* Computing MAX */
 r__5 = smlnum; r__6 = ulp * temp; // , expr subst  
 ...
 *ns = jw - *nd;
 ...
 r_cnjg(&q__3, &q__1);
 q__2.r = a[i__5] * q__3.r; q__2.i = a[i__5] * q__3.i; // , expr subst  
 a[i__4] = q__2.r;
 }
 }
 i__1 = kwtop;
