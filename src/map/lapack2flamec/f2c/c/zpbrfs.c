        ...
        if (upper)
        {
                    ...
                    ++k)
            {
                        ...
                        ++i__)
                {
                    ...
                    rwork[i__] += ((d__1 = ab[i__3].r, abs(d__1)) + (d__2 = d_imag(&ab[l + i__ + k * ab_dim1]), abs(d__2))) * xk;
                    i__3 = l + i__ + k * ab_dim1;
                    i__4 = i__ + j * x_dim1;
                    s += ((d__1 = ab[i__3].r, abs(d__1)) + (d__2 = d_imag(&ab[ l + i__ + k * ab_dim1]), abs(d__2))) * ((d__3 = x[ i__4].r, abs(d__3)) + (d__4 = d_imag(&x[i__ + j * x_dim1]), abs(d__4)));
                    /* L40: */
                }
                i__5 = *kd + 1 + k * ab_dim1;
