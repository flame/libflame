                                       ...
                                       dim_t   mb,  dim_t    nb,  FLA_Quadrant quadrant )
{
  ...
  e_val = FLA_Check_valid_object_datatype_ts( FLA_cntl_init_i, ATL );
  FLA_Check_error_code( e_val );

  e_val = FLA_Check_valid_object_datatype_ts( FLA_cntl_init_i, ABL );
  FLA_Check_error_code( e_val );

  e_val = FLA_Check_valid_object_datatype_ts( FLA_cntl_init_i, ATR );
  FLA_Check_error_code( e_val );

  e_val = FLA_Check_valid_object_datatype_ts( FLA_cntl_init_i, ABR );
  FLA_Check_error_code( e_val );
