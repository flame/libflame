...
void FLASH_Hemm_cntl_init_ts(FLA_Cntl_init_flash_s *FLA_cntl_flash_init_i)
{
	// Set hemm blocksize for hierarchical storage.
	FLA_cntl_flash_init_i->flash_hemm_bsize      = FLA_Blocksize_create( 1, 1, 1, 1 );

	// Create a control tree that assumes A and B are b x b blocks.
	FLA_cntl_flash_init_i->flash_hemm_cntl_blas  = FLA_Cntl_hemm_obj_create( FLA_HIER, 
	                                                  FLA_SUBPROBLEM,
	                                                  NULL,
	                                                  NULL,
	                                                  NULL,
	...
	FLA_cntl_flash_init_i->flash_hemm_cntl_bp    = FLA_Cntl_hemm_obj_create( FLA_HIER,
	                                                  FLA_BLOCKED_VARIANT9,
	                                                  FLA_cntl_flash_init_i->flash_hemm_bsize,
	                                                  FLA_cntl_flash_init_i->flash_scal_cntl,
	                                                  FLA_cntl_flash_init_i->flash_hemm_cntl_blas,
	                                                  NULL,
	                                                  NULL );

	// Create a control tree that assumes A is large and B is a panel.
	FLA_cntl_flash_init_i->flash_hemm_cntl_mp    = FLA_Cntl_hemm_obj_create( FLA_HIER,
	...
	FLA_cntl_flash_init_i->flash_hemm_cntl_mm    = FLA_Cntl_hemm_obj_create( FLA_HIER,
	                                                  FLA_BLOCKED_VARIANT9,
	                                                  FLA_cntl_flash_init_i->flash_hemm_bsize,
	                                                  FLA_cntl_flash_init_i->flash_scal_cntl,
	                                                  FLA_cntl_flash_init_i->flash_hemm_cntl_mp,
	                                                  NULL,
	                                                  NULL );
}

void FLASH_Hemm_cntl_finalize_ts(FLA_Cntl_init_flash_s *FLA_cntl_flash_init_i)
{
	FLA_Cntl_obj_free( FLA_cntl_flash_init_i->flash_hemm_cntl_blas );

	FLA_Cntl_obj_free( FLA_cntl_flash_init_i->flash_hemm_cntl_bp );
	FLA_Cntl_obj_free( FLA_cntl_flash_init_i->flash_hemm_cntl_mp );
	FLA_Cntl_obj_free( FLA_cntl_flash_init_i->flash_hemm_cntl_mm );

	FLA_Blocksize_free( FLA_cntl_flash_init_i->flash_hemm_bsize );
}
