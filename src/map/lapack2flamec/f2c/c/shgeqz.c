 ...
 *info = *n + 1;
 ...
 /* Computing MAX */
 /* Computing MAX */
 r__3 = 1.f, r__4 = f2c_abs(wr); r__3 = max(r__3,r__4); r__4 = f2c_abs(wi); // ; expr subst  
 ...
 if (f2c_abs(wr) > temp) {
 /* Computing MIN */
 r__1 = scale; r__2 = temp / f2c_abs(wr); // , expr subst  
 scale = min(r__1,r__2);
 }
 s1 = scale * s1;
 wr = scale * wr;
 ...
 ilpivt = FALSE_;
 /* Computing MAX */
 r__3 = (r__1 = t[j + 1 + (j + 1) * t_dim1], f2c_abs(r__1)); r__4 = (r__2 = t[j + 1 + (j + 2) * t_dim1], f2c_abs(r__2)); // , expr subst  
 temp = max(r__3,r__4);
 /* Computing MAX */
 r__3 = (r__1 = t[j + 2 + (j + 1) * t_dim1], f2c_abs(r__1)); r__4 = (r__2 = t[j + 2 + (j + 2) * t_dim1], f2c_abs(r__2)); // , expr subst  
 temp2 = max(r__3,r__4);
 ...
 /* Computing MIN */
 r__2 = scale; r__3 = (r__1 = w11 / u1, f2c_abs(r__1)); // , expr subst  
 scale = min(r__2,r__3);
 }
 /* Solve */
 u2 = scale * u2 / w22;
