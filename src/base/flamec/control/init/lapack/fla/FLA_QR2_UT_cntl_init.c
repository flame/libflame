...
void FLA_QR2_UT_cntl_init_ts(FLA_Cntl_init_flamec_s *FLA_cntl_flamec_init_i)
{
	...
	// but scaled down.
	FLA_cntl_flamec_init_i->fla_qr2ut_var1_bsize = FLA_Query_blocksizes( FLA_DIMENSION_MIN );
	FLA_Blocksize_scale_ts( FLA_cntl_flamec_init_i, FLA_cntl_flamec_init_i->fla_qr2ut_var1_bsize, FLA_QR_INNER_TO_OUTER_B_RATIO );

	// Create a control tree to invoke unblocked variant 1.
	FLA_cntl_flamec_init_i->fla_qr2ut_cntl_unb = FLA_Cntl_qr2ut_obj_create( FLA_FLAT,
	...
	FLA_cntl_flamec_init_i->fla_qr2ut_cntl_leaf = FLA_Cntl_qr2ut_obj_create( FLA_FLAT,
	                                                 FLA_BLOCKED_VARIANT1, 
	                                                 FLA_cntl_flamec_init_i->fla_qr2ut_var1_bsize,
	                                                 FLA_cntl_flamec_init_i->fla_qr2ut_cntl_unb,
...
{
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_qr2ut_cntl_unb );
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_qr2ut_cntl_leaf );

	FLA_Blocksize_free( FLA_cntl_flamec_init_i->fla_qr2ut_var1_bsize );
}
#endif
...
fla_qr2ut_t*       fla_qr2ut_cntl_unb = NULL;
fla_qr2ut_t*       fla_qr2ut_cntl_leaf = NULL;
fla_blocksize_t*   fla_qr2ut_var1_bsize = NULL;
