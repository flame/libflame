/* ../netlib/v3.9.0/dlasq6.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 on Linux or Unix systems, link with .../path/to/libf2c.a -lm or, if you install libf2c.a in a standard place, with -lf2c -lm -- in that order, at the end of the command line, as in cc *.o -lf2c -lm Source for libf2c is in /netlib/f2c/libf2c.zip, e.g., http://www.netlib.org/f2c/libf2c.zip */
 #include "FLA_f2c.h" /* > \brief \b DLASQ6 computes one dqd transform in ping-pong form. Used by sbdsqr and sstegr. */
 /* =========== DOCUMENTATION =========== */
 ...
 *dmin__ = min(*dmin__,d__);
 /* Computing MIN */
 d__1 = emin; d__2 = z__[j4]; // , expr subst  
 emin = min(d__1,d__2);
 /* L10: */
 }
 }
 ...
 *dmin__ = min(*dmin__,d__);
 /* Computing MIN */
 d__1 = emin; d__2 = z__[j4 - 1]; // , expr subst  
 emin = min(d__1,d__2);
 /* L20: */
 }
 }
