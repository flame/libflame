 ...
 *info = -1;
 ...
 /* Computing MAX */
 r__2 = gl; r__3 = tmp - tmp1 - eps * 100.f * (r__1 = tmp - tmp1, f2c_abs(r__1)); // , expr subst  
 ...
 *info = -1;
 ...
 /* Computing MIN */
 r__2 = gu; r__3 = tmp + tmp1 + eps * 100.f * (r__1 = tmp + tmp1, f2c_abs(r__1)); // , expr subst  
 ...
 /* Computing MAX */
 r__2 = gl; r__3 = w[wbegin] - werr[wbegin] - eps * 100.f * (r__1 = w[wbegin] - werr[wbegin], f2c_abs(r__1)); // , expr subst  
 isleft = max(r__2,r__3);
 /* Computing MIN */
 r__2 = gu; r__3 = w[wend] + werr[wend] + eps * 100.f * (r__1 = w[ wend] + werr[wend], f2c_abs(r__1)); // , expr subst  
 isrght = min(r__2,r__3);
 }
 ...
 /* Computing MAX */
 r__1 = tau; r__2 = eps * 2.f * f2c_abs(sigma); // , expr subst  
 tau = max(r__1,r__2);
 }
 else {
 if (mb > 1) {
 ...
 work[i__ + 1] = dpivot;
 /* Computing MAX */
 r__1 = dmax__; r__2 = f2c_abs(dpivot); // , expr subst  
