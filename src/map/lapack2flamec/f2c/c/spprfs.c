/* ../netlib/spprfs.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
        ...
        if (upper)
        {
                    ...
                    ++k)
            {
                        ...
                        ++i__)
                {
                    ...
                    s += (r__1 = ap[ik], abs(r__1)) * (r__2 = x[i__ + j * x_dim1], abs(r__2));
                    ++ik;
                    /* L40: */
                }
                work[k] = work[k] + (r__1 = ap[kk + k - 1], abs(r__1)) * xk + s;
                kk += k;
                /* L50: */
            }
        }
