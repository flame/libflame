/* ../netlib/v3.9.0/chetri2x.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 ...
 t.r = r__1; t.i = 0.f; // , expr subst  
 i__1 = k + k * a_dim1;
 r__1 = a[i__1].r;
 q__2.r = r__1; q__2.i = 0.f; // , expr subst  
 c_div(&q__1, &q__2, &t);
 ...
 q__2.r = q__3.r - 1.f; q__2.i = q__3.i; // , expr subst  
