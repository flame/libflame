...
extern TLS_CLASS_SPEC fla_ttmm_t*  flash_ttmm_cntl;

TLS_CLASS_SPEC fla_spdinv_t*       flash_spdinv_cntl = NULL;
TLS_CLASS_SPEC fla_blocksize_t*    flash_spdinv_size_cutoff = NULL;
