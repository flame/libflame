        ...
        else if (lsvec && ! rsvec)
        {
            ...
            if (lquery)
            {
                ...
                if (conda)
                {
                    ...
                    i__1 = max(i__1, lwrk_sgesvd__); // , expr subst
            ...
            if (lquery)
            {
                if (rtrans)
                {
                    ...
                    if (wntva)
                    {
                        ...
                        /* Computing MAX */
                        i__1 = lwrk_sgeqp3__, i__2 = *n / 2 + lwrk_sgeqrf__, i__1 = max(i__1,i__2), i__2 = *n / 2 + lwrk_sgesvd2__;
                        i__1 = max(i__1,i__2);
                ...
                else
                {
                    ...
                    if (wntva)
                    {
                        ...
                        /* Computing MAX */
                        i__1 = lwrk_sgeqp3__, i__2 = *n / 2 + lwrk_sgelqf__, i__1 = max(i__1,i__2), i__2 = *n / 2 + lwrk_sgesvd2__;
                        i__1 = max(i__1,i__2);
