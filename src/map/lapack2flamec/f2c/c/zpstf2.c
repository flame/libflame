/* ../netlib/v3.9.0/zpstf2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 1;
 ...
 i__3 = j - 1 + i__ * a_dim1;
 z__1.r = z__2.r * a[i__3].r - z__2.i * a[i__3].i; z__1.i = z__2.r * a[i__3].i + z__2.i * a[i__3].r; // , expr subst  
 work[i__] += z__1.r;
 }
 i__3 = i__ + i__ * a_dim1;
 ...
 i__2 = j + j * a_dim1;
 a[i__2].r = ajj; a[i__2].i = 0.; // , expr subst  
 goto L190;
 }
 }
 if (j != pvt) {
 ...
 i__3 = i__ + pvt * a_dim1;
 a[i__3].r = ztemp.r; a[i__3].i = ztemp.i; // , expr subst  
 /* L140: */
 }
 i__2 = j + pvt * a_dim1;
