/* ../netlib/slahqr.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int slahqr_(logical *wantt, logical *wantz, integer *n, integer *ilo, integer *ihi, real *h__, integer *ldh, real *wr, real * wi, integer *iloz, integer *ihiz, real *z__, integer *ldz, integer * info)
{
    ...
    extern /* Subroutine */
    int srot_(integer *, real *, integer *, real *, integer *, real *, real *), scopy_(integer *, real *, integer *, real *, integer *), slanv2_(real *, real *, real *, real *, real * , real *, real *, real *, real *, real *), slabad_(real *, real *) ;
...
L20:
            ...
            ++its)
    {
                ...
                --k)
        {
            ...
            tst = (r__1 = h__[k - 1 + (k - 1) * h_dim1], abs(r__1)) + (r__2 = h__[k + k * h_dim1], abs(r__2));
            if (tst == 0.f)
            {
                if (k - 2 >= *ilo)
                {
            ...
            {
                /* Computing MAX */
                r__3 = (r__1 = h__[k + (k - 1) * h_dim1], abs(r__1));
                r__4 = ( r__2 = h__[k - 1 + k * h_dim1], abs(r__2)); // , expr subst
                ab = max(r__3,r__4);
                /* Computing MIN */
                r__3 = (r__1 = h__[k + (k - 1) * h_dim1], abs(r__1));
                r__4 = ( r__2 = h__[k - 1 + k * h_dim1], abs(r__2)); // , expr subst
                ba = min(r__3,r__4);
                /* Computing MAX */
                r__3 = (r__1 = h__[k + k * h_dim1], abs(r__1));
                r__4 = (r__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], abs(r__2)); // , expr subst
                aa = max(r__3,r__4);
                /* Computing MIN */
                r__3 = (r__1 = h__[k + k * h_dim1], abs(r__1));
                r__4 = (r__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], abs(r__2)); // , expr subst
...
L40:
        ...
        {
            /* Exceptional shift. */
            s = (r__1 = h__[l + 1 + l * h_dim1], abs(r__1)) + (r__2 = h__[l + 2 + (l + 1) * h_dim1], abs(r__2));
        ...
        {
            /* Exceptional shift. */
            s = (r__1 = h__[i__ + (i__ - 1) * h_dim1], abs(r__1)) + (r__2 = h__[i__ - 1 + (i__ - 2) * h_dim1], abs(r__2));
        ...
        else
        {
            ...
            else
            {
                ...
                rt1r = tr + rtdisc;
                rt2r = tr - rtdisc;
                if ((r__1 = rt1r - h22, abs(r__1)) <= (r__2 = rt2r - h22, abs( r__2)))
                {
                    rt1r *= s;
                    rt2r = rt1r;
                }
                ...
                --m)
        {
            ...
            s = (r__1 = h__[m + m * h_dim1] - rt2r, abs(r__1)) + abs(rt2i) + abs(h21s);
            ...
            if ((r__1 = h__[m + (m - 1) * h_dim1], abs(r__1)) * (abs(v[1]) + abs(v[2])) <= ulp * abs(v[0]) * ((r__2 = h__[m - 1 + (m - 1) * h_dim1], abs(r__2)) + (r__3 = h__[m + m * h_dim1], abs(r__3)) + (r__4 = h__[m + 1 + (m + 1) * h_dim1], abs( r__4))))
            {
                goto L60;
            }
            /* L50: */
