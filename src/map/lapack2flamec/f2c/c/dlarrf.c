 ...
 *info = 0;
 ...
 /* Computing MAX */
 d__2 = max1; d__3 = (d__1 = dplus[i__ + 1], f2c_abs(d__1)); // , expr subst  
 max1 = max(d__2,d__3);
 /* L6: */
 }
 ...
 *sigma = lsigma;
 ...
 /* Computing MAX */
 d__2 = max2; d__3 = (d__1 = work[i__ + 1], f2c_abs(d__1)); // , expr subst  
 max2 = max(d__2,d__3);
 /* L7: */
 }
 ...
 *sigma = rsigma;
 ...
 prod *= (d__1 = work[*n + i__], f2c_abs(d__1));
 }
 oldp = prod;
 /* Computing 2nd power */
 d__1 = prod;
 znm2 += d__1 * d__1;
 /* Computing MAX */
 d__2 = tmp; d__3 = (d__1 = dplus[i__] * prod, f2c_abs(d__1)); // , expr subst  
 tmp = max(d__2,d__3);
 /* L15: */
 }
 ...
 *sigma = lsigma;
 ...
 prod *= (d__1 = lplus[i__], f2c_abs(d__1));
 }
 oldp = prod;
 /* Computing 2nd power */
 d__1 = prod;
 znm2 += d__1 * d__1;
 /* Computing MAX */
 d__2 = tmp; d__3 = (d__1 = work[i__] * prod, f2c_abs(d__1)); // , expr subst  
 tmp = max(d__2,d__3);
 /* L16: */
 }
