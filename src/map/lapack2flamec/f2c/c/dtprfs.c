                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        for (i__ = 1;
                                ...
                                ++i__)
                        {
                            work[i__] += (d__1 = ap[kc + i__ - 1], f2c_abs(d__1)) * xk;
                            /* L30: */
                        }
                        kc += k;
                        /* L40: */
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        for (i__ = k;
                                ...
                                ++i__)
                        {
                            work[i__] += (d__1 = ap[kc + i__ - k], f2c_abs(d__1)) * xk;
                            /* L70: */
                        }
                        kc = kc + *n - k + 1;
                        /* L80: */
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        for (i__ = 1;
                                ...
                                ++i__)
                        {
                            s += (d__1 = ap[kc + i__ - 1], f2c_abs(d__1)) * (d__2 = x[i__ + j * x_dim1], f2c_abs(d__2));
                            /* L110: */
                        }
                        work[k] += s;
                        kc += k;
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        for (i__ = k;
                                ...
                                ++i__)
                        {
                            s += (d__1 = ap[kc + i__ - k], f2c_abs(d__1)) * (d__2 = x[i__ + j * x_dim1], f2c_abs(d__2));
                            /* L150: */
                        }
                        work[k] += s;
                        kc = kc + *n - k + 1;
