/* ../netlib/cla_porpvgrw.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
    ...
    if (lsame_("Upper", uplo))
    {
                ...
                ++j)
        {
                    ...
                    ++i__)
            {
                /* Computing MAX */
                i__3 = i__ + j * af_dim1;
                r__3 = (r__1 = af[i__3].r, abs(r__1)) + (r__2 = r_imag(&af[ i__ + j * af_dim1]), abs(r__2));
