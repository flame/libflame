/* zlahqr.f -- translated by f2c (version 20190311). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
    ...
    *info = 0;
            ...
            ++i__)
    {
        if (d_imag(&h__[i__ + (i__ - 1) * h_dim1]) != 0.)
        {
            ...
            d__3 = (d__1 = h__[i__3].r, f2c_dabs(d__1)) + (d__2 = d_imag(&h__[i__ + (i__ - 1) * h_dim1]), f2c_dabs(d__2));
...
L30:
            ...
            ++its)
    {
        ...
        {
            i__3 = k + (k - 1) * h_dim1;
            if ((d__1 = h__[i__3].r, f2c_dabs(d__1)) + (d__2 = d_imag(&h__[k + (k - 1) * h_dim1]), f2c_dabs(d__2)) <= smlnum)
            {
                goto L50;
            }
            i__3 = k - 1 + (k - 1) * h_dim1;
            i__4 = k + k * h_dim1;
            tst = (d__1 = h__[i__3].r, f2c_dabs(d__1)) + (d__2 = d_imag(&h__[k - 1 + (k - 1) * h_dim1]), f2c_dabs(d__2)) + ((d__3 = h__[i__4].r, f2c_dabs(d__3)) + (d__4 = d_imag(&h__[k + k * h_dim1]), f2c_dabs( d__4)));
            if (tst == 0.)
            {
                if (k - 2 >= *ilo)
                {
                    i__3 = k - 1 + (k - 2) * h_dim1;
                    tst += (d__1 = h__[i__3].r, f2c_dabs(d__1));
                }
                if (k + 1 <= *ihi)
                {
                    i__3 = k + 1 + k * h_dim1;
            ...
            i__3 = k + (k - 1) * h_dim1;
            if ((d__1 = h__[i__3].r, f2c_dabs(d__1)) <= ulp * tst)
            {
                /* Computing MAX */
                i__3 = k + (k - 1) * h_dim1;
                i__4 = k - 1 + k * h_dim1;
                d__5 = (d__1 = h__[i__3].r, f2c_dabs(d__1)) + (d__2 = d_imag(&h__[ k + (k - 1) * h_dim1]), f2c_dabs(d__2));
                d__6 = (d__3 = h__[i__4].r, f2c_dabs(d__3)) + (d__4 = d_imag(&h__[k - 1 + k * h_dim1]), f2c_dabs(d__4)); // , expr subst
                ...
                z__2.i = h__[i__3].i - h__[i__4].i; // , expr subst
                z__1.r = z__2.r;
                z__1.i = z__2.i; // , expr subst
                /* Computing MAX */
                i__5 = k + k * h_dim1;
                d__5 = (d__1 = h__[i__5].r, f2c_dabs(d__1)) + (d__2 = d_imag(&h__[ k + k * h_dim1]), f2c_dabs(d__2));
...
L50:
        ...
        if (kdefl % 20 == 0)
        {
            /* Exceptional shift. */
            i__2 = i__ + (i__ - 1) * h_dim1;
            s = (d__1 = h__[i__2].r, f2c_dabs(d__1)) * .75;
            i__2 = i__ + i__ * h_dim1;
            z__1.r = s + h__[i__2].r;
            z__1.i = h__[i__2].i; // , expr subst
            t.r = z__1.r;
        ...
        else
        {
            ...
            s = (d__1 = u.r, f2c_dabs(d__1)) + (d__2 = d_imag(&u), f2c_dabs(d__2));
            if (s != 0.)
            {
                i__2 = i__ - 1 + (i__ - 1) * h_dim1;
                z__2.r = h__[i__2].r - t.r;
                z__2.i = h__[i__2].i - t.i; // , expr subst
                z__1.r = z__2.r * .5;
                z__1.i = z__2.i * .5; // , expr subst
                x.r = z__1.r;
                x.i = z__1.i; // , expr subst
                sx = (d__1 = x.r, f2c_dabs(d__1)) + (d__2 = d_imag(&x), f2c_dabs(d__2));
                /* Computing MAX */
                d__3 = s;
                d__4 = (d__1 = x.r, f2c_dabs(d__1)) + (d__2 = d_imag(&x), f2c_dabs(d__2)); // , expr subst
                s = fla_max(d__3,d__4);
                z__5.r = x.r / s;
                ...
                --m)
        {
            ...
            i__3 = m + (m - 1) * h_dim1;
            h10 = h__[i__3].r;
            if (f2c_dabs(h10) * f2c_dabs(h21) <= ulp * (((d__1 = h11s.r, f2c_dabs(d__1)) + ( d__2 = d_imag(&h11s), f2c_dabs(d__2))) * ((d__3 = h11.r, f2c_dabs( d__3)) + (d__4 = d_imag(&h11), f2c_dabs(d__4)) + ((d__5 = h22.r, f2c_dabs(d__5)) + (d__6 = d_imag(&h22), f2c_dabs(d__6))))))
            {
                goto L70;
            }
            /* L60: */
...
L70: /* Single-shift QR step */
                ...
                ++k)
        {
                    ...
                    ++j)
            {
                ...
                z__2.i = z__3.r * h__[i__4].i + z__3.i * h__[i__4].r; // , expr subst
                i__5 = k + 1 + j * h_dim1;
                z__4.r = t2 * h__[i__5].r;
                z__4.i = t2 * h__[i__5].i; // , expr subst
                ...
                i__4 = k + j * h_dim1;
                i__5 = k + j * h_dim1;
                z__1.r = h__[i__5].r - sum.r;
                z__1.i = h__[i__5].i - sum.i; // , expr subst
                h__[i__4].r = z__1.r;
            ...
            {
                i__4 = j + k * h_dim1;
                z__2.r = t1.r * h__[i__4].r - t1.i * h__[i__4].i;
                z__2.i = t1.r * h__[i__4].i + t1.i * h__[i__4].r; // , expr subst
                i__5 = j + (k + 1) * h_dim1;
                z__3.r = t2 * h__[i__5].r;
                z__3.i = t2 * h__[i__5].i; // , expr subst
            ...
            if (*wantz)
            {
                        ...
                        ++j)
                {
                    ...
                    z__2.i = t1.r * z__[i__4].i + t1.i * z__[i__4].r; // , expr subst
                    i__5 = j + (k + 1) * z_dim1;
                    z__3.r = t2 * z__[i__5].r;
                    z__3.i = t2 * z__[i__5].i; // , expr subst
                    z__1.r = z__2.r + z__3.r;
                    z__1.i = z__2.i + z__3.i; // , expr subst
                    sum.r = z__1.r;
                    sum.i = z__1.i; // , expr subst
                    i__4 = j + k * z_dim1;
                    i__5 = j + k * z_dim1;
                    z__1.r = z__[i__5].r - sum.r;
                    z__1.i = z__[i__5].i - sum.i; // , expr subst
                    z__[i__4].r = z__1.r;
            ...
            if (k == m && m > l)
            {
                ...
                i__4 = m + 1 + m * h_dim1;
                d_cnjg(&z__2, &temp);
                z__1.r = h__[i__4].r * z__2.r - h__[i__4].i * z__2.i;
                z__1.i = h__[i__4].r * z__2.i + h__[i__4].i * z__2.r; // , expr subst
                h__[i__3].r = z__1.r;
                ...
                if (m + 2 <= i__)
                {
                    ...
                    z__1.i = h__[i__4].r * temp.i + h__[i__4].i * temp.r; // , expr subst
                    h__[i__3].r = z__1.r;
                    h__[i__3].i = z__1.i; // , expr subst
                }
                i__3 = i__;
