 ...
 */
 ...
 extern /* Subroutine */
 int csscal_(integer *, real *, complex *, integer *), claset_(char *, integer *, integer *, complex *, complex *, complex *, integer *), clacpy_(char *, integer *, integer *, complex *, integer *, complex *, integer *), xerbla_( char *, integer *);
 ...
 */
 ...
 i__1 = ki + iv * *n;
 work[i__1].r = 1.f; work[i__1].i = 0.f; // , expr subst  
 ...
 i__3 = k + iv * *n;
 i__4 = k + ki * t_dim1;
 q__1.r = -t[i__4].r; q__1.i = -t[i__4].i; // , expr subst  
 ...
 i__1 = ki + iv * *n;
 work[i__1].r = scale; work[i__1].i = 0.f; // , expr subst  
 }
 ...
 ++k) {
 i__3 = k + is * vr_dim1;
 vr[i__3].r = 0.f; vr[i__3].i = 0.f; // , expr subst  
 /* L60: */
 }
 }
 else if (nb == 1) {
 ...
 if (ki > 1) {
 i__1 = ki - 1;
 q__1.r = scale; q__1.i = 0.f; // , expr subst  
 ...
 */
 ...
 i__3 = ki + iv * *n;
 work[i__3].r = 1.f; work[i__3].i = 0.f; // , expr subst  
 /* Form right-hand side. */
 i__3 = *n;
 for (k = ki + 1;
 k <= i__3;
 ...
 i__3 = ki + iv * *n;
 work[i__3].r = scale; work[i__3].i = 0.f; // , expr subst  
 }
 ...
 ++k) {
 i__4 = k + is * vl_dim1;
 vl[i__4].r = 0.f; vl[i__4].i = 0.f; // , expr subst  
 /* L110: */
 }
 }
 else if (nb == 1) {
 ...
 ++k) {
 i__4 = k + iv * *n;
 work[i__4].r = 0.f; work[i__4].i = 0.f; // , expr subst  
 }
