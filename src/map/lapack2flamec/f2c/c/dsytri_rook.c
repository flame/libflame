/* ../netlib/dsytri_rook.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
L30: /* If K > N, exit from loop. */
        ...
        else
        {
            ...
            /* Invert the diagonal block. */
            t = (d__1 = a[k + (k + 1) * a_dim1], f2c_dabs(d__1));
            ak = a[k + k * a_dim1] / t;
