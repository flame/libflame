/* ../netlib/v3.9.0/chetri_3x.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
;
 ...
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/chetri_ 3x.f"> */
 /* > [TGZ]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/chetri_ 3x.f"> */
 /* > [ZIP]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/chetri_ 3x.f"> */
 /* > [TXT]</a> */
 /* > \endhtmlonly */
 /* Definition: */
 /* =========== */
 ...
 */
 ...
 /* ===================================================================== */
 /* Subroutine */
 int chetri_3x_(char *uplo, integer *n, complex *a, integer * lda, complex *e, integer *ipiv, complex *work, integer *nb, integer * info) {
 AOCL_DTL_TRACE_ENTRY(AOCL_DTL_LEVEL_TRACE_5);
#if AOCL_DTL_LOG_ENABLE 
 char buffer[256]; 
#if FLA_ENABLE_ILP64 
 snprintf(buffer, 256,"chetri_3x inputs: uplo %c, n %lld, lda %lld, ipiv %lld, nb %lld",*uplo, *n, *lda, *ipiv, *nb);
#else 
 snprintf(buffer, 256,"chetri_3x inputs: uplo %c, n %d, lda %d, ipiv %d, nb %d",*uplo, *n, *lda, *ipiv, *nb);
#endif
 ...
 *info = 0;
 ...
 i__2 = k + k * a_dim1;
 r__1 = 1.f / a[i__2].r;
 work[i__1].r = r__1; work[i__1].i = 0.f; // , expr subst  
 i__1 = k + (invd + 1) * work_dim1;
 work[i__1].r = 0.f; work[i__1].i = 0.f; // , expr subst  
 }
 else {
 /* 2 x 2 diagonal NNB */
 ...
 akp1 = a[i__1].r / t;
 i__1 = k + 1 + work_dim1;
 q__1.r = work[i__1].r / t; q__1.i = work[i__1].i / t; // , expr subst  
 akkp1.r = q__1.r; akkp1.i = q__1.i; // , expr subst  
 r__1 = ak * akp1;
 q__2.r = r__1 - 1.f; q__2.i = -0.f; // , expr subst  
 q__1.r = t * q__2.r; q__1.i = t * q__2.i; // , expr subst  
 d__.r = q__1.r; d__.i = q__1.i; // , expr subst  
 i__1 = k + invd * work_dim1;
 q__2.r = akp1; q__2.i = 0.f; // , expr subst  
 c_div(&q__1, &q__2, &d__);
 work[i__1].r = q__1.r; work[i__1].i = q__1.i; // , expr subst  
 i__1 = k + 1 + (invd + 1) * work_dim1;
 q__2.r = ak; q__2.i = 0.f; // , expr subst  
 c_div(&q__1, &q__2, &d__);
 work[i__1].r = q__1.r; work[i__1].i = q__1.i; // , expr subst  
 i__1 = k + (invd + 1) * work_dim1;
 q__2.r = -akkp1.r; q__2.i = -akkp1.i; // , expr subst  
 c_div(&q__1, &q__2, &d__);
 work[i__1].r = q__1.r; work[i__1].i = q__1.i; // , expr subst  
 ...
 work[i__2].r = 1.f; work[i__2].i = 0.f; // , expr subst  
 i__2 = i__ - 1;
 for (j = 1;
 j <= i__2;
 ++j) {
 i__3 = u11 + i__ + j * work_dim1;
 work[i__3].r = 0.f; work[i__3].i = 0.f; // , expr subst  
 }
 i__2 = nnb;
 for (j = i__ + 1;
 j <= i__2;
 ...
 q__1.r = work[i__3].r * work[i__4].r - work[i__3].i * work[i__4].i; q__1.i = work[i__3].r * work[ i__4].i + work[i__3].i * work[i__4].r; // , expr subst  
 work[i__2].r = q__1.r; work[i__2].i = q__1.i; // , expr subst  
 }
 }
 else {
 i__1 = nnb;
 ...
 i__2 = i__ + j * work_dim1;
 i__3 = i__ + invd * work_dim1;
 q__2.r = work[i__3].r * u01_i_j__.r - work[i__3].i * u01_i_j__.i; q__2.i = work[i__3].r * u01_i_j__.i + work[i__3].i * u01_i_j__.r; // , expr subst  
 i__4 = i__ + (invd + 1) * work_dim1;
 q__3.r = work[i__4].r * u01_ip1_j__.r - work[i__4].i * u01_ip1_j__.i; q__3.i = work[i__4].r * u01_ip1_j__.i + work[i__4].i * u01_ip1_j__.r; // , expr subst  
 ...
 i__3 = cut + i__ + invd * work_dim1;
 i__4 = u11 + i__ + j * work_dim1;
 q__2.r = work[i__3].r * work[i__4].r - work[i__3].i * work[i__4].i; q__2.i = work[i__3].r * work[ i__4].i + work[i__3].i * work[i__4].r; // , expr subst  
 i__5 = cut + i__ + (invd + 1) * work_dim1;
 i__6 = u11 + i__ + 1 + j * work_dim1;
 q__3.r = work[i__5].r * work[i__6].r - work[i__5].i * work[i__6].i; q__3.i = work[i__5].r * work[ i__6].i + work[i__5].i * work[i__6].r; // , expr subst  
 q__1.r = q__2.r + q__3.r; q__1.i = q__2.i + q__3.i; // , expr subst  
 work[i__2].r = q__1.r; work[i__2].i = q__1.i; // , expr subst  
 i__2 = u11 + i__ + 1 + j * work_dim1;
 i__3 = cut + i__ + 1 + invd * work_dim1;
 q__2.r = work[i__3].r * u11_i_j__.r - work[i__3].i * u11_i_j__.i; q__2.i = work[i__3].r * u11_i_j__.i + work[i__3].i * u11_i_j__.r; // , expr subst  
 i__4 = cut + i__ + 1 + (invd + 1) * work_dim1;
 q__3.r = work[i__4].r * u11_ip1_j__.r - work[i__4].i * u11_ip1_j__.i; q__3.i = work[i__4].r * u11_ip1_j__.i + work[i__4].i * u11_ip1_j__.r; // , expr subst  
 q__1.r = q__2.r + q__3.r; q__1.i = q__2.i + q__3.i; // , expr subst  
 work[i__2].r = q__1.r; work[i__2].i = q__1.i; // , expr subst  
 }
 ++i__;
 ...
 q__1.r = a[i__4].r + work[i__5].r; q__1.i = a[i__4].i + work[i__5].i; // , expr subst  
 ...
 q__2.r = work[i__3].r * work[i__4].r - work[i__3].i * work[i__4].i; q__2.i = work[i__3].r * work[ i__4].i + work[i__3].i * work[i__4].r; // , expr subst  
 i__5 = cut + i__ + (invd + 1) * work_dim1;
 q__3.r = work[i__5].r * u11_ip1_j__.r - work[i__5].i * u11_ip1_j__.i; q__3.i = work[i__5].r * u11_ip1_j__.i + work[i__5].i * u11_ip1_j__.r; // , expr subst  
 q__1.r = q__2.r + q__3.r; q__1.i = q__2.i + q__3.i; // , expr subst  
 work[i__2].r = q__1.r; work[i__2].i = q__1.i; // , expr subst  
 i__2 = u11 + i__ - 1 + j * work_dim1;
