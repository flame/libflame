/* ../netlib/dlarrf.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int dlarrf_(integer *n, doublereal *d__, doublereal *l, doublereal *ld, integer *clstrt, integer *clend, doublereal *w, doublereal *wgap, doublereal *werr, doublereal *spdiam, doublereal * clgapl, doublereal *clgapr, doublereal *pivmin, doublereal *sigma, doublereal *dplus, doublereal *lplus, doublereal *work, integer *info)
{
    ...
    *info = 0;
    ...
    clwdth = (d__1 = w[*clend] - w[*clstrt], f2c_dabs(d__1)) + werr[*clend] + werr[ *clstrt];
    ...
    lsigma -= f2c_dabs(lsigma) * 4. * eps;
    rsigma += f2c_dabs(rsigma) * 4. * eps;
...
L5:
            ...
            ++i__)
    {
        ...
        if ((d__1 = dplus[i__ + 1], f2c_dabs(d__1)) < *pivmin)
        {
            dplus[i__ + 1] = -(*pivmin);
            /* Need to set SAWNAN1 because refined RRR test should not be used */
            /* in this case */
        ...
        /* Computing MAX */
        d__2 = max1;
        d__3 = (d__1 = dplus[i__ + 1], f2c_dabs(d__1)); // , expr subst
        max1 = max(d__2,d__3);
        /* L6: */
    }
            ...
            ++i__)
    {
        ...
        if ((d__1 = work[i__ + 1], f2c_dabs(d__1)) < *pivmin)
        {
            work[i__ + 1] = -(*pivmin);
            /* Need to set SAWNAN2 because refined RRR test should not be used */
            /* in this case */
        ...
        /* Computing MAX */
        d__2 = max2;
        d__3 = (d__1 = work[i__ + 1], f2c_dabs(d__1)); // , expr subst
        max2 = max(d__2,d__3);
        /* L7: */
    }
    ...
    if (tryrrr1 && dorrr1)
    {
        if (indx == 1)
        {
            tmp = (d__1 = dplus[*n], f2c_dabs(d__1));
            znm2 = 1.;
            prod = 1.;
            oldp = 1.;
            for (i__ = *n - 1;
                    ...
                    --i__)
            {
                ...
                {
                    prod *= (d__1 = work[*n + i__], f2c_dabs(d__1));
                }
                oldp = prod;
                /* Computing 2nd power */
                d__1 = prod;
                ...
                /* Computing MAX */
                d__2 = tmp;
                d__3 = (d__1 = dplus[i__] * prod, f2c_dabs(d__1)); // , expr subst
                tmp = max(d__2,d__3);
                /* L15: */
            }
        ...
        else if (indx == 2)
        {
                    ...
                    --i__)
            {
                ...
                {
                    prod *= (d__1 = lplus[i__], f2c_dabs(d__1));
                }
                oldp = prod;
                /* Computing 2nd power */
                d__1 = prod;
                ...
                /* Computing MAX */
                d__2 = tmp;
                d__3 = (d__1 = work[i__] * prod, f2c_dabs(d__1)); // , expr subst
                tmp = max(d__2,d__3);
                /* L16: */
            }
