/* ../netlib/dtrsna.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int dtrsna_(char *job, char *howmny, logical *select, integer *n, doublereal *t, integer *ldt, doublereal *vl, integer * ldvl, doublereal *vr, integer *ldvr, doublereal *s, doublereal *sep, integer *mm, integer *m, doublereal *work, integer *ldwork, integer * iwork, integer *info)
{
    ...
    *info = 0;
    ...
    if (*n == 1)
    {
        ...
        if (wantsp)
        {
            sep[1] = (d__1 = t[t_dim1 + 1], f2c_dabs(d__1));
        }
        return 0;
    }
        ...
        if (wantsp)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    mu = sqrt((d__1 = work[(work_dim1 << 1) + 1], f2c_dabs(d__1))) * sqrt((d__2 = work[work_dim1 + 2], f2c_dabs(d__2)));
