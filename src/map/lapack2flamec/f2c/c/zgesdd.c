...
int zgesdd_(char *jobz, integer *m, integer *n, doublecomplex *a, integer *lda, doublereal *s, doublecomplex *u, integer *ldu, doublecomplex *vt, integer *ldvt, doublecomplex *work, integer *lwork, doublereal *rwork, integer *iwork, integer *info)
{
    ...
    AOCL_DTL_SNPRINTF("zgesdd inputs: jobz %c, m %" FLA_IS ", n %" FLA_IS ", lda %" FLA_IS ", ldu %" FLA_IS ", ldvt %" FLA_IS "",*jobz, *m, *n, *lda, *ldu, *ldvt);
            ...
            */
            ...
            if (*m >= mnthr1)
            {
                if (wntqn)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*n << 1) + lwork_zgebrd_nn__; // , expr subst
                ...
                else if (wntqo)
                {
                    ...
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = *n + lwork_zungqr_mn__; // , expr subst
                    ...
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = (*n << 1) + lwork_zunmbr_qln_nn__; // , expr subst
                    wrkbl = fla_max(i__1,i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = (*n << 1) + lwork_zunmbr_prc_nn__; // , expr subst
                    wrkbl = fla_max(i__1,i__2);
                ...
                else if (wntqa)
                {
                    ...
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = *n + lwork_zungqr_mm__; // , expr subst
                    wrkbl = fla_max(i__1,i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = (*n << 1) + lwork_zgebrd_nn__; // , expr subst
            ...
            else if (*m >= mnthr2)
            {
                ...
                if (wntqo)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*n << 1) + lwork_zungbr_p_nn__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*n << 1) + lwork_zungbr_q_mn__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                    maxwrk += *m * *n;
                    minwrk += *n * *n;
                }
                ...
                else if (wntqa)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*n << 1) + lwork_zungbr_q_mm__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                }
            }
            else
            {
                ...
                if (wntqo)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*n << 1) + lwork_zunmbr_qln_mn__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                    maxwrk += *m * *n;
                    minwrk += *n * *n;
                }
                ...
                else if (wntqa)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*n << 1) + lwork_zunmbr_qln_mm__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*n << 1) + lwork_zunmbr_prc_nn__; // , expr subst
            ...
            */
            ...
            if (*n >= mnthr1)
            {
                if (wntqn)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*m << 1) + lwork_zgebrd_mm__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                    minwrk = *m * 3;
                }
                else if (wntqo)
                {
                    ...
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = *m + lwork_zunglq_mn__; // , expr subst
                    wrkbl = fla_max(i__1,i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = (*m << 1) + lwork_zgebrd_mm__; // , expr subst
                    ...
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = (*m << 1) + lwork_zunmbr_qln_mm__; // , expr subst
                    wrkbl = fla_max(i__1,i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = (*m << 1) + lwork_zunmbr_prc_mm__; // , expr subst
                    wrkbl = fla_max(i__1,i__2);
                ...
                else if (wntqa)
                {
                    ...
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = *m + lwork_zunglq_nn__; // , expr subst
                    wrkbl = fla_max(i__1,i__2);
                    /* Computing MAX */
                    i__1 = wrkbl;
                    i__2 = (*m << 1) + lwork_zgebrd_mm__; // , expr subst
            ...
            else if (*n >= mnthr2)
            {
                ...
                if (wntqo)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*m << 1) + lwork_zungbr_q_mm__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*m << 1) + lwork_zungbr_p_mn__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                    maxwrk += *m * *n;
                    minwrk += *m * *m;
                }
                ...
                else if (wntqa)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*m << 1) + lwork_zungbr_p_nn__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                }
            }
            else
            {
                ...
                if (wntqo)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*m << 1) + lwork_zunmbr_prc_mn__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                    maxwrk += *m * *n;
                    minwrk += *m * *m;
                }
                ...
                else if (wntqa)
                {
                    ...
                    /* Computing MAX */
                    i__1 = maxwrk;
                    i__2 = (*m << 1) + lwork_zunmbr_prc_nn__; // , expr subst
                    maxwrk = fla_max(i__1,i__2);
                }
            }
        }
