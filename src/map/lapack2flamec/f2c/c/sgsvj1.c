/* ../netlib/sgsvj1.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 ...
 /* Computing MAX */
 r__1 = mxaapq; r__2 = f2c_abs(aapq); // , expr subst  
