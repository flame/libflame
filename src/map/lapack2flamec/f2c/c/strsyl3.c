/* strsyl3.f -- translated by f2c (version 20190311). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > \param[out] SWORK */
/* > \verbatim */
/* > SWORK is REAL array, dimension (fla_max(2, ROWS), */
/* > fla_max(1,COLS)). */
...
int strsyl3_(char *trana, char *tranb, integer *isgn, integer *m, integer *n, real *a, integer *lda, real *b, integer *ldb, real *c__, integer *ldc, real *scale, integer *iwork, integer *liwork, real *swork, integer *ldswork, integer *info)
{
    ...
    *info = 0;
    ...
    else if (! lquery && *ldswork < fla_max(nba,nbb))
    {
        *info = -16;
    }
    if (*info != 0)
    ...
    *scale = 1.f;
            ...
            ++k)
    {
                ...
                ++l)
        {
            ...
            if (a[l + (l + 1) * a_dim1] != 0.f && a[l + 1 + l * a_dim1] != 0.f)
            {
            ...
            ++k)
    {
                ...
                ++l)
        {
            ...
            if (b[l + (l + 1) * b_dim1] != 0.f && b[l + 1 + l * b_dim1] != 0.f)
            {
                /* Check if 2-by-2 block is split */
                if (l + 1 == iwork[pc + k + 1])
                {
            ...
            ++k)
    {
                ...
                ++l)
        {
            ...
            if (notrna)
            {
                i__3 = k2 - k1;
                i__4 = l2 - l1;
                swork[k + (awrk + l) * swork_dim1] = slange_("I", &i__3, & i__4, &a[k1 + l1 * a_dim1], lda, wnrm);
            }
            else
            {
                i__3 = k2 - k1;
                i__4 = l2 - l1;
                swork[l + (awrk + k) * swork_dim1] = slange_("1", &i__3, & i__4, &a[k1 + l1 * a_dim1], lda, wnrm);
            }
        }
    }
    bwrk = nbb + nba;
            ...
            ++k)
    {
                ...
                ++l)
        {
            ...
            if (notrnb)
            {
                i__3 = k2 - k1;
                i__4 = l2 - l1;
                swork[k + (bwrk + l) * swork_dim1] = slange_("I", &i__3, & i__4, &b[k1 + l1 * b_dim1], ldb, wnrm);
            }
            else
            {
                i__3 = k2 - k1;
                i__4 = l2 - l1;
                swork[l + (bwrk + k) * swork_dim1] = slange_("1", &i__3, & i__4, &b[k1 + l1 * b_dim1], ldb, wnrm);
            }
        }
    }
    sgn = (real) (*isgn);
    if (notrna && notrnb)
    {
                ...
                --k)
        {
                    ...
                    ++l)
            {
                ...
                i__2 = k2 - k1;
                i__3 = l2 - l1;
                strsyl_(trana, tranb, isgn, &i__2, &i__3, &a[k1 + k1 * a_dim1], lda, &b[l1 + l1 * b_dim1], ldb, &c__[k1 + l1 * c_dim1], ldc, &scaloc, &iinfo);
                *info = fla_max(*info,iinfo);
                if (scaloc * swork[k + l * swork_dim1] == 0.f)
                {
                            ...
                            ++jj)
                    {
                                ...
                                ++ll)
                        {
                            ...
                            frexp(scaloc, &temp); d__1 = temp;
                            r__1 = bignum;
                            r__2 = swork[ll + jj * swork_dim1] / pow_dd(&c_b19, &d__1); // , expr subst
                        ...
                        --i__)
                {
                    ...
                    i__3 = l2 - l1;
                    i__4 = k2 - k1;
                    sgemm_("N", "N", &i__2, &i__3, &i__4, &c_b31, &a[i1 + k1 * a_dim1], lda, &c__[k1 + l1 * c_dim1], ldc, & c_b32, &c__[i1 + l1 * c_dim1], ldc);
                }
                i__2 = nbb;
                for (j = l + 1;
                        j <= i__2;
                        ++j)
                {
                    ...
                    i__5 = l2 - l1;
                    r__1 = -sgn;
                    sgemm_("N", "N", &i__3, &i__4, &i__5, &r__1, &c__[k1 + l1 * c_dim1], ldc, &b[l1 + j1 * b_dim1], ldb, &c_b32, &c__[k1 + j1 * c_dim1], ldc);
                }
            }
        }
    }
    else if (! notrna && notrnb)
    {
                ...
                ++k)
        {
                    ...
                    ++l)
            {
                ...
                i__3 = k2 - k1;
                i__4 = l2 - l1;
                strsyl_(trana, tranb, isgn, &i__3, &i__4, &a[k1 + k1 * a_dim1], lda, &b[l1 + l1 * b_dim1], ldb, &c__[k1 + l1 * c_dim1], ldc, &scaloc, &iinfo);
                *info = fla_max(*info,iinfo);
                if (scaloc * swork[k + l * swork_dim1] == 0.f)
                {
                    if (scaloc == 0.f)
                        ...
                        ++i__)
                {
                    ...
                    i__5 = l2 - l1;
                    i__6 = k2 - k1;
                    sgemm_("T", "N", &i__4, &i__5, &i__6, &c_b31, &a[k1 + i1 * a_dim1], lda, &c__[k1 + l1 * c_dim1], ldc, & c_b32, &c__[i1 + l1 * c_dim1], ldc);
                }
                i__3 = nbb;
                for (j = l + 1;
                        j <= i__3;
                        ++j)
                {
                    ...
                    i__6 = l2 - l1;
                    r__1 = -sgn;
                    sgemm_("N", "N", &i__4, &i__5, &i__6, &r__1, &c__[k1 + l1 * c_dim1], ldc, &b[l1 + j1 * b_dim1], ldb, &c_b32, &c__[k1 + j1 * c_dim1], ldc);
                }
            }
        }
    }
                    ...
                    --l)
            {
                ...
                *info = fla_max(*info,iinfo);
                        ...
                        ++i__)
                {
                    ...
                    i__4 = l2 - l1;
                    i__5 = k2 - k1;
                    sgemm_("T", "N", &i__3, &i__4, &i__5, &c_b31, &a[k1 + i1 * a_dim1], lda, &c__[k1 + l1 * c_dim1], ldc, & c_b32, &c__[i1 + l1 * c_dim1], ldc);
                }
                i__2 = l - 1;
                for (j = 1;
                        j <= i__2;
                        ++j)
                {
                    ...
                    i__5 = l2 - l1;
                    r__1 = -sgn;
                    sgemm_("N", "T", &i__3, &i__4, &i__5, &r__1, &c__[k1 + l1 * c_dim1], ldc, &b[j1 + l1 * b_dim1], ldb, &c_b32, &c__[k1 + j1 * c_dim1], ldc);
                }
            }
        }
    }
    else if (notrna && ! notrnb)
    {
                ...
                --k)
        {
                    ...
                    --l)
            {
                ...
                i__1 = k2 - k1;
                i__2 = l2 - l1;
                strsyl_(trana, tranb, isgn, &i__1, &i__2, &a[k1 + k1 * a_dim1], lda, &b[l1 + l1 * b_dim1], ldb, &c__[k1 + l1 * c_dim1], ldc, &scaloc, &iinfo);
                *info = fla_max(*info,iinfo);
                if (scaloc * swork[k + l * swork_dim1] == 0.f)
                {
                    if (scaloc == 0.f)
                        ...
                        ++j)
                {
                    ...
                    i__4 = l2 - l1;
                    r__1 = -sgn;
                    sgemm_("N", "T", &i__2, &i__3, &i__4, &r__1, &c__[k1 + l1 * c_dim1], ldc, &b[j1 + l1 * b_dim1], ldb, &c_b32, &c__[k1 + j1 * c_dim1], ldc);
                }
            }
        }
    }
    ...
    if (buf != 1.f && buf > 0.f)
    {
                ...
                ++k)
        {
                    ...
                    ++l)
            {
                /* Computing fla_max */
                r__2 = scal;
                r__3 = (r__1 = c__[k + l * c_dim1], f2c_abs(r__1)); // , expr subst
                scal = fla_max(r__2,r__3);
            }
        }
