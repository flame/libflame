 ...
 */
 ...
 char buffer[256]; 
 snprintf(buffer, 256,"dsyequb inputs: uplo %c, n %" FLA_IS ", lda %" FLA_IS "",*uplo, *n, *lda);
 ...
 *amax = 0.;
 ...
 ++i__) {
 /* Computing MAX */
 d__2 = s[i__]; d__3 = (d__1 = a[i__ + j * a_dim1], f2c_abs(d__1)); // , expr subst  
 s[i__] = max(d__2,d__3);
 /* Computing MAX */
 d__2 = s[j]; d__3 = (d__1 = a[i__ + j * a_dim1], f2c_abs(d__1)); // , expr subst  
 s[j] = max(d__2,d__3);
 /* Computing MAX */
 d__2 = *amax; d__3 = (d__1 = a[i__ + j * a_dim1], f2c_abs(d__1)); // , expr subst  
 *amax = max(d__2,d__3);
 }
 /* Computing MAX */
 d__2 = s[j]; d__3 = (d__1 = a[j + j * a_dim1], f2c_abs(d__1)); // , expr subst  
 s[j] = max(d__2,d__3);
 /* Computing MAX */
 d__2 = *amax; d__3 = (d__1 = a[j + j * a_dim1], f2c_abs(d__1)); // , expr subst  
 *amax = max(d__2,d__3);
 }
 }
 else {
