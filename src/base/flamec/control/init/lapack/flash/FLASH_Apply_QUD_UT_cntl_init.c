...
__thread fla_apqudut_t*   flash_apqudut_cntl_leaf = NULL;
__thread fla_apqudut_t*   flash_apqudut_cntl_mid = NULL;
__thread fla_apqudut_t*   flash_apqudut_cntl = NULL;
__thread fla_blocksize_t* flash_apqudut_var2_bsize = NULL;
__thread fla_blocksize_t* flash_apqudut_var3_bsize = NULL;
