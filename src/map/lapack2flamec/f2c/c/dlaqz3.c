 ...
 *info = 0;
 ...
 /* Computing 2nd power */
 i__3 = jw;
 i__1 = lworkreq; i__2 = (integer) work[1] + (i__3 * i__3 << 1); // , expr subst  
 ...
 *nd = 0;
 /* Computing MAX */
 d__2 = smlnum; d__3 = ulp * (d__1 = a[kwtop + kwtop * a_dim1], f2c_abs( d__1)); // , expr subst  
 ...
 *ns = jw - qz_small_info__;
 ...
 /* Computing MAX */
 d__3 = (d__1 = s * qc[(kwbot - kwtop) * qc_dim1 + 1], f2c_abs( d__1)); d__4 = (d__2 = s * qc[(kwbot - kwtop + 1) * qc_dim1 + 1], f2c_abs(d__2)); // , expr subst  
 /* Computing MAX */
 d__5 = smlnum; d__6 = ulp * temp; // , expr subst  
 ...
 *ns = jw - *nd;
 ...
 ++jli) {
 i__3 = jli * qc_dim1 + 1;
 q__1.r = qc[i__3]; q__1.i = 0.f; // , expr subst  
 i__4 = jki + (kwtop - 1) * a_dim1;
 i__5 = kwtop + (kwtop - 1) * a_dim1;
 r_cnjg(&q__2, &q__1);
 z__1.r = a[i__5] * q__2.r; z__1.i = a[i__5] * q__2.i; // , expr subst  
 a[i__4] = z__1.r;
 }
 }
 i__1 = kwtop;
