...
__thread fla_her2k_t*        fla_her2k_cntl_blas = NULL;
__thread fla_her2k_t*        fla_her2k_cntl_ip = NULL;
__thread fla_her2k_t*        fla_her2k_cntl_op = NULL;
__thread fla_her2k_t*        fla_her2k_cntl_mm = NULL;
__thread fla_blocksize_t*    fla_her2k_var3_bsize = NULL;
__thread fla_blocksize_t*    fla_her2k_var9_bsize = NULL;
