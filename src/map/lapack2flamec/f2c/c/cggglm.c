/* ../netlib/v3.9.0/cggglm.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 extern /* Subroutine */
 int cgemv_(char *, integer *, integer *, complex * , complex *, integer *, complex *, integer *, complex *, complex * , integer *), ccopy_(integer *, complex *, integer *, complex *, integer *), cggqrf_(integer *, integer *, integer *, complex *, integer *, complex *, complex *, integer *, complex *, complex *, integer *, integer *), xerbla_(char *, integer *);
 ...
 *info = -12;
 ...
 /* Computing MAX */
 i__3 = *m + np + 1;
 i__1 = lopt; i__2 = (integer) work[i__3].r; // , expr subst  
 lopt = max(i__1,i__2);
 ...
 *info = 1;
 ...
 ++i__) {
 i__2 = i__;
 y[i__2].r = 0.f; y[i__2].i = 0.f; // , expr subst  
 /* L10: */
 }
 /* Update d1 = d1 - T12*y2 */
 i__1 = *n - *m;
 q__1.r = -1.f; q__1.i = -0.f; // , expr subst  
 cgemv_("No transpose", m, &i__1, &q__1, &b[(*m + *p - *n + 1) * b_dim1 + 1], ldb, &y[*m + *p - *n + 1], &c__1, &c_b2, &d__[1], &c__1);
