 ...
 *info = -9;
 ...
 ++q) {
 /* Computing MIN */
 d__3 = (d__1 = v[p + p * v_dim1], f2c_abs(d__1)); d__4 = (d__2 = v[q + q * v_dim1], f2c_abs( d__2)); // , expr subst  
 ...
 ++p) {
 /* Computing MIN */
 d__3 = (d__1 = u[p + p * u_dim1], f2c_abs(d__1)); d__4 = ( d__2 = u[q + q * u_dim1], f2c_abs(d__2)); // , expr subst  
 temp1 = xsc * min(d__3,d__4);
