...
// Static variables.
static char* op_str                   = "QR factorization via UT transform (incremental)";
static char* flash_front_str          = "FLASH_QR_UT_inc";
...
// Local prototypes.
void libfla_test_qrutinc_experiment( test_params_t params,
                                     unsigned int  var,
                                     char*         sc_str,
...
void libfla_test_qrutinc( FILE* output_stream, test_params_t params, test_op_t op )
{
	...
	if ( op.flash_front == ENABLE )
	{
		...
		libfla_test_op_driver( flash_front_str, NULL,
		                       ...
		                       params, thresh, libfla_test_qrutinc_experiment );
	}
                                     ...
                                     double*       residual )
{
	...
	FLASH_QR_UT_inc_solve( A_test, TW_test, b_test, x_test );
