...
int dlagv2_(doublereal *a, integer *lda, doublereal *b, integer *ldb, doublereal *alphar, doublereal *alphai, doublereal * beta, doublereal *csl, doublereal *snl, doublereal *csr, doublereal * snr)
{
    ...
    /* Scale B */
    /* Computing MAX */
    d__4 = (d__3 = b[b_dim1 + 1], abs(d__3));
    d__5 = (d__1 = b[(b_dim1 << 1) + 1], abs(d__1)) + (d__2 = b[(b_dim1 << 1) + 2], abs(d__2));
    ...
    else
    {
        ...
        if (wi == 0.)
        {
            ...
            *snr = -(*snr);
            ...
            d__6 = (d__3 = a[a_dim1 + 2], abs(d__3) ) + (d__4 = a[(a_dim1 << 1) + 2], abs(d__4)); // , expr subst
            h1 = max(d__5,d__6);
            /* Computing MAX */
