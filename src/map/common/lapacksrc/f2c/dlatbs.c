/* ../netlib/dlatbs.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
    ...
    if (notran)
    {
        ...
        if (nounit)
        {
                    ...
                    j += i__2)
            {
                ...
                tjj = (d__1 = ab[maind + j * ab_dim1], f2c_abs(d__1));
                /* Computing MIN */
                d__1 = xbnd;
