/* ../netlib/dlange.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
doublereal dlange_(char *norm, integer *m, integer *n, doublereal *a, integer *lda, doublereal *work)
{
    ...
    AOCL_DTL_SNPRINTF("dlange inputs: norm %c, m %" FLA_IS ", n %" FLA_IS ", lda %" FLA_IS "",*norm, *m, *n, *lda);
