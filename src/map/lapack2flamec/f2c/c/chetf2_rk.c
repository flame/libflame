 ...
 *info = k;
 ...
 a[i__1].r = r__1; a[i__1].i = 0.f; // , expr subst  
 i__1 = p + p * a_dim1;
 a[i__1].r = r1; a[i__1].i = 0.f; // , expr subst  
 ...
 i__2 = ii + k * a_dim1;
 i__3 = ii + k * a_dim1;
 q__1.r = a[i__3].r / d11; q__1.i = a[i__3].i / d11; // , expr subst  
 a[i__2].r = q__1.r; a[i__2].i = q__1.i; // , expr subst  
 /* L16: */
 }
 ...
 i__1 = k + k * a_dim1;
 q__1.r = a[i__1].r / d__; q__1.i = a[i__1].i / d__; // , expr subst  
 d11 = q__1.r;
 i__1 = k - 1 + (k - 1) * a_dim1;
 q__1.r = a[i__1].r / d__; q__1.i = a[i__1].i / d__; // , expr subst  
 d22 = q__1.r;
 i__1 = k - 1 + k * a_dim1;
 q__1.r = a[i__1].r / d__; q__1.i = a[i__1].i / d__; // , expr subst  
 d12.r = q__1.r; d12.i = q__1.i; // , expr subst  
 tt = 1.f / (d11 * d22 - 1.f);
 for (j = k - 2;
 j >= 1;
 --j) {
 ...
 i__1 = j + (k - 1) * a_dim1;
 q__3.r = d11 * a[i__1].r; q__3.i = d11 * a[i__1].i; // , expr subst  
 r_cnjg(&q__5, &d12);
 i__2 = j + k * a_dim1;
 q__4.r = q__5.r * a[i__2].r - q__5.i * a[i__2].i; q__4.i = q__5.r * a[i__2].i + q__5.i * a[i__2] .r; // , expr subst  
 q__2.r = q__3.r - q__4.r; q__2.i = q__3.i - q__4.i; // , expr subst  
 q__1.r = tt * q__2.r; q__1.i = tt * q__2.i; // , expr subst  
 wkm1.r = q__1.r; wkm1.i = q__1.i; // , expr subst  
 i__1 = j + k * a_dim1;
 q__3.r = d22 * a[i__1].r; q__3.i = d22 * a[i__1].i; // , expr subst  
 i__2 = j + (k - 1) * a_dim1;
 q__4.r = d12.r * a[i__2].r - d12.i * a[i__2].i; q__4.i = d12.r * a[i__2].i + d12.i * a[i__2] .r; // , expr subst  
 q__2.r = q__3.r - q__4.r; q__2.i = q__3.i - q__4.i; // , expr subst  
 q__1.r = tt * q__2.r; q__1.i = tt * q__2.i; // , expr subst  
 ...
 i__2 = i__ + j * a_dim1;
 i__3 = i__ + k * a_dim1;
 q__4.r = a[i__3].r / d__; q__4.i = a[i__3].i / d__; // , expr subst  
 r_cnjg(&q__5, &wk);
 ...
 i__4 = i__ + (k - 1) * a_dim1;
 q__7.r = a[i__4].r / d__; q__7.i = a[i__4].i / d__; // , expr subst  
 r_cnjg(&q__8, &wkm1);
 q__6.r = q__7.r * q__8.r - q__7.i * q__8.i; q__6.i = q__7.r * q__8.i + q__7.i * q__8.r; // , expr subst  
 ...
 i__1 = j + k * a_dim1;
 q__1.r = wk.r / d__; q__1.i = wk.i / d__; // , expr subst  
 a[i__1].r = q__1.r; a[i__1].i = q__1.i; // , expr subst  
 i__1 = j + (k - 1) * a_dim1;
 q__1.r = wkm1.r / d__; q__1.i = wkm1.i / d__; // , expr subst  
 a[i__1].r = q__1.r; a[i__1].i = q__1.i; // , expr subst  
 /* (*) Make sure that diagonal element of pivot is real */
 i__1 = j + j * a_dim1;
 i__2 = j + j * a_dim1;
 ...
 *info = k;
 ...
 i__1 = k + 1 + k * a_dim1;
 q__1.r = a[i__1].r / d__; q__1.i = a[i__1].i / d__; // , expr subst  
 d21.r = q__1.r; d21.i = q__1.i; // , expr subst  
 tt = 1.f / (d11 * d22 - 1.f);
 i__1 = *n;
 for (j = k + 2;
 j <= i__1;
 ...
 /* Compute D21 * ( W(k)W(k+1) ) * inv(D(k)) for row J */
 i__2 = j + k * a_dim1;
 q__3.r = d11 * a[i__2].r; q__3.i = d11 * a[i__2].i; // , expr subst  
 i__3 = j + (k + 1) * a_dim1;
 q__4.r = d21.r * a[i__3].r - d21.i * a[i__3].i; q__4.i = d21.r * a[i__3].i + d21.i * a[i__3] .r; // , expr subst  
 q__2.r = q__3.r - q__4.r; q__2.i = q__3.i - q__4.i; // , expr subst  
 q__1.r = tt * q__2.r; q__1.i = tt * q__2.i; // , expr subst  
 wk.r = q__1.r; wk.i = q__1.i; // , expr subst  
 i__2 = j + (k + 1) * a_dim1;
 q__3.r = d22 * a[i__2].r; q__3.i = d22 * a[i__2].i; // , expr subst  
 r_cnjg(&q__5, &d21);
 i__3 = j + k * a_dim1;
 q__4.r = q__5.r * a[i__3].r - q__5.i * a[i__3].i; q__4.i = q__5.r * a[i__3].i + q__5.i * a[i__3] .r; // , expr subst  
 q__2.r = q__3.r - q__4.r; q__2.i = q__3.i - q__4.i; // , expr subst  
 q__1.r = tt * q__2.r; q__1.i = tt * q__2.i; // , expr subst  
 ...
 i__4 = i__ + j * a_dim1;
 i__5 = i__ + k * a_dim1;
 q__4.r = a[i__5].r / d__; q__4.i = a[i__5].i / d__; // , expr subst  
 r_cnjg(&q__5, &wk);
 q__3.r = q__4.r * q__5.r - q__4.i * q__5.i; q__3.i = q__4.r * q__5.i + q__4.i * q__5.r; // , expr subst  
 q__2.r = a[i__4].r - q__3.r; q__2.i = a[i__4].i - q__3.i; // , expr subst  
 i__6 = i__ + (k + 1) * a_dim1;
 q__7.r = a[i__6].r / d__; q__7.i = a[i__6].i / d__; // , expr subst  
 r_cnjg(&q__8, &wkp1);
 q__6.r = q__7.r * q__8.r - q__7.i * q__8.i; q__6.i = q__7.r * q__8.i + q__7.i * q__8.r; // , expr subst  
 q__1.r = q__2.r - q__6.r; q__1.i = q__2.i - q__6.i; // , expr subst  
 ...
 a[i__2].r = q__1.r; a[i__2].i = q__1.i; // , expr subst  
 i__2 = j + (k + 1) * a_dim1;
 q__1.r = wkp1.r / d__; q__1.i = wkp1.i / d__; // , expr subst  
 a[i__2].r = q__1.r; a[i__2].i = q__1.i; // , expr subst  
 /* (*) Make sure that diagonal element of pivot is real */
 i__2 = j + j * a_dim1;
 i__3 = j + j * a_dim1;
