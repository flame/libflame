            ...
            if (upper)
            {
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        {
                            i__4 = kc + i__ - 1;
                            rwork[i__] += ((d__1 = ap[i__4].r, abs(d__1)) + ( d__2 = d_imag(&ap[kc + i__ - 1]), abs( d__2))) * xk;
                            /* L30: */
                        }
                        kc += k;
                        /* L40: */
            ...
            else
            {
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        {
                            i__4 = kc + i__ - k;
                            rwork[i__] += ((d__1 = ap[i__4].r, abs(d__1)) + ( d__2 = d_imag(&ap[kc + i__ - k]), abs( d__2))) * xk;
                            /* L70: */
                        }
                        kc = kc + *n - k + 1;
                        /* L80: */
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                                ...
                                ++i__)
                        {
                            i__4 = kc + i__ - 1;
                            i__5 = i__ + j * x_dim1;
                            s += ((d__1 = ap[i__4].r, abs(d__1)) + (d__2 = d_imag(&ap[kc + i__ - 1]), abs(d__2))) * ( (d__3 = x[i__5].r, abs(d__3)) + (d__4 = d_imag(&x[i__ + j * x_dim1]), abs(d__4)));
                            /* L110: */
                        }
                        rwork[k] += s;
                        kc += k;
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                                ...
                                ++i__)
                        {
                            i__4 = kc + i__ - k;
                            i__5 = i__ + j * x_dim1;
                            s += ((d__1 = ap[i__4].r, abs(d__1)) + (d__2 = d_imag(&ap[kc + i__ - k]), abs(d__2))) * ( (d__3 = x[i__5].r, abs(d__3)) + (d__4 = d_imag(&x[i__ + j * x_dim1]), abs(d__4)));
                            /* L150: */
                        }
                        rwork[k] += s;
                        kc = kc + *n - k + 1;
