...
void FLA_Eig_gest_cntl_init_ts(FLA_Cntl_init_flamec_s *FLA_cntl_flamec_init_i)
{
	...
	FLA_cntl_flamec_init_i->fla_eig_gest_var1_bsize = FLA_Query_blocksizes( FLA_DIMENSION_MIN );

	// Create a control tree to invoke the unblocked subproblem (inverse cases).
	FLA_cntl_flamec_init_i->fla_eig_gest_ix_cntl_leaf = FLA_Cntl_eig_gest_obj_create( FLA_FLAT,
	...
	FLA_cntl_flamec_init_i->fla_eig_gest_nx_cntl_leaf = FLA_Cntl_eig_gest_obj_create( FLA_FLAT,
#ifdef FLA_ENABLE_EXTERNAL_LAPACK_FOR_SUBPROBLEMS
	                                                          FLA_BLOCKED_EXTERN,
#else
	...
	// (inverse cases).
	FLA_cntl_flamec_init_i->fla_eig_gest_ix_cntl      = FLA_Cntl_eig_gest_obj_create( FLA_FLAT,
	                                                          FLA_BLOCKED_VARIANT4, 
	                                                          FLA_cntl_flamec_init_i->fla_eig_gest_var1_bsize,
	                                                          FLA_cntl_flamec_init_i->fla_eig_gest_ix_cntl_leaf,
	...
	// Create a control tree for large problems with no extra recursion
	// (no inverse cases).
	FLA_cntl_flamec_init_i->fla_eig_gest_nx_cntl      = FLA_Cntl_eig_gest_obj_create( FLA_FLAT,
	                                                          FLA_BLOCKED_VARIANT2, 
	                                                          FLA_cntl_flamec_init_i->fla_eig_gest_var1_bsize,
	                                                          FLA_cntl_flamec_init_i->fla_eig_gest_nx_cntl_leaf,
	                                                          FLA_cntl_flamec_init_i->fla_axpy_cntl_blas,
	                                                          FLA_cntl_flamec_init_i->fla_axpy_cntl_blas,
	                                                          FLA_cntl_flamec_init_i->fla_gemm_cntl_blas,
	                                                          FLA_cntl_flamec_init_i->fla_gemm_cntl_blas,
...
{
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_eig_gest_ix_cntl );
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_eig_gest_nx_cntl );
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_eig_gest_ix_cntl_leaf );
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_eig_gest_nx_cntl_leaf );

	FLA_Blocksize_free( FLA_cntl_flamec_init_i->fla_eig_gest_var1_bsize );
}
#endif
