/* ../netlib/v3.9.0/slasy2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *xnorm = (r__1 = x[x_dim1 + 1], abs(r__1));
 ...
 L20: /* Computing MAX */
 /* Computing MAX */
 r__7 = (r__1 = tl[tl_dim1 + 1], abs(r__1)), r__8 = (r__2 = tr[tr_dim1 + 1] , abs(r__2)), r__7 = max(r__7,r__8), r__8 = (r__3 = tr[(tr_dim1 << 1) + 1], abs(r__3)), r__7 = max(r__7,r__8), r__8 = (r__4 = tr[ tr_dim1 + 2], abs(r__4)); r__7 = max(r__7,r__8); r__8 = (r__5 = tr[(tr_dim1 << 1) + 2], abs(r__5)); // ; expr subst  
 ...
 L30: /* Computing MAX */
 /* Computing MAX */
 r__7 = (r__1 = tr[tr_dim1 + 1], abs(r__1)), r__8 = (r__2 = tl[tl_dim1 + 1] , abs(r__2)), r__7 = max(r__7,r__8), r__8 = (r__3 = tl[(tl_dim1 << 1) + 1], abs(r__3)), r__7 = max(r__7,r__8), r__8 = (r__4 = tl[ tl_dim1 + 2], abs(r__4)); r__7 = max(r__7,r__8); r__8 = (r__5 = tl[(tl_dim1 << 1) + 2], abs(r__5)); // ; expr subst  
 r__6 = eps * max(r__7,r__8);
 smin = max(r__6,smlnum);
 tmp[0] = tl[tl_dim1 + 1] + sgn * tr[tr_dim1 + 1];
 ...
 *scale = 1.f;
 ...
 /* Computing MAX */
 r__1 = abs(btmp[0]); r__2 = abs(btmp[1]); // , expr subst  
 ...
 *xnorm = (r__1 = x[x_dim1 + 1], abs(r__1)) + (r__2 = x[(x_dim1 << 1) + 1], abs(r__2));
 ...
 x[x_dim1 + 2] = x2[1];
 /* Computing MAX */
 r__3 = (r__1 = x[x_dim1 + 1], abs(r__1)); r__4 = (r__2 = x[x_dim1 + 2] , abs(r__2)); // , expr subst  
 *xnorm = max(r__3,r__4);
 }
 return 0;
 /* 2 by 2: */
 ...
 /* Set pivots less than SMIN to SMIN. */
 L50: /* Computing MAX */
 r__5 = (r__1 = tr[tr_dim1 + 1], abs(r__1)), r__6 = (r__2 = tr[(tr_dim1 << 1) + 1], abs(r__2)), r__5 = max(r__5,r__6), r__6 = (r__3 = tr[ tr_dim1 + 2], abs(r__3)); r__5 = max(r__5,r__6); r__6 = (r__4 = tr[(tr_dim1 << 1) + 2], abs(r__4)); // ; expr subst  
 smin = max(r__5,r__6);
 /* Computing MAX */
 r__5 = smin, r__6 = (r__1 = tl[tl_dim1 + 1], abs(r__1)), r__5 = max(r__5, r__6), r__6 = (r__2 = tl[(tl_dim1 << 1) + 1], abs(r__2)), r__5 = max(r__5,r__6), r__6 = (r__3 = tl[tl_dim1 + 2], abs(r__3)); r__5 = max(r__5,r__6); r__6 = (r__4 = tl[(tl_dim1 << 1) + 2], abs(r__4)) ; // ; expr subst  
 smin = max(r__5,r__6);
 /* Computing MAX */
 r__1 = eps * smin;
 ...
 *scale = 1.f;
 ...
 /* Computing MAX */
 r__1 = abs(btmp[0]), r__2 = abs(btmp[1]), r__1 = max(r__1,r__2), r__2 = abs(btmp[2]); r__1 = max(r__1,r__2); r__2 = abs(btmp[3]); // ; expr subst  
 *scale = .125f / max(r__1,r__2);
 ...
 x[(x_dim1 << 1) + 2] = tmp[3];
 /* Computing MAX */
 r__1 = abs(tmp[0]) + abs(tmp[2]); r__2 = abs(tmp[1]) + abs(tmp[3]); // , expr subst  
 *xnorm = max(r__1,r__2);
 return 0;
 /* End of SLASY2 */
 }
