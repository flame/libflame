/* ../netlib/v3.9.0/dgesvj.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -6;
 ...
 /* Computing MAX */
 d__1 = mxaapq; d__2 = abs(aapq); // , expr subst  
 ...
 aqoap = aaqq / aapp;
 apoaq = aapp / aaqq;
 theta = (d__1 = aqoap - apoaq, abs( d__1)) * -.5 / aapq;
