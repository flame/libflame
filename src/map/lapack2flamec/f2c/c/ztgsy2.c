/* ../netlib/v3.9.0/ztgsy2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *scale = 1.;
 ...
 /* Build 2 by 2 system */
 i__2 = i__ + i__ * a_dim1;
 z__[0].r = a[i__2].r; z__[0].i = a[i__2].i; // , expr subst  
 i__2 = i__ + i__ * d_dim1;
 z__[1].r = d__[i__2].r; z__[1].i = d__[i__2].i; // , expr subst  
 i__2 = j + j * b_dim1;
 z__1.r = -b[i__2].r; z__1.i = -b[i__2].i; // , expr subst  
 z__[2].r = z__1.r; z__[2].i = z__1.i; // , expr subst  
 i__2 = j + j * e_dim1;
 z__1.r = -e[i__2].r; z__1.i = -e[i__2].i; // , expr subst  
 z__[3].r = z__1.r; z__[3].i = z__1.i; // , expr subst  
 /* Set up right hand side(s) */
 i__2 = i__ + j * c_dim1;
 rhs[0].r = c__[i__2].r; rhs[0].i = c__[i__2].i; // , expr subst  
 i__2 = i__ + j * f_dim1;
 rhs[1].r = f[i__2].r; rhs[1].i = f[i__2].i; // , expr subst  
 /* Solve Z * x = RHS */
 ...
 *info = ierr;
 ...
 k <= i__2;
 ++k) {
 z__1.r = scaloc; z__1.i = 0.; // , expr subst  
 ...
 *scale *= scaloc;
 ...
 i__2 = i__ + j * c_dim1;
 c__[i__2].r = rhs[0].r; c__[i__2].i = rhs[0].i; // , expr subst  
 i__2 = i__ + j * f_dim1;
 f[i__2].r = rhs[1].r; f[i__2].i = rhs[1].i; // , expr subst  
 /* Substitute R(I, J) and L(I, J) into remaining equation. */
 if (i__ > 1) {
 z__1.r = -rhs[0].r; z__1.i = -rhs[0].i; // , expr subst  
 ...
 *scale = 1.;
 ...
 z__[0].r = z__1.r; z__[0].i = z__1.i; // , expr subst  
 d_cnjg(&z__2, &b[j + j * b_dim1]);
 z__1.r = -z__2.r; z__1.i = -z__2.i; // , expr subst  
 z__[1].r = z__1.r; z__[1].i = z__1.i; // , expr subst  
 ...
 *scale *= scaloc;
 ...
 z__3.r = rhs[0].r * z__4.r - rhs[0].i * z__4.i; z__3.i = rhs[0].r * z__4.i + rhs[0].i * z__4.r; // , expr subst  
 z__2.r = f[i__4].r + z__3.r; z__2.i = f[i__4].i + z__3.i; // , expr subst  
 d_cnjg(&z__6, &e[k + j * e_dim1]);
 z__5.r = rhs[1].r * z__6.r - rhs[1].i * z__6.i; z__5.i = rhs[1].r * z__6.i + rhs[1].i * z__6.r; // , expr subst  
 z__1.r = z__2.r + z__5.r; z__1.i = z__2.i + z__5.i; // , expr subst  
 f[i__3].r = z__1.r; f[i__3].i = z__1.i; // , expr subst  
 /* L50: */
 }
 i__2 = *m;
 for (k = i__ + 1;
 ...
 z__3.r = z__4.r * rhs[0].r - z__4.i * rhs[0].i; z__3.i = z__4.r * rhs[0].i + z__4.i * rhs[0].r; // , expr subst  
 z__2.r = c__[i__4].r - z__3.r; z__2.i = c__[i__4].i - z__3.i; // , expr subst  
 d_cnjg(&z__6, &d__[i__ + k * d_dim1]);
 z__5.r = z__6.r * rhs[1].r - z__6.i * rhs[1].i; z__5.i = z__6.r * rhs[1].i + z__6.i * rhs[1].r; // , expr subst  
 z__1.r = z__2.r - z__5.r; z__1.i = z__2.i - z__5.i; // , expr subst  
 c__[i__3].r = z__1.r; c__[i__3].i = z__1.i; // , expr subst  
 /* L60: */
 }
 /* L70: */
 }
