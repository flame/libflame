/* ctbmv.f -- translated by f2c (version 19991025). You must link the resulting object file with the libraries: -lf2c -lm (in that order) */
#include "FLA_f2c.h"
/* Subroutine */
                        ...
                        ++j)
                {
                    ...
                    if (x[i__4].r != 0.f || x[i__4].i != 0.f)
                    {
                        ...
                        if (nounit)
                        {
                            ...
                            q__1.r = x[i__4].r * a[i__2].r - x[i__4].i * a[ i__2].i, q__1.i = x[i__4].r * a[i__2].i + x[i__4].i * a[i__2].r;
                        ...
                        --j)
                {
                    ...
                    if (x[i__1].r != 0.f || x[i__1].i != 0.f)
                    {
                        ...
                        if (nounit)
                        {
                            ...
                            i__1 = j;
                            i__3 = j * a_dim1 + 1;
                            q__1.r = x[i__1].r * a[i__3].r - x[i__1].i * a[ i__3].i, q__1.i = x[i__1].r * a[i__3].i + x[i__1].i * a[i__3].r;
                            x[i__4].r = q__1.r, x[i__4].i = q__1.i;
                        }
                    }
                    /* L60: */
                        ...
                        --j)
                {
                    ...
                    if (x[i__4].r != 0.f || x[i__4].i != 0.f)
                    {
                        ...
                        if (nounit)
                        {
                            ...
                            i__4 = jx;
                            i__1 = j * a_dim1 + 1;
                            q__1.r = x[i__4].r * a[i__1].r - x[i__4].i * a[ i__1].i, q__1.i = x[i__4].r * a[i__1].i + x[i__4].i * a[i__1].r;
                            x[i__3].r = q__1.r, x[i__3].i = q__1.i;
                        }
                    }
                    jx -= *incx;
                        ...
                        --j)
                {
                    ...
                    if (noconj)
                    {
                                ...
                                --i__)
                        {
                            i__4 = l + i__ + j * a_dim1;
                            i__1 = i__;
                            q__2.r = a[i__4].r * x[i__1].r - a[i__4].i * x[ i__1].i, q__2.i = a[i__4].r * x[i__1].i + a[i__4].i * x[i__1].r;
                        ...
                        ++j)
                {
                    ...
                    if (noconj)
                    {
                                ...
                                ++i__)
                        {
                            i__1 = l + i__ + j * a_dim1;
                            i__2 = i__;
                            q__2.r = a[i__1].r * x[i__2].r - a[i__1].i * x[ i__2].i, q__2.i = a[i__1].r * x[i__2].i + a[i__1].i * x[i__2].r;
                            q__1.r = temp.r + q__2.r, q__1.i = temp.i + q__2.i;
                            temp.r = q__1.r, temp.i = q__1.i;
                            /* L150: */
                        }
