                        ...
                        ++j)
                {
                    ...
                    if (x[i__2].r != 0. || x[i__2].i != 0.)
                    {
                        ...
                        if (nounit)
                        {
                            ...
                            i__3 = j;
                            i__4 = kk + j - 1;
                            z__1.r = x[i__3].r * ap[i__4].r - x[i__3].i * ap[ i__4].i, z__1.i = x[i__3].r * ap[i__4].i + x[i__3].i * ap[i__4].r;
                        ...
                        --j)
                {
                    ...
                    if (x[i__1].r != 0. || x[i__1].i != 0.)
                    {
                        ...
                        if (nounit)
                        {
                            ...
                            i__2 = j;
                            i__3 = kk - *n + j;
                            z__1.r = x[i__2].r * ap[i__3].r - x[i__2].i * ap[ i__3].i, z__1.i = x[i__2].r * ap[i__3].i + x[i__2].i * ap[i__3].r;
            ...
            if (*incx == 1)
            {
                        ...
                        --j)
                {
                    ...
                    if (noconj)
                    {
                        ...
                        {
                            i__1 = kk;
                            z__1.r = temp.r * ap[i__1].r - temp.i * ap[i__1] .i, z__1.i = temp.r * ap[i__1].i + temp.i * ap[i__1].r;
                                ...
                                --i__)
                        {
                            i__1 = k;
                            i__2 = i__;
                            z__2.r = ap[i__1].r * x[i__2].r - ap[i__1].i * x[ i__2].i, z__2.i = ap[i__1].r * x[i__2].i + ap[i__1].i * x[i__2].r;
            ...
            if (*incx == 1)
            {
                        ...
                        ++j)
                {
                    ...
                    if (noconj)
                    {
                        ...
                        {
                            i__2 = kk;
                            z__1.r = temp.r * ap[i__2].r - temp.i * ap[i__2] .i, z__1.i = temp.r * ap[i__2].i + temp.i * ap[i__2].r;
                            temp.r = z__1.r, temp.i = z__1.i;
                        }
                        i__2 = *n;
                        for (i__ = j + 1;
