/* ../netlib/cpbrfs.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
L20: /* Loop until stopping criterion is satisfied. */
        ...
        chbmv_(uplo, n, kd, &q__1, &ab[ab_offset], ldab, &x[j * x_dim1 + 1], & c__1, &c_b1, &work[1], &c__1);
        ...
        if (upper)
        {
                    ...
                    ++k)
            {
                        ...
                        ++i__)
                {
                    ...
                    rwork[i__] += ((r__1 = ab[i__3].r, f2c_abs(r__1)) + (r__2 = r_imag(&ab[l + i__ + k * ab_dim1]), f2c_abs(r__2))) * xk;
                    i__3 = l + i__ + k * ab_dim1;
                    i__4 = i__ + j * x_dim1;
                    s += ((r__1 = ab[i__3].r, f2c_abs(r__1)) + (r__2 = r_imag(&ab[ l + i__ + k * ab_dim1]), f2c_abs(r__2))) * ((r__3 = x[ i__4].r, f2c_abs(r__3)) + (r__4 = r_imag(&x[i__ + j * x_dim1]), f2c_abs(r__4)));
                    /* L40: */
                }
                i__5 = *kd + 1 + k * ab_dim1;
