/* ../netlib/chbgst.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int chbgst_(char *vect, char *uplo, integer *n, integer *ka, integer *kb, complex *ab, integer *ldab, complex *bb, integer *ldbb, complex *x, integer *ldx, complex *work, real *rwork, integer *info)
{
    ...
    extern /* Subroutine */
    int crot_(integer *, complex *, integer *, complex *, integer *, real *, complex *), cgerc_(integer *, integer *, complex *, complex *, integer *, complex *, integer *, complex *, integer *);
    ...
    if (upper)
    {
        ...
        if (update)
        {
                    ...
                    ++j)
            {
                ...
                q__1.r = ab[i__3].r / bii;
                q__1.i = ab[i__3].i / bii; // , expr subst
                ab[i__2].r = q__1.r;
                    ...
                    ++j)
            {
                ...
                q__1.r = ab[i__2].r / bii;
                q__1.i = ab[i__2].i / bii; // , expr subst
                ab[i__1].r = q__1.r;
                    ...
                    ++k)
            {
                        ...
                        ++j)
                {
                    ...
                    q__4.i = bb[i__5].r * q__5.i + bb[i__5].i * q__5.r; // , expr subst
                    q__3.r = ab[i__4].r - q__4.r;
                    q__3.i = ab[i__4].i - q__4.i; // , expr subst
                    ...
                    q__9.r = r__1 * bb[i__8].r;
                    q__9.i = r__1 * bb[i__8].i; // , expr subst
                    r_cnjg(&q__10, &bb[k - i__ + kb1 + i__ * bb_dim1]);
                    q__8.r = q__9.r * q__10.r - q__9.i * q__10.i;
                    q__8.i = q__9.r * q__10.i + q__9.i * q__10.r; // , expr subst
            ...
            if (wantx)
            {
                ...
                if (kbt > 0)
                {
                    ...
                    cgerc_(&i__3, &kbt, &q__1, &x[m + 1 + i__ * x_dim1], & c__1, &bb[kb1 - kbt + i__ * bb_dim1], &c__1, &x[m + 1 + (i__ - kbt) * x_dim1], ldx);
                }
            }
                ...
                ++k)
        {
            if (update)
            {
                ...
                if (i__ - k + *ka < *n && i__ - k > 1)
                {
                    ...
                    q__2.r = -bb[i__2].r;
                    q__2.i = -bb[i__2].i; // , expr subst
                    q__1.r = q__2.r * ra1.r - q__2.i * ra1.i;
                    q__1.i = q__2.r * ra1.i + q__2.i * ra1.r; // , expr subst
                    t.r = q__1.r;
                    t.i = q__1.i; // , expr subst
                    i__2 = i__ - k;
                    i__4 = i__ - k + *ka - m;
                    q__2.r = rwork[i__4] * t.r;
                    q__2.i = rwork[i__4] * t.i; // , expr subst
                    ...
                    i__4 = i__ - k + *ka - m;
                    q__2.r = work[i__4].r * t.r - work[i__4].i * t.i;
                    q__2.i = work[i__4].r * t.i + work[i__4].i * t.r; // , expr subst
                    i__1 = i__ - k + *ka - m;
                    i__5 = (i__ - k + *ka) * ab_dim1 + 1;
                    q__3.r = rwork[i__1] * ab[i__5].r;
                    q__3.i = rwork[i__1] * ab[i__5].i; // , expr subst
                    q__1.r = q__2.r + q__3.r;
                    q__1.i = q__2.i + q__3.i; // , expr subst
                    ab[i__2].r = q__1.r;
                    ab[i__2].i = q__1.i; // , expr subst
            ...
            if (nrt > 0)
            {
                clargv_(&nrt, &ab[j2t * ab_dim1 + 1], &inca, &work[j2t - m], & ka1, &rwork[j2t - m], &ka1);
            }
            if (nr > 0)
            {
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    clartv_(&nr, &ab[ka1 - l + j2 * ab_dim1], &inca, &ab[*ka - l + (j2 + 1) * ab_dim1], &inca, &rwork[j2 - m], &work[j2 - m], &ka1);
                    /* L100: */
                }
                /* apply rotations in 1st set from both sides to diagonal */
                /* blocks */
                clar2v_(&nr, &ab[ka1 + j2 * ab_dim1], &ab[ka1 + (j2 + 1) * ab_dim1], &ab[*ka + (j2 + 1) * ab_dim1], &inca, & rwork[j2 - m], &work[j2 - m], &ka1);
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[l + (j2 + ka1 - l) * ab_dim1], &inca, & ab[l + 1 + (j2 + ka1 - l) * ab_dim1], &inca, & rwork[j2 - m], &work[j2 - m], &ka1);
                }
                /* L110: */
            }
            if (wantx)
            {
                        ...
                        j += i__2)
                {
                    ...
                    crot_(&i__1, &x[m + 1 + j * x_dim1], &c__1, &x[m + 1 + (j + 1) * x_dim1], &c__1, &rwork[j - m], &q__1);
                    /* L120: */
                }
            }
            /* L130: */
                ...
                --k)
        {
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[l + (j2 - l + 1) * ab_dim1], &inca, &ab[ l + 1 + (j2 - l + 1) * ab_dim1], &inca, &rwork[j2 - *ka], &work[j2 - *ka], &ka1);
                }
                /* L140: */
            }
            nr = (*n - j2 + *ka) / ka1;
                ...
                --k)
        {
            ...
            if (nr > 0)
            {
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    clartv_(&nr, &ab[ka1 - l + j2 * ab_dim1], &inca, &ab[*ka - l + (j2 + 1) * ab_dim1], &inca, &rwork[j2], & work[j2], &ka1);
                    /* L180: */
                }
                /* apply rotations in 2nd set from both sides to diagonal */
                /* blocks */
                clar2v_(&nr, &ab[ka1 + j2 * ab_dim1], &ab[ka1 + (j2 + 1) * ab_dim1], &ab[*ka + (j2 + 1) * ab_dim1], &inca, & rwork[j2], &work[j2], &ka1);
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[l + (j2 + ka1 - l) * ab_dim1], &inca, & ab[l + 1 + (j2 + ka1 - l) * ab_dim1], &inca, & rwork[j2], &work[j2], &ka1);
                }
                /* L190: */
            }
            if (wantx)
            {
                        ...
                        j += i__2)
                {
                    i__4 = *n - m;
                    r_cnjg(&q__1, &work[j]);
                    crot_(&i__4, &x[m + 1 + j * x_dim1], &c__1, &x[m + 1 + (j + 1) * x_dim1], &c__1, &rwork[j], &q__1);
                    /* L200: */
                }
            }
            /* L210: */
    ...
    else
    {
        ...
        if (update)
        {
                    ...
                    ++j)
            {
                ...
                q__1.r = ab[i__4].r / bii;
                q__1.i = ab[i__4].i / bii; // , expr subst
                ab[i__3].r = q__1.r;
                    ...
                    ++k)
            {
                        ...
                        ++j)
                {
                    ...
                    q__4.r = bb[i__5].r * q__5.r - bb[i__5].i * q__5.i;
                    q__4.i = bb[i__5].r * q__5.i + bb[i__5].i * q__5.r; // , expr subst
                    q__3.r = ab[i__1].r - q__4.r;
                    q__3.i = ab[i__1].i - q__4.i; // , expr subst
            ...
            if (wantx)
            {
                ...
                if (kbt > 0)
                {
                    ...
                    q__1.i = -0.f; // , expr subst
                    i__3 = *ldbb - 1;
                    cgeru_(&i__4, &kbt, &q__1, &x[m + 1 + i__ * x_dim1], & c__1, &bb[kbt + 1 + (i__ - kbt) * bb_dim1], &i__3, &x[m + 1 + (i__ - kbt) * x_dim1], ldx);
                }
            }
                ...
                ++k)
        {
            if (update)
            {
                ...
                if (i__ - k + *ka < *n && i__ - k > 1)
                {
                    ...
                    clartg_(&ab[ka1 - k + i__ * ab_dim1], &ra1, &rwork[i__ - k + *ka - m], &work[i__ - k + *ka - m], &ra);
                    /* create nonzero element a(i-k+ka+1,i-k) outside the */
                    /* band and store it in WORK(i-k) */
                    i__3 = k + 1 + (i__ - k) * bb_dim1;
                    q__2.r = -bb[i__3].r;
                    q__2.i = -bb[i__3].i; // , expr subst
                    q__1.r = q__2.r * ra1.r - q__2.i * ra1.i;
                    q__1.i = q__2.r * ra1.i + q__2.i * ra1.r; // , expr subst
                    t.r = q__1.r;
                    t.i = q__1.i; // , expr subst
                    i__3 = i__ - k;
                    i__1 = i__ - k + *ka - m;
                    q__2.r = rwork[i__1] * t.r;
                    q__2.i = rwork[i__1] * t.i; // , expr subst
                    r_cnjg(&q__4, &work[i__ - k + *ka - m]);
                    ...
                    i__1 = i__ - k + *ka - m;
                    q__2.r = work[i__1].r * t.r - work[i__1].i * t.i;
                    q__2.i = work[i__1].r * t.i + work[i__1].i * t.r; // , expr subst
                    i__2 = i__ - k + *ka - m;
                    i__5 = ka1 + (i__ - k) * ab_dim1;
                    q__3.r = rwork[i__2] * ab[i__5].r;
                    q__3.i = rwork[i__2] * ab[i__5].i; // , expr subst
                    q__1.r = q__2.r + q__3.r;
                    q__1.i = q__2.i + q__3.i; // , expr subst
                    ab[i__3].r = q__1.r;
                    ab[i__3].i = q__1.i; // , expr subst
            ...
            if (nrt > 0)
            {
                clargv_(&nrt, &ab[ka1 + (j2t - *ka) * ab_dim1], &inca, &work[ j2t - m], &ka1, &rwork[j2t - m], &ka1);
            }
            if (nr > 0)
            {
                ...
                /* apply rotations in 1st set from both sides to diagonal */
                /* blocks */
                clar2v_(&nr, &ab[j2 * ab_dim1 + 1], &ab[(j2 + 1) * ab_dim1 + 1], &ab[j2 * ab_dim1 + 2], &inca, &rwork[j2 - m], & work[j2 - m], &ka1);
                clacgv_(&nr, &work[j2 - m], &ka1);
            }
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[ka1 - l + 1 + j2 * ab_dim1], &inca, &ab[ ka1 - l + (j2 + 1) * ab_dim1], &inca, &rwork[j2 - m], &work[j2 - m], &ka1);
                }
                /* L340: */
            }
            if (wantx)
            {
                ...
                {
                    i__2 = *n - m;
                    crot_(&i__2, &x[m + 1 + j * x_dim1], &c__1, &x[m + 1 + (j + 1) * x_dim1], &c__1, &rwork[j - m], &work[j - m] );
                    /* L350: */
                }
            }
            /* L360: */
                ...
                --k)
        {
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[ka1 - l + 1 + (j2 - *ka) * ab_dim1], & inca, &ab[ka1 - l + (j2 - *ka + 1) * ab_dim1], & inca, &rwork[j2 - *ka], &work[j2 - *ka], &ka1);
                }
                /* L370: */
            }
            nr = (*n - j2 + *ka) / ka1;
                ...
                --k)
        {
            ...
            if (nr > 0)
            {
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    clartv_(&nr, &ab[l + 1 + (j2 - l) * ab_dim1], &inca, &ab[ l + 2 + (j2 - l) * ab_dim1], &inca, &rwork[j2], & work[j2], &ka1);
                    /* L410: */
                }
                /* apply rotations in 2nd set from both sides to diagonal */
                /* blocks */
                clar2v_(&nr, &ab[j2 * ab_dim1 + 1], &ab[(j2 + 1) * ab_dim1 + 1], &ab[j2 * ab_dim1 + 2], &inca, &rwork[j2], &work[ j2], &ka1);
                clacgv_(&nr, &work[j2], &ka1);
            }
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[ka1 - l + 1 + j2 * ab_dim1], &inca, &ab[ ka1 - l + (j2 + 1) * ab_dim1], &inca, &rwork[j2], &work[j2], &ka1);
                }
                /* L420: */
            }
            if (wantx)
            {
                ...
                {
                    i__1 = *n - m;
                    crot_(&i__1, &x[m + 1 + j * x_dim1], &c__1, &x[m + 1 + (j + 1) * x_dim1], &c__1, &rwork[j], &work[j]);
                    /* L430: */
                }
            }
            /* L440: */
    ...
    if (upper)
    {
        ...
        if (update)
        {
                    ...
                    ++j)
            {
                ...
                i__1 = j - i__ + ka1 + i__ * ab_dim1;
                q__1.r = ab[i__1].r / bii;
                q__1.i = ab[i__1].i / bii; // , expr subst
                ab[i__4].r = q__1.r;
                ab[i__4].i = q__1.i; // , expr subst
                /* L500: */
            }
                    ...
                    ++k)
            {
                        ...
                        ++j)
                {
                    ...
                    q__4.r = bb[i__5].r * q__5.r - bb[i__5].i * q__5.i;
                    q__4.i = bb[i__5].r * q__5.i + bb[i__5].i * q__5.r; // , expr subst
                    q__3.r = ab[i__2].r - q__4.r;
                    q__3.i = ab[i__2].i - q__4.i; // , expr subst
            ...
            if (wantx)
            {
                ...
                if (kbt > 0)
                {
                    ...
                    q__1.i = -0.f; // , expr subst
                    i__3 = *ldbb - 1;
                    cgeru_(&nx, &kbt, &q__1, &x[i__ * x_dim1 + 1], &c__1, &bb[ *kb + (i__ + 1) * bb_dim1], &i__3, &x[(i__ + 1) * x_dim1 + 1], ldx);
                }
            }
            /* store a(i1,i) in RA1 for use in next loop over K */
                ...
                ++k)
        {
            if (update)
            {
                ...
                {
                    /* generate rotation to annihilate a(i+k-ka-1,i) */
                    clartg_(&ab[k + 1 + i__ * ab_dim1], &ra1, &rwork[i__ + k - *ka], &work[i__ + k - *ka], &ra);
                    /* create nonzero element a(i+k-ka-1,i+k) outside the */
                    /* band and store it in WORK(m-kb+i+k) */
                    i__4 = kb1 - k + (i__ + k) * bb_dim1;
                    q__2.r = -bb[i__4].r;
                    q__2.i = -bb[i__4].i; // , expr subst
                    q__1.r = q__2.r * ra1.r - q__2.i * ra1.i;
                    q__1.i = q__2.r * ra1.i + q__2.i * ra1.r; // , expr subst
                    t.r = q__1.r;
                    t.i = q__1.i; // , expr subst
            ...
            if (nrt > 0)
            {
                clargv_(&nrt, &ab[(j1 + *ka) * ab_dim1 + 1], &inca, &work[j1], &ka1, &rwork[j1], &ka1);
            }
            if (nr > 0)
            {
                /* apply rotations in 1st set from the left */
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    clartv_(&nr, &ab[ka1 - l + (j1 + l) * ab_dim1], &inca, & ab[*ka - l + (j1 + l) * ab_dim1], &inca, &rwork[ j1], &work[j1], &ka1);
                    /* L580: */
                }
                /* apply rotations in 1st set from both sides to diagonal */
                /* blocks */
                clar2v_(&nr, &ab[ka1 + j1 * ab_dim1], &ab[ka1 + (j1 - 1) * ab_dim1], &ab[*ka + j1 * ab_dim1], &inca, &rwork[j1], &work[j1], &ka1);
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[l + j1t * ab_dim1], &inca, &ab[l + 1 + ( j1t - 1) * ab_dim1], &inca, &rwork[j1t], &work[ j1t], &ka1);
                }
                /* L590: */
            }
            if (wantx)
            {
                ...
                for (j = j1;
                        ...
                        j += i__4)
                {
                    crot_(&nx, &x[j * x_dim1 + 1], &c__1, &x[(j - 1) * x_dim1 + 1], &c__1, &rwork[j], &work[j]);
                    /* L600: */
                }
            }
            /* L610: */
                ...
                --k)
        {
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[l + (j1t + *ka) * ab_dim1], &inca, &ab[ l + 1 + (j1t + *ka - 1) * ab_dim1], &inca, &rwork[ m - *kb + j1t + *ka], &work[m - *kb + j1t + *ka], &ka1);
                }
                /* L620: */
            }
            nr = (j2 + *ka - 1) / ka1;
                ...
                --k)
        {
            ...
            if (nr > 0)
            {
                /* generate rotations in 2nd set to annihilate elements */
                /* which have been created outside the band */
                clargv_(&nr, &ab[(j1 + *ka) * ab_dim1 + 1], &inca, &work[m - * kb + j1], &ka1, &rwork[m - *kb + j1], &ka1);
                /* apply rotations in 2nd set from the left */
                i__3 = *ka - 1;
                for (l = 1;
                        l <= i__3;
                        ++l)
                {
                    clartv_(&nr, &ab[ka1 - l + (j1 + l) * ab_dim1], &inca, & ab[*ka - l + (j1 + l) * ab_dim1], &inca, &rwork[m - *kb + j1], &work[m - *kb + j1], &ka1);
                    /* L660: */
                }
                /* apply rotations in 2nd set from both sides to diagonal */
                /* blocks */
                clar2v_(&nr, &ab[ka1 + j1 * ab_dim1], &ab[ka1 + (j1 - 1) * ab_dim1], &ab[*ka + j1 * ab_dim1], &inca, &rwork[m - * kb + j1], &work[m - *kb + j1], &ka1);
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[l + j1t * ab_dim1], &inca, &ab[l + 1 + ( j1t - 1) * ab_dim1], &inca, &rwork[m - *kb + j1t], &work[m - *kb + j1t], &ka1);
                }
                /* L670: */
            }
            if (wantx)
            {
                ...
                for (j = j1;
                        ...
                        j += i__4)
                {
                    crot_(&nx, &x[j * x_dim1 + 1], &c__1, &x[(j - 1) * x_dim1 + 1], &c__1, &rwork[m - *kb + j], &work[m - *kb + j]);
                    /* L680: */
                }
            }
            /* L690: */
    ...
    else
    {
        ...
        if (update)
        {
            ...
            if (wantx)
            {
                ...
                if (kbt > 0)
                {
                    q__1.r = -1.f;
                    q__1.i = -0.f; // , expr subst
                    cgerc_(&nx, &kbt, &q__1, &x[i__ * x_dim1 + 1], &c__1, &bb[ i__ * bb_dim1 + 2], &c__1, &x[(i__ + 1) * x_dim1 + 1], ldx);
                }
            }
            /* store a(i,i1) in RA1 for use in next loop over K */
                ...
                ++k)
        {
            if (update)
            {
                ...
                {
                    /* generate rotation to annihilate a(i,i+k-ka-1) */
                    clartg_(&ab[ka1 - k + (i__ + k - *ka) * ab_dim1], &ra1, & rwork[i__ + k - *ka], &work[i__ + k - *ka], &ra);
                    /* create nonzero element a(i+k,i+k-ka-1) outside the */
                    /* band and store it in WORK(m-kb+i+k) */
            ...
            if (nrt > 0)
            {
                clargv_(&nrt, &ab[ka1 + j1 * ab_dim1], &inca, &work[j1], &ka1, &rwork[j1], &ka1);
            }
            if (nr > 0)
            {
                /* apply rotations in 1st set from the right */
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    clartv_(&nr, &ab[l + 1 + j1 * ab_dim1], &inca, &ab[l + 2 + (j1 - 1) * ab_dim1], &inca, &rwork[j1], &work[ j1], &ka1);
                    /* L810: */
                }
                /* apply rotations in 1st set from both sides to diagonal */
                /* blocks */
                clar2v_(&nr, &ab[j1 * ab_dim1 + 1], &ab[(j1 - 1) * ab_dim1 + 1], &ab[(j1 - 1) * ab_dim1 + 2], &inca, &rwork[j1], & work[j1], &ka1);
                clacgv_(&nr, &work[j1], &ka1);
            }
            /* start applying rotations in 1st set from the left */
            i__1 = *kb - k + 1;
            ...
            if (wantx)
            {
                ...
                {
                    r_cnjg(&q__1, &work[j]);
                    crot_(&nx, &x[j * x_dim1 + 1], &c__1, &x[(j - 1) * x_dim1 + 1], &c__1, &rwork[j], &q__1);
                    /* L830: */
                }
            }
            /* L840: */
                ...
                --k)
        {
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    clartv_(&nrt, &ab[ka1 - l + 1 + (j1t + l - 1) * ab_dim1], &inca, &ab[ka1 - l + (j1t + l - 1) * ab_dim1], & inca, &rwork[m - *kb + j1t + *ka], &work[m - *kb + j1t + *ka], &ka1);
                }
                /* L850: */
            }
            nr = (j2 + *ka - 1) / ka1;
                ...
                --k)
        {
            ...
            if (nr > 0)
            {
                /* generate rotations in 2nd set to annihilate elements */
                /* which have been created outside the band */
                clargv_(&nr, &ab[ka1 + j1 * ab_dim1], &inca, &work[m - *kb + j1], &ka1, &rwork[m - *kb + j1], &ka1);
                /* apply rotations in 2nd set from the right */
                i__4 = *ka - 1;
                for (l = 1;
                        l <= i__4;
                ...
                /* apply rotations in 2nd set from both sides to diagonal */
                /* blocks */
                clar2v_(&nr, &ab[j1 * ab_dim1 + 1], &ab[(j1 - 1) * ab_dim1 + 1], &ab[(j1 - 1) * ab_dim1 + 2], &inca, &rwork[m - * kb + j1], &work[m - *kb + j1], &ka1);
                clacgv_(&nr, &work[m - *kb + j1], &ka1);
            }
            /* start applying rotations in 2nd set from the left */
            i__4 = *kb - k + 1;
            ...
            if (wantx)
            {
                        ...
                        j += i__3)
                {
                    ...
                    crot_(&nx, &x[j * x_dim1 + 1], &c__1, &x[(j - 1) * x_dim1 + 1], &c__1, &rwork[m - *kb + j], &q__1);
                    /* L910: */
                }
            }
            /* L920: */
