...
// Static variables.
static char* op_str                   = "Symmetric matrix-matrix multiply";
static char* flash_front_str          = "FLASH_Symm";
static char* fla_front_str            = "FLA_Symm";
...
static fla_symm_t*      symm_cntl_unb;
static fla_symm_t*      symm_cntl_blk;
static fla_blocksize_t* symm_cntl_bsize;
...
void libfla_test_symm_impl( int         impl,
                            ...
                            FLA_Obj     beta,
                            FLA_Obj     C );
void libfla_test_symm_cntl_create( unsigned int var,
                                   dim_t        b_alg_flat );
void libfla_test_symm_cntl_free( void );


void libfla_test_symm( FILE* output_stream, test_params_t params, test_op_t op )
{
	...
	if ( op.flash_front == ENABLE )
	{
		libfla_test_op_driver( flash_front_str, NULL,
		                       ...
		                       params, thresh, libfla_test_symm_experiment );
	}
...
extern LIBFLAME_IMPORT TLS_CLASS_SPEC fla_symm_t* fla_symm_cntl_blas;
                                   ...
                                   dim_t        b_alg_flat )
{
	...
	symm_cntl_bsize = FLA_Blocksize_create( b_alg_flat,
	                                        b_alg_flat,
	                                        b_alg_flat,
	                                        b_alg_flat );

	symm_cntl_unb   = FLA_Cntl_symm_obj_create( FLA_FLAT,
	                                            var_unb,
	                                            NULL,
	                                            NULL,
	                                            NULL,
	...
	symm_cntl_blk   = FLA_Cntl_symm_obj_create( FLA_FLAT,
	                                            var_blk,
	                                            symm_cntl_bsize,
	                                            fla_scal_cntl_blas,
	                                            fla_symm_cntl_blas,
