 ...
 *info = 0;
 ...
 i__1 = *m + *n;
 cwork[1].r = (doublereal) i__1; cwork[1].i = 0.; // , expr subst  
 ...
 *info = -6;
 ...
 ++q) {
 i__2 = q;
 cwork[i__2].r = 1.; cwork[i__2].i = 0.; // , expr subst  
 /* L1868: */
 }
 swband = 3;
 ...
 if (aapp > small / aaqq) {
 zdotc_f2c_(&z__3, m, &a[p * a_dim1 + 1], & c__1, &a[q * a_dim1 + 1], & c__1);
 z__2.r = z__3.r / aapp; z__2.i = z__3.i / aapp; // , expr subst  
 z__1.r = z__2.r / aaqq; z__1.i = z__2.i / aaqq; // , expr subst  
 aapq.r = z__1.r; aapq.i = z__1.i; // , expr subst  
 }
 else {
 ...
 i__5 = p;
 i__6 = q;
 z__2.r = -cwork[i__6].r; z__2.i = -cwork[i__6].i; // , expr subst  
 z__1.r = z__2.r * ompq.r - z__2.i * ompq.i; z__1.i = z__2.r * ompq.i + z__2.i * ompq.r; // , expr subst  
 cwork[i__5].r = z__1.r; cwork[i__5].i = z__1.i; // , expr subst  
 }
 else {
