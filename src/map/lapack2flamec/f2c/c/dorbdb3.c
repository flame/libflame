/* ../netlib/dorbdb3.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int dorbdb3_(integer *m, integer *p, integer *q, doublereal * x11, integer *ldx11, doublereal *x21, integer *ldx21, doublereal * theta, doublereal *phi, doublereal *taup1, doublereal *taup2, doublereal *tauq1, doublereal *work, integer *lwork, integer *info)
{
    ...
    *info = 0;
            ...
            ++i__)
    {
        ...
        i__2 = *p - i__ + 1;
        /* Computing 2nd power */
        d__1 = dnrm2_(&i__2, &x11[i__ + i__ * x11_dim1], &c__1, &x11[i__ + i__ * x11_dim1], &c__1);
        i__3 = *m - *p - i__;
        /* Computing 2nd power */
