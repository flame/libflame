...
L20: /* Loop until stopping criterion is satisfied. */
        ...
        if (upper)
        {
                    ...
                    ++k)
            {
                ...
                i__3 = kk + k - 1;
                rwork[k] = rwork[k] + ((d__1 = ap[i__3].r, f2c_dabs(d__1)) + (d__2 = d_imag(&ap[kk + k - 1]), f2c_dabs(d__2))) * xk + s;
                kk += k;
                /* L50: */
            }
        }
        else
        {
                    ...
                    ++k)
            {
                ...
                xk = (d__1 = x[i__3].r, f2c_dabs(d__1)) + (d__2 = d_imag(&x[k + j * x_dim1]), f2c_dabs(d__2));
                i__3 = kk;
                rwork[k] += ((d__1 = ap[i__3].r, f2c_dabs(d__1)) + (d__2 = d_imag(& ap[kk]), f2c_dabs(d__2))) * xk;
                ik = kk + 1;
                i__3 = *n;
                for (i__ = k + 1;
                        i__ <= i__3;
