/* ../netlib/dlaed2.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int dlaed2_(integer *k, integer *n, integer *n1, doublereal * d__, doublereal *q, integer *ldq, integer *indxq, doublereal *rho, doublereal *z__, doublereal *dlamda, doublereal *w, doublereal *q2, integer *indx, integer *indxc, integer *indxp, integer *coltyp, integer *info)
{
    ...
    *rho = (d__1 = *rho * 2., abs(d__1));
    ...
    eps = dlamch_("Epsilon");
    /* Computing MAX */
    d__3 = (d__1 = d__[jmax], abs(d__1));
    d__4 = (d__2 = z__[imax], abs(d__2)) ; // , expr subst
