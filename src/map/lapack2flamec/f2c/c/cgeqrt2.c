/* ../netlib/v3.9.0/cgeqrt2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -6;
 ...
 i__2 = i__ + i__ * a_dim1;
 aii.r = a[i__2].r; aii.i = a[i__2].i; // , expr subst  
 i__2 = i__ + i__ * a_dim1;
 ...
 i__2 = i__ + i__ * a_dim1;
 a[i__2].r = aii.r; a[i__2].i = aii.i; // , expr subst  
 }
 }
 i__1 = *n;
 for (i__ = 2;
