...
/* ../netlib/v3.9.0/zgerfsx.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
,inf) * norm(Z,inf)) for some */
 ...
 extern /* Subroutine */
 int zla_gerfsx_extended_(integer *, integer *, integer *, integer *, doublecomplex *, integer *, doublecomplex *, integer *, integer *, logical *, doublereal *, doublecomplex *, integer *, doublecomplex *, integer *, doublereal *, integer *, doublereal *, doublereal *, doublecomplex *, doublereal *, doublecomplex *, doublereal *, doublereal *, integer *, doublereal *, doublereal *, logical *, integer *);
 char norm[1];
 ...
 extern /* Subroutine */
 int zgecon_(char *, integer *, doublecomplex *, integer *, doublereal *, doublereal *, doublecomplex *, doublereal *, integer *);
 ...
 *(unsigned char *)norm = '1';
 ...
 if (colequ && notran) {
 rcond_tmp__ = zla_gercond_c_(trans, n, &a[a_offset], lda, &af[ af_offset], ldaf, &ipiv[1], &c__[1], &c_true, info, &work[ 1], &rwork[1]);
 }
 else if (rowequ && ! notran) {
 rcond_tmp__ = zla_gercond_c_(trans, n, &a[a_offset], lda, &af[ af_offset], ldaf, &ipiv[1], &r__[1], &c_true, info, &work[ 1], &rwork[1]);
 }
 else {
 rcond_tmp__ = zla_gercond_c_(trans, n, &a[a_offset], lda, &af[ af_offset], ldaf, &ipiv[1], &c__[1], &c_false, info, & work[1], &rwork[1]);
 }
 i__1 = *nrhs;
 for (j = 1;
 j <= i__1;
 ...
 *info = *n + j;
 ...
 rcond_tmp__ = zla_gercond_x_(trans, n, &a[a_offset], lda, & af[af_offset], ldaf, &ipiv[1], &x[j * x_dim1 + 1], info, &work[1], &rwork[1]);
 }
 else {
 rcond_tmp__ = 0.;
 }
