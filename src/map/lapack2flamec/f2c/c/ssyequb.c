 ...
 *amax = 0.f;
 ...
 ++i__) {
 /* Computing MAX */
 r__2 = s[i__]; r__3 = (r__1 = a[i__ + j * a_dim1], f2c_abs(r__1)); // , expr subst  
 s[i__] = max(r__2,r__3);
 /* Computing MAX */
 r__2 = s[j]; r__3 = (r__1 = a[i__ + j * a_dim1], f2c_abs(r__1)); // , expr subst  
 s[j] = max(r__2,r__3);
 /* Computing MAX */
 r__2 = *amax; r__3 = (r__1 = a[i__ + j * a_dim1], f2c_abs(r__1)); // , expr subst  
 *amax = max(r__2,r__3);
 }
 /* Computing MAX */
 r__2 = s[j]; r__3 = (r__1 = a[j + j * a_dim1], f2c_abs(r__1)); // , expr subst  
 s[j] = max(r__2,r__3);
 /* Computing MAX */
 r__2 = *amax; r__3 = (r__1 = a[j + j * a_dim1], f2c_abs(r__1)); // , expr subst  
 *amax = max(r__2,r__3);
 }
 }
 else {
