/* ../netlib/v3.9.0/zgesdd.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 /* Local variables */
 integer lwork_zgebrd_mm__, lwork_zgebrd_mn__, lwork_zgebrd_nn__, lwork_zgelqf_mn__, lwork_zgeqrf_mn__, lwork_zunglq_mn__, lwork_zunglq_nn__, lwork_zungqr_mm__, lwork_zungqr_mn__, i__, ie, il, ir, iu, lwork_zungbr_p_mn__, lwork_zungbr_p_nn__, lwork_zungbr_q_mn__, lwork_zungbr_q_mm__, blk;
 ...
 extern /* Subroutine */
 int zlacp2_(char *, integer *, integer *, doublereal *, integer *, doublecomplex *, integer *);
 ...
 logical wntqas;
 extern /* Subroutine */
 int zunmbr_(char *, char *, char *, integer *, integer *, integer *, doublecomplex *, integer *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, integer *, integer * ), zunglq_(integer *, integer *, integer * , doublecomplex *, integer *, doublecomplex *, doublecomplex *, integer *, integer *);
 logical lquery;
 integer nrwork;
 extern /* Subroutine */
 ...
 */
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zgebrd_nn__; // , expr subst  
 ...
 /* Computing MAX */
 i__1 = wrkbl; i__2 = *n + lwork_zungqr_mn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*n << 1) + lwork_zgebrd_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*n << 1) + lwork_zunmbr_qln_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*n << 1) + lwork_zunmbr_prc_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 ...
 wrkbl = *n + lwork_zgeqrf_mn__;
 /* Computing MAX */
 i__1 = wrkbl; i__2 = *n + lwork_zungqr_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*n << 1) + lwork_zgebrd_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 ...
 /* Path 5o (M >> N, JOBZ='O') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zungbr_p_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zungbr_q_mn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 maxwrk += *m * *n;
 minwrk += *n * *n;
 }
 ...
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zungbr_q_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 }
 else {
 ...
 /* Path 6o (M >= N, JOBZ='O') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zunmbr_prc_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zunmbr_qln_mn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 maxwrk += *m * *n;
 minwrk += *n * *n;
 }
 ...
 /* Path 6a (M >= N, JOBZ='A') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zunmbr_qln_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zunmbr_prc_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 ...
 */
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_zgebrd_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 minwrk = *m * 3;
 }
 else if (wntqo) {
 ...
 /* Computing MAX */
 i__1 = wrkbl; i__2 = *m + lwork_zunglq_mn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*m << 1) + lwork_zgebrd_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*m << 1) + lwork_zunmbr_qln_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*m << 1) + lwork_zunmbr_prc_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 ...
 wrkbl = *m + lwork_zgelqf_mn__;
 /* Computing MAX */
 i__1 = wrkbl; i__2 = *m + lwork_zunglq_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*m << 1) + lwork_zgebrd_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 ...
 /* Path 5to (N >> M, JOBZ='O') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_zungbr_q_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_zungbr_p_mn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 maxwrk += *m * *n;
 minwrk += *m * *m;
 }
 ...
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_zungbr_p_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 }
 else {
 ...
 /* Path 6to (N > M, JOBZ='O') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_zunmbr_qln_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_zunmbr_prc_mn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 maxwrk += *m * *n;
 minwrk += *m * *m;
 }
 ...
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_zunmbr_prc_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 }
 }
 ...
 *info = -12;
 ...
 /* RWorkspace: need N [e] */
 i__1 = *lwork - nwork + 1;
 zgebrd_(n, n, &a[a_offset], lda, &s[1], &rwork[ie], &work[ itauq], &work[itaup], &work[nwork], &i__1, &ierr);
 nrwork = ie + *n;
 ...
 /* RWorkspace: need N [e] */
 i__1 = *lwork - nwork + 1;
 zgebrd_(n, n, &work[ir], &ldwrkr, &s[1], &rwork[ie], &work[ itauq], &work[itaup], &work[nwork], &i__1, &ierr);
 ...
 irvt = iru + *n * *n;
 nrwork = irvt + *n * *n;
 dbdsdc_("U", "I", n, &s[1], &rwork[ie], &rwork[iru], n, & rwork[irvt], n, dum, idum, &rwork[nrwork], &iwork[1], info);
 ...
 i__1 = *lwork - nwork + 1;
 zunmbr_("Q", "L", "N", n, n, n, &work[ir], &ldwrkr, &work[ itauq], &work[iu], &ldwrku, &work[nwork], &i__1, & ierr);
 ...
 i__1 = *lwork - nwork + 1;
 zunmbr_("P", "R", "C", n, n, n, &work[ir], &ldwrkr, &work[ itaup], &vt[vt_offset], ldvt, &work[nwork], &i__1, & ierr);
 ...
 zgemm_("N", "N", &chunk, n, n, &c_b2, &a[i__ + a_dim1], lda, &work[iu], &ldwrku, &c_b1, &work[ir], & ldwrkr);
 ...
 /* RWorkspace: need N [e] */
 i__2 = *lwork - nwork + 1;
 zgebrd_(n, n, &work[ir], &ldwrkr, &s[1], &rwork[ie], &work[ itauq], &work[itaup], &work[nwork], &i__2, &ierr);
 /* Perform bidiagonal SVD, computing left singular vectors */
 ...
 i__2 = *lwork - nwork + 1;
 zunmbr_("Q", "L", "N", n, n, n, &work[ir], &ldwrkr, &work[ itauq], &u[u_offset], ldu, &work[nwork], &i__2, &ierr);
 /* Copy real matrix RWORK(IRVT) to complex matrix VT */
 ...
 zlacp2_("F", n, n, &rwork[irvt], n, &vt[vt_offset], ldvt);
 i__2 = *lwork - nwork + 1;
 zunmbr_("P", "R", "C", n, n, n, &work[ir], &ldwrkr, &work[ itaup], &vt[vt_offset], ldvt, &work[nwork], &i__2, & ierr);
 /* Multiply Q in A by left singular vectors of R in */
 ...
 /* RWorkspace: need N [e] */
 i__2 = *lwork - nwork + 1;
 zgebrd_(n, n, &a[a_offset], lda, &s[1], &rwork[ie], &work[ itauq], &work[itaup], &work[nwork], &i__2, &ierr);
 iru = ie + *n;
 irvt = iru + *n * *n;
 nrwork = irvt + *n * *n;
 /* Perform bidiagonal SVD, computing left singular vectors */
 ...
 zlarcm_(n, n, &rwork[irvt], n, &vt[vt_offset], ldvt, &work[iu] , &ldwrku, &rwork[nrwork]);
 ...
 zlacrm_(&chunk, n, &a[i__ + a_dim1], lda, &rwork[iru], n, &work[iu], &ldwrku, &rwork[nrwork]);
 ...
 zlacpy_("U", n, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
 i__1 = *lwork - nwork + 1;
 zungbr_("P", n, n, n, &vt[vt_offset], ldvt, &work[itaup], & work[nwork], &i__1, &ierr);
 ...
 /* CWorkspace: need 0 */
 /* RWorkspace: need N [e] + N*N [RU] + N*N [RVT] + 2*N*N [rwork] */
 zlarcm_(n, n, &rwork[irvt], n, &vt[vt_offset], ldvt, &a[ a_offset], lda, &rwork[nrwork]);
 ...
 /* RWorkspace: need N [e] */
 i__1 = *lwork - nwork + 1;
 zgebrd_(m, n, &a[a_offset], lda, &s[1], &rwork[ie], &work[itauq], &work[itaup], &work[nwork], &i__1, &ierr);
 if (wntqn) {
 /* Path 6n (M >= N, JOBZ='N') */
 /* Compute singular values only */
 /* CWorkspace: need 0 */
 ...
 zlacp2_("F", n, n, &rwork[irvt], n, &vt[vt_offset], ldvt);
 i__1 = *lwork - nwork + 1;
 zunmbr_("P", "R", "C", n, n, n, &a[a_offset], lda, &work[ itaup], &vt[vt_offset], ldvt, &work[nwork], &i__1, & ierr);
 if (*lwork >= *m * *n + *n * 3) {
 /* Path 6o-fast */
 /* Copy real matrix RWORK(IRU) to complex matrix WORK(IU) */
 ...
 zlacp2_("F", n, n, &rwork[iru], n, &work[iu], &ldwrku);
 i__1 = *lwork - nwork + 1;
 zunmbr_("Q", "L", "N", m, n, n, &a[a_offset], lda, &work[ itauq], &work[iu], &ldwrku, &work[nwork], &i__1, & ierr);
 ...
 /* RWorkspace: need 0 */
 i__1 = *lwork - nwork + 1;
 zungbr_("Q", m, n, n, &a[a_offset], lda, &work[itauq], & work[nwork], &i__1, &ierr);
 /* Multiply Q in A by real matrix RWORK(IRU), storing the */
 /* result in WORK(IU), copying to A */
 /* CWorkspace: need 2*N [tauq, taup] + N*N [U] */
 /* CWorkspace: prefer 2*N [tauq, taup] + M*N [U] */
 ...
 zlacp2_("F", n, n, &rwork[iru], n, &u[u_offset], ldu);
 i__2 = *lwork - nwork + 1;
 zunmbr_("Q", "L", "N", m, n, n, &a[a_offset], lda, &work[ itauq], &u[u_offset], ldu, &work[nwork], &i__2, &ierr);
 /* Copy real matrix RWORK(IRVT) to complex matrix VT */
 /* Overwrite VT by right singular vectors of A */
 /* CWorkspace: need 2*N [tauq, taup] + N [work] */
 /* CWorkspace: prefer 2*N [tauq, taup] + N*NB [work] */
 ...
 zlacp2_("F", n, n, &rwork[iru], n, &u[u_offset], ldu);
 i__2 = *lwork - nwork + 1;
 zunmbr_("Q", "L", "N", m, m, n, &a[a_offset], lda, &work[ itauq], &u[u_offset], ldu, &work[nwork], &i__2, &ierr);
 /* Copy real matrix RWORK(IRVT) to complex matrix VT */
 /* Overwrite VT by right singular vectors of A */
 /* CWorkspace: need 2*N [tauq, taup] + N [work] */
 /* CWorkspace: prefer 2*N [tauq, taup] + N*NB [work] */
 ...
 /* RWorkspace: need M [e] */
 i__2 = *lwork - nwork + 1;
 zgebrd_(m, m, &a[a_offset], lda, &s[1], &rwork[ie], &work[ itauq], &work[itaup], &work[nwork], &i__2, &ierr);
 nrwork = ie + *m;
 /* Perform bidiagonal SVD, compute singular values only */
 /* CWorkspace: need 0 */
 /* RWorkspace: need M [e] + BDSPAC */
 dbdsdc_("U", "N", m, &s[1], &rwork[ie], dum, &c__1, dum, & c__1, dum, idum, &rwork[nrwork], &iwork[1], info);
 }
 else if (wntqo) {
 /* Path 2t (N >> M, JOBZ='O') */
 ...
 /* RWorkspace: need M [e] */
 i__2 = *lwork - nwork + 1;
 zgebrd_(m, m, &work[il], &ldwrkl, &s[1], &rwork[ie], &work[ itauq], &work[itaup], &work[nwork], &i__2, &ierr);
 /* Perform bidiagonal SVD, computing left singular vectors */
 /* of bidiagonal matrix in RWORK(IRU) and computing right */
 /* singular vectors of bidiagonal matrix in RWORK(IRVT) */
 /* CWorkspace: need 0 */
 ...
 irvt = iru + *m * *m;
 nrwork = irvt + *m * *m;
 dbdsdc_("U", "I", m, &s[1], &rwork[ie], &rwork[iru], m, & rwork[irvt], m, dum, idum, &rwork[nrwork], &iwork[1], info);
 /* Copy real matrix RWORK(IRU) to complex matrix WORK(IU) */
 ...
 i__2 = *lwork - nwork + 1;
 zunmbr_("Q", "L", "N", m, m, m, &work[il], &ldwrkl, &work[ itauq], &u[u_offset], ldu, &work[nwork], &i__2, &ierr);
 ...
 i__2 = *lwork - nwork + 1;
 zunmbr_("P", "R", "C", m, m, m, &work[il], &ldwrkl, &work[ itaup], &work[ivt], &ldwkvt, &work[nwork], &i__2, & ierr);
 ...
 i__3 = *n - i__ + 1;
 blk = min(i__3,chunk);
 zgemm_("N", "N", m, &blk, m, &c_b2, &work[ivt], m, &a[i__ * a_dim1 + 1], lda, &c_b1, &work[il], &ldwrkl);
 ...
 /* RWorkspace: need M [e] */
 i__1 = *lwork - nwork + 1;
 zgebrd_(m, m, &work[il], &ldwrkl, &s[1], &rwork[ie], &work[ itauq], &work[itaup], &work[nwork], &i__1, &ierr);
 /* Perform bidiagonal SVD, computing left singular vectors */
 /* of bidiagonal matrix in RWORK(IRU) and computing right */
 /* singular vectors of bidiagonal matrix in RWORK(IRVT) */
 /* CWorkspace: need 0 */
 ...
 zlacp2_("F", m, m, &rwork[iru], m, &u[u_offset], ldu);
 i__1 = *lwork - nwork + 1;
 zunmbr_("Q", "L", "N", m, m, m, &work[il], &ldwrkl, &work[ itauq], &u[u_offset], ldu, &work[nwork], &i__1, &ierr);
 /* Copy real matrix RWORK(IRVT) to complex matrix VT */
 ...
 i__1 = *lwork - nwork + 1;
 zunmbr_("P", "R", "C", m, m, m, &work[il], &ldwrkl, &work[ itaup], &vt[vt_offset], ldvt, &work[nwork], &i__1, & ierr);
 /* Copy VT to WORK(IL), multiply right singular vectors of L */
 /* in WORK(IL) by Q in A, storing result in VT */
 /* CWorkspace: need M*M [L] */
 /* RWorkspace: need 0 */
 zlacpy_("F", m, m, &vt[vt_offset], ldvt, &work[il], &ldwrkl);
 zgemm_("N", "N", m, n, m, &c_b2, &work[il], &ldwrkl, &a[ a_offset], lda, &c_b1, &vt[vt_offset], ldvt);
 }
 else if (wntqa) {
 /* Path 4t (N >> M, JOBZ='A') */
 ...
 /* RWorkspace: need M [e] */
 i__1 = *lwork - nwork + 1;
 zgebrd_(m, m, &a[a_offset], lda, &s[1], &rwork[ie], &work[ itauq], &work[itaup], &work[nwork], &i__1, &ierr);
 /* Perform bidiagonal SVD, computing left singular vectors */
 /* of bidiagonal matrix in RWORK(IRU) and computing right */
 /* singular vectors of bidiagonal matrix in RWORK(IRVT) */
 /* CWorkspace: need 0 */
 ...
 zlacp2_("F", m, m, &rwork[iru], m, &u[u_offset], ldu);
 i__1 = *lwork - nwork + 1;
 zunmbr_("Q", "L", "N", m, m, m, &a[a_offset], lda, &work[ itauq], &u[u_offset], ldu, &work[nwork], &i__1, &ierr);
 /* Copy real matrix RWORK(IRVT) to complex matrix WORK(IVT) */
 ...
 zlacp2_("F", m, m, &rwork[irvt], m, &work[ivt], &ldwkvt);
 i__1 = *lwork - nwork + 1;
 zunmbr_("P", "R", "C", m, m, m, &a[a_offset], lda, &work[ itaup], &work[ivt], &ldwkvt, &work[nwork], &i__1, & ierr);
 /* Multiply right singular vectors of L in WORK(IVT) by */
 /* Q in VT, storing result in A */
 /* CWorkspace: need M*M [VT] */
 /* RWorkspace: need 0 */
 zgemm_("N", "N", m, n, m, &c_b2, &work[ivt], &ldwkvt, &vt[ vt_offset], ldvt, &c_b1, &a[a_offset], lda);
 ...
 /* CWorkspace: need 0 */
 /* RWorkspace: need M [e] + BDSPAC */
 dbdsdc_("L", "N", m, &s[1], &rwork[ie], dum, &c__1, dum, & c__1, dum, idum, &rwork[nrwork], &iwork[1], info);
 }
 else if (wntqo) {
 irvt = nrwork;
 iru = irvt + *m * *m;
 ...
 dbdsdc_("L", "I", m, &s[1], &rwork[ie], &rwork[iru], m, & rwork[irvt], m, dum, idum, &rwork[nrwork], &iwork[1], info);
 /* Multiply Q in U by real matrix RWORK(IRVT) */
 /* storing the result in WORK(IVT), copying to U */
 /* CWorkspace: need 2*M [tauq, taup] + M*M [VT] */
 /* RWorkspace: need M [e] + M*M [RVT] + M*M [RU] + 2*M*M [rwork] */
 zlacrm_(m, m, &u[u_offset], ldu, &rwork[iru], m, &work[ivt], & ldwkvt, &rwork[nrwork]);
 ...
 i__3 = *n - i__ + 1;
 blk = min(i__3,chunk);
 zlarcm_(m, &blk, &rwork[irvt], m, &a[i__ * a_dim1 + 1], lda, &work[ivt], &ldwkvt, &rwork[nrwork]);
 ...
 zlacpy_("U", m, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
 i__2 = *lwork - nwork + 1;
 zungbr_("P", m, n, m, &vt[vt_offset], ldvt, &work[itaup], & work[nwork], &i__2, &ierr);
 /* Perform bidiagonal SVD, computing left singular vectors */
 /* of bidiagonal matrix in RWORK(IRU) and computing right */
 /* singular vectors of bidiagonal matrix in RWORK(IRVT) */
 /* CWorkspace: need 0 */
 ...
 nrwork = iru;
 zlarcm_(m, n, &rwork[irvt], m, &vt[vt_offset], ldvt, &a[ a_offset], lda, &rwork[nrwork]);
 zlacpy_("F", m, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
 }
 else {
 /* Path 5ta (N >> M, JOBZ='A') */
 ...
 zlacpy_("U", m, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
 i__2 = *lwork - nwork + 1;
 zungbr_("P", n, n, m, &vt[vt_offset], ldvt, &work[itaup], & work[nwork], &i__2, &ierr);
 /* Perform bidiagonal SVD, computing left singular vectors */
 /* of bidiagonal matrix in RWORK(IRU) and computing right */
 /* singular vectors of bidiagonal matrix in RWORK(IRVT) */
 /* CWorkspace: need 0 */
 ...
 zlacp2_("F", m, m, &rwork[irvt], m, &work[ivt], &ldwkvt);
 i__2 = *lwork - nwork + 1;
 zunmbr_("P", "R", "C", m, n, m, &a[a_offset], lda, &work[ itaup], &work[ivt], &ldwkvt, &work[nwork], &i__2, &ierr);
 ...
 /* RWorkspace: need 0 */
 i__2 = *lwork - nwork + 1;
 zungbr_("P", m, n, m, &a[a_offset], lda, &work[itaup], & work[nwork], &i__2, &ierr);
 /* Multiply Q in A by real matrix RWORK(IRU), storing the */
 /* result in WORK(IU), copying to A */
 /* CWorkspace: need 2*M [tauq, taup] + M*M [VT] */
 /* CWorkspace: prefer 2*M [tauq, taup] + M*N [VT] */
 ...
 zlacp2_("F", m, m, &rwork[iru], m, &u[u_offset], ldu);
 i__1 = *lwork - nwork + 1;
 zunmbr_("Q", "L", "N", m, m, n, &a[a_offset], lda, &work[ itauq], &u[u_offset], ldu, &work[nwork], &i__1, &ierr);
 /* Copy real matrix RWORK(IRVT) to complex matrix VT */
 /* Overwrite VT by right singular vectors of A */
 /* CWorkspace: need 2*M [tauq, taup] + M [work] */
 /* CWorkspace: prefer 2*M [tauq, taup] + M*NB [work] */
 ...
 zlacp2_("F", m, m, &rwork[irvt], m, &vt[vt_offset], ldvt);
 i__1 = *lwork - nwork + 1;
 zunmbr_("P", "R", "C", m, n, m, &a[a_offset], lda, &work[ itaup], &vt[vt_offset], ldvt, &work[nwork], &i__1, & ierr);
 }
 else {
 /* Path 6ta (N > M, JOBZ='A') */
 /* Perform bidiagonal SVD, computing left singular vectors */
 ...
 zlacp2_("F", m, m, &rwork[irvt], m, &vt[vt_offset], ldvt);
 i__1 = *lwork - nwork + 1;
 zunmbr_("P", "R", "C", n, n, m, &a[a_offset], lda, &work[ itaup], &vt[vt_offset], ldvt, &work[nwork], &i__1, & ierr);
 }
 }
 }
