/* ../netlib/v3.9.0/zla_gbamv.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zla_gba mv.f"> */
 /* > [TGZ]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zla_gba mv.f"> */
 /* > [ZIP]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zla_gba mv.f"> */
 /* > [TXT]</a> */
 /* > \endhtmlonly */
 /* Definition: */
 /* =========== */
 ...
 temp = (d__1 = ab[i__2].r, abs(d__1)) + (d__2 = d_imag(&ab[kd + i__ - j + j * ab_dim1]), abs( d__2));
 i__2 = j;
 symb_zero__ = symb_zero__ && (x[i__2].r == 0. && x[ i__2].i == 0. || temp == 0.);
 i__2 = j;
 y[iy] += *alpha * ((d__1 = x[i__2].r, abs(d__1)) + ( d__2 = d_imag(&x[j]), abs(d__2))) * temp;
 }
 }
 if (! symb_zero__) {
 ...
 temp = (d__1 = ab[i__3].r, abs(d__1)) + (d__2 = d_imag(&ab[ke - i__ + j + i__ * ab_dim1]), abs(d__2));
 i__3 = j;
 ...
 symb_zero__ = symb_zero__ && (x[i__2].r == 0. && x[ i__2].i == 0. || temp == 0.);
 i__2 = jx;
 y[iy] += *alpha * ((d__1 = x[i__2].r, abs(d__1)) + ( d__2 = d_imag(&x[jx]), abs(d__2))) * temp;
 jx += *incx;
 }
 }
 if (! symb_zero__) {
