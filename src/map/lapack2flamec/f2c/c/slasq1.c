/* ../netlib/v3.9.0/slasq1.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -1;
 ...
 /* Computing MAX */
 r__2 = sigmx; r__3 = (r__1 = e[i__], abs(r__1)); // , expr subst  
 sigmx = max(r__2,r__3);
 /* L10: */
 }
 ...
 ++i__) {
 /* Computing MAX */
 r__1 = sigmx; r__2 = d__[i__]; // , expr subst  
 sigmx = max(r__1,r__2);
 /* L20: */
 }
