/* ../netlib/v3.9.0/cgesdd.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 /* Local variables */
 integer lwork_cunglq_mn__, lwork_cunglq_nn__, lwork_cungqr_mm__, lwork_cungqr_mn__, i__, ie, lwork_cungbr_p_mn__, il, lwork_cungbr_p_nn__, lwork_cungbr_q_mn__, lwork_cungbr_q_mm__, ir, iu, blk;
 real dum[1], eps;
 integer iru, ivt;
 complex cdum[1];
 ...
 */
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_cgebrd_nn__; // , expr subst  
 ...
 /* Computing MAX */
 i__1 = wrkbl; i__2 = *n + lwork_cungqr_mn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*n << 1) + lwork_cgebrd_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*n << 1) + lwork_cunmbr_qln_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*n << 1) + lwork_cunmbr_prc_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 ...
 wrkbl = *n + lwork_cgeqrf_mn__;
 /* Computing MAX */
 i__1 = wrkbl; i__2 = *n + lwork_cungqr_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*n << 1) + lwork_cgebrd_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 ...
 /* Path 5o (M >> N, JOBZ='O') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_cungbr_p_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_cungbr_q_mn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 maxwrk += *m * *n;
 minwrk += *n * *n;
 }
 ...
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_cungbr_q_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 }
 else {
 ...
 /* Path 6o (M >= N, JOBZ='O') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_cunmbr_prc_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_cunmbr_qln_mn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 maxwrk += *m * *n;
 minwrk += *n * *n;
 }
 ...
 /* Path 6a (M >= N, JOBZ='A') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_cunmbr_qln_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_cunmbr_prc_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 ...
 */
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_cgebrd_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 minwrk = *m * 3;
 }
 else if (wntqo) {
 ...
 /* Computing MAX */
 i__1 = wrkbl; i__2 = *m + lwork_cunglq_mn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*m << 1) + lwork_cgebrd_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*m << 1) + lwork_cunmbr_qln_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*m << 1) + lwork_cunmbr_prc_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 ...
 wrkbl = *m + lwork_cgelqf_mn__;
 /* Computing MAX */
 i__1 = wrkbl; i__2 = *m + lwork_cunglq_nn__; // , expr subst  
 wrkbl = max(i__1,i__2);
 /* Computing MAX */
 i__1 = wrkbl; i__2 = (*m << 1) + lwork_cgebrd_mm__; // , expr subst  
 wrkbl = max(i__1,i__2);
 ...
 /* Path 5to (N >> M, JOBZ='O') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_cungbr_q_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_cungbr_p_mn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 maxwrk += *m * *n;
 minwrk += *m * *m;
 }
 ...
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_cungbr_p_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 }
 else {
 ...
 /* Path 6to (N > M, JOBZ='O') */
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_cunmbr_qln_mm__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_cunmbr_prc_mn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 maxwrk += *m * *n;
 minwrk += *m * *m;
 }
 ...
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_cunmbr_prc_nn__; // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 }
 }
