/* ../netlib/v3.9.0/zhetri2x.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 ...
 t.r = d__1; t.i = 0.; // , expr subst  
 i__1 = k + k * a_dim1;
 d__1 = a[i__1].r;
 z__2.r = d__1; z__2.i = 0.; // , expr subst  
 z_div(&z__1, &z__2, &t);
 ...
 z__2.r = z__3.r - 1.; z__2.i = z__3.i; // , expr subst  
