/* ../netlib/cgbequb.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 on Linux or Unix systems, link with .../path/to/libf2c.a -lm or, if you install libf2c.a in a standard place, with -lf2c -lm -- in that order, at the end of the command line, as in cc *.o -lf2c -lm Source for libf2c is in /netlib/f2c/libf2c.zip, e.g., http://www.netlib.org/f2c/libf2c.zip */
#include "FLA_f2c.h" /* > \brief \b CGBEQUB */
/* =========== DOCUMENTATION =========== */
    ...
    *info = 0;
            ...
            ++j)
    {
                ...
                ++i__)
        {
            ...
            r__3 = r__[i__];
            r__4 = (r__1 = ab[i__2].r, abs(r__1)) + (r__2 = r_imag(&ab[kd + i__ - j + j * ab_dim1]), abs(r__2)); // , expr subst
    ...
    *amax = rcmax;
            ...
            ++j)
    {
                ...
                ++i__)
        {
            ...
            r__3 = c__[j];
            r__4 = ((r__1 = ab[i__3].r, abs(r__1)) + (r__2 = r_imag(&ab[kd + i__ - j + j * ab_dim1]), abs(r__2))) * r__[i__]; // , expr subst
            c__[j] = max(r__3,r__4);
            /* L80: */
        }
        if (c__[j] > 0.f)
