/* ../netlib/v3.9.0/zlarft.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 i__3 = j + i__ * t_dim1;
 i__4 = i__;
 z__2.r = -tau[i__4].r; z__2.i = -tau[i__4].i; // , expr subst  
 ...
 i__3 = i__ - 1;
 i__4 = i__;
 z__1.r = -tau[i__4].r; z__1.i = -tau[i__4].i; // , expr subst  
 ...
 z__2.r = -tau[i__4].r; z__2.i = -tau[i__4].i; // , expr subst  
 i__5 = j + i__ * v_dim1;
 z__1.r = z__2.r * v[i__5].r - z__2.i * v[i__5].i; z__1.i = z__2.r * v[i__5].i + z__2.i * v[i__5] .r; // , expr subst  
 t[i__3].r = z__1.r; t[i__3].i = z__1.i; // , expr subst  
 }
 j = min(lastv,prevlastv);
 ...
 i__2 = j + i__ * t_dim1;
 i__3 = i__;
 z__2.r = -tau[i__3].r; z__2.i = -tau[i__3].i; // , expr subst  
 ...
 z__1.r = z__2.r * v[i__4].r - z__2.i * v[i__4].i; z__1.i = z__2.r * v[i__4].i + z__2.i * v[ i__4].r; // , expr subst  
 t[i__2].r = z__1.r; t[i__2].i = z__1.i; // , expr subst  
 }
 j = max(lastv,prevlastv);
