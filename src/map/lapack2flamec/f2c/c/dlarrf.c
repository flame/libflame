/* ../netlib/v3.9.0/dlarrf.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 ...
 /* Computing MIN */
 d__1 = w[*clstrt]; d__2 = w[*clend]; // , expr subst  
 ...
 /* Computing MAX */
 d__1 = avgap; d__2 = wgap[*clstrt]; // , expr subst  
 ldelta = max(d__1,d__2) / fact;
 /* Computing MAX */
 d__1 = avgap; d__2 = wgap[*clend - 1]; // , expr subst  
 ...
 /* Computing MAX */
 d__2 = max1; d__3 = (d__1 = dplus[i__ + 1], abs(d__1)); // , expr subst  
 max1 = max(d__2,d__3);
 /* L6: */
 }
 ...
 *sigma = lsigma;
 ...
 /* Computing MAX */
 d__2 = max2; d__3 = (d__1 = work[i__ + 1], abs(d__1)); // , expr subst  
 max2 = max(d__2,d__3);
 /* L7: */
 }
 ...
 *sigma = rsigma;
 ...
 znm2 += d__1 * d__1;
 /* Computing MAX */
 d__2 = tmp; d__3 = (d__1 = dplus[i__] * prod, abs(d__1)); // , expr subst  
 tmp = max(d__2,d__3);
 /* L15: */
 }
 ...
 *sigma = lsigma;
 ...
 znm2 += d__1 * d__1;
 /* Computing MAX */
 d__2 = tmp; d__3 = (d__1 = work[i__] * prod, abs(d__1)); // , expr subst  
 tmp = max(d__2,d__3);
 /* L16: */
 }
 ...
 *sigma = rsigma;
 ...
 /* Computing MAX */
 d__1 = lsigma - ldelta; d__2 = lsigma - ldmax; // , expr subst  
 lsigma = max(d__1,d__2);
 /* Computing MIN */
 d__1 = rsigma + rdelta; d__2 = rsigma + rdmax; // , expr subst  
