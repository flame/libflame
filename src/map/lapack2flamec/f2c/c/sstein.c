/* ../netlib/sstein.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -5;
 ...
 /* Computing MAX */
 r__3 = onenrm; r__4 = (r__1 = d__[bn], f2c_abs(r__1)) + (r__2 = e[bn - 1], f2c_abs(r__2)); // , expr subst  
 ...
 ++i__) {
 /* Computing MAX */
 r__4 = onenrm; r__5 = (r__1 = d__[i__], f2c_abs(r__1)) + (r__2 = e[ i__ - 1], f2c_abs(r__2)) + (r__3 = e[i__], f2c_abs(r__3)); // , expr subst  
 ...
 /* Computing MAX */
 r__3 = eps; r__4 = (r__1 = work[indrv4 + blksiz], f2c_abs(r__1)); // , expr subst  
