/* ../netlib/clantp.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 on Linux or Unix systems, link with .../path/to/libf2c.a -lm or, if you install libf2c.a in a standard place, with -lf2c -lm -- in that order, at the end of the command line, as in cc *.o -lf2c -lm Source for libf2c is in /netlib/f2c/libf2c.zip, e.g., http://www.netlib.org/f2c/libf2c.zip */
 #include "FLA_f2c.h" /* Table of constant values */
 static integer c__1 = 1;
 /* > \brief \b CLANTP returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the ele ment of largest absolute value of a triangular matrix supplied in packed form. */
 /* =========== DOCUMENTATION =========== */
 ...
 /* > \verbatim */
 /* > */
 /* > CLANTP = ( max(f2c_abs(A(i,j))), NORM = 'M' or 'm' */
 /* > ( */
 ...
 */
 ...
 char buffer[256]; 
#if FLA_ENABLE_ILP64 
 snprintf(buffer, 256,"clantp inputs: norm %c, uplo %c, diag %c, n %lld",*norm, *uplo, *diag, *n);
#else 
 snprintf(buffer, 256,"clantp inputs: norm %c, uplo %c, diag %c, n %d",*norm, *uplo, *diag, *n);
#endif
