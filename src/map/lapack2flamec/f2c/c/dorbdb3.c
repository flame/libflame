/* ../netlib/dorbdb3.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 char buffer[256]; 
 snprintf(buffer, 256,"dorbdb3 inputs: m %" FLA_IS ", p %" FLA_IS ", q %" FLA_IS ", ldx11 %" FLA_IS ", ldx21 %" FLA_IS ", lwork %" FLA_IS "",*m, *p, *q, *ldx11, *ldx21, *lwork);
 ...
 *info = -14;
 ...
 if (i__ > 1) {
 i__2 = *q - i__ + 1;
 drot_(&i__2, &x11[i__ - 1 + i__ * x11_dim1], ldx11, &x21[i__ + i__ * x21_dim1], ldx11, &c__, &s);
 }
 i__2 = *q - i__ + 1;
 ...
 i__2 = *p - i__ + 1;
 i__3 = *q - i__ + 1;
 dlarf_("R", &i__2, &i__3, &x21[i__ + i__ * x21_dim1], ldx21, &tauq1[ i__], &x11[i__ + i__ * x11_dim1], ldx11, &work[ilarf]);
 i__2 = *m - *p - i__;
 i__3 = *q - i__ + 1;
 ...
 i__3 = *m - *p - i__;
 i__4 = *q - i__;
 dorbdb5_(&i__2, &i__3, &i__4, &x11[i__ + i__ * x11_dim1], &c__1, &x21[ i__ + 1 + i__ * x21_dim1], &c__1, &x11[i__ + (i__ + 1) * x11_dim1], ldx11, &x21[i__ + 1 + (i__ + 1) * x21_dim1], ldx21, &work[iorbdb5], &lorbdb5, &childinfo);
 i__2 = *p - i__ + 1;
 dlarfgp_(&i__2, &x11[i__ + i__ * x11_dim1], &x11[i__ + 1 + i__ * x11_dim1], &c__1, &taup1[i__]);
 if (i__ < *m - *p) {
 i__2 = *m - *p - i__;
 dlarfgp_(&i__2, &x21[i__ + 1 + i__ * x21_dim1], &x21[i__ + 2 + i__ * x21_dim1], &c__1, &taup2[i__]);
 ...
 i__2 = *m - *p - i__;
 i__3 = *q - i__;
 dlarf_("L", &i__2, &i__3, &x21[i__ + 1 + i__ * x21_dim1], &c__1, & taup2[i__], &x21[i__ + 1 + (i__ + 1) * x21_dim1], ldx21, & work[ilarf]);
 }
