/* ../netlib/v3.9.0/dlaed2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *rho = (d__1 = *rho * 2., abs(d__1));
 ...
 eps = dlamch_("Epsilon");
 /* Computing MAX */
 d__3 = (d__1 = d__[jmax], abs(d__1)); d__4 = (d__2 = z__[imax], abs(d__2)) ; // , expr subst  
