...
/* Subroutine */ int lapack_dgesvd(char *jobu, char *jobvt, integer *m, integer *n, 
...
/*   
    ...
    extern /* Subroutine */ int lapack_dgebrd(integer *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
	     doublereal *, integer *, integer *);
    extern doublereal dlamch_(char *), dlange_(char *, integer *, 
	    integer *, doublereal *, integer *, doublereal *);
    static integer bdspac;
    extern /* Subroutine */ int lapack_dgelqf(integer *, integer *, doublereal *, 
	    ...
	    doublereal *, doublereal *, doublereal *, integer *, doublereal *,
	     integer *, doublereal *, integer *, doublereal *, integer *), lapack_dorgbr(char *, integer *, integer *, integer *, 
    ...
    extern /* Subroutine */ int lapack_dormbr(char *, char *, char *, integer *, 
	    integer *, integer *, doublereal *, integer *, doublereal *, 
	    doublereal *, integer *, doublereal *, integer *, integer *), lapack_dorglq(integer *, integer *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *, integer *, 
	    integer *), lapack_dorgqr(integer *, integer *, integer *, doublereal *,
	     integer *, doublereal *, doublereal *, integer *, integer *);
...
/*              Bidiagonalize R in A   
		...
		i__2 = *lwork - iwork + 1;
		lapack_dgebrd(n, n, &a[a_offset], lda, &s[1], &work[ie], &work[
...
/*              Perform bidiagonal QR iteration, computing right   
		...
		lapack_dbdsqr("U", n, &ncvt, &c__0, &c__0, &s[1], &work[ie], &a[
...
/*                 Generate Q in A   
		    ...
		    i__2 = *lwork - iwork + 1;
		    lapack_dorgqr(m, n, n, &a[a_offset], lda, &work[itau], &work[
			    iwork], &i__2, &ierr);
		    ie = itau;
		    itauq = ie + *n;
		    itaup = itauq + *n;
...
/*                 Bidiagonalize R in WORK(IR)   
		    ...
		    i__2 = *lwork - iwork + 1;
		    lapack_dgebrd(n, n, &work[ir], &ldwrkr, &s[1], &work[ie], &work[
			    itauq], &work[itaup], &work[iwork], &i__2, &ierr);
...
/*                 Perform bidiagonal QR iteration, computing left   
		    ...
		    lapack_dbdsqr("U", n, &c__0, n, &c__0, &s[1], &work[ie], dum, &
...
/*                 Bidiagonalize A   
		    ...
		    i__3 = *lwork - iwork + 1;
		    lapack_dgebrd(m, n, &a[a_offset], lda, &s[1], &work[ie], &work[
...
/*                 Perform bidiagonal QR iteration, computing left   
		    ...
		    lapack_dbdsqr("U", n, &c__0, m, &c__0, &s[1], &work[ie], dum, &
...
/*                 Perform bidiagonal QR iteration, computing left   
		    ...
		    lapack_dbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &vt[
...
/*                 Perform bidiagonal QR iteration, computing left   
		    ...
		    lapack_dbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &vt[
...
/*                    Perform bidiagonal QR iteration, computing left   
			...
			lapack_dbdsqr("U", n, &c__0, n, &c__0, &s[1], &work[ie], 
...
/*                    Generate Q in U   
			...
			i__2 = *lwork - iwork + 1;
			lapack_dorgqr(m, n, n, &u[u_offset], ldu, &work[itau], &
				work[iwork], &i__2, &ierr);
			ie = itau;
			itauq = ie + *n;
			itaup = itauq + *n;
...
/*                    Perform bidiagonal QR iteration, computing left   
			...
			lapack_dbdsqr("U", n, &c__0, m, &c__0, &s[1], &work[ie], 
...
/*                    Perform bidiagonal QR iteration, computing left   
			...
			lapack_dbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &work[
...
/*                    Perform bidiagonal QR iteration, computing left   
			...
			lapack_dbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &a[
...
/*                    Generate right bidiagonalizing vectors in VT   
			...
			i__2 = *lwork - iwork + 1;
			lapack_dorgbr("P", n, n, n, &vt[vt_offset], ldvt, &work[
...
/*                    Generate Q in U   
			...
			i__2 = *lwork - iwork + 1;
			lapack_dorgqr(m, m, n, &u[u_offset], ldu, &work[itau], &
				work[iwork], &i__2, &ierr);
			ie = itau;
			itauq = ie + *n;
			itaup = itauq + *n;
...
/*              If left singular vectors desired in A, generate left   
		...
		i__2 = *lwork - iwork + 1;
		lapack_dorgbr("Q", m, n, n, &a[a_offset], lda, &work[itauq], &work[
			iwork], &i__2, &ierr);
	    }
	    if (wntvo) {
...
/*              If right singular vectors desired in A, generate right   
		...
		i__2 = *lwork - iwork + 1;
		lapack_dorgbr("P", n, n, n, &a[a_offset], lda, &work[itaup], &work[
			iwork], &i__2, &ierr);
	    }
	    iwork = ie + *n;
	    if (wntuas || wntuo) {
...
/*              Perform bidiagonal QR iteration, if desired, computing   
		...
		lapack_dbdsqr("U", n, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[
...
/*              Perform bidiagonal QR iteration, if desired, computing   
		...
		lapack_dbdsqr("U", n, &ncvt, &nru, &c__0, &s[1], &work[ie], &a[
...
/*              Bidiagonalize L in A   
		...
		i__2 = *lwork - iwork + 1;
		lapack_dgebrd(m, m, &a[a_offset], lda, &s[1], &work[ie], &work[
			itauq], &work[itaup], &work[iwork], &i__2, &ierr);
		if (wntuo || wntuas) {
...
/*                 Generate Q in A   
		    ...
		    i__2 = *lwork - iwork + 1;
		    lapack_dorglq(m, n, m, &a[a_offset], lda, &work[itau], &work[
			    iwork], &i__2, &ierr);
		    ie = itau;
		    itauq = ie + *m;
		    itaup = itauq + *m;
...
/*                 Bidiagonalize L in WORK(IR)   
		    ...
		    i__2 = *lwork - iwork + 1;
		    lapack_dgebrd(m, m, &work[ir], &ldwrkr, &s[1], &work[ie], &work[
			    itauq], &work[itaup], &work[iwork], &i__2, &ierr);
...
/*                 Perform bidiagonal QR iteration, computing right   
		    ...
		    lapack_dbdsqr("U", m, m, &c__0, &c__0, &s[1], &work[ie], &work[
...
/*                 Perform bidiagonal QR iteration, computing right   
		    ...
		    lapack_dbdsqr("L", m, n, &c__0, &c__0, &s[1], &work[ie], &a[
...
/*                 Bidiagonalize L in U, copying result to WORK(IR)   
		    ...
		    i__3 = *lwork - iwork + 1;
		    lapack_dgebrd(m, m, &u[u_offset], ldu, &s[1], &work[ie], &work[
			    itauq], &work[itaup], &work[iwork], &i__3, &ierr);
...
/*                 Multiply right vectors bidiagonalizing L by Q in A   
		    ...
		    i__2 = *lwork - iwork + 1;
		    lapack_dormbr("P", "L", "T", m, n, m, &u[u_offset], ldu, &work[
...
/*                 Perform bidiagonal QR iteration, computing left   
		    ...
		    lapack_dbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &a[
			    a_offset], lda, &u[u_offset], ldu, dum, &c__1, &
			    work[iwork], info);
...
/*                    Compute A=L*Q   
			...
			i__2 = *lwork - iwork + 1;
			lapack_dgelqf(m, n, &a[a_offset], lda, &work[itau], &work[
				iwork], &i__2, &ierr);
...
/*                    Perform bidiagonal QR iteration, computing right   
			...
			lapack_dbdsqr("U", m, m, &c__0, &c__0, &s[1], &work[ie], &
...
/*                    Perform bidiagonal QR iteration, computing left   
			...
			lapack_dbdsqr("U", m, m, m, &c__0, &s[1], &work[ie], &work[
...
/*                    Perform bidiagonal QR iteration, compute left   
			...
			lapack_dbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &vt[
...
/*              If left singular vectors desired in U, copy result to U   
		...
		dlacpy_("L", m, m, &a[a_offset], lda, &u[u_offset], ldu);
		i__2 = *lwork - iwork + 1;
		lapack_dorgbr("Q", m, m, n, &u[u_offset], ldu, &work[itauq], &work[
			iwork], &i__2, &ierr);
	    }
	    if (wntvas) {
...
/*              If left singular vectors desired in A, generate left   
		...
		i__2 = *lwork - iwork + 1;
		lapack_dorgbr("Q", m, m, n, &a[a_offset], lda, &work[itauq], &work[
			iwork], &i__2, &ierr);
	    }
	    if (wntvo) {
...
/*              If right singular vectors desired in A, generate right   
		...
		i__2 = *lwork - iwork + 1;
		lapack_dorgbr("P", m, n, m, &a[a_offset], lda, &work[itaup], &work[
			iwork], &i__2, &ierr);
	    }
	    iwork = ie + *m;
	    if (wntuas || wntuo) {
...
/*              Perform bidiagonal QR iteration, if desired, computing   
		...
		lapack_dbdsqr("L", m, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[
			vt_offset], ldvt, &u[u_offset], ldu, dum, &c__1, &
			work[iwork], info);
	    } else if (! wntuo && wntvo) {
...
/*              Perform bidiagonal QR iteration, if desired, computing   
		...
		lapack_dbdsqr("L", m, &ncvt, &nru, &c__0, &s[1], &work[ie], &a[
			a_offset], lda, &u[u_offset], ldu, dum, &c__1, &work[
			iwork], info);
	    } else {
