/* ../netlib/sgejsv.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
                    ...
                    if (l2pert)
                    {
                                ...
                                ++p)
                        {
                                    ...
                                    ++q)
                            {
                                ...
                                r__4 = (r__2 = v[q + q * v_dim1], abs( r__2)); // , expr subst
        ...
        else
        {
            ...
            if (l2pert)
            {
                        ...
                        ++q)
                {
                    ...
                    {
                        /* Computing MIN */
                        r__3 = (r__1 = u[p + p * u_dim1], abs(r__1));
                        r__4 = ( r__2 = u[q + q * u_dim1], abs(r__2)); // , expr subst
                        temp1 = xsc * min(r__3,r__4);
