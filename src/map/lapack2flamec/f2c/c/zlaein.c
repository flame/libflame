    ...
    *info = 0;
    ...
    if (*rightv)
    {
                ...
                ++i__)
        {
            ...
            i__2 = i__ + i__ * b_dim1;
            if ((d__1 = b[i__2].r, abs(d__1)) + (d__2 = d_imag(&b[i__ + i__ * b_dim1]), abs(d__2)) < (d__3 = ei.r, abs(d__3)) + (d__4 = d_imag(&ei), abs(d__4)))
            {
    ...
    else
    {
                ...
                --j)
        {
            ...
            i__1 = j + j * b_dim1;
            if ((d__1 = b[i__1].r, abs(d__1)) + (d__2 = d_imag(&b[j + j * b_dim1]), abs(d__2)) < (d__3 = ej.r, abs(d__3)) + (d__4 = d_imag(&ej), abs(d__4)))
            {
...
L120: /* Normalize eigenvector. */
    ...
    i__1 = i__;
    d__3 = 1. / ((d__1 = v[i__1].r, abs(d__1)) + (d__2 = d_imag(&v[i__]), abs( d__2)));
