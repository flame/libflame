/* ../netlib/v3.9.0/ztrsna.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 /* > to lambda;
 v**H denotes the conjugate transpose of v, and norm(u) */
 ...
 *info = -16;
 ...
 prod.r = z__1.r; prod.i = z__1.i; // , expr subst  
 ...
 i__5 = work_dim1 + 1;
 z__1.r = work[i__4].r - work[i__5].r; z__1.i = work[i__4].i - work[i__5].i; // , expr subst  
