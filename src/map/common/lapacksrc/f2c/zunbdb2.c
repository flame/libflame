/* ../netlib/zunbdb2.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int zunbdb2_(integer *m, integer *p, integer *q, doublecomplex *x11, integer *ldx11, doublecomplex *x21, integer * ldx21, doublereal *theta, doublereal *phi, doublecomplex *taup1, doublecomplex *taup2, doublecomplex *tauq1, doublecomplex *work, integer *lwork, integer *info)
{
    ...
    extern doublereal dznrm2_(integer *, doublecomplex *, integer *, doublecomplex *, integer *);
    extern /* Subroutine */
    ...
    *info = 0;
            ...
            ++i__)
    {
        ...
        {
            i__2 = *q - i__ + 1;
            zdrot_(&i__2, &x11[i__ + i__ * x11_dim1], ldx11, &x21[i__ - 1 + i__ * x21_dim1], ldx21, &c__, &s);
        }
        i__2 = *q - i__ + 1;
        ...
        i__2 = *m - *p - i__ + 1;
        i__3 = *q - i__ + 1;
        zlarf_("R", &i__2, &i__3, &x11[i__ + i__ * x11_dim1], ldx11, &tauq1[ i__], &x21[i__ + i__ * x21_dim1], ldx21, &work[ilarf]);
        i__2 = *q - i__ + 1;
        zlacgv_(&i__2, &x11[i__ + i__ * x11_dim1], ldx11);
        i__2 = *p - i__;
        /* Computing 2nd power */
        d__1 = dznrm2_(&i__2, &x11[i__ + 1 + i__ * x11_dim1], &c__1, &x11[i__ + 1 + i__ * x11_dim1], &c__1);
        i__3 = *m - *p - i__ + 1;
        /* Computing 2nd power */
        d__2 = dznrm2_(&i__3, &x21[i__ + i__ * x21_dim1], &c__1, &x21[i__ + i__ * x21_dim1], &c__1);
        s = sqrt(d__1 * d__1 + d__2 * d__2);
        theta[i__] = atan2(s, c__);
        i__2 = *p - i__;
        i__3 = *m - *p - i__ + 1;
        i__4 = *q - i__;
        zunbdb5_(&i__2, &i__3, &i__4, &x11[i__ + 1 + i__ * x11_dim1], &c__1, & x21[i__ + i__ * x21_dim1], &c__1, &x11[i__ + 1 + (i__ + 1) * x11_dim1], ldx11, &x21[i__ + (i__ + 1) * x21_dim1], ldx21, & work[iorbdb5], &lorbdb5, &childinfo);
        i__2 = *p - i__;
        ...
        {
            i__2 = *p - i__;
            zlarfgp_(&i__2, &x11[i__ + 1 + i__ * x11_dim1], &x11[i__ + 2 + i__ * x11_dim1], &c__1, &taup1[i__]);
            phi[i__] = atan2((doublereal) x11[i__ + 1 + i__ * x11_dim1].r, ( doublereal) x21[i__ + i__ * x21_dim1].r);
            c__ = cos(phi[i__]);
            s = sin(phi[i__]);
            ...
            zlarf_("L", &i__2, &i__3, &x11[i__ + 1 + i__ * x11_dim1], &c__1, & z__1, &x11[i__ + 1 + (i__ + 1) * x11_dim1], ldx11, &work[ ilarf]);
        }
