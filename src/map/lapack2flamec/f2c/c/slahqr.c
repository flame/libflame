 ...
 *info = 0;
 ...
 /* Computing MAX */
 r__3 = (r__1 = h__[k + (k - 1) * h_dim1], f2c_abs(r__1)); r__4 = ( r__2 = h__[k - 1 + k * h_dim1], f2c_abs(r__2)); // , expr subst  
 ab = max(r__3,r__4);
 /* Computing MIN */
 r__3 = (r__1 = h__[k + (k - 1) * h_dim1], f2c_abs(r__1)); r__4 = ( r__2 = h__[k - 1 + k * h_dim1], f2c_abs(r__2)); // , expr subst  
 ba = min(r__3,r__4);
 /* Computing MAX */
 r__3 = (r__1 = h__[k + k * h_dim1], f2c_abs(r__1)); r__4 = (r__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], f2c_abs(r__2)); // , expr subst  
 aa = max(r__3,r__4);
 /* Computing MIN */
 r__3 = (r__1 = h__[k + k * h_dim1], f2c_abs(r__1)); r__4 = (r__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], f2c_abs(r__2)); // , expr subst  
 bb = min(r__3,r__4);
