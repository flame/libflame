...
=
  \FlaThreeByOneB{A_0 B^T + \hat{C}_0}
                 {\hat{C}_1}
                 {\hat{C}_2}
...
%  \ref{FLA_Gemm_nt:ws_blk_var3} in the \LaTeX source 
 
\label{FLA_Gemm_nt:ws_blk_var3} 
...
% The following command creates a label so that the figure can 
% be referenced by its number by inserting  
%  \ref{FLA_Gemm_nt:alg_blk_var3} in the \LaTeX source 
 
\label{FLA_Gemm_nt:alg_blk_var3} 
