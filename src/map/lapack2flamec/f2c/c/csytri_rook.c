/* ../netlib/v3.9.0/csytri_rook.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 ...
 q__1.r = a[i__2].r - q__2.r; q__1.i = a[i__2].i - q__2.i; // , expr subst  
 a[i__1].r = q__1.r; a[i__1].i = q__1.i; // , expr subst  
 }
 kstep = 1;
 }
