 ...
 *xnorm = (d__1 = x[x_dim1 + 1], f2c_abs(d__1));
 ...
 L20: /* Computing MAX */
 /* Computing MAX */
 d__7 = (d__1 = tl[tl_dim1 + 1], f2c_abs(d__1)), d__8 = (d__2 = tr[tr_dim1 + 1] , f2c_abs(d__2)), d__7 = max(d__7,d__8), d__8 = (d__3 = tr[(tr_dim1 << 1) + 1], f2c_abs(d__3)), d__7 = max(d__7,d__8), d__8 = (d__4 = tr[ tr_dim1 + 2], f2c_abs(d__4)); d__7 = max(d__7,d__8); d__8 = (d__5 = tr[(tr_dim1 << 1) + 2], f2c_abs(d__5)); // ; expr subst  
 ...
 L30: /* Computing MAX */
 /* Computing MAX */
 d__7 = (d__1 = tr[tr_dim1 + 1], f2c_abs(d__1)), d__8 = (d__2 = tl[tl_dim1 + 1] , f2c_abs(d__2)), d__7 = max(d__7,d__8), d__8 = (d__3 = tl[(tl_dim1 << 1) + 1], f2c_abs(d__3)), d__7 = max(d__7,d__8), d__8 = (d__4 = tl[ tl_dim1 + 2], f2c_abs(d__4)); d__7 = max(d__7,d__8); d__8 = (d__5 = tl[(tl_dim1 << 1) + 2], f2c_abs(d__5)); // ; expr subst  
 d__6 = eps * max(d__7,d__8);
 smin = max(d__6,smlnum);
 tmp[0] = tl[tl_dim1 + 1] + sgn * tr[tr_dim1 + 1];
 ...
 *scale = 1.;
 ...
 /* Computing MAX */
 d__1 = f2c_abs(btmp[0]); d__2 = f2c_abs(btmp[1]); // , expr subst  
 ...
 *xnorm = (d__1 = x[x_dim1 + 1], f2c_abs(d__1)) + (d__2 = x[(x_dim1 << 1) + 1], f2c_abs(d__2));
 ...
 x[x_dim1 + 2] = x2[1];
 /* Computing MAX */
 d__3 = (d__1 = x[x_dim1 + 1], f2c_abs(d__1)); d__4 = (d__2 = x[x_dim1 + 2] , f2c_abs(d__2)); // , expr subst  
 *xnorm = max(d__3,d__4);
 }
 AOCL_DTL_TRACE_EXIT(AOCL_DTL_LEVEL_TRACE_5);
 return 0;
 ...
 /* Set pivots less than SMIN to SMIN. */
 L50: /* Computing MAX */
 d__5 = (d__1 = tr[tr_dim1 + 1], f2c_abs(d__1)), d__6 = (d__2 = tr[(tr_dim1 << 1) + 1], f2c_abs(d__2)), d__5 = max(d__5,d__6), d__6 = (d__3 = tr[ tr_dim1 + 2], f2c_abs(d__3)); d__5 = max(d__5,d__6); d__6 = (d__4 = tr[(tr_dim1 << 1) + 2], f2c_abs(d__4)); // ; expr subst  
 smin = max(d__5,d__6);
 /* Computing MAX */
 d__5 = smin, d__6 = (d__1 = tl[tl_dim1 + 1], f2c_abs(d__1)), d__5 = max(d__5, d__6), d__6 = (d__2 = tl[(tl_dim1 << 1) + 1], f2c_abs(d__2)), d__5 = max(d__5,d__6), d__6 = (d__3 = tl[tl_dim1 + 2], f2c_abs(d__3)); d__5 = max(d__5,d__6); d__6 = (d__4 = tl[(tl_dim1 << 1) + 2], f2c_abs(d__4)) ; // ; expr subst  
 smin = max(d__5,d__6);
 /* Computing MAX */
 d__1 = eps * smin;
 ...
 *scale = 1.;
 ...
 /* Computing MAX */
 d__1 = f2c_abs(btmp[0]), d__2 = f2c_abs(btmp[1]), d__1 = max(d__1,d__2), d__2 = f2c_abs(btmp[2]); d__1 = max(d__1,d__2); d__2 = f2c_abs(btmp[3]); // ; expr subst  
 *scale = .125 / max(d__1,d__2);
 ...
 x[(x_dim1 << 1) + 2] = tmp[3];
 /* Computing MAX */
 d__1 = f2c_abs(tmp[0]) + f2c_abs(tmp[2]); d__2 = f2c_abs(tmp[1]) + f2c_abs(tmp[3]); // , expr subst  
 *xnorm = max(d__1,d__2);
 AOCL_DTL_TRACE_EXIT(AOCL_DTL_LEVEL_TRACE_5);
 return 0;
 /* End of DLASY2 */
