...
=
  \FlaThreeByOneB{ A_{0}^T B^T + \hat{C}_0 }
                 {               \hat{C}_1 }
                 {               \hat{C}_2 }
...
%  \ref{FLA_Gemm_tt:ws_blk_var1} in the \LaTeX source 
 
\label{FLA_Gemm_tt:ws_blk_var1} 
...
% The following command creates a label so that the figure can 
% be referenced by its number by inserting  
%  \ref{FLA_Gemm_tt:alg_blk_var1} in the \LaTeX source 
 
\label{FLA_Gemm_tt:alg_blk_var1} 
