/* ../netlib/cunbdb1.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
#else 
 snprintf(buffer, 256,"cunbdb1 inputs: m %d, p %d, q %d, ldx11 %d, ldx21 %d, lwork %d", *m, *p, *q, *ldx11, *ldx21, *lwork);
#endif
