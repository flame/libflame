/* ../netlib/v3.9.0/ctgsy2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *scale = 1.f;
 ...
 i__2 = j + j * b_dim1;
 q__1.r = -b[i__2].r; q__1.i = -b[i__2].i; // , expr subst  
 z__[2].r = q__1.r; z__[2].i = q__1.i; // , expr subst  
 i__2 = j + j * e_dim1;
 q__1.r = -e[i__2].r; q__1.i = -e[i__2].i; // , expr subst  
 z__[3].r = q__1.r; z__[3].i = q__1.i; // , expr subst  
 ...
 *info = ierr;
 ...
 k <= i__2;
 ++k) {
 q__1.r = scaloc; q__1.i = 0.f; // , expr subst  
 ...
 *scale *= scaloc;
 ...
 if (i__ > 1) {
 q__1.r = -rhs[0].r; q__1.i = -rhs[0].i; // , expr subst  
 ...
 *scale = 1.f;
 ...
 z__[0].r = q__1.r; z__[0].i = q__1.i; // , expr subst  
 r_cnjg(&q__2, &b[j + j * b_dim1]);
 q__1.r = -q__2.r; q__1.i = -q__2.i; // , expr subst  
 z__[1].r = q__1.r; z__[1].i = q__1.i; // , expr subst  
 ...
 *scale *= scaloc;
 ...
 q__3.r = rhs[0].r * q__4.r - rhs[0].i * q__4.i; q__3.i = rhs[0].r * q__4.i + rhs[0].i * q__4.r; // , expr subst  
 q__2.r = f[i__4].r + q__3.r; q__2.i = f[i__4].i + q__3.i; // , expr subst  
 r_cnjg(&q__6, &e[k + j * e_dim1]);
 q__5.r = rhs[1].r * q__6.r - rhs[1].i * q__6.i; q__5.i = rhs[1].r * q__6.i + rhs[1].i * q__6.r; // , expr subst  
 q__1.r = q__2.r + q__5.r; q__1.i = q__2.i + q__5.i; // , expr subst  
 f[i__3].r = q__1.r; f[i__3].i = q__1.i; // , expr subst  
 /* L50: */
 }
 i__2 = *m;
 for (k = i__ + 1;
 ...
 q__3.r = q__4.r * rhs[0].r - q__4.i * rhs[0].i; q__3.i = q__4.r * rhs[0].i + q__4.i * rhs[0].r; // , expr subst  
 q__2.r = c__[i__4].r - q__3.r; q__2.i = c__[i__4].i - q__3.i; // , expr subst  
 r_cnjg(&q__6, &d__[i__ + k * d_dim1]);
 q__5.r = q__6.r * rhs[1].r - q__6.i * rhs[1].i; q__5.i = q__6.r * rhs[1].i + q__6.i * rhs[1].r; // , expr subst  
 q__1.r = q__2.r - q__5.r; q__1.i = q__2.i - q__5.i; // , expr subst  
 c__[i__3].r = q__1.r; c__[i__3].i = q__1.i; // , expr subst  
 /* L60: */
 }
 /* L70: */
 }
