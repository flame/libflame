/* ../netlib/dgejsv.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
                    ...
                    if (l2pert)
                    {
                                ...
                                ++p)
                        {
                                    ...
                                    ++q)
                            {
                                ...
                                d__4 = (d__2 = v[q + q * v_dim1], abs( d__2)); // , expr subst
        ...
        else
        {
            ...
            if (l2pert)
            {
                        ...
                        ++q)
                {
                    ...
                    {
                        /* Computing MIN */
                        d__3 = (d__1 = u[p + p * u_dim1], abs(d__1));
                        d__4 = ( d__2 = u[q + q * u_dim1], abs(d__2)); // , expr subst
                        temp1 = xsc * min(d__3,d__4);
