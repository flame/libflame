...
FLA_Error FLA_LU_piv_unb_external_ts( FLA_cntl_init_s *FLA_cntl_init_i, FLA_Obj A, FLA_Obj p )
{
  ...
  FLA_Shift_pivots_to_ts( FLA_cntl_init_i, FLA_NATIVE_PIVOTS, p );
...
{
  return FLA_LU_piv_unb_external_ts( FLA_cntl_init_i, A, p );
}
#endif
