 ...
 *info = istop + 1;
 ...
 /* Computing MAX */
 r__4 = smlnum; r__5 = ulp * ((r__1 = a[istop - 1 + (istop - 1) * a_dim1], f2c_abs(r__1)) + (r__2 = a[istop - 2 + (istop - 2) * a_dim1], f2c_abs(r__2))); // , expr subst  
 ...
 {
 /* Computing MAX */
 r__4 = smlnum; r__5 = ulp * ((r__1 = a[istop + istop * a_dim1], f2c_abs(r__1)) + (r__2 = a[istop - 1 + (istop - 1) * a_dim1], f2c_abs(r__2))); // , expr subst  
 ...
 /* Computing MAX */
 r__4 = smlnum; r__5 = ulp * ((r__1 = a[istart + 1 + (istart + 1) * a_dim1], f2c_abs(r__1)) + (r__2 = a[istart + 2 + (istart + 2) * a_dim1], f2c_abs(r__2))); // , expr subst  
 ...
 {
 /* Computing MAX */
 r__4 = smlnum; r__5 = ulp * ((r__1 = a[istart + istart * a_dim1], f2c_abs(r__1)) + (r__2 = a[istart + 1 + (istart + 1) * a_dim1] , f2c_abs(r__2))); // , expr subst  
 ...
 --k) {
 /* Computing MAX */
 r__4 = smlnum; r__5 = ulp * ((r__1 = a[k + k * a_dim1], f2c_abs(r__1)) + (r__2 = a[k - 1 + (k - 1) * a_dim1], f2c_abs(r__2))); // , expr subst  
 ...
 /* Computing MAX */
 r__2 = smlnum; r__3 = ulp * temp; // , expr subst  
 ...
 L80: shgeqz_(wants, wantq, wantz, n, ilo, ihi, &a[a_offset], lda, &b[b_offset], ldb, &alphar[1], &alphai[1], &beta[1], &q[q_offset], ldq, &z__[ z_offset], ldz, &work[1], lwork, &norm_info__);
 *info = norm_info__;
 return 0;
 }
 /* slaqz0_ */
