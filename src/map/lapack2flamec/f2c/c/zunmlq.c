/* ../netlib/v3.9.0/zunmlq.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -12;
 ...
 /* Computing MIN */
 i__1 = 64; i__2 = ilaenv_(&c__1, "ZUNMLQ", ch__1, m, n, k, &c_n1); // , expr subst  
 nb = min(i__1,i__2);
 ...
 /* Computing MAX */
 i__1 = 2; i__2 = ilaenv_(&c__2, "ZUNMLQ", ch__1, m, n, k, &c_n1); // , expr subst  
 nbmin = max(i__1,i__2);
 }
 }
 if (nb < nbmin || nb >= *k) {
