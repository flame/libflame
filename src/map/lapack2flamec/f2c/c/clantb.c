/* ../netlib/clantb.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
            ...
            if (lsame_(diag, "U"))
            {
                        ...
                        ++j)
                {
                    ...
                    for (i__ = max(i__2,i__3);
                            ...
                            ++i__)
                    {
                        work[i__] += c_f2c_abs(&ab[l + i__ + j * ab_dim1]);
                        /* L160: */
                    }
                    /* L170: */
                }
        ...
        if (lsame_(uplo, "U"))
        {
            if (lsame_(diag, "U"))
            {
                ...
                if (*k > 0)
                {
                            ...
                            ++j)
                    {
                        ...
                        /* Computing MAX */
                        i__2 = *k + 2 - j;
                        classq_(&i__3, &ab[max(i__2,1) + j * ab_dim1], &c__1, &scale, &sum);
                        /* L280: */
                    }
                }
            }
            else
            {
                        ...
                        ++j)
                {
                    ...
                    /* Computing MAX */
                    i__5 = *k + 2 - j;
                    classq_(&i__3, &ab[max(i__5,1) + j * ab_dim1], &c__1, & scale, &sum);
                    /* L290: */
                }
            }
        }
