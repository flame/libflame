...
extern __thread fla_copy_t* flash_copy_cntl_tb;

__thread fla_copyr_t*       flash_copyr_cntl_blas = NULL;
__thread fla_copyr_t*       flash_copyr_cntl;
__thread fla_blocksize_t*   flash_copyr_bsize;
