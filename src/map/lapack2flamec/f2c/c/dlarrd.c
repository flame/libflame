/* ../netlib/v3.9.0/dlarrd.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 ++j) {
 /* Computing MIN */
 d__1 = gl; d__2 = gers[(j << 1) - 1]; // , expr subst  
 gl = min(d__1,d__2);
 /* Computing MAX */
 d__1 = gu; d__2 = gers[j * 2]; // , expr subst  
 gu = max(d__1,d__2);
 /* L40: */
 }
 /* [JAN/28/2009] */
