/* ../netlib/csptrf.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
L10:
        ...
        i__1 = kc + k - 1;
        absakk = (r__1 = ap[i__1].r, abs(r__1)) + (r__2 = r_imag(&ap[kc + k - 1]), abs(r__2));
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    i__1 = kpc + imax - 1;
                    if ((r__1 = ap[i__1].r, abs(r__1)) + (r__2 = r_imag(&ap[ kpc + imax - 1]), abs(r__2)) >= alpha * rowmax)
                    {
...
L60:
        ...
        /* a 1-by-1 or 2-by-2 pivot block will be used */
        i__1 = kc;
        absakk = (r__1 = ap[i__1].r, abs(r__1)) + (r__2 = r_imag(&ap[kc]), abs(r__2));
        /* IMAX is the row-index of the largest off-diagonal element in */
        /* column K, and COLMAX is its absolute value */
        if (k < *n)
        {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    i__1 = kpc;
                    if ((r__1 = ap[i__1].r, abs(r__1)) + (r__2 = r_imag(&ap[ kpc]), abs(r__2)) >= alpha * rowmax)
                    {
                        /* interchange rows and columns K and IMAX, use 1-by-1 */
                        /* pivot block */
                        kp = imax;
