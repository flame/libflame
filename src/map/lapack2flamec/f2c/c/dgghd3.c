 ...
 */
 ...
 /* ===================================================================== */
 /* Subroutine */
 int dgghd3_(char *compq, char *compz, integer *n, integer * ilo, integer *ihi, doublereal *a, integer *lda, doublereal *b, integer *ldb, doublereal *q, integer *ldq, doublereal *z__, integer * ldz, doublereal *work, integer *lwork, integer *info) {
 AOCL_DTL_TRACE_ENTRY(AOCL_DTL_LEVEL_TRACE_5);
#if AOCL_DTL_LOG_ENABLE 
 char buffer[256]; 
 snprintf(buffer, 256,"dgghd3 inputs: compq %c, compz %c, n %" FLA_IS ", ilo %" FLA_IS ", ihi %" FLA_IS ", lda %" FLA_IS ", ldb %" FLA_IS ", ldq %" FLA_IS ", ldz %" FLA_IS ", lwork %" FLA_IS "",*compq, *compz, *n, *ilo, *ihi, *lda, *ldb, *ldq, *ldz, *lwork);
 ...
 integer nbmin;
 extern /* Subroutine */
 int dorm22_(char *, char *, integer *, integer *, integer *, integer *, doublereal *, integer *, doublereal *, integer *, doublereal *, integer *, integer *);
 integer nblst;
 logical initq, wantq;
 extern /* Subroutine */
 int dtrmv_(char *, char *, char *, integer *, doublereal *, integer *, doublereal *, integer *);
 logical initz, wantz;
 char compq2[1], compz2[1];
 extern /* Subroutine */
 int dgghrd_(char *, char *, integer *, integer *, integer *, doublereal *, integer *, doublereal *, integer *, doublereal *, integer *, doublereal *, integer *, integer *), dlaset_(char *, integer *, integer *, doublereal *, doublereal *, doublereal *, integer *), dlartg_( doublereal *, doublereal *, doublereal *, doublereal *, doublereal *);
 ...
 *info = -15;
 ...
 /* Computing MAX */
 i__1 = nb; i__2 = ilaenv_(&c__3, "DGGHD3", " ", n, ilo, ihi, &c_n1); // , expr subst  
 nx = max(i__1,i__2);
 if (nx < nh) {
 ...
 /* unblocked code. */
 /* Computing MAX */
 i__1 = 2; i__2 = ilaenv_(&c__2, "DGGHD3", " ", n, ilo, ihi, & c_n1); // , expr subst  
 nbmin = max(i__1,i__2);
 if (*lwork >= *n * 6 * nbmin) {
 nb = *lwork / (*n * 6);
 }
 ...
 /* Use blocked code */
 kacc22 = ilaenv_(&c__16, "DGGHD3", " ", n, ilo, ihi, &c_n1);
 blk22 = kacc22 == 2;
 i__1 = *ihi - 2;
 i__2 = nb;
 for (jcol = *ilo;
 ...
 i__3 = *ihi - jcol - 1;
 dlaset_("Lower", &i__3, &nnb, &c_b14, &c_b14, &a[jcol + 2 + jcol * a_dim1], lda);
 i__3 = *ihi - jcol - 1;
