/* ../netlib/v3.9.0/zgebrd.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 /* Computing MAX */
 i__1 = 1; i__2 = ilaenv_(&c__1, "ZGEBRD", " ", m, n, &c_n1, &c_n1); // , expr subst  
 nb = max(i__1,i__2);
 lwkopt = (*m + *n) * nb;
 ...
 *info = -10;
 ...
 /* Computing MAX */
 i__1 = nb; i__2 = ilaenv_(&c__3, "ZGEBRD", " ", m, n, &c_n1, &c_n1); // , expr subst  
 nx = max(i__1,i__2);
 ...
 i__4 = j + j * a_dim1;
 i__5 = j;
 a[i__4].r = d__[i__5]; a[i__4].i = 0.; // , expr subst  
 i__4 = j + (j + 1) * a_dim1;
 i__5 = j;
 a[i__4].r = e[i__5]; a[i__4].i = 0.; // , expr subst  
 /* L10: */
 }
 }
 else {
 ...
 work[1].r = (doublereal) ws; work[1].i = 0.; // , expr subst  
 return 0;
 /* End of ZGEBRD */
 }
 /* zgebrd_ */
