/* ../netlib/v3.9.0/ssyequb.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *amax = 0.f;
 ...
 ++i__) {
 /* Computing MAX */
 r__2 = s[i__]; r__3 = (r__1 = a[i__ + j * a_dim1], abs(r__1)); // , expr subst  
 s[i__] = max(r__2,r__3);
 /* Computing MAX */
 r__2 = s[j]; r__3 = (r__1 = a[i__ + j * a_dim1], abs(r__1)); // , expr subst  
 s[j] = max(r__2,r__3);
 /* Computing MAX */
 r__2 = *amax; r__3 = (r__1 = a[i__ + j * a_dim1], abs(r__1)); // , expr subst  
 *amax = max(r__2,r__3);
 }
 /* Computing MAX */
 r__2 = s[j]; r__3 = (r__1 = a[j + j * a_dim1], abs(r__1)); // , expr subst  
 s[j] = max(r__2,r__3);
 /* Computing MAX */
 r__2 = *amax; r__3 = (r__1 = a[j + j * a_dim1], abs(r__1)); // , expr subst  
 *amax = max(r__2,r__3);
 }
 }
 else {
