                    ...
                    ++i__)
            {
                ...
                if (*alpha != 0.f)
                {
                            ...
                            ++j)
                    {
                        ...
                        temp = (r__1 = ab[i__2].r, abs(r__1)) + (r__2 = r_imag(&ab[kd + i__ - j + j * ab_dim1]), abs( r__2));
                        i__2 = j;
                        symb_zero__ = symb_zero__ && (x[i__2].r == 0.f && x[ i__2].i == 0.f || temp == 0.f);
                        i__2 = j;
                        y[iy] += *alpha * ((r__1 = x[i__2].r, abs(r__1)) + ( r__2 = r_imag(&x[j]), abs(r__2))) * temp;
                    }
                }
                if (! symb_zero__)
                {
                    ...
                    ++i__)
            {
                ...
                if (*alpha != 0.f)
                {
                            ...
                            ++j)
                    {
                        ...
                        temp = (r__1 = ab[i__3].r, abs(r__1)) + (r__2 = r_imag(&ab[ke - i__ + j + i__ * ab_dim1]), abs(r__2));
                        i__3 = j;
                    ...
                    ++i__)
            {
                ...
                if (*alpha != 0.f)
                {
                            ...
                            ++j)
                    {
                        ...
                        symb_zero__ = symb_zero__ && (x[i__2].r == 0.f && x[ i__2].i == 0.f || temp == 0.f);
                        i__2 = jx;
                        y[iy] += *alpha * ((r__1 = x[i__2].r, abs(r__1)) + ( r__2 = r_imag(&x[jx]), abs(r__2))) * temp;
                        jx += *incx;
                    }
                }
                if (! symb_zero__)
