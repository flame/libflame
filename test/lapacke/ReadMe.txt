...
5) In the terminal, Go to the '<lapacke>/' folder and run "make clean; make -j" command to generate the lapacke gtest executable "xlapacke_test_main" in the '<lapacke>/' folder.
