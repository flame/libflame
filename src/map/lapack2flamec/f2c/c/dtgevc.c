    ...
    *m = im;
    ...
    if (compl)
    {
                ...
                ++je)
        {
            ...
            if (! ilcplx)
            {
                if ((d__1 = s[je + je * s_dim1], abs(d__1)) <= safmin && ( d__2 = p[je + je * p_dim1], abs(d__2)) <= safmin)
                {
            ...
            if (! ilcplx)
            {
                /* Real eigenvalue */
                /* Computing MAX */
                d__3 = (d__1 = s[je + je * s_dim1], abs(d__1)) * ascale;
                d__4 = (d__2 = p[je + je * p_dim1], abs(d__2)) * bscale;
                ...
                if (lsb)
                {
                    /* Computing MAX */
                    d__1 = scale;
                    d__2 = small / abs(salfar) * min(bnorm,big); // , expr subst
                    scale = max(d__1,d__2);
                }
                if (lsa || lsb)
                {
                    /* Computing MIN */
                    /* Computing MAX */
                    d__3 = 1., d__4 = abs(acoef);
                    d__3 = max(d__3,d__4);
                    d__4 = abs(bcoefr); // ; expr subst
                    d__1 = scale;
            ...
            else
            {
                ...
                /* Computing MAX */
                d__5 = (d__1 = work[(*n << 1) + je], abs(d__1)) + (d__2 = work[*n * 3 + je], abs(d__2));
                d__6 = (d__3 = work[(* n << 1) + je + 1], abs(d__3)) + (d__4 = work[*n * 3 + je + 1], abs(d__4)); // , expr subst
                xmax = max(d__5,d__6);
            }
            /* Computing MAX */
...
L160:
            ...
            if (ilcplx)
            {
                        ...
                        ++j)
                {
                    /* Computing MAX */
                    d__3 = xmax;
                    d__4 = (d__1 = vl[j + ieig * vl_dim1], abs( d__1)) + (d__2 = vl[j + (ieig + 1) * vl_dim1], abs(d__2)); // , expr subst
                    xmax = max(d__3,d__4);
                    /* L180: */
                }
            }
            else
            {
                        ...
                        ++j)
                {
                    /* Computing MAX */
                    d__2 = xmax;
                    d__3 = (d__1 = vl[j + ieig * vl_dim1], abs( d__1)); // , expr subst
                    xmax = max(d__2,d__3);
                    /* L190: */
                }
            }
...
L370:
            ...
            if (ilcplx)
            {
                        ...
                        ++j)
                {
                    /* Computing MAX */
                    d__3 = xmax;
                    d__4 = (d__1 = vr[j + ieig * vr_dim1], abs( d__1)) + (d__2 = vr[j + (ieig + 1) * vr_dim1], abs(d__2)); // , expr subst
                    xmax = max(d__3,d__4);
                    /* L460: */
                }
            }
            else
            {
                        ...
                        ++j)
                {
                    /* Computing MAX */
                    d__2 = xmax;
                    d__3 = (d__1 = vr[j + ieig * vr_dim1], abs( d__1)); // , expr subst
                    xmax = max(d__2,d__3);
                    /* L470: */
                }
            }
