                ...
                ++i__)
        {
            ...
            if (*capply)
            {
                        ...
                        ++j)
                {
                    ...
                    tmp += ((d__1 = ab[i__2].r, f2c_dabs(d__1)) + (d__2 = d_imag(& ab[kd + i__ - j + j * ab_dim1]), f2c_dabs(d__2))) / c__[j];
                }
            }
            else
            {
                        ...
                        ++j)
                {
                    ...
                    tmp += (d__1 = ab[i__3].r, f2c_dabs(d__1)) + (d__2 = d_imag(& ab[kd + i__ - j + j * ab_dim1]), f2c_dabs(d__2));
                }
            }
            rwork[i__] = tmp;
            anorm = max(anorm,tmp);
                ...
                ++i__)
        {
            ...
            if (*capply)
            {
                        ...
                        ++j)
                {
                    ...
                    tmp += ((d__1 = ab[i__2].r, f2c_dabs(d__1)) + (d__2 = d_imag(& ab[ke - i__ + j + i__ * ab_dim1]), f2c_dabs(d__2))) / c__[j];
                }
            }
            else
            {
                        ...
                        ++j)
                {
                    ...
                    tmp += (d__1 = ab[i__3].r, f2c_dabs(d__1)) + (d__2 = d_imag(& ab[ke - i__ + j + i__ * ab_dim1]), f2c_dabs(d__2));
                }
            }
            rwork[i__] = tmp;
            anorm = max(anorm,tmp);
