/* ../netlib/v3.9.0/slaed2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *rho = (r__1 = *rho * 2.f, abs(r__1));
 ...
 eps = slamch_("Epsilon");
 /* Computing MAX */
 r__3 = (r__1 = d__[jmax], abs(r__1)); r__4 = (r__2 = z__[imax], abs(r__2)) ; // , expr subst  
