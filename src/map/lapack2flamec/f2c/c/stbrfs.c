                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        for (i__ = max(i__3,i__4);
                                ...
                                ++i__)
                        {
                            work[i__] += (r__1 = ab[*kd + 1 + i__ - k + k * ab_dim1], abs(r__1)) * xk;
                            /* L30: */
                        }
                        /* L40: */
                    }
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        for (i__ = k;
                                ...
                                ++i__)
                        {
                            work[i__] += (r__1 = ab[i__ + 1 - k + k * ab_dim1] , abs(r__1)) * xk;
                            /* L70: */
                        }
                        /* L80: */
                    }
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        for (i__ = max(i__4,i__5);
                                ...
                                ++i__)
                        {
                            s += (r__1 = ab[*kd + 1 + i__ - k + k * ab_dim1], abs(r__1)) * (r__2 = x[i__ + j * x_dim1], abs(r__2));
                            /* L110: */
                        }
                        work[k] += s;
                        /* L120: */
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        for (i__ = k;
                                ...
                                ++i__)
                        {
                            s += (r__1 = ab[i__ + 1 - k + k * ab_dim1], abs( r__1)) * (r__2 = x[i__ + j * x_dim1], abs( r__2));
                            /* L150: */
                        }
                        work[k] += s;
                        /* L160: */
