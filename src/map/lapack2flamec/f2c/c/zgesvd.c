/* ../netlib/zgesvd.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 char buffer[256]; 
 snprintf(buffer, 256,"zgesvd inputs: jobu %c, jobvt %c, m %d, n %d, lda %d, ldu %d, ldvt %d",*jobu, *jobvt, *m, *n, *lda, *ldu, *ldvt);
 ...
 doublereal bignum;
 extern /* Subroutine */
 int zgelqf_(integer *, integer *, doublecomplex *, integer *, doublecomplex *, doublecomplex *, integer *, integer * ), zlascl_(char *, integer *, integer *, doublereal *, doublereal *, integer *, integer *, doublecomplex *, integer *, integer *), zgeqrf_(integer *, integer *, doublecomplex *, integer *, doublecomplex *, doublecomplex *, integer *, integer *), zlacpy_( char *, integer *, integer *, doublecomplex *, integer *, doublecomplex *, integer *), zlaset_(char *, integer *, integer *, doublecomplex *, doublecomplex *, doublecomplex *, integer *);
 integer ldwrkr;
 extern /* Subroutine */
 ...
 *info = -11;
 ...
 zgebrd_(n, n, &a[a_offset], lda, &s[1], dum, cdum, cdum, cdum, & c_n1, &ierr);
 ...
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*n << 1) + lwork_zgebrd__; // , expr subst  
 maxwrk = max(i__2,i__3);
 if (wntvo || wntvas) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*n << 1) + lwork_zungbr_p__; // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 minwrk = *n * 3;
 }
 ...
 /* Computing MAX */
 i__2 = wrkbl; i__3 = *n + lwork_zungqr_n__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = wrkbl; i__3 = (*n << 1) + lwork_zgebrd__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = wrkbl; i__3 = (*n << 1) + lwork_zungbr_q__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 ...
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = wrkbl; i__3 = (*n << 1) + lwork_zungbr_p__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = *n * *n + wrkbl; i__3 = *n * *n + *m * *n; // , expr subst  
 maxwrk = max(i__2,i__3);
 ...
 wrkbl = *n + lwork_zgeqrf__;
 /* Computing MAX */
 i__2 = wrkbl; i__3 = *n + lwork_zungqr_m__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = wrkbl; i__3 = (*n << 1) + lwork_zgebrd__; // , expr subst  
 wrkbl = max(i__2,i__3);
 ...
 zgebrd_(m, n, &a[a_offset], lda, &s[1], dum, cdum, cdum, cdum, &c_n1, &ierr);
 lwork_zgebrd__ = (integer) cdum[0].r;
 maxwrk = (*n << 1) + lwork_zgebrd__;
 if (wntus || wntuo) {
 zungbr_("Q", m, n, n, &a[a_offset], lda, cdum, cdum, & c_n1, &ierr);
 lwork_zungbr_q__ = (integer) cdum[0].r;
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*n << 1) + lwork_zungbr_q__; // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 if (wntua) {
 zungbr_("Q", m, m, n, &a[a_offset], lda, cdum, cdum, & c_n1, &ierr);
 lwork_zungbr_q__ = (integer) cdum[0].r;
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*n << 1) + lwork_zungbr_q__; // , expr subst  
 maxwrk = max(i__2,i__3);
 ...
 /* Compute space needed for ZGEBRD */
 zgebrd_(m, m, &a[a_offset], lda, &s[1], dum, cdum, cdum, cdum, & c_n1, &ierr);
 lwork_zgebrd__ = (integer) cdum[0].r;
 ...
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*m << 1) + lwork_zgebrd__; // , expr subst  
 maxwrk = max(i__2,i__3);
 if (wntuo || wntuas) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*m << 1) + lwork_zungbr_q__; // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 minwrk = *m * 3;
 }
 ...
 /* Computing MAX */
 i__2 = wrkbl; i__3 = *m + lwork_zunglq_m__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = wrkbl; i__3 = (*m << 1) + lwork_zgebrd__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = wrkbl; i__3 = (*m << 1) + lwork_zungbr_p__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 ...
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = wrkbl; i__3 = (*m << 1) + lwork_zungbr_q__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = *m * *m + wrkbl; i__3 = *m * *m + *m * *n; // , expr subst  
 maxwrk = max(i__2,i__3);
 ...
 wrkbl = *m + lwork_zgelqf__;
 /* Computing MAX */
 i__2 = wrkbl; i__3 = *m + lwork_zunglq_n__; // , expr subst  
 wrkbl = max(i__2,i__3);
 /* Computing MAX */
 i__2 = wrkbl; i__3 = (*m << 1) + lwork_zgebrd__; // , expr subst  
 wrkbl = max(i__2,i__3);
 ...
 if (wntvs || wntvo) {
 /* Compute space needed for ZUNGBR P */
 zungbr_("P", m, n, m, &a[a_offset], n, cdum, cdum, &c_n1, &ierr);
 lwork_zungbr_p__ = (integer) cdum[0].r;
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*m << 1) + lwork_zungbr_p__; // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 if (wntva) {
 zungbr_("P", n, n, m, &a[a_offset], n, cdum, cdum, &c_n1, &ierr);
 lwork_zungbr_p__ = (integer) cdum[0].r;
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*m << 1) + lwork_zungbr_p__; // , expr subst  
 maxwrk = max(i__2,i__3);
