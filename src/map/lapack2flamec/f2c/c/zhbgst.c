/* ../netlib/zhbgst.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int zhbgst_(char *vect, char *uplo, integer *n, integer *ka, integer *kb, doublecomplex *ab, integer *ldab, doublecomplex *bb, integer *ldbb, doublecomplex *x, integer *ldx, doublecomplex *work, doublereal *rwork, integer *info)
{
    ...
    extern /* Subroutine */
    int zgerc_(integer *, integer *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, integer *, doublecomplex *, integer *);
    logical upper;
    extern /* Subroutine */
...
L10:
    ...
    if (upper)
    {
        ...
        if (update)
        {
            ...
            if (wantx)
            {
                ...
                if (kbt > 0)
                {
                    ...
                    z__1.r = -1.;
                    z__1.i = -0.; // , expr subst
                    zgerc_(&i__3, &kbt, &z__1, &x[m + 1 + i__ * x_dim1], & c__1, &bb[kb1 - kbt + i__ * bb_dim1], &c__1, &x[m + 1 + (i__ - kbt) * x_dim1], ldx);
                }
            }
                ...
                ++k)
        {
            ...
            if (nrt > 0)
            {
                zlargv_(&nrt, &ab[j2t * ab_dim1 + 1], &inca, &work[j2t - m], & ka1, &rwork[j2t - m], &ka1);
            }
            if (nr > 0)
            {
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    zlartv_(&nr, &ab[ka1 - l + j2 * ab_dim1], &inca, &ab[*ka - l + (j2 + 1) * ab_dim1], &inca, &rwork[j2 - m], &work[j2 - m], &ka1);
                    /* L100: */
                }
                /* apply rotations in 1st set from both sides to diagonal */
                /* blocks */
                zlar2v_(&nr, &ab[ka1 + j2 * ab_dim1], &ab[ka1 + (j2 + 1) * ab_dim1], &ab[*ka + (j2 + 1) * ab_dim1], &inca, & rwork[j2 - m], &work[j2 - m], &ka1);
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[l + (j2 + ka1 - l) * ab_dim1], &inca, & ab[l + 1 + (j2 + ka1 - l) * ab_dim1], &inca, & rwork[j2 - m], &work[j2 - m], &ka1);
                }
                /* L110: */
            }
            if (wantx)
            {
                        ...
                        j += i__2)
                {
                    ...
                    zrot_(&i__1, &x[m + 1 + j * x_dim1], &c__1, &x[m + 1 + (j + 1) * x_dim1], &c__1, &rwork[j - m], &z__1);
                    /* L120: */
                }
            }
            /* L130: */
                ...
                --k)
        {
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[l + (j2 - l + 1) * ab_dim1], &inca, &ab[ l + 1 + (j2 - l + 1) * ab_dim1], &inca, &rwork[j2 - *ka], &work[j2 - *ka], &ka1);
                }
                /* L140: */
            }
            nr = (*n - j2 + *ka) / ka1;
                ...
                --k)
        {
            ...
            if (nr > 0)
            {
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    zlartv_(&nr, &ab[ka1 - l + j2 * ab_dim1], &inca, &ab[*ka - l + (j2 + 1) * ab_dim1], &inca, &rwork[j2], & work[j2], &ka1);
                    /* L180: */
                }
                /* apply rotations in 2nd set from both sides to diagonal */
                /* blocks */
                zlar2v_(&nr, &ab[ka1 + j2 * ab_dim1], &ab[ka1 + (j2 + 1) * ab_dim1], &ab[*ka + (j2 + 1) * ab_dim1], &inca, & rwork[j2], &work[j2], &ka1);
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[l + (j2 + ka1 - l) * ab_dim1], &inca, & ab[l + 1 + (j2 + ka1 - l) * ab_dim1], &inca, & rwork[j2], &work[j2], &ka1);
                }
                /* L190: */
            }
            if (wantx)
            {
                        ...
                        j += i__2)
                {
                    i__4 = *n - m;
                    d_cnjg(&z__1, &work[j]);
                    zrot_(&i__4, &x[m + 1 + j * x_dim1], &c__1, &x[m + 1 + (j + 1) * x_dim1], &c__1, &rwork[j], &z__1);
                    /* L200: */
                }
            }
            /* L210: */
    ...
    else
    {
        ...
        if (update)
        {
            ...
            if (wantx)
            {
                ...
                if (kbt > 0)
                {
                    ...
                    z__1.i = -0.; // , expr subst
                    i__3 = *ldbb - 1;
                    zgeru_(&i__4, &kbt, &z__1, &x[m + 1 + i__ * x_dim1], & c__1, &bb[kbt + 1 + (i__ - kbt) * bb_dim1], &i__3, &x[m + 1 + (i__ - kbt) * x_dim1], ldx);
                }
            }
                ...
                ++k)
        {
            if (update)
            {
                ...
                if (i__ - k + *ka < *n && i__ - k > 1)
                {
                    ...
                    zlartg_(&ab[ka1 - k + i__ * ab_dim1], &ra1, &rwork[i__ - k + *ka - m], &work[i__ - k + *ka - m], &ra);
            ...
            if (nrt > 0)
            {
                zlargv_(&nrt, &ab[ka1 + (j2t - *ka) * ab_dim1], &inca, &work[ j2t - m], &ka1, &rwork[j2t - m], &ka1);
            }
            if (nr > 0)
            {
                ...
                /* apply rotations in 1st set from both sides to diagonal */
                /* blocks */
                zlar2v_(&nr, &ab[j2 * ab_dim1 + 1], &ab[(j2 + 1) * ab_dim1 + 1], &ab[j2 * ab_dim1 + 2], &inca, &rwork[j2 - m], & work[j2 - m], &ka1);
                zlacgv_(&nr, &work[j2 - m], &ka1);
            }
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[ka1 - l + 1 + j2 * ab_dim1], &inca, &ab[ ka1 - l + (j2 + 1) * ab_dim1], &inca, &rwork[j2 - m], &work[j2 - m], &ka1);
                }
                /* L340: */
            }
            if (wantx)
            {
                ...
                {
                    i__2 = *n - m;
                    zrot_(&i__2, &x[m + 1 + j * x_dim1], &c__1, &x[m + 1 + (j + 1) * x_dim1], &c__1, &rwork[j - m], &work[j - m] );
                    /* L350: */
                }
            }
            /* L360: */
                ...
                --k)
        {
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[ka1 - l + 1 + (j2 - *ka) * ab_dim1], & inca, &ab[ka1 - l + (j2 - *ka + 1) * ab_dim1], & inca, &rwork[j2 - *ka], &work[j2 - *ka], &ka1);
                }
                /* L370: */
            }
            nr = (*n - j2 + *ka) / ka1;
                ...
                --k)
        {
            ...
            if (nr > 0)
            {
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    zlartv_(&nr, &ab[l + 1 + (j2 - l) * ab_dim1], &inca, &ab[ l + 2 + (j2 - l) * ab_dim1], &inca, &rwork[j2], & work[j2], &ka1);
                    /* L410: */
                }
                /* apply rotations in 2nd set from both sides to diagonal */
                /* blocks */
                zlar2v_(&nr, &ab[j2 * ab_dim1 + 1], &ab[(j2 + 1) * ab_dim1 + 1], &ab[j2 * ab_dim1 + 2], &inca, &rwork[j2], &work[ j2], &ka1);
                zlacgv_(&nr, &work[j2], &ka1);
            }
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[ka1 - l + 1 + j2 * ab_dim1], &inca, &ab[ ka1 - l + (j2 + 1) * ab_dim1], &inca, &rwork[j2], &work[j2], &ka1);
                }
                /* L420: */
            }
            if (wantx)
            {
                ...
                {
                    i__1 = *n - m;
                    zrot_(&i__1, &x[m + 1 + j * x_dim1], &c__1, &x[m + 1 + (j + 1) * x_dim1], &c__1, &rwork[j], &work[j]);
                    /* L430: */
                }
            }
            /* L440: */
    ...
    if (upper)
    {
        ...
        if (update)
        {
            ...
            if (wantx)
            {
                ...
                if (kbt > 0)
                {
                    ...
                    z__1.i = -0.; // , expr subst
                    i__3 = *ldbb - 1;
                    zgeru_(&nx, &kbt, &z__1, &x[i__ * x_dim1 + 1], &c__1, &bb[ *kb + (i__ + 1) * bb_dim1], &i__3, &x[(i__ + 1) * x_dim1 + 1], ldx);
                }
            }
            /* store a(i1,i) in RA1 for use in next loop over K */
                ...
                ++k)
        {
            if (update)
            {
                ...
                {
                    /* generate rotation to annihilate a(i+k-ka-1,i) */
                    zlartg_(&ab[k + 1 + i__ * ab_dim1], &ra1, &rwork[i__ + k - *ka], &work[i__ + k - *ka], &ra);
                    /* create nonzero element a(i+k-ka-1,i+k) outside the */
            ...
            if (nrt > 0)
            {
                zlargv_(&nrt, &ab[(j1 + *ka) * ab_dim1 + 1], &inca, &work[j1], &ka1, &rwork[j1], &ka1);
            }
            if (nr > 0)
            {
                /* apply rotations in 1st set from the left */
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    zlartv_(&nr, &ab[ka1 - l + (j1 + l) * ab_dim1], &inca, & ab[*ka - l + (j1 + l) * ab_dim1], &inca, &rwork[ j1], &work[j1], &ka1);
                    /* L580: */
                }
                /* apply rotations in 1st set from both sides to diagonal */
                /* blocks */
                zlar2v_(&nr, &ab[ka1 + j1 * ab_dim1], &ab[ka1 + (j1 - 1) * ab_dim1], &ab[*ka + j1 * ab_dim1], &inca, &rwork[j1], &work[j1], &ka1);
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[l + j1t * ab_dim1], &inca, &ab[l + 1 + ( j1t - 1) * ab_dim1], &inca, &rwork[j1t], &work[ j1t], &ka1);
                }
                /* L590: */
            }
            if (wantx)
            {
                ...
                for (j = j1;
                        ...
                        j += i__4)
                {
                    zrot_(&nx, &x[j * x_dim1 + 1], &c__1, &x[(j - 1) * x_dim1 + 1], &c__1, &rwork[j], &work[j]);
                    /* L600: */
                }
            }
            /* L610: */
                ...
                --k)
        {
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[l + (j1t + *ka) * ab_dim1], &inca, &ab[ l + 1 + (j1t + *ka - 1) * ab_dim1], &inca, &rwork[ m - *kb + j1t + *ka], &work[m - *kb + j1t + *ka], &ka1);
                }
                /* L620: */
            }
            nr = (j2 + *ka - 1) / ka1;
                ...
                --k)
        {
            ...
            if (nr > 0)
            {
                /* generate rotations in 2nd set to annihilate elements */
                /* which have been created outside the band */
                zlargv_(&nr, &ab[(j1 + *ka) * ab_dim1 + 1], &inca, &work[m - * kb + j1], &ka1, &rwork[m - *kb + j1], &ka1);
                /* apply rotations in 2nd set from the left */
                i__3 = *ka - 1;
                for (l = 1;
                        l <= i__3;
                        ++l)
                {
                    zlartv_(&nr, &ab[ka1 - l + (j1 + l) * ab_dim1], &inca, & ab[*ka - l + (j1 + l) * ab_dim1], &inca, &rwork[m - *kb + j1], &work[m - *kb + j1], &ka1);
                    /* L660: */
                }
                /* apply rotations in 2nd set from both sides to diagonal */
                /* blocks */
                zlar2v_(&nr, &ab[ka1 + j1 * ab_dim1], &ab[ka1 + (j1 - 1) * ab_dim1], &ab[*ka + j1 * ab_dim1], &inca, &rwork[m - * kb + j1], &work[m - *kb + j1], &ka1);
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[l + j1t * ab_dim1], &inca, &ab[l + 1 + ( j1t - 1) * ab_dim1], &inca, &rwork[m - *kb + j1t], &work[m - *kb + j1t], &ka1);
                }
                /* L670: */
            }
            if (wantx)
            {
                ...
                for (j = j1;
                        ...
                        j += i__4)
                {
                    zrot_(&nx, &x[j * x_dim1 + 1], &c__1, &x[(j - 1) * x_dim1 + 1], &c__1, &rwork[m - *kb + j], &work[m - *kb + j]);
                    /* L680: */
                }
            }
            /* L690: */
    ...
    else
    {
        ...
        if (update)
        {
            ...
            if (wantx)
            {
                ...
                if (kbt > 0)
                {
                    z__1.r = -1.;
                    z__1.i = -0.; // , expr subst
                    zgerc_(&nx, &kbt, &z__1, &x[i__ * x_dim1 + 1], &c__1, &bb[ i__ * bb_dim1 + 2], &c__1, &x[(i__ + 1) * x_dim1 + 1], ldx);
                }
            }
            /* store a(i,i1) in RA1 for use in next loop over K */
                ...
                ++k)
        {
            if (update)
            {
                ...
                {
                    /* generate rotation to annihilate a(i,i+k-ka-1) */
                    zlartg_(&ab[ka1 - k + (i__ + k - *ka) * ab_dim1], &ra1, & rwork[i__ + k - *ka], &work[i__ + k - *ka], &ra);
                    /* create nonzero element a(i+k,i+k-ka-1) outside the */
                    /* band and store it in WORK(m-kb+i+k) */
            ...
            if (nr > 0)
            {
                ...
                for (l = 1;
                        ...
                        ++l)
                {
                    zlartv_(&nr, &ab[l + 1 + j1 * ab_dim1], &inca, &ab[l + 2 + (j1 - 1) * ab_dim1], &inca, &rwork[j1], &work[ j1], &ka1);
                    /* L810: */
                }
                /* apply rotations in 1st set from both sides to diagonal */
                /* blocks */
                zlar2v_(&nr, &ab[j1 * ab_dim1 + 1], &ab[(j1 - 1) * ab_dim1 + 1], &ab[(j1 - 1) * ab_dim1 + 2], &inca, &rwork[j1], & work[j1], &ka1);
                zlacgv_(&nr, &work[j1], &ka1);
            }
            /* start applying rotations in 1st set from the left */
            i__1 = *kb - k + 1;
            ...
            if (wantx)
            {
                ...
                {
                    d_cnjg(&z__1, &work[j]);
                    zrot_(&nx, &x[j * x_dim1 + 1], &c__1, &x[(j - 1) * x_dim1 + 1], &c__1, &rwork[j], &z__1);
                    /* L830: */
                }
            }
            /* L840: */
                ...
                --k)
        {
                    ...
                    --l)
            {
                ...
                if (nrt > 0)
                {
                    zlartv_(&nrt, &ab[ka1 - l + 1 + (j1t + l - 1) * ab_dim1], &inca, &ab[ka1 - l + (j1t + l - 1) * ab_dim1], & inca, &rwork[m - *kb + j1t + *ka], &work[m - *kb + j1t + *ka], &ka1);
                }
                /* L850: */
            }
            nr = (j2 + *ka - 1) / ka1;
                ...
                --k)
        {
            ...
            if (nr > 0)
            {
                /* generate rotations in 2nd set to annihilate elements */
                /* which have been created outside the band */
                zlargv_(&nr, &ab[ka1 + j1 * ab_dim1], &inca, &work[m - *kb + j1], &ka1, &rwork[m - *kb + j1], &ka1);
                /* apply rotations in 2nd set from the right */
                i__4 = *ka - 1;
                for (l = 1;
                        l <= i__4;
                ...
                /* apply rotations in 2nd set from both sides to diagonal */
                /* blocks */
                zlar2v_(&nr, &ab[j1 * ab_dim1 + 1], &ab[(j1 - 1) * ab_dim1 + 1], &ab[(j1 - 1) * ab_dim1 + 2], &inca, &rwork[m - * kb + j1], &work[m - *kb + j1], &ka1);
                zlacgv_(&nr, &work[m - *kb + j1], &ka1);
            }
            /* start applying rotations in 2nd set from the left */
            i__4 = *kb - k + 1;
            ...
            if (wantx)
            {
                        ...
                        j += i__3)
                {
                    ...
                    zrot_(&nx, &x[j * x_dim1 + 1], &c__1, &x[(j - 1) * x_dim1 + 1], &c__1, &rwork[m - *kb + j], &z__1);
                    /* L910: */
                }
            }
            /* L920: */
