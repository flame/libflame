/* ../netlib/v3.9.0/cunbdb.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -21;
 ...
 if (i__ == 1) {
 i__2 = *p - i__ + 1;
 q__1.r = z1; q__1.i = 0.f; // , expr subst  
 ...
 if (i__ == 1) {
 i__2 = *m - *p - i__ + 1;
 q__1.r = z2; q__1.i = 0.f; // , expr subst  
 ...
 x12[i__2].r = 1.f; x12[i__2].i = 0.f; // , expr subst  
 if (i__ < *q) {
 i__2 = *p - i__;
 i__3 = *q - i__;
 ...
 x22[i__2].r = 1.f; x22[i__2].i = 0.f; // , expr subst  
 i__2 = *m - *p - *q - i__;
 i__3 = *m - *p - *q - i__ + 1;
