/* ../netlib/dormrq.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
    ...
    *info = 0;
    ...
    else
    {
                ...
                i__ += i__2)
        {
            ...
            i__4 = nq - *k + i__ + ib - 1;
            dlarft_("Backward", "Rowwise", &i__4, &ib, &a[i__ + a_dim1], lda, &tau[i__], t, &c__65);
            if (left)
            {
            ...
            /* Apply H or H**T */
            dlarfb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, &a[ i__ + a_dim1], lda, t, &c__65, &c__[c_offset], ldc, &work[ 1], &ldwork);
            /* L10: */
        }
    }
    work[1] = (doublereal) lwkopt;
