/* ../netlib/v3.9.0/zgesc2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
;
 ...
 i__5 = j + i__ * a_dim1;
 i__6 = i__;
 z__2.r = a[i__5].r * rhs[i__6].r - a[i__5].i * rhs[i__6].i; z__2.i = a[i__5].r * rhs[i__6].i + a[i__5].i * rhs[i__6] .r; // , expr subst  
 z__1.r = rhs[i__4].r - z__2.r; z__1.i = rhs[i__4].i - z__2.i; // , expr subst  
 rhs[i__3].r = z__1.r; rhs[i__3].i = z__1.i; // , expr subst  
 /* L10: */
 }
 /* L20: */
 }
 ...
 *scale = 1.;
 ...
 d__1 = z_abs(&rhs[i__]);
 z__1.r = .5 / d__1; z__1.i = 0. / d__1; // , expr subst  
 ...
 *scale *= temp.r;
 ...
 i__1 = i__;
 i__2 = i__;
 z__1.r = rhs[i__2].r * temp.r - rhs[i__2].i * temp.i; z__1.i = rhs[ i__2].r * temp.i + rhs[i__2].i * temp.r; // , expr subst  
 rhs[i__1].r = z__1.r; rhs[i__1].i = z__1.i; // , expr subst  
 i__1 = *n;
 for (j = i__ + 1;
 j <= i__1;
 ++j) {
 ...
 i__4 = j;
 i__5 = i__ + j * a_dim1;
 z__3.r = a[i__5].r * temp.r - a[i__5].i * temp.i; z__3.i = a[i__5] .r * temp.i + a[i__5].i * temp.r; // , expr subst  
 z__2.r = rhs[i__4].r * z__3.r - rhs[i__4].i * z__3.i; z__2.i = rhs[i__4].r * z__3.i + rhs[i__4].i * z__3.r; // , expr subst  
 z__1.r = rhs[i__3].r - z__2.r; z__1.i = rhs[i__3].i - z__2.i; // , expr subst  
 rhs[i__2].r = z__1.r; rhs[i__2].i = z__1.i; // , expr subst  
 /* L30: */
 }
 /* L40: */
 }
