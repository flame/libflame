...
int chptrf_(char *uplo, integer *n, complex *ap, integer * ipiv, integer *info)
{
    ...
    char buffer[256]; 
    snprintf(buffer, 256,"chptrf inputs: uplo %c, n %d\n",*uplo, *n);
        ...
        else
        {
            ...
            else
            {
                ...
                if (k > 2)
                {
                    ...
                    tt = 1.f / (d11 * d22 - 1.f);
                    i__1 = k - 1 + (k - 1) * k / 2;
                    q__1.r = ap[i__1].r / d__;
                    q__1.i = ap[i__1].i / d__; // , expr subst
                    d12.r = q__1.r;
                            ...
                            --j)
                    {
                        ...
                        q__3.i = d11 * ap[i__1].i; // , expr subst
                        r_cnjg(&q__5, &d12);
                        i__2 = j + (k - 1) * k / 2;
        ...
        else
        {
            ...
            if (kstep == 1)
            {
                ...
                if (k < *n)
                {
                    ...
                    i__1 = *n - k;
                    r__1 = -r1;
                    chpr_(uplo, &i__1, &r__1, &ap[kc + 1], &c__1, &ap[kc + *n - k + 1]);
            ...
            else
            {
                ...
                if (k < *n - 1)
                {
                            ...
                            ++j)
                    {
                        ...
                        wk.i = q__1.i; // , expr subst
                        i__2 = j + k * ((*n << 1) - k - 1) / 2;
                        q__3.r = d22 * ap[i__2].r;
                        q__3.i = d22 * ap[i__2].i; // , expr subst
                        r_cnjg(&q__5, &d21);
                        i__3 = j + (k - 1) * ((*n << 1) - k) / 2;
