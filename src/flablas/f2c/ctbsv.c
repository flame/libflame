/* ctbsv.f -- translated by f2c (version 19991025). You must link the resulting object file with the libraries: -lf2c -lm (in that order) */
#include "FLA_f2c.h"
/* Subroutine */
                        ...
                        --j)
                {
                    ...
                    if (noconj)
                    {
                                ...
                                --i__)
                        {
                            i__1 = l + i__ + j * a_dim1;
                            i__4 = i__;
                            q__2.r = a[i__1].r * x[i__4].r - a[i__1].i * x[ i__4].i, q__2.i = a[i__1].r * x[i__4].i + a[i__1].i * x[i__4].r;
                            q__1.r = temp.r - q__2.r, q__1.i = temp.i - q__2.i;
                            temp.r = q__1.r, temp.i = q__1.i;
                            /* L150: */
                        }
