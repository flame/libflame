/* ../netlib/sbdsqr.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 ...
 ++i__) {
 /* Computing MAX */
 r__2 = smax; r__3 = (r__1 = d__[i__], f2c_abs(r__1)); // , expr subst  
 smax = max(r__2,r__3);
 /* L20: */
 }
 i__1 = *n - 1;
 ...
 /* Computing MAX */
 r__1 = f2c_abs(tol) * smax; r__2 = *n * (*n * unfl) * 6; // , expr subst  
 thresh = max(r__1,r__2);
 }
