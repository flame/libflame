/* ../netlib/v3.9.0/zstedc.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -12;
 ...
 i__3 = i__ + j * z_dim1;
 i__4 = (j - 1) * *n + i__;
 z__[i__3].r = rwork[i__4]; z__[i__3].i = 0.; // , expr subst  
 /* L10: */
 }
 /* L20: */
 }
 ...
 *info = start * (*n + 1) + finish;
 ...
 L70: work[1].r = (doublereal) lwmin; work[1].i = 0.; // , expr subst  
 rwork[1] = (doublereal) lrwmin;
 iwork[1] = liwmin;
 return 0;
 /* End of ZSTEDC */
