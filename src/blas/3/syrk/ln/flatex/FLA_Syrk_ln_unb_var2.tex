...
=
  \FlaThreeByThreeBR{ A_0   A_0^T + \hat{C}_{00}   }{ \hat{c}_{01}      }{ \hat{C}_{02}   }
                    { a_1^T A_0^T + \hat{c}_{10}^T }{ \hat{\gamma}_{11} }{ \hat{c}_{12}^T }
...
=
  \FlaThreeByThreeBR{ A_0   A_0^T + \hat{C}_{00}   }{             \hat{c}_{01}      }{ \hat{C}_{02}   }
                    ...
                    { A_2   A_0^T + \hat{C}_{20}   }{ A_2 a_1   + \hat{c}_{21}      }{ \hat{C}_{22}   }
}
...
%  \ref{FLA_Syrk_ln:ws_unb_var2} in the \LaTeX source 
...
% The following command creates a label so that the figure can 
% be referenced by its number by inserting  
%  \ref{FLA_Syrk_ln:alg_unb_var2} in the \LaTeX source 
 
\label{FLA_Syrk_ln:alg_unb_var2} 
