/* ../netlib/v3.9.0/zuncsd2by1.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -19;
 ...
 if (wantv1t && *q > 0) {
 i__1 = v1t_dim1 + 1;
 v1t[i__1].r = 1.; v1t[i__1].i = 0.; // , expr subst  
 i__1 = *q;
 for (j = 2;
 j <= i__1;
 ++j) {
 i__2 = j * v1t_dim1 + 1;
 v1t[i__2].r = 0.; v1t[i__2].i = 0.; // , expr subst  
 i__2 = j + v1t_dim1;
 v1t[i__2].r = 0.; v1t[i__2].i = 0.; // , expr subst  
 }
 i__1 = *q - 1;
 ...
 if (wantu1 && *p > 0) {
 i__1 = u1_dim1 + 1;
 u1[i__1].r = 1.; u1[i__1].i = 0.; // , expr subst  
 i__1 = *p;
 for (j = 2;
 j <= i__1;
 ++j) {
 i__2 = j * u1_dim1 + 1;
 u1[i__2].r = 0.; u1[i__2].i = 0.; // , expr subst  
 i__2 = j + u1_dim1;
 u1[i__2].r = 0.; u1[i__2].i = 0.; // , expr subst  
 }
 i__1 = *p - 1;
 ...
 if (wantu2 && *m - *p > 0) {
 i__1 = u2_dim1 + 1;
 u2[i__1].r = 1.; u2[i__1].i = 0.; // , expr subst  
 i__1 = *m - *p;
 for (j = 2;
 j <= i__1;
 ++j) {
 i__2 = j * u2_dim1 + 1;
 u2[i__2].r = 0.; u2[i__2].i = 0.; // , expr subst  
 i__2 = j + u2_dim1;
 u2[i__2].r = 0.; u2[i__2].i = 0.; // , expr subst  
 }
 i__1 = *m - *p - 1;
