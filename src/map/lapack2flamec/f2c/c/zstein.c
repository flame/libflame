/* ../netlib/v3.9.0/zstein.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -5;
 ...
 /* Computing MAX */
 d__3 = onenrm; d__4 = (d__1 = d__[bn], abs(d__1)) + (d__2 = e[bn - 1], abs(d__2)); // , expr subst  
 ...
 ++i__) {
 /* Computing MAX */
 d__4 = onenrm; d__5 = (d__1 = d__[i__], abs(d__1)) + (d__2 = e[ i__ - 1], abs(d__2)) + (d__3 = e[i__], abs(d__3)); // , expr subst  
 ...
 /* Computing MAX */
 d__3 = eps; d__4 = (d__1 = work[indrv4 + blksiz], abs(d__1)); // , expr subst  
