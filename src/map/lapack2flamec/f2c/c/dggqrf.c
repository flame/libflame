/* ../netlib/dggqrf.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > \param[out] TAUA */
/* > \verbatim */
/* > TAUA is DOUBLE PRECISION array, dimension (fla_min(N,M)) */
...
/* > \param[out] TAUB */
/* > \verbatim */
/* > TAUB is DOUBLE PRECISION array, dimension (fla_min(N,P)) */
/* > The scalar factors of the elementary reflectors which */
