/* ../netlib/dsptrf.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
        ...
        else
        {
            ...
            else
            {
                ...
                if (imax > 1)
                {
                    ...
                    /* Computing MAX */
                    d__2 = rowmax;
                    d__3 = (d__1 = ap[kpc + jmax - 1], abs( d__1)); // , expr subst
                ...
                else if ((d__1 = ap[kpc + imax - 1], abs(d__1)) >= alpha * rowmax)
                {
        ...
        else
        {
            ...
            else
            {
                ...
                if (imax < *n)
                {
                    ...
                    /* Computing MAX */
                    d__2 = rowmax;
                    d__3 = (d__1 = ap[kpc + jmax - imax], abs( d__1)); // , expr subst
                    rowmax = max(d__2,d__3);
                }
                if (absakk >= alpha * colmax * (colmax / rowmax))
                {
