        ...
        if (upper)
        {
                    ...
                    ++k)
            {
                        ...
                        ++i__)
                {
                    ...
                    rwork[i__] += ((r__1 = ab[i__3].r, abs(r__1)) + (r__2 = r_imag(&ab[l + i__ + k * ab_dim1]), abs(r__2))) * xk;
                    i__3 = l + i__ + k * ab_dim1;
                    i__4 = i__ + j * x_dim1;
                    s += ((r__1 = ab[i__3].r, abs(r__1)) + (r__2 = r_imag(&ab[ l + i__ + k * ab_dim1]), abs(r__2))) * ((r__3 = x[ i__4].r, abs(r__3)) + (r__4 = r_imag(&x[i__ + j * x_dim1]), abs(r__4)));
                    /* L40: */
                }
                i__5 = *kd + 1 + k * ab_dim1;
