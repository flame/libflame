...
void FLA_LU_piv_cntl_init_ts(FLA_Cntl_init_flamec_s *FLA_cntl_flamec_init_i)
{
	...
	FLA_cntl_flamec_init_i->fla_lu_piv_var5_bsize    = FLA_Query_blocksizes( FLA_DIMENSION_MIN );
	FLA_cntl_flamec_init_i->fla_lu_piv_var5_bsize_in = FLA_Blocksize_create_copy_ts( FLA_cntl_flamec_init_i, FLA_cntl_flamec_init_i->fla_lu_piv_var5_bsize );
	FLA_Blocksize_scale_ts( FLA_cntl_flamec_init_i, FLA_cntl_flamec_init_i->fla_lu_piv_var5_bsize_in, fla_lu_piv_var5_in_to_ou_bsize_ratio );

	// Create a control tree to invoke LAPACK.
	FLA_cntl_flamec_init_i->fla_lu_piv_cntl_leaf   = FLA_Cntl_lu_obj_create( FLA_FLAT,
	...
	FLA_cntl_flamec_init_i->fla_lu_piv_cntl_in     = FLA_Cntl_lu_obj_create( FLA_FLAT, 
	                                                 FLA_BLOCKED_VARIANT5,
	                                                 FLA_cntl_flamec_init_i->fla_lu_piv_var5_bsize_in,
	                                                 FLA_cntl_flamec_init_i->fla_lu_piv_cntl_leaf,
	                                                 FLA_cntl_flamec_init_i->fla_gemm_cntl_blas,
	                                                 FLA_cntl_flamec_init_i->fla_gemm_cntl_blas,
	                                                 FLA_cntl_flamec_init_i->fla_gemm_cntl_blas,
	                                                 FLA_cntl_flamec_init_i->fla_trsm_cntl_blas,
	                                                 FLA_cntl_flamec_init_i->fla_trsm_cntl_blas,
	                                                 FLA_cntl_flamec_init_i->fla_appiv_cntl_leaf,
	                                                 FLA_cntl_flamec_init_i->fla_appiv_cntl_leaf );

	// Create a control tree for larger problems with one level of recursion.
	FLA_cntl_flamec_init_i->fla_lu_piv_cntl2       = FLA_Cntl_lu_obj_create( FLA_FLAT, 
	                                                 FLA_BLOCKED_VARIANT5,
	                                                 FLA_cntl_flamec_init_i->fla_lu_piv_var5_bsize,
	                                                 FLA_cntl_flamec_init_i->fla_lu_piv_cntl_in,
	                                                 FLA_cntl_flamec_init_i->fla_gemm_cntl_blas,
	                                                 FLA_cntl_flamec_init_i->fla_gemm_cntl_blas,
	                                                 FLA_cntl_flamec_init_i->fla_gemm_cntl_blas,
	                                                 FLA_cntl_flamec_init_i->fla_trsm_cntl_blas,
	...
	FLA_cntl_flamec_init_i->fla_lu_piv_cntl        = FLA_Cntl_lu_obj_create( FLA_FLAT, 
	                                                 FLA_BLOCKED_VARIANT5,
	                                                 FLA_cntl_flamec_init_i->fla_lu_piv_var5_bsize,
	                                                 FLA_cntl_flamec_init_i->fla_lu_piv_cntl_leaf,
	                                                 FLA_cntl_flamec_init_i->fla_gemm_cntl_blas,
...
{
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_lu_piv_cntl );
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_lu_piv_cntl2 );
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_lu_piv_cntl_in );
	FLA_Cntl_obj_free( FLA_cntl_flamec_init_i->fla_lu_piv_cntl_leaf );

	FLA_Blocksize_free( FLA_cntl_flamec_init_i->fla_lu_piv_var5_bsize );
	FLA_Blocksize_free( FLA_cntl_flamec_init_i->fla_lu_piv_var5_bsize_in );
}
#endif
