/* ../netlib/zlanhp.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
doublereal zlanhp_(char *norm, char *uplo, integer *n, doublecomplex *ap, doublereal *work)
{
    ...
    char buffer[256];
    snprintf(buffer, 256,"zlanhp inputs: norm %c, uplo %c, n %d",*norm, *uplo, *n);
