/* ../netlib/v3.9.0/zheevr_2stage.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zheevr_ 2stage.f"> */
 /* > [TGZ]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zheevr_ 2stage.f"> */
 /* > [ZIP]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zheevr_ 2stage.f"> */
 /* > [TXT]</a> */
 /* > \endhtmlonly */
 /* Definition: */
 /* =========== */
 ...
 *m = 0;
 ...
 if (*n == 1) {
 work[1].r = 2.; work[1].i = 0.; // , expr subst  
 if (alleig || indeig) {
 *m = 1;
 i__1 = a_dim1 + 1;
 w[1] = a[i__1].r;
 ...
 *m = 1;
 ...
 /* ZSTEIN. This information is discarded;
 ...
 zhetrd_2stage_(jobz, uplo, n, &a[a_offset], lda, &rwork[indrd], &rwork[ indre], &work[indtau], &work[indhous], &lhtrd, &work[indwk], & llwork, &iinfo);
