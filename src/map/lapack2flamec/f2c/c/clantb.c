/* ../netlib/clantb.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > \verbatim */
/* > */
/* > CLANTB = ( max(f2c_abs(A(i,j))), NORM = 'M' or 'm' */
/* > ( */
        ...
        if (lsame_(uplo, "U"))
        {
            if (lsame_(diag, "U"))
            {
                ...
                if (*k > 0)
                {
                            ...
                            ++j)
                    {
                        ...
                        /* Computing MAX */
                        i__2 = *k + 2 - j;
                        classq_(&i__3, &ab[max(i__2,1) + j * ab_dim1], &c__1, colssq, &colssq[1]);
            ...
            else
            {
                        ...
                        ++j)
                {
                    ...
                    /* Computing MAX */
                    i__5 = *k + 2 - j;
                    classq_(&i__3, &ab[max(i__5,1) + j * ab_dim1], &c__1, colssq, &colssq[1]);
                    scombssq_(ssq, colssq);
                    /* L290: */
                }
            }
        ...
        else
        {
            if (lsame_(diag, "U"))
            {
                ...
                if (*k > 0)
                {
                            ...
                            ++j)
                    {
                        ...
                        i__4 = *n - j;
                        i__3 = min(i__4,*k);
                        classq_(&i__3, &ab[j * ab_dim1 + 2], &c__1, colssq, & colssq[1]);
                        scombssq_(ssq, colssq);
                        /* L300: */
                    }
                }
            ...
            else
            {
                        ...
                        ++j)
                {
                    ...
                    i__2 = *k + 1; // , expr subst
                    i__3 = min(i__4,i__2);
                    classq_(&i__3, &ab[j * ab_dim1 + 1], &c__1, colssq, & colssq[1]);
                    scombssq_(ssq, colssq);
                    /* L310: */
                }
            }
