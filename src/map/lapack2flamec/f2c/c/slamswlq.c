...
int slamswlq_(char *side, char *trans, integer *m, integer * n, integer *k, integer *mb, integer *nb, real *a, integer *lda, real * t, integer *ldt, real *c__, integer *ldc, real *work, integer *lwork, integer *info)
{
    ...
    *info = 0;
    ...
    if (left && tran)
    {
        ...
        {
            ii = *m - kk + 1;
            stpmlqt_("L", "T", &kk, n, k, &c__0, mb, &a[ii * a_dim1 + 1], lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, &c__[ii + c_dim1], ldc, &work[1], info);
        }
        else
        {
            ii = *m + 1;
                ...
                i__ += i__2)
        {
            ...
            --ctr;
            i__3 = *nb - *k;
            stpmlqt_("L", "T", &i__3, n, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, &c__[i__ + c_dim1], ldc, &work[1], info);
        }
        /* Multiply Q to the first block of C (1:M,1:NB) */
        sgemlqt_("L", "T", nb, n, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
    }
    else if (left && notran)
    {
        ...
        ii = *m - kk + 1;
        ctr = 1;
        sgemlqt_("L", "N", nb, n, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
        i__2 = ii - *nb + *k;
        i__1 = *nb - *k;
        for (i__ = *nb + 1;
                ...
                i__ += i__1)
        {
            ...
            i__3 = *nb - *k;
            stpmlqt_("L", "N", &i__3, n, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, &c__[i__ + c_dim1], ldc, &work[1], info);
            ++ctr;
        }
        if (ii <= *m)
        {
            /* Multiply Q to the last block of C */
            stpmlqt_("L", "N", &kk, n, k, &c__0, mb, &a[ii * a_dim1 + 1], lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, &c__[ii + c_dim1], ldc, &work[1], info);
        }
    }
    else if (right && notran)
    {
        ...
        {
            ii = *n - kk + 1;
            stpmlqt_("R", "N", m, &kk, k, &c__0, mb, &a[ii * a_dim1 + 1], lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, &c__[ii * c_dim1 + 1], ldc, &work[1], info);
        }
        else
        {
            ii = *n + 1;
                ...
                i__ += i__2)
        {
            ...
            --ctr;
            i__3 = *nb - *k;
            stpmlqt_("R", "N", m, &i__3, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, &c__[i__ * c_dim1 + 1], ldc, &work[1], info);
        }
        /* Multiply Q to the first block of C (1:M,1:MB) */
        sgemlqt_("R", "N", m, nb, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
    }
    else if (right && tran)
    {
        /* Multiply Q to the first block of C */
        ...
        ii = *n - kk + 1;
        ctr = 1;
        sgemlqt_("R", "T", m, nb, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
        i__2 = ii - *nb + *k;
        i__1 = *nb - *k;
        for (i__ = *nb + 1;
                i__1 < 0 ? i__ >= i__2 : i__ <= i__2;
                i__ += i__1)
        {
            /* Multiply Q to the current block of C (1:M,I:I+MB) */
            i__3 = *nb - *k;
            stpmlqt_("R", "T", m, &i__3, k, &c__0, mb, &a[i__ * a_dim1 + 1], lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, &c__[i__ * c_dim1 + 1], ldc, &work[1], info);
            ++ctr;
        }
        if (ii <= *n)
        {
            /* Multiply Q to the last block of C */
            stpmlqt_("R", "T", m, &kk, k, &c__0, mb, &a[ii * a_dim1 + 1], lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, &c__[ii * c_dim1 + 1], ldc, &work[1], info);
        }
    }
    work[1] = (real) lw;
    AOCL_DTL_TRACE_LOG_EXIT
