/* ../netlib/v3.9.0/ztprfb.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 i__5 = i__ + j * a_dim1;
 z__1.r = work[i__4].r + a[i__5].r; z__1.i = work[i__4].i + a[ i__5].i; // , expr subst  
 ...
 i__4 = *m - *l + i__ + j * b_dim1;
 i__5 = i__ + j * work_dim1;
 z__1.r = b[i__4].r - work[i__5].r; z__1.i = b[i__4].i - work[ i__5].i; // , expr subst  
