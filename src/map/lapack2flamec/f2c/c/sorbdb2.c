/* ../netlib/sorbdb2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 char buffer[256]; 
 snprintf(buffer, 256,"sorbdb2 inputs: m %d, p %d, q %d, ldx11 %d, ldx21 %d",*m, *p, *q, *ldx11, *ldx21);
 ...
 *info = -7;
 ...
 ilarf = 2;
 /* Computing MAX */
 i__1 = *p - 1, i__2 = *m - *p; i__1 = max(i__1,i__2); i__2 = *q - 1; // ; expr subst  
 llarf = max(i__1,i__2);
 iorbdb5 = 2;
 lorbdb5 = *q - 1;
 /* Computing MAX */
