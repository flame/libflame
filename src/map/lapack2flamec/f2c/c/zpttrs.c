/* ../netlib/zpttrs.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int zpttrs_(char *uplo, integer *n, integer *nrhs, doublereal *d__, doublecomplex *e, doublecomplex *b, integer *ldb, integer *info)
{
    ...
    logical upper;
    extern /* Subroutine */
    int zptts2_(integer *, integer *, integer *, doublereal *, doublecomplex *, doublecomplex *, integer *), xerbla_(char *, integer *);
