...
L30:
            ...
            ++nblk)
    {
        ...
        /* Computing MAX */
        d__3 = onenrm;
        d__4 = (d__1 = d__[bn], abs(d__1)) + (d__2 = e[bn - 1], abs(d__2)); // , expr subst
                ...
                ++i__)
        {
            /* Computing MAX */
            d__4 = onenrm;
            d__5 = (d__1 = d__[i__], abs(d__1)) + (d__2 = e[ i__ - 1], abs(d__2)) + (d__3 = e[i__], abs(d__3)); // , expr subst
...
L70:
            ...
            /* Computing MAX */
            d__2 = eps;
            d__3 = (d__1 = work[indrv4 + blksiz], abs(d__1)); // , expr subst
