/* ../netlib/v3.9.0/cgebal.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -3;
 ...
 L170: g = c__ / 2.f;
 L180: /* Computing MIN */
 r__1 = min(f,c__); r__1 = min(r__1,g); // , expr subst  
