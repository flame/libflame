...
/* Subroutine */ int lapack_dorglq(integer *m, integer *n, integer *k, doublereal *
...
/*    
    ...
    extern /* Subroutine */ int lapack_dorgl2(integer *, integer *, integer *, 
...
/*     Use unblocked code for the last or only block. */
	...
	i__2 = *n - kk;
	i__3 = *k - kk;
	lapack_dorgl2(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &
...
/*           Apply H' to columns i:n of current block */
	    ...
	    i__2 = *n - i__ + 1;
	    lapack_dorgl2(&ib, &i__2, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
