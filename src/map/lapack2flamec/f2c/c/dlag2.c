/* ../netlib/dlag2.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 on Linux or Unix systems, link with .../path/to/libf2c.a -lm or, if you install libf2c.a in a standard place, with -lf2c -lm -- in that order, at the end of the command line, as in cc *.o -lf2c -lm Source for libf2c is in /netlib/f2c/libf2c.zip, e.g., http://www.netlib.org/f2c/libf2c.zip */
#include "FLA_f2c.h" /* > \brief \b DLAG2 computes the eigenvalues of a 2-by-2 generalized eigenvalue problem, with scaling as nece ssary to avoid over-/underflow. */
/* =========== DOCUMENTATION =========== */
...
int dlag2_(doublereal *a, integer *lda, doublereal *b, integer *ldb, doublereal *safmin, doublereal *scale1, doublereal * scale2, doublereal *wr1, doublereal *wr2, doublereal *wi)
{
    ...
    /* Local variables */
    doublereal r__, c1, c2, c3, c4, c5, s1, s2, a11, a12, a21, a22, b11, b12, b22, pp, qq, ss, as11, as12, as22, sum, abi22, diff, bmin, wbig, wabs, wdet, binv11, binv22, discr, anorm, bnorm, bsize, shift, rtmin, rtmax, wsize, ascale, bscale, wscale, safmax, wsmall;
    ...
    b22 = b[(b_dim1 << 1) + 2];
    /* Computing MAX */
    d__1 = abs(b11), d__2 = abs(b12), d__1 = max(d__1,d__2);
    d__2 = abs(b22);
    ...
    /* Computing MAX */
    d__1 = abs(b11);
    d__2 = abs(b12) + abs(b22);
    d__1 = max(d__1,d__2); // ; expr subst
    bnorm = max(d__1,*safmin);
    /* Computing MAX */
    d__1 = abs(b11);
    d__2 = abs(b22); // , expr subst
    bsize = max(d__1,d__2);
    bscale = 1. / bsize;
    b11 *= bscale;
    b12 *= bscale;
    ...
    if (*wi == 0.)
    {
        ...
        d__1 = max(*safmin,c1), d__2 = (abs(*wr2) * c2 + c3) * 1.0000100000000001;
        d__1 = max(d__1,d__2);
        d__2 = min(d__3, d__4); // ; expr subst
        wsize = max(d__1,d__2);
        if (wsize != 1.)
