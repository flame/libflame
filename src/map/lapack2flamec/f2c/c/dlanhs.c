/* ../netlib/dlanhs.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 /* > \verbatim */
 /* > */
 /* > DLANHS = ( max(f2c_abs(A(i,j))), NORM = 'M' or 'm' */
 /* > ( */
 ...
 char buffer[256]; 
 snprintf(buffer, 256,"dlanhs inputs: norm %c, n %" FLA_IS ", lda %" FLA_IS "",*norm, *n, *lda);
