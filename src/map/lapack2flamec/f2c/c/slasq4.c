/* ../netlib/v3.9.0/slasq4.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *ttype = -1;
 ...
 if (gap1 > 0.f && gap1 > b1) {
 /* Computing MAX */
 r__1 = *dn - b1 / gap1 * b1; r__2 = *dmin__ * .5f; // , expr subst  
 s = max(r__1,r__2);
 *ttype = -2;
 }
 else {
 ...
 if (a2 > b1 + b2) {
 /* Computing MIN */
 r__1 = s; r__2 = a2 - (b1 + b2); // , expr subst  
 s = min(r__1,r__2);
 }
 /* Computing MAX */
 r__1 = s; r__2 = *dmin__ * .333f; // , expr subst  
 s = max(r__1,r__2);
 *ttype = -3;
 }
 }
 ...
 *ttype = -7;
 ...
 /* Computing MAX */
 r__1 = s; r__2 = a2 * (1.f - a2 * 1.01f * (b2 / gap2) * b2); // , expr subst  
 s = max(r__1,r__2);
 }
 else {
 /* Computing MAX */
 r__1 = s; r__2 = a2 * (1.f - b2 * 1.01f); // , expr subst  
 s = max(r__1,r__2);
 *ttype = -8;
 }
 }
