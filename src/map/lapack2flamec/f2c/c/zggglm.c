/* ../netlib/v3.9.0/zggglm.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 1;
 ...
 ++i__) {
 i__2 = i__;
 y[i__2].r = 0.; y[i__2].i = 0.; // , expr subst  
 /* L10: */
 }
 /* Update d1 = d1 - T12*y2 */
 i__1 = *n - *m;
