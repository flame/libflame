/* ../netlib/sgelss.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int sgelss_(integer *m, integer *n, integer *nrhs, real *a, integer *lda, real *b, integer *ldb, real *s, real *rcond, integer * rank, real *work, integer *lwork, integer *info)
{
    ...
    *info = 0;
    ...
    else if (anrm == 0.f)
    {
        ...
        slaset_("F", &minmn, &c__1, &c_b50, &c_b50, &s[1], &c__1);
        *rank = 0;
        goto L70;
    }
    ...
    if (*m >= *n)
    {
        ...
        *rank = 0;
        ...
        {
            sgemm_("T", "N", n, nrhs, n, &c_b84, &a[a_offset], lda, &b[ b_offset], ldb, &c_b50, &work[1], ldb);
        ...
        else if (*nrhs > 1)
        {
                    ...
                    i__ += i__2)
            {
                ...
                i__3 = *nrhs - i__ + 1;
                bl = min(i__3,chunk);
                sgemm_("T", "N", n, &bl, n, &c_b84, &a[a_offset], lda, &b[i__ * b_dim1 + 1], ldb, &c_b50, &work[1], n);
        ...
        {
            sgemv_("T", n, n, &c_b84, &a[a_offset], lda, &b[b_offset], &c__1, &c_b50, &work[1], &c__1);
    ...
    else /* if(complicated condition) */
    {
        ...
        if (*n >= mnthr && *lwork >= (*m << 2) + *m * *m + max(i__2,i__1))
        {
            ...
            *rank = 0;
            ...
            {
                sgemm_("T", "N", m, nrhs, m, &c_b84, &work[il], &ldwork, &b[ b_offset], ldb, &c_b50, &work[iwork], ldb);
            ...
            else if (*nrhs > 1)
            {
                        ...
                        i__ += i__1)
                {
                    ...
                    i__3 = *nrhs - i__ + 1;
                    bl = min(i__3,chunk);
                    sgemm_("T", "N", m, &bl, m, &c_b84, &work[il], &ldwork, & b[i__ * b_dim1 + 1], ldb, &c_b50, &work[iwork], m);
            ...
            {
                sgemv_("T", m, m, &c_b84, &work[il], &ldwork, &b[b_dim1 + 1], &c__1, &c_b50, &work[iwork], &c__1);
        ...
        else
        {
            ...
            *rank = 0;
            ...
            if (*lwork >= *ldb * *nrhs && *nrhs > 1)
            {
                sgemm_("T", "N", n, nrhs, m, &c_b84, &a[a_offset], lda, &b[ b_offset], ldb, &c_b50, &work[1], ldb);
            ...
            else if (*nrhs > 1)
            {
                        ...
                        i__ += i__2)
                {
                    ...
                    i__3 = *nrhs - i__ + 1;
                    bl = min(i__3,chunk);
                    sgemm_("T", "N", n, &bl, m, &c_b84, &a[a_offset], lda, &b[ i__ * b_dim1 + 1], ldb, &c_b50, &work[1], n);
            ...
            {
                sgemv_("T", m, n, &c_b84, &a[a_offset], lda, &b[b_offset], & c__1, &c_b50, &work[1], &c__1);
                scopy_(n, &work[1], &c__1, &b[b_offset], &c__1);
            }
        }
    }
