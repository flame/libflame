...
int zlags2_(logical *upper, doublereal *a1, doublecomplex * a2, doublereal *a3, doublereal *b1, doublecomplex *b2, doublereal *b3, doublereal *csu, doublecomplex *snu, doublereal *csv, doublecomplex * snv, doublereal *csq, doublecomplex *snq)
{
    ...
    if (*upper)
    {
        ...
        if (f2c_dabs(csl) >= f2c_dabs(snl) || f2c_dabs(csr) >= f2c_dabs(snr))
        {
            ...
            aua12 = f2c_dabs(csl) * ((d__1 = a2->r, f2c_dabs(d__1)) + (d__2 = d_imag(a2) , f2c_dabs(d__2))) + f2c_dabs(snl) * f2c_dabs(*a3);
            avb12 = f2c_dabs(csr) * ((d__1 = b2->r, f2c_dabs(d__1)) + (d__2 = d_imag(b2) , f2c_dabs(d__2))) + f2c_dabs(snr) * f2c_dabs(*b3);
            /* zero (1,2) elements of U**H *A and V**H *B */
            if (f2c_dabs(ua11r) + ((d__1 = ua12.r, f2c_dabs(d__1)) + (d__2 = d_imag(& ua12), f2c_dabs(d__2))) == 0.)
            {
                z__2.r = vb11r;
                z__2.i = 0.; // , expr subst
                z__1.r = -z__2.r;
            ...
            else if (f2c_dabs(vb11r) + ((d__1 = vb12.r, f2c_dabs(d__1)) + (d__2 = d_imag(&vb12), f2c_dabs(d__2))) == 0.)
            {
                z__2.r = ua11r;
                z__2.i = 0.; // , expr subst
                z__1.r = -z__2.r;
            ...
            else if (aua12 / (f2c_dabs(ua11r) + ((d__1 = ua12.r, f2c_dabs(d__1)) + ( d__2 = d_imag(&ua12), f2c_dabs(d__2)))) <= avb12 / (f2c_dabs(vb11r) + ((d__3 = vb12.r, f2c_dabs(d__3)) + (d__4 = d_imag(&vb12), f2c_dabs(d__4)))))
            {
                z__2.r = ua11r;
                z__2.i = 0.; // , expr subst
                z__1.r = -z__2.r;
        ...
        else
        {
            ...
            aua22 = f2c_dabs(snl) * ((d__1 = a2->r, f2c_dabs(d__1)) + (d__2 = d_imag(a2) , f2c_dabs(d__2))) + f2c_dabs(csl) * f2c_dabs(*a3);
            avb22 = f2c_dabs(snr) * ((d__1 = b2->r, f2c_dabs(d__1)) + (d__2 = d_imag(b2) , f2c_dabs(d__2))) + f2c_dabs(csr) * f2c_dabs(*b3);
            /* zero (2,2) elements of U**H *A and V**H *B, and then swap. */
            if ((d__1 = ua21.r, f2c_dabs(d__1)) + (d__2 = d_imag(&ua21), f2c_dabs(d__2)) + ((d__3 = ua22.r, f2c_dabs(d__3)) + (d__4 = d_imag(&ua22), f2c_dabs(d__4))) == 0.)
            {
                d_cnjg(&z__2, &vb21);
                z__1.r = -z__2.r;
                z__1.i = -z__2.i; // , expr subst
            ...
            else if ((d__1 = vb21.r, f2c_dabs(d__1)) + (d__2 = d_imag(&vb21), f2c_dabs(d__2)) + z_abs(&vb22) == 0.)
            {
                d_cnjg(&z__2, &ua21);
                z__1.r = -z__2.r;
                z__1.i = -z__2.i; // , expr subst
            ...
            else if (aua22 / ((d__1 = ua21.r, f2c_dabs(d__1)) + (d__2 = d_imag(& ua21), f2c_dabs(d__2)) + ((d__3 = ua22.r, f2c_dabs(d__3)) + (d__4 = d_imag(&ua22), f2c_dabs(d__4)))) <= avb22 / ((d__5 = vb21.r, f2c_dabs(d__5)) + (d__6 = d_imag(&vb21), f2c_dabs(d__6)) + ((d__7 = vb22.r, f2c_dabs(d__7)) + (d__8 = d_imag(&vb22), f2c_dabs(d__8)))))
            {
                d_cnjg(&z__2, &ua21);
                z__1.r = -z__2.r;
                z__1.i = -z__2.i; // , expr subst
    ...
    else
    {
        ...
        if (f2c_dabs(csr) >= f2c_dabs(snr) || f2c_dabs(csl) >= f2c_dabs(snl))
        {
            ...
            vb21.i = z__1.i; // , expr subst
            vb22r = csl * *b3;
            aua21 = f2c_dabs(snr) * f2c_dabs(*a1) + f2c_dabs(csr) * ((d__1 = a2->r, f2c_dabs(d__1) ) + (d__2 = d_imag(a2), f2c_dabs(d__2)));
            avb21 = f2c_dabs(snl) * f2c_dabs(*b1) + f2c_dabs(csl) * ((d__1 = b2->r, f2c_dabs(d__1) ) + (d__2 = d_imag(b2), f2c_dabs(d__2)));
            /* zero (2,1) elements of U**H *A and V**H *B. */
            if ((d__1 = ua21.r, f2c_dabs(d__1)) + (d__2 = d_imag(&ua21), f2c_dabs(d__2)) + f2c_dabs(ua22r) == 0.)
            {
                z__1.r = vb22r;
                z__1.i = 0.; // , expr subst
                zlartg_(&z__1, &vb21, csq, snq, &r__);
            }
            else if ((d__1 = vb21.r, f2c_dabs(d__1)) + (d__2 = d_imag(&vb21), f2c_dabs(d__2)) + f2c_dabs(vb22r) == 0.)
            {
                z__1.r = ua22r;
                z__1.i = 0.; // , expr subst
                zlartg_(&z__1, &ua21, csq, snq, &r__);
            }
            else if (aua21 / ((d__1 = ua21.r, f2c_dabs(d__1)) + (d__2 = d_imag(& ua21), f2c_dabs(d__2)) + f2c_dabs(ua22r)) <= avb21 / ((d__3 = vb21.r, f2c_dabs(d__3)) + (d__4 = d_imag(&vb21), f2c_dabs(d__4)) + f2c_dabs(vb22r)))
            {
                z__1.r = ua22r;
                z__1.i = 0.; // , expr subst
                zlartg_(&z__1, &ua21, csq, snq, &r__);
        ...
        else
        {
            ...
            vb12.r = z__1.r;
            vb12.i = z__1.i; // , expr subst
            aua11 = f2c_dabs(csr) * f2c_dabs(*a1) + f2c_dabs(snr) * ((d__1 = a2->r, f2c_dabs(d__1) ) + (d__2 = d_imag(a2), f2c_dabs(d__2)));
            avb11 = f2c_dabs(csl) * f2c_dabs(*b1) + f2c_dabs(snl) * ((d__1 = b2->r, f2c_dabs(d__1) ) + (d__2 = d_imag(b2), f2c_dabs(d__2)));
            /* zero (1,1) elements of U**H *A and V**H *B, and then swap. */
            if ((d__1 = ua11.r, f2c_dabs(d__1)) + (d__2 = d_imag(&ua11), f2c_dabs(d__2)) + ((d__3 = ua12.r, f2c_dabs(d__3)) + (d__4 = d_imag(&ua12), f2c_dabs(d__4))) == 0.)
            {
                zlartg_(&vb12, &vb11, csq, snq, &r__);
            }
            else if ((d__1 = vb11.r, f2c_dabs(d__1)) + (d__2 = d_imag(&vb11), f2c_dabs(d__2)) + ((d__3 = vb12.r, f2c_dabs(d__3)) + (d__4 = d_imag( &vb12), f2c_dabs(d__4))) == 0.)
            {
                zlartg_(&ua12, &ua11, csq, snq, &r__);
            }
            else if (aua11 / ((d__1 = ua11.r, f2c_dabs(d__1)) + (d__2 = d_imag(& ua11), f2c_dabs(d__2)) + ((d__3 = ua12.r, f2c_dabs(d__3)) + (d__4 = d_imag(&ua12), f2c_dabs(d__4)))) <= avb11 / ((d__5 = vb11.r, f2c_dabs(d__5)) + (d__6 = d_imag(&vb11), f2c_dabs(d__6)) + ((d__7 = vb12.r, f2c_dabs(d__7)) + (d__8 = d_imag(&vb12), f2c_dabs(d__8)))))
            {
                zlartg_(&ua12, &ua11, csq, snq, &r__);
            }
            else
