/* ../netlib/v3.9.0/sgeev.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -11;
 ...
 minwrk = *n << 2;
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + (*n - 1) * ilaenv_(&c__1, "SORGHR", " ", n, &c__1, n, &c_n1); // , expr subst  
