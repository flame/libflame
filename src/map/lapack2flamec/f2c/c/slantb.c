/* ../netlib/v3.9.0/slantb.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 i__ <= i__4;
 ++i__) {
 work[i__] += (r__1 = ab[l + i__ + j * ab_dim1], abs( r__1));
 /* L160: */
 }
 /* L170: */
 }
