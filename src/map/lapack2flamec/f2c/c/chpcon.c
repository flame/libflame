/* ../netlib/chpcon.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int chpcon_(char *uplo, integer *n, complex *ap, integer * ipiv, real *anorm, real *rcond, complex *work, integer *info)
{
    ...
    char buffer[256]; 
    snprintf(buffer, 256,"chpcon inputs: uplo %c, n %d\n",*uplo, *n);
    ...
    real ainvnm;
    extern /* Subroutine */
    int chptrs_(char *, integer *, integer *, complex *, integer *, complex *, integer *, integer *);
