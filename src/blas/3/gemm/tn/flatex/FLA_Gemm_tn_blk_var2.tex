...
%  \ref{FLA_Gemm_tn:ws_blk_var2} in the \LaTeX source 
 
\label{FLA_Gemm_tn:ws_blk_var2} 
...
% The following command creates a label so that the figure can 
% be referenced by its number by inserting  
%  \ref{FLA_Gemm_tn:alg_blk_var2} in the \LaTeX source 
 
\label{FLA_Gemm_tn:alg_blk_var2} 
