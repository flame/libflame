/* ../netlib/v3.9.0/zgelss.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -7;
 ...
 mm = *n;
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n + *n * ilaenv_(&c__1, "ZGEQRF", " ", m, n, &c_n1, &c_n1); // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n + *nrhs * ilaenv_(&c__1, "ZUNMQR", "LC", m, nrhs, n, &c_n1); // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 if (*m >= *n) {
 /* Path 1 - overdetermined or exactly determined */
 /* Compute space needed for ZGEBRD */
 zgebrd_(&mm, n, &a[a_offset], lda, &s[1], &s[1], dum, dum, dum, &c_n1, info);
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zgebrd__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zunmbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*n << 1) + lwork_zungbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 ...
 /* Compute space needed for ZGEBRD */
 zgebrd_(m, m, &a[a_offset], lda, &s[1], &s[1], dum, dum, dum, &c_n1, info);
 lwork_zgebrd__ = (integer) dum[0].r;
 /* Compute space needed for ZUNMBR */
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m * 3 + *m * *m + lwork_zgebrd__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m * 3 + *m * *m + lwork_zunmbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m * 3 + *m * *m + lwork_zungbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 if (*nrhs > 1) {
 /* Computing MAX */
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *m + lwork_zunmlq__; // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 else {
 /* Path 2 - underdetermined */
 /* Compute space needed for ZGEBRD */
 zgebrd_(m, n, &a[a_offset], lda, &s[1], &s[1], dum, dum, dum, &c_n1, info);
 lwork_zgebrd__ = (integer) dum[0].r;
 /* Compute space needed for ZUNMBR */
 ...
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_zunmbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = (*m << 1) + lwork_zungbr__; // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n * *nrhs; // , expr subst  
 maxwrk = max(i__1,i__2);
 ...
 *rank = 0;
 ...
 {
 /* Computing MAX */
 i__2 = max(*m,*nrhs); i__1 = *n - (*m << 1); // , expr subst  
 ...
 *rank = 0;
 ...
 L70: work[1].r = (doublereal) maxwrk; work[1].i = 0.; // , expr subst  
 return 0;
 /* End of ZGELSS */
 }
 /* zgelss_ */
