...
\renewcommand{\afterupdate}{
  C = A_{0}^T B_{0} + A_{1}^T B_{1} + \hat{C}
}
...
%  \ref{FLA_Gemm_tn:ws_blk_var5} in the \LaTeX source 
 
\label{FLA_Gemm_tn:ws_blk_var5} 
...
% The following command creates a label so that the figure can 
% be referenced by its number by inserting  
%  \ref{FLA_Gemm_tn:alg_blk_var5} in the \LaTeX source 
 
\label{FLA_Gemm_tn:alg_blk_var5} 
