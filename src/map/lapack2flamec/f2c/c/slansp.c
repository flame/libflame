/* slansp.f -- translated by f2c (version 20190311). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
real slansp_(char *norm, char *uplo, integer *n, real *ap, real *work)
{
    ...
    AOCL_DTL_SNPRINTF("slansp inputs: norm %c, uplo %c, n %" FLA_IS "",*norm, *uplo, *n);
