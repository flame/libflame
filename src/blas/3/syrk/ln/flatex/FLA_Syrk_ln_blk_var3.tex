...
\renewcommand{\invariant}{
  ...
  \FlaTwoByTwo{ \hat{C}_{TL} }{             \hat{C}_{TR} }
              { \hat{C}_{BL} }{ A_B A_B^T + \hat{C}_{BR} }
}
...
=
  \FlaThreeByThreeTL{ \hat{C}_{00} }{ \hat{C}_{01} }{             \hat{C}_{02} }
                    { \hat{C}_{10} }{ \hat{C}_{11} }{             \hat{C}_{12} }
                    { \hat{C}_{20} }{ \hat{C}_{21} }{ A_2 A_2^T + \hat{C}_{22} }
}
...
=
  \FlaThreeByThreeTL{ \hat{C}_{00} }{             \hat{C}_{01} }{             \hat{C}_{02} }
                    { \hat{C}_{10} }{ A_1 A_1^T + \hat{C}_{11} }{             \hat{C}_{12} }
                    { \hat{C}_{20} }{ A_2 A_1^T + \hat{C}_{21} }{ A_2 A_2^T + \hat{C}_{22} }
}
...
%  \ref{FLA_Syrk_ln:ws_blk_var3} in the \LaTeX source 
 
\label{FLA_Syrk_ln:ws_blk_var3} 
...
% The following command creates a label so that the figure can 
% be referenced by its number by inserting  
%  \ref{FLA_Syrk_ln:alg_blk_var3} in the \LaTeX source 
 
\label{FLA_Syrk_ln:alg_blk_var3} 
