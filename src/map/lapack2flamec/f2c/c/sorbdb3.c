/* ../netlib/sorbdb3.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int sorbdb3_(integer *m, integer *p, integer *q, real *x11, integer *ldx11, real *x21, integer *ldx21, real *theta, real *phi, real *taup1, real *taup2, real *tauq1, real *work, integer *lwork, integer *info)
{
    ...
    *info = 0;
            ...
            ++i__)
    {
        ...
        {
            i__2 = *q - i__ + 1;
            srot_(&i__2, &x11[i__ - 1 + i__ * x11_dim1], ldx11, &x21[i__ + i__ * x21_dim1], ldx11, &c__, &s);
        }
        i__2 = *q - i__ + 1;
        ...
        i__2 = *p - i__ + 1;
        i__3 = *q - i__ + 1;
        slarf_("R", &i__2, &i__3, &x21[i__ + i__ * x21_dim1], ldx21, &tauq1[ i__], &x11[i__ + i__ * x11_dim1], ldx11, &work[ilarf]);
        i__2 = *m - *p - i__;
        i__3 = *q - i__ + 1;
        slarf_("R", &i__2, &i__3, &x21[i__ + i__ * x21_dim1], ldx21, &tauq1[ i__], &x21[i__ + 1 + i__ * x21_dim1], ldx21, &work[ilarf]);
        i__2 = *p - i__ + 1;
        /* Computing 2nd power */
        r__1 = snrm2_(&i__2, &x11[i__ + i__ * x11_dim1], &c__1, &x11[i__ + i__ * x11_dim1], &c__1);
        i__3 = *m - *p - i__;
        /* Computing 2nd power */
        r__2 = snrm2_(&i__3, &x21[i__ + 1 + i__ * x21_dim1], &c__1, &x21[i__ + 1 + i__ * x21_dim1], &c__1);
        c__ = sqrt(r__1 * r__1 + r__2 * r__2);
        theta[i__] = atan2(s, c__);
        i__2 = *p - i__ + 1;
        i__3 = *m - *p - i__;
        i__4 = *q - i__;
        sorbdb5_(&i__2, &i__3, &i__4, &x11[i__ + i__ * x11_dim1], &c__1, &x21[ i__ + 1 + i__ * x21_dim1], &c__1, &x11[i__ + (i__ + 1) * x11_dim1], ldx11, &x21[i__ + 1 + (i__ + 1) * x21_dim1], ldx21, &work[iorbdb5], &lorbdb5, &childinfo);
        i__2 = *p - i__ + 1;
        slarfgp_(&i__2, &x11[i__ + i__ * x11_dim1], &x11[i__ + 1 + i__ * x11_dim1], &c__1, &taup1[i__]);
        if (i__ < *m - *p)
        {
            i__2 = *m - *p - i__;
            slarfgp_(&i__2, &x21[i__ + 1 + i__ * x21_dim1], &x21[i__ + 2 + i__ * x21_dim1], &c__1, &taup2[i__]);
            ...
            i__2 = *m - *p - i__;
            i__3 = *q - i__;
            slarf_("L", &i__2, &i__3, &x21[i__ + 1 + i__ * x21_dim1], &c__1, & taup2[i__], &x21[i__ + 1 + (i__ + 1) * x21_dim1], ldx21, & work[ilarf]);
        }
