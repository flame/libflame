...
FLA_Error FLA_Tevd_v_ops_var4( integer       m_A,
                               integer       m_U,
                               integer       n_G,
                               integer       n_G_extra,
...
FLA_Error FLA_Tevd_v_opd_var4( integer       m_A,
                               integer       m_U,
                               integer       n_G,
                               integer       n_G_extra,
...
FLA_Error FLA_Tevd_v_opc_var4( integer       m_A,
                               integer       m_U,
                               integer       n_G,
                               integer       n_G_extra,
                               float*    buff_d, integer inc_d, 
...
FLA_Error FLA_Tevd_v_opz_var4( integer       m_A,
                               integer       m_U,
                               integer       n_G,
                               integer       n_G_extra,
                               double*   buff_d, integer inc_d, 
