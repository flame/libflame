/* ../netlib/v3.9.0/zunbdb3.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -7;
 ...
 ilarf = 2;
 /* Computing MAX */
 i__1 = *p, i__2 = *m - *p - 1; i__1 = max(i__1,i__2); i__2 = *q - 1; // ; expr subst  
 llarf = max(i__1,i__2);
 iorbdb5 = 2;
 lorbdb5 = *q - 1;
 /* Computing MAX */
 i__1 = ilarf + llarf - 1; i__2 = iorbdb5 + lorbdb5 - 1; // , expr subst  
