/* ../netlib/v3.9.0/zgetc2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 1;
 i__1 = a_dim1 + 1;
 z__1.r = smlnum; z__1.i = 0.; // , expr subst  
 ...
 *info = i__;
 i__2 = i__ + i__ * a_dim1;
 z__1.r = smin; z__1.i = 0.; // , expr subst  
