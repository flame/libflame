...
/* Subroutine */ int lapack_dorgqr(integer *m, integer *n, integer *k, doublereal *
...
/*  
    ...
    extern /* Subroutine */ int lapack_dorg2r(integer *, integer *, integer *, 
...
/*     Use unblocked code for the last or only block. */
	...
	i__2 = *n - kk;
	i__3 = *k - kk;
	lapack_dorg2r(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &
...
/*           Apply H to rows i:m of current block */
	    ...
	    i__2 = *m - i__ + 1;
	    lapack_dorg2r(&i__2, &ib, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
