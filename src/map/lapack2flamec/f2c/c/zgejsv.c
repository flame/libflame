    ...
    if (*info == 0)
    {
        ...
        if (! (lsvec || rsvec))
        {
            ...
            if (lquery)
            {
                ...
                if (errest)
                {
                    ...
                    /* Computing 2nd power */
                    i__3 = *n;
                    i__1 = *n + lwrk_zgeqp3__, i__2 = i__3 * i__3 + lwcon, i__1 = max(i__1,i__2);
        ...
        else if (rsvec && ! lsvec)
        {
            ...
            if (lquery)
            {
                ...
                {
                    /* Computing MAX */
                    i__1 = *n + lwrk_zgeqp3__, i__1 = max(i__1,lwcon), i__1 = max(i__1,lwrk_zgesvj__), i__2 = *n + lwrk_zgelqf__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwrk_zgeqrf__, i__1 = max(i__1,i__2), i__2 = *n + lwrk_zgesvj__;
                    i__1 = max(i__1,i__2);
                ...
                {
                    /* Computing MAX */
                    i__1 = *n + lwrk_zgeqp3__, i__1 = max(i__1,lwrk_zgesvj__), i__2 = *n + lwrk_zgelqf__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwrk_zgeqrf__, i__1 = max( i__1,i__2), i__2 = *n + lwrk_zgesvj__;
                    i__1 = max( i__1,i__2);
                    i__2 = *n + lwrk_zunmlq__; // ; expr subst
                    optwrk = max(i__1,i__2);
                }
        ...
        else if (lsvec && ! rsvec)
        {
            ...
            if (lquery)
            {
                ...
                {
                    /* Computing MAX */
                    i__1 = max(lwrk_zgeqp3__,lwcon), i__2 = *n + lwrk_zgeqrf__;
                    i__1 = max(i__1,i__2);
                    i__1 = max( i__1,lwrk_zgesvj__); // ; expr subst
            ...
            if (lquery)
            {
                ...
                else
                {
                    ...
                    if (errest)
                    {
                        ...
                        /* Computing 2nd power */
                        i__5 = *n;
                        i__1 = *n + lwrk_zgeqp3__, i__2 = *n + lwcon, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwrk_zgeqrf__, i__1 = max(i__1,i__2), i__2 = ( *n << 1) + i__3 * i__3, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + lwrk_zgesvjv__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__5 * i__5 + *n + lwrk_zunmqr__;
                        i__1 = max(i__1,i__2);
                        i__2 = *n + lwrk_zunmqrm__; // ; expr subst
                        optwrk = max(i__1,i__2);
                    }
                    else
                    {
                        ...
                        /* Computing 2nd power */
                        i__5 = *n;
                        i__1 = *n + lwrk_zgeqp3__, i__2 = (*n << 1) + lwrk_zgeqrf__, i__1 = max(i__1,i__2), i__2 = ( *n << 1) + i__3 * i__3, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + lwrk_zgesvjv__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__5 * i__5 + *n + lwrk_zunmqr__;
                        i__1 = max(i__1,i__2);
                        i__2 = *n + lwrk_zunmqrm__; // ; expr subst
                        optwrk = max(i__1,i__2);
                    }
