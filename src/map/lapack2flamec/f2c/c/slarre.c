/* ../netlib/v3.9.0/slarre.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *m = 1;
 ...
 /* Computing MIN */
 r__1 = gl; r__2 = gers[(i__ << 1) - 1]; // , expr subst  
 gl = min(r__1,r__2);
 gers[i__ * 2] = d__[i__] + tmp1;
 /* Computing MAX */
 r__1 = gu; r__2 = gers[i__ * 2]; // , expr subst  
 gu = max(r__1,r__2);
 eold = eabs;
 /* L5: */
 }
 ...
 /* Computing 2nd power */
 r__3 = emax;
 r__1 = 1.f; r__2 = r__3 * r__3; // , expr subst  
 ...
 *info = -1;
 ...
 ++i__) {
 /* Computing MAX */
 r__1 = 0.f; r__2 = w[i__ + 1] - werr[i__ + 1] - (w[i__] + werr[i__]); // , expr subst  
 wgap[i__] = max(r__1,r__2);
 /* L30: */
 }
 /* Computing MAX */
 r__1 = 0.f; r__2 = *vu - sigma - (w[wend] + werr[wend]); // , expr subst  
 ...
 *info = -1;
 ...
 /* Computing MAX */
 r__2 = gl; r__3 = tmp - tmp1 - eps * 100.f * (r__1 = tmp - tmp1, abs(r__1)); // , expr subst  
 ...
 *info = -1;
 ...
 /* Computing MIN */
 r__2 = gu; r__3 = tmp + tmp1 + eps * 100.f * (r__1 = tmp + tmp1, abs(r__1)); // , expr subst  
 ...
 /* Computing MAX */
 r__2 = gl; r__3 = w[wbegin] - werr[wbegin] - eps * 100.f * (r__1 = w[wbegin] - werr[wbegin], abs(r__1)); // , expr subst  
 isleft = max(r__2,r__3);
 /* Computing MIN */
 r__2 = gu; r__3 = w[wend] + werr[wend] + eps * 100.f * (r__1 = w[ wend] + werr[wend], abs(r__1)); // , expr subst  
 isrght = min(r__2,r__3);
 }
 ...
 /* Computing MAX */
 r__1 = tau; r__2 = eps * 2.f * abs(sigma); // , expr subst  
 tau = max(r__1,r__2);
 }
 else {
 if (mb > 1) {
 ...
 /* Computing MAX */
 r__1 = tau; r__2 = werr[wbegin]; // , expr subst  
 tau = max(r__1,r__2);
 }
 else {
 /* Computing MAX */
 ...
 tau = max(r__1,avgap) * .5f;
 /* Computing MAX */
 r__1 = tau; r__2 = werr[wend]; // , expr subst  
 tau = max(r__1,r__2);
 }
 }
 else {
 ...
 work[i__ + 1] = dpivot;
 /* Computing MAX */
 r__1 = dmax__; r__2 = abs(dpivot); // , expr subst  
 ...
 *info = -6;
 ...
 /* Computing MAX */
 r__1 = 0.f; r__2 = *vu - sigma - (w[*m] + werr[*m]); // , expr subst  
