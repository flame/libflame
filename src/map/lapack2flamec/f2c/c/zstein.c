/* ../netlib/zstein.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -5;
 ...
 /* Computing MAX */
 d__3 = onenrm; d__4 = (d__1 = d__[bn], f2c_abs(d__1)) + (d__2 = e[bn - 1], f2c_abs(d__2)); // , expr subst  
 ...
 ++i__) {
 /* Computing MAX */
 d__4 = onenrm; d__5 = (d__1 = d__[i__], f2c_abs(d__1)) + (d__2 = e[ i__ - 1], f2c_abs(d__2)) + (d__3 = e[i__], f2c_abs(d__3)); // , expr subst  
 ...
 /* Computing MAX */
 d__3 = eps; d__4 = (d__1 = work[indrv4 + blksiz], f2c_abs(d__1)); // , expr subst  
 scl = blksiz * onenrm * max(d__3,d__4) / (d__2 = work[indrv1 + jmax], f2c_abs(d__2));
 ...
 L110: jmax = idamax_(&blksiz, &work[indrv1 + 1], &c__1);
 ...
 L130: scl = 1. / dnrm2_(&blksiz, &work[indrv1 + 1], &c__1);
 jmax = idamax_(&blksiz, &work[indrv1 + 1], &c__1);
 ...
 ++i__) {
 i__4 = i__ + j * z_dim1;
 z__[i__4].r = 0.; z__[i__4].i = 0.; // , expr subst  
 /* L150: */
 }
 i__3 = blksiz;
 for (i__ = 1;
