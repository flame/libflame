...
L20: /* Loop until stopping criterion is satisfied. */
        ...
        if (upper)
        {
                    ...
                    ++k)
            {
                ...
                {
                    i__4 = ik;
                    rwork[i__] += ((r__1 = ap[i__4].r, abs(r__1)) + (r__2 = r_imag(&ap[ik]), abs(r__2))) * xk;
                    i__4 = ik;
                    i__5 = i__ + j * x_dim1;
                    s += ((r__1 = ap[i__4].r, abs(r__1)) + (r__2 = r_imag(&ap[ ik]), abs(r__2))) * ((r__3 = x[i__5].r, abs(r__3)) + (r__4 = r_imag(&x[i__ + j * x_dim1]), abs(r__4) ));
                    ++ik;
                    /* L40: */
                }
                i__3 = kk + k - 1;
                rwork[k] = rwork[k] + ((r__1 = ap[i__3].r, abs(r__1)) + (r__2 = r_imag(&ap[kk + k - 1]), abs(r__2))) * xk + s;
                kk += k;
                /* L50: */
            }
        }
        else
        {
                    ...
                    ++k)
            {
                ...
                xk = (r__1 = x[i__3].r, abs(r__1)) + (r__2 = r_imag(&x[k + j * x_dim1]), abs(r__2));
                i__3 = kk;
                rwork[k] += ((r__1 = ap[i__3].r, abs(r__1)) + (r__2 = r_imag(& ap[kk]), abs(r__2))) * xk;
                ik = kk + 1;
                i__3 = *n;
                for (i__ = k + 1;
                        i__ <= i__3;
