/* ../netlib/v3.9.0/chetrs2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 logical upper;
 extern /* Subroutine */
 int csscal_(integer *, real *, complex *, integer *), xerbla_(char *, integer *), csyconv_(char *, char *, integer *, complex *, integer *, integer *, complex *, integer *);
