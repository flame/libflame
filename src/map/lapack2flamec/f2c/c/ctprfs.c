            ...
            if (upper)
            {
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        {
                            i__4 = kc + i__ - 1;
                            rwork[i__] += ((r__1 = ap[i__4].r, abs(r__1)) + ( r__2 = r_imag(&ap[kc + i__ - 1]), abs( r__2))) * xk;
                            /* L30: */
                        }
                        kc += k;
                        /* L40: */
            ...
            else
            {
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                        ...
                        {
                            i__4 = kc + i__ - k;
                            rwork[i__] += ((r__1 = ap[i__4].r, abs(r__1)) + ( r__2 = r_imag(&ap[kc + i__ - k]), abs( r__2))) * xk;
                            /* L70: */
                        }
                        kc = kc + *n - k + 1;
                        /* L80: */
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                                ...
                                ++i__)
                        {
                            i__4 = kc + i__ - 1;
                            i__5 = i__ + j * x_dim1;
                            s += ((r__1 = ap[i__4].r, abs(r__1)) + (r__2 = r_imag(&ap[kc + i__ - 1]), abs(r__2))) * ( (r__3 = x[i__5].r, abs(r__3)) + (r__4 = r_imag(&x[i__ + j * x_dim1]), abs(r__4)));
                            /* L110: */
                        }
                        rwork[k] += s;
                        kc += k;
                ...
                if (nounit)
                {
                            ...
                            ++k)
                    {
                                ...
                                ++i__)
                        {
                            i__4 = kc + i__ - k;
                            i__5 = i__ + j * x_dim1;
                            s += ((r__1 = ap[i__4].r, abs(r__1)) + (r__2 = r_imag(&ap[kc + i__ - k]), abs(r__2))) * ( (r__3 = x[i__5].r, abs(r__3)) + (r__4 = r_imag(&x[i__ + j * x_dim1]), abs(r__4)));
                            /* L150: */
                        }
                        rwork[k] += s;
                        kc = kc + *n - k + 1;
