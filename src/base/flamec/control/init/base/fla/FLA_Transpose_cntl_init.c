...
void FLA_Transpose_cntl_init_ts(FLA_Transpose_cntl_init_s* FLA_Transpose_cntl_init_i)
{
	...
	FLA_Transpose_cntl_init_i->fla_tpose_bsize      = FLA_Query_blocksizes( FLA_DIMENSION_MIN );
	FLA_Transpose_cntl_init_i->fla_tpose_swap_bsize = FLA_Query_blocksizes( FLA_DIMENSION_MIN );

	// Create a control tree that performs unblocked variant 2 transposition.
	FLA_Transpose_cntl_init_i->fla_tpose_cntl_unb   = FLA_Cntl_tpose_obj_create( FLA_FLAT, 
	...
	FLA_Transpose_cntl_init_i->fla_swap_cntl_blas   = FLA_Cntl_swap_obj_create( FLA_FLAT,
	                                                  FLA_SUBPROBLEM,
	                                                  NULL,
	                                                  NULL );

	// Create a control tree that invokes unblocked variant 2 of swap.
	FLA_Transpose_cntl_init_i->fla_swap_cntl_panel  = FLA_Cntl_swap_obj_create( FLA_FLAT,
	                                                  FLA_BLOCKED_VARIANT2, 
	                                                  FLA_Transpose_cntl_init_i->fla_tpose_swap_bsize,
	                                                  FLA_Transpose_cntl_init_i->fla_swap_cntl_blas );

	// Create a control tree that assumes a large matrix argument.
	FLA_Transpose_cntl_init_i->fla_tpose_cntl       = FLA_Cntl_tpose_obj_create( FLA_FLAT,
	                                                  FLA_BLOCKED_VARIANT2, 
	                                                  FLA_Transpose_cntl_init_i->fla_tpose_bsize,
	                                                  FLA_Transpose_cntl_init_i->fla_tpose_cntl_unb,
	                                                  FLA_Transpose_cntl_init_i->fla_swap_cntl_panel );
}

void FLA_Transpose_cntl_finalize_ts(FLA_Transpose_cntl_init_s* FLA_Transpose_cntl_init_i)
{
	FLA_Cntl_obj_free( FLA_Transpose_cntl_init_i->fla_tpose_cntl );
	FLA_Cntl_obj_free( FLA_Transpose_cntl_init_i->fla_tpose_cntl_unb );
	FLA_Cntl_obj_free( FLA_Transpose_cntl_init_i->fla_swap_cntl_panel );
	FLA_Cntl_obj_free( FLA_Transpose_cntl_init_i->fla_swap_cntl_blas );

	FLA_Blocksize_free( FLA_Transpose_cntl_init_i->fla_tpose_bsize );
	FLA_Blocksize_free( FLA_Transpose_cntl_init_i->fla_tpose_swap_bsize );
}
#endif
