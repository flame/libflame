/* ../netlib/dlange.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > \verbatim */
/* > */
/* > DLANGE = ( max(f2c_dabs(A(i,j))), NORM = 'M' or 'm' */
/* > ( */
    ...
    else if (lsame_(norm, "I"))
    {
                ...
                ++j)
        {
            ...
            for (i__ = 1;
                    ...
                    ++i__)
            {
                work[i__] += (d__1 = a[i__ + j * a_dim1], f2c_dabs(d__1));
                /* L60: */
            }
            /* L70: */
        }
