 ...
 */
 ...
 char buffer[256]; 
 snprintf(buffer, 256,"dggevx inputs: balanc %c, jobvl %c, jobvr %c, sense %c, n %" FLA_IS ", lda %" FLA_IS ", ldb %" FLA_IS ", ldvl %" FLA_IS ", ldvr %" FLA_IS ", lwork %" FLA_IS "",*balanc, *jobvl, *jobvr, *sense, *n, *lda, *ldb, *ldvl, *ldvr, *lwork);
 ...
 *info = -16;
 ...
 if (wantsv || wantsb) {
 /* Computing MAX */
 i__1 = minwrk; i__2 = (*n << 1) * (*n + 4) + 16; // , expr subst  
 minwrk = max(i__1,i__2);
 }
 maxwrk = minwrk;
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n + *n * ilaenv_(&c__1, "DGEQRF", " ", n, & c__1, n, &c__0); // , expr subst  
 maxwrk = max(i__1,i__2);
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n + *n * ilaenv_(&c__1, "DORMQR", " ", n, & c__1, n, &c__0); // , expr subst  
 maxwrk = max(i__1,i__2);
 if (ilvl) {
 /* Computing MAX */
 i__1 = maxwrk; i__2 = *n + *n * ilaenv_(&c__1, "DORGQR", " ", n, &c__1, n, &c__0); // , expr subst  
 maxwrk = max(i__1,i__2);
 }
 }
 ...
 *info = *n + 2;
 ...
 ++jr) {
 /* Computing MAX */
 d__2 = temp; d__3 = (d__1 = vl[jr + jc * vl_dim1], f2c_abs( d__1)); // , expr subst  
 temp = max(d__2,d__3);
 /* L30: */
 }
 }
 ...
 ++jr) {
 /* Computing MAX */
 d__3 = temp; d__4 = (d__1 = vl[jr + jc * vl_dim1], f2c_abs( d__1)) + (d__2 = vl[jr + (jc + 1) * vl_dim1], f2c_abs( d__2)); // , expr subst  
 temp = max(d__3,d__4);
 /* L40: */
 }
 }
 ...
 ++jr) {
 /* Computing MAX */
 d__2 = temp; d__3 = (d__1 = vr[jr + jc * vr_dim1], f2c_abs( d__1)); // , expr subst  
 temp = max(d__2,d__3);
 /* L80: */
 }
 }
 ...
 ++jr) {
 /* Computing MAX */
 d__3 = temp; d__4 = (d__1 = vr[jr + jc * vr_dim1], f2c_abs( d__1)) + (d__2 = vr[jr + (jc + 1) * vr_dim1], f2c_abs( d__2)); // , expr subst  
 temp = max(d__3,d__4);
 /* L90: */
 }
 }
