/* ../netlib/v3.9.0/cstein.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -5;
 ...
 /* Computing MAX */
 r__3 = onenrm; r__4 = (r__1 = d__[bn], abs(r__1)) + (r__2 = e[bn - 1], abs(r__2)); // , expr subst  
 ...
 ++i__) {
 /* Computing MAX */
 r__4 = onenrm; r__5 = (r__1 = d__[i__], abs(r__1)) + (r__2 = e[ i__ - 1], abs(r__2)) + (r__3 = e[i__], abs(r__3)); // , expr subst  
 ...
 /* Computing MAX */
 r__3 = eps; r__4 = (r__1 = work[indrv4 + blksiz], abs(r__1)); // , expr subst  
 scl = blksiz * onenrm * max(r__3,r__4) / (r__2 = work[indrv1 + jmax], abs(r__2));
 ...
 L110: jmax = isamax_(&blksiz, &work[indrv1 + 1], &c__1);
 ...
 L130: scl = 1.f / snrm2_(&blksiz, &work[indrv1 + 1], &c__1);
 jmax = isamax_(&blksiz, &work[indrv1 + 1], &c__1);
 ...
 ++i__) {
 i__4 = i__ + j * z_dim1;
 z__[i__4].r = 0.f; z__[i__4].i = 0.f; // , expr subst  
 /* L150: */
 }
 i__3 = blksiz;
 for (i__ = 1;
