/* ../netlib/v3.9.0/ztrevc.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -11;
 ...
 i__2 = i__ + *n;
 i__3 = i__ + i__ * t_dim1;
 work[i__2].r = t[i__3].r; work[i__2].i = t[i__3].i; // , expr subst  
 /* L20: */
 }
 ...
 i__2 = k;
 i__3 = k + ki * t_dim1;
 z__1.r = -t[i__3].r; z__1.i = -t[i__3].i; // , expr subst  
 ...
 i__3 = k + k * t_dim1;
 i__4 = ki + ki * t_dim1;
 z__1.r = t[i__3].r - t[i__4].r; z__1.i = t[i__3].i - t[i__4] .i; // , expr subst  
 t[i__2].r = z__1.r; t[i__2].i = z__1.i; // , expr subst  
 i__2 = k + k * t_dim1;
 if ((d__1 = t[i__2].r, abs(d__1)) + (d__2 = d_imag(&t[k + k * t_dim1]), abs(d__2)) < smin) {
 i__3 = k + k * t_dim1;
 t[i__3].r = smin; t[i__3].i = 0.; // , expr subst  
 }
 /* L50: */
 }
 if (ki > 1) {
 ...
 ++k) {
 i__2 = k + is * vr_dim1;
 vr[i__2].r = 0.; vr[i__2].i = 0.; // , expr subst  
 /* L60: */
 }
 }
 else {
 ...
 i__2 = k + k * t_dim1;
 i__3 = k + *n;
 t[i__2].r = work[i__3].r; t[i__2].i = work[i__3].i; // , expr subst  
 /* L70: */
 }
 --is;
 L80: ;
 ...
 /* Computing MAX */
 i__2 = ki + ki * t_dim1;
 d__3 = ulp * ((d__1 = t[i__2].r, abs(d__1)) + (d__2 = d_imag(&t[ ki + ki * t_dim1]), abs(d__2)));
 smin = max(d__3,smlnum);
 i__2 = *n;
 ...
 i__2 = ki;
 work[i__2].r = scale; work[i__2].i = 0.; // , expr subst  
 }
 ...
 i__2 = ii + is * vl_dim1;
 remax = 1. / ((d__1 = vl[i__2].r, abs(d__1)) + (d__2 = d_imag( &vl[ii + is * vl_dim1]), abs(d__2)));
 i__2 = *n - ki + 1;
 ...
 ++k) {
 i__3 = k + is * vl_dim1;
 vl[i__3].r = 0.; vl[i__3].i = 0.; // , expr subst  
 /* L110: */
 }
 }
 else {
 ...
 i__2 = ii + ki * vl_dim1;
 remax = 1. / ((d__1 = vl[i__2].r, abs(d__1)) + (d__2 = d_imag( &vl[ii + ki * vl_dim1]), abs(d__2)));
