/* ../netlib/zlansy.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
    ...
    else if (lsame_(norm, "I") || lsame_(norm, "O") || *(unsigned char *)norm == '1')
    {
        ...
        if (lsame_(uplo, "U"))
        {
                    ...
                    ++j)
            {
                ...
                work[j] = sum + z_f2c_abs(&a[j + j * a_dim1]);
                /* L60: */
            }
            i__1 = *n;
            for (i__ = 1;
        ...
        else
        {
            ...
            for (j = 1;
                    ...
                    ++j)
            {
                sum = work[j] + z_f2c_abs(&a[j + j * a_dim1]);
                i__2 = *n;
                for (i__ = j + 1;
                        i__ <= i__2;
                        ++i__)
