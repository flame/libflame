    ...
    if (rightv)
    {
                ...
                --ki)
        {
                    ...
                    ++k)
            {
                ...
                i__2 = k + k * t_dim1;
                if ((d__1 = t[i__2].r, f2c_dabs(d__1)) + (d__2 = d_imag(&t[k + k * t_dim1]), f2c_dabs(d__2)) < smin)
                {
                    i__3 = k + k * t_dim1;
                    t[i__3].r = smin;
...
L80:
    ...
    if (leftv)
    {
                ...
                ++ki)
        {
            ...
            /* Computing MAX */
            i__2 = ki + ki * t_dim1;
            d__3 = ulp * ((d__1 = t[i__2].r, f2c_dabs(d__1)) + (d__2 = d_imag(&t[ ki + ki * t_dim1]), f2c_dabs(d__2)));
            smin = max(d__3,smlnum);
            i__2 = *n;
            work[i__2].r = 1.;
            ...
            if (! over)
            {
                ...
                i__2 = ii + is * vl_dim1;
                remax = 1. / ((d__1 = vl[i__2].r, f2c_dabs(d__1)) + (d__2 = d_imag( &vl[ii + is * vl_dim1]), f2c_dabs(d__2)));
                i__2 = *n - ki + 1;
            ...
            else
            {
                ...
                i__2 = ii + ki * vl_dim1;
                remax = 1. / ((d__1 = vl[i__2].r, f2c_dabs(d__1)) + (d__2 = d_imag( &vl[ii + ki * vl_dim1]), f2c_dabs(d__2)));
