/* ../netlib/v3.9.0/cla_porpvgrw.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 /* Computing MAX */
 i__3 = i__ + j * a_dim1;
 r__3 = (r__1 = a[i__3].r, abs(r__1)) + (r__2 = r_imag(&a[i__ + j * a_dim1]), abs(r__2)); r__4 = work[*ncols + j]; // , expr subst  
 ...
 /* Computing MAX */
 i__3 = i__ + j * af_dim1;
 r__3 = (r__1 = af[i__3].r, abs(r__1)) + (r__2 = r_imag(&af[ i__ + j * af_dim1]), abs(r__2)); r__4 = work[j]; // , expr subst  
