/* ../netlib/dlantb.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > \verbatim */
/* > */
/* > DLANTB = ( max(f2c_dabs(A(i,j))), NORM = 'M' or 'm' */
/* > ( */
            ...
            if (lsame_(uplo, "U"))
            {
                        ...
                        ++j)
                {
                    ...
                    for (i__ = max(i__2,1);
                            ...
                            ++i__)
                    {
                        sum = (d__1 = ab[i__ + j * ab_dim1], f2c_dabs(d__1));
            ...
            if (lsame_(diag, "U"))
            {
                        ...
                        ++j)
                {
                    ...
                    for (i__ = max(i__2,i__3);
                            ...
                            ++i__)
                    {
                        work[i__] += (d__1 = ab[l + i__ + j * ab_dim1], f2c_dabs( d__1));
                        /* L160: */
                    }
                    /* L170: */
                }
        ...
        if (lsame_(uplo, "U"))
        {
            if (lsame_(diag, "U"))
            {
                ...
                if (*k > 0)
                {
                            ...
                            ++j)
                    {
                        ...
                        /* Computing MAX */
                        i__2 = *k + 2 - j;
                        dlassq_(&i__3, &ab[max(i__2,1) + j * ab_dim1], &c__1, &scale, &sum);
                        /* L280: */
                    }
                }
            }
            else
            {
                        ...
                        ++j)
                {
                    ...
                    /* Computing MAX */
                    i__5 = *k + 2 - j;
                    dlassq_(&i__3, &ab[max(i__5,1) + j * ab_dim1], &c__1, & scale, &sum);
                    /* L290: */
                }
            }
        }
