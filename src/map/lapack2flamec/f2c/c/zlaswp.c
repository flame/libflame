/* ../netlib/v3.9.0/zlaswp.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 on Linux or Unix systems, link with .../path/to/libf2c.a -lm or, if you install libf2c.a in a standard place, with -lf2c -lm -- in that order, at the end of the command line, as in cc *.o -lf2c -lm Source for libf2c is in /netlib/f2c/libf2c.zip, e.g., http://www.netlib.org/f2c/libf2c.zip */
 #include "FLA_f2c.h" /* > \brief \b ZLASWP performs a series of row interchanges on a general rectangular matrix. */
 /* =========== DOCUMENTATION =========== */
 ...
 i__5 = i__ + k * a_dim1;
 i__6 = ip + k * a_dim1;
 a[i__5].r = a[i__6].r; a[i__5].i = a[i__6].i; // , expr subst  
 i__5 = ip + k * a_dim1;
 a[i__5].r = temp.r; a[i__5].i = temp.i; // , expr subst  
 /* L10: */
 }
 }
 ix += *incx;
 ...
 i__4 = ip + k * a_dim1;
 a[i__4].r = temp.r; a[i__4].i = temp.i; // , expr subst  
 /* L40: */
 }
 }
 ix += *incx;
