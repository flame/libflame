/* ../netlib/v3.9.0/clarft.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 i__3 = j + i__ * t_dim1;
 i__4 = i__;
 q__2.r = -tau[i__4].r; q__2.i = -tau[i__4].i; // , expr subst  
 ...
 i__3 = i__ - 1;
 i__4 = i__;
 q__1.r = -tau[i__4].r; q__1.i = -tau[i__4].i; // , expr subst  
 ...
 q__2.r = -tau[i__4].r; q__2.i = -tau[i__4].i; // , expr subst  
 i__5 = j + i__ * v_dim1;
 q__1.r = q__2.r * v[i__5].r - q__2.i * v[i__5].i; q__1.i = q__2.r * v[i__5].i + q__2.i * v[i__5] .r; // , expr subst  
 t[i__3].r = q__1.r; t[i__3].i = q__1.i; // , expr subst  
 }
 j = min(lastv,prevlastv);
 ...
 i__2 = j + i__ * t_dim1;
 i__3 = i__;
 q__2.r = -tau[i__3].r; q__2.i = -tau[i__3].i; // , expr subst  
 r_cnjg(&q__3, &v[*n - *k + i__ + j * v_dim1]);
 q__1.r = q__2.r * q__3.r - q__2.i * q__3.i; q__1.i = q__2.r * q__3.i + q__2.i * q__3.r; // , expr subst  
 t[i__2].r = q__1.r; t[i__2].i = q__1.i; // , expr subst  
 }
 ...
 i__2 = *k - i__;
 i__3 = i__;
 q__1.r = -tau[i__3].r; q__1.i = -tau[i__3].i; // , expr subst  
 ...
 q__1.r = q__2.r * v[i__4].r - q__2.i * v[i__4].i; q__1.i = q__2.r * v[i__4].i + q__2.i * v[ i__4].r; // , expr subst  
 t[i__2].r = q__1.r; t[i__2].i = q__1.i; // , expr subst  
 }
 j = max(lastv,prevlastv);
 ...
 i__1 = i__ + i__ * t_dim1;
 i__2 = i__;
 t[i__1].r = tau[i__2].r; t[i__1].i = tau[i__2].i; // , expr subst  
 }
 }
 }
 return 0;
