...
/*! @brief Partial LDL' factorization without pivoting
    ...
    * \b Purpose:
    * \verbatim
        SSPFFRTX computes the partial factorization of a real symmetric matrix A
...
\par Further Details:
    ...
    * \verbatim
    ...
    then SSPFFRTX performs ncolm successive factorizations of the form:
...
void sspffrtx_fla(real *ap, integer *n, integer * ncolm, real *work, real *work2)
{
    ...
    AOCL_DTL_TRACE_ENTRY(AOCL_DTL_LEVEL_TRACE_5);
    	...
    	char buffer[256];
	sprintf(buffer, "sspffrtx inputs: n %d, ncolm %d\n", *n, *ncolm);
