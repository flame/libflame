 ...
 *info = -11;
    ...
    if (*m >= *n && minmn > 0)
    {
        ...
        if (*m >= mnthr)
        {
            ...
            if (wntun) {
                ...
                if (wntvo || wntvas) {
                /* Computing MAX */
                i__2 = maxwrk; i__3 = *n * 3 + lwork_dorgbrp; // , expr subst  
                maxwrk = fla_max(i__2,i__3);
                }
                ...
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *n + lwork_dorgqrn; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *n * 3 + lwork_dgebrd; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *n * 3 + lwork_dorgbrq; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                ...
                wrkbl = fla_max(i__2,i__3);
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *n * 3 + lwork_dorgbrp; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                wrkbl = fla_max(wrkbl,bdspac);
                /* Computing MAX */
                i__2 = *n * *n + wrkbl; i__3 = *n * *n + *m * *n + *n; // , expr subst  
                ...
                wrkbl = *n + lwork_dgeqrf;
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *n + lwork_dorgqrm; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *n * 3 + lwork_dgebrd; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
        ...
        else
        {
            ...
            if (wntus || wntuo) {
                lwork_dorgbrq = fla_max(1, *n) * FLA_GEQRF_BLOCK_SIZE;
                /* Computing MAX */
                i__2 = maxwrk; i__3 = *n * 3 + lwork_dorgbrq; // , expr subst  
                maxwrk = fla_max(i__2,i__3);
            }
            if (wntua) {
                /* Compute space needed for DORGBR Q */
        ...
        if (*n >= mnthr) {
            ...
            if (wntvn) {
                ...
                if (wntuo || wntuas) {
                    lwork_dorgbrq = fla_max(1, *m) * FLA_GEQRF_BLOCK_SIZE;
                    /* Computing MAX */
                    i__2 = maxwrk; i__3 = *m * 3 + lwork_dorgbrq; // , expr subst  
                    maxwrk = fla_max(i__2,i__3);
                }
                maxwrk = fla_max(maxwrk,bdspac);
                /* Computing MAX */
                ...
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *m + lwork_dorglqm; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *m * 3 + lwork_dgebrd; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *m * 3 + lwork_dorgbrp; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                wrkbl = fla_max(wrkbl,bdspac);
                /* Computing MAX */
                ...
                wrkbl = fla_max(i__2,i__3);
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *m * 3 + lwork_dorgbrq; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                wrkbl = fla_max(wrkbl,bdspac);
                /* Computing MAX */
                i__2 = *m * *m + wrkbl; i__3 = *m * *m + *m * *n + *m; // , expr subst  
                ...
                wrkbl = *m + lwork_dgelqf;
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *m + lwork_dorglqn; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
                /* Computing MAX */
                i__2 = wrkbl; i__3 = *m * 3 + lwork_dgebrd; // , expr subst  
                wrkbl = fla_max(i__2,i__3);
            ...
            if (wntvs || wntvo) {
                ...
                lwork_dorgbrp = fla_max(1, (*n - 1)) * FLA_GEQRF_BLOCK_SIZE;
                /* Computing MAX */
                i__2 = maxwrk; i__3 = *m * 3 + lwork_dorgbrp; // , expr subst  
                maxwrk = fla_max(i__2,i__3);
            }
            if (wntva) {
                /* Compute space needed for DORGBR P */
 ...
 if (*info == 0)
 {
    ...
    if (*m >= *n && minmn > 0)
    {
        ...
        if (*m >= mnthr)
        {
            ...
            /* Compute space needed for DGEBRD */
            lapack_dgebrd(n, n, &a[a_offset], lda, &s[1], dum, dum, dum, dum, &c_n1, &ierr);
        ...
        {
            /* Path 10 (M at least N, but not much larger) */
            lapack_dgebrd(m, n, &a[a_offset], lda, &s[1], dum, dum, dum, dum, & c_n1, &ierr);
            lwork_dgebrd = (integer) dum[0];
            maxwrk = *n * 3 + lwork_dgebrd;
            if (wntus || wntuo) {
                lapack_dorgbr("Q", m, n, n, &a[a_offset], lda, dum, dum, &c_n1, &ierr);
                lwork_dorgbrq = (integer) dum[0];
                /* Computing MAX */
                i__2 = maxwrk; i__3 = *n * 3 + lwork_dorgbrq; // , expr subst  
                maxwrk = fla_max(i__2,i__3);
    ...
    else if (minmn > 0)
    {
        ...
        /* Compute space needed for DGEBRD */
        lapack_dgebrd(m, m, &a[a_offset], lda, &s[1], dum, dum, dum, dum, &c_n1, &ierr);
        lwork_dgebrd = (integer) dum[0];
        /* Compute space needed for DORGBR P */
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dgebrd(n, n, &a[a_offset], lda, &s[1], &work[ie], &work[ itauq], &work[itaup], &work[iwork], &i__2, &ierr);
 ncvt = 0;
 if (wntvo || wntvas) {
 /* If right singular vectors desired, generate P'. */
 /* (Workspace: need 4*N-1, prefer 3*N + (N-1)*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("P", n, n, n, &a[a_offset], lda, &work[itaup], & work[iwork], &i__2, &ierr);
 ncvt = *n;
 }
 iwork = ie + *n;
 ...
 lapack_dbdsqr("U", n, &ncvt, &c__0, &c__0, &s[1], &work[ie], &a[ a_offset], lda, dum, &c__1, dum, &c__1, &work[iwork], info);
 ...
 /* (Workspace: need N*N + 2*N, prefer N*N + N + N*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgqr(m, n, n, &a[a_offset], lda, &work[itau], &work[ iwork], &i__2, &ierr);
 ie = itau;
 itauq = ie + *n;
 itaup = itauq + *n;
 iwork = itaup + *n;
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dgebrd(n, n, &work[ir], &ldwrkr, &s[1], &work[ie], &work[ itauq], &work[itaup], &work[iwork], &i__2, &ierr);
 /* Generate left vectors bidiagonalizing R */
 /* (Workspace: need N*N + 4*N, prefer N*N + 3*N + N*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", n, n, n, &work[ir], &ldwrkr, &work[itauq], & work[iwork], &i__2, &ierr);
 iwork = ie + *n;
 /* Perform bidiagonal QR iteration, computing left */
 /* singular vectors of R in WORK(IR) */
 /* (Workspace: need N*N + BDSPAC) */
 lapack_dbdsqr("U", n, &c__0, n, &c__0, &s[1], &work[ie], dum, & c__1, &work[ir], &ldwrkr, dum, &c__1, &work[iwork] , info);
 iu = ie + *n;
 ...
 i__3 = *lwork - iwork + 1;
 lapack_dgebrd(m, n, &a[a_offset], lda, &s[1], &work[ie], &work[ itauq], &work[itaup], &work[iwork], &i__3, &ierr);
 /* Generate left vectors bidiagonalizing A */
 /* (Workspace: need 4*N, prefer 3*N + N*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, n, n, &a[a_offset], lda, &work[itauq], & work[iwork], &i__3, &ierr);
 iwork = ie + *n;
 /* Perform bidiagonal QR iteration, computing left */
 /* singular vectors of A in A */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", n, &c__0, m, &c__0, &s[1], &work[ie], dum, & c__1, &a[a_offset], lda, dum, &c__1, &work[iwork], info);
 }
 }
 else if (wntuo && wntvas) {
 ...
 /* (Workspace: need N*N + 2*N, prefer N*N + N + N*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dorgqr(m, n, n, &a[a_offset], lda, &work[itau], &work[ iwork], &i__3, &ierr);
 ie = itau;
 itauq = ie + *n;
 itaup = itauq + *n;
 iwork = itaup + *n;
 ...
 /* (Workspace: need N*N + 4*N, prefer N*N + 3*N + 2*N*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dgebrd(n, n, &vt[vt_offset], ldvt, &s[1], &work[ie], & work[itauq], &work[itaup], &work[iwork], &i__3, & ierr);
 dlacpy_("L", n, n, &vt[vt_offset], ldvt, &work[ir], & ldwrkr);
 /* Generate left vectors bidiagonalizing R in WORK(IR) */
 /* (Workspace: need N*N + 4*N, prefer N*N + 3*N + N*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dorgbr("Q", n, n, n, &work[ir], &ldwrkr, &work[itauq], & work[iwork], &i__3, &ierr);
 /* Generate right vectors bidiagonalizing R in VT */
 /* (Workspace: need N*N + 4*N-1, prefer N*N + 3*N + (N-1)*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dorgbr("P", n, n, n, &vt[vt_offset], ldvt, &work[itaup], &work[iwork], &i__3, &ierr);
 iwork = ie + *n;
 /* Perform bidiagonal QR iteration, computing left */
 /* singular vectors of R in WORK(IR) and computing right */
 /* singular vectors of R in VT */
 /* (Workspace: need N*N + BDSPAC) */
 lapack_dbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &work[ir], &ldwrkr, dum, &c__1, &work[iwork], info);
 iu = ie + *n;
 /* Multiply Q in A by left singular vectors of R in */
 /* WORK(IR), storing result in WORK(IU) and copying to A */
 /* (Workspace: need N*N + 2*N, prefer N*N + M*N + N) */
 ...
 /* (Workspace: need 4*N, prefer 3*N + 2*N*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dgebrd(n, n, &vt[vt_offset], ldvt, &s[1], &work[ie], & work[itauq], &work[itaup], &work[iwork], &i__2, & ierr);
 /* Multiply Q in A by left vectors bidiagonalizing R */
 /* (Workspace: need 3*N + M, prefer 3*N + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dormbr("Q", "R", "N", m, n, n, &vt[vt_offset], ldvt, & work[itauq], &a[a_offset], lda, &work[iwork], & i__2, &ierr);
 /* Generate right vectors bidiagonalizing R in VT */
 /* (Workspace: need 4*N-1, prefer 3*N + (N-1)*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("P", n, n, n, &vt[vt_offset], ldvt, &work[itaup], &work[iwork], &i__2, &ierr);
 iwork = ie + *n;
 /* Perform bidiagonal QR iteration, computing left */
 /* singular vectors of A in A and computing right */
 /* singular vectors of A in VT */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &a[a_offset], lda, dum, &c__1, & work[iwork], info);
 }
 }
 else if (wntus) {
 if (wntvn) {
 ...
 /* (Workspace: need N*N) */
 dgemm_("N", "N", m, n, n, &c_b79, &a[a_offset], lda, & work[ir], &ldwrkr, &c_b57, &u[u_offset], ldu);
 }
 else {
 /* Insufficient workspace for a fast algorithm */
 itau = 1;
 ...
 /* (Workspace: need 2*N, prefer N + N*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgqr(m, n, n, &u[u_offset], ldu, &work[itau], & work[iwork], &i__2, &ierr);
 ie = itau;
 itauq = ie + *n;
 itaup = itauq + *n;
 iwork = itaup + *n;
 ...
 /* (Workspace: need 3*N + M, prefer 3*N + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dormbr("Q", "R", "N", m, n, n, &a[a_offset], lda, & work[itauq], &u[u_offset], ldu, &work[iwork], &i__2, &ierr) ;
 iwork = ie + *n;
 /* Perform bidiagonal QR iteration, computing left */
 /* singular vectors of A in U */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", n, &c__0, m, &c__0, &s[1], &work[ie], dum, &c__1, &u[u_offset], ldu, dum, &c__1, & work[iwork], info);
 }
 }
 else if (wntvo) {
 /* Path 5 (M much larger than N, JOBU='S', JOBVT='O') */
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dgebrd(n, n, &work[iu], &ldwrku, &s[1], &work[ie], & work[itauq], &work[itaup], &work[iwork], & i__2, &ierr);
 dlacpy_("U", n, n, &work[iu], &ldwrku, &work[ir], & ldwrkr);
 /* Generate left bidiagonalizing vectors in WORK(IU) */
 /* (Workspace: need 2*N*N + 4*N, prefer 2*N*N + 3*N + N*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", n, n, n, &work[iu], &ldwrku, &work[itauq] , &work[iwork], &i__2, &ierr);
 /* Generate right bidiagonalizing vectors in WORK(IR) */
 /* (Workspace: need 2*N*N + 4*N-1, */
 /* prefer 2*N*N+3*N+(N-1)*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("P", n, n, n, &work[ir], &ldwrkr, &work[itaup] , &work[iwork], &i__2, &ierr);
 iwork = ie + *n;
 /* Perform bidiagonal QR iteration, computing left */
 /* singular vectors of R in WORK(IU) and computing */
 /* right singular vectors of R in WORK(IR) */
 /* (Workspace: need 2*N*N + BDSPAC) */
 lapack_dbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &work[ ir], &ldwrkr, &work[iu], &ldwrku, dum, &c__1, &work[iwork], info);
 /* Multiply Q in A by left singular vectors of R in */
 /* WORK(IU), storing result in U */
 /* (Workspace: need N*N) */
 dgemm_("N", "N", m, n, n, &c_b79, &a[a_offset], lda, & work[iu], &ldwrku, &c_b57, &u[u_offset], ldu);
 ...
 /* singular vectors of A in A */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &a[ a_offset], lda, &u[u_offset], ldu, dum, &c__1, &work[iwork], info);
 }
 }
 else if (wntvas) {
 ...
 /* (Workspace: need N*N + BDSPAC) */
 lapack_dbdsqr("U", n, n, n, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &work[iu], &ldwrku, dum, & c__1, &work[iwork], info);
 /* Multiply Q in A by left singular vectors of R in */
 /* WORK(IU), storing result in U */
 /* (Workspace: need N*N) */
 dgemm_("N", "N", m, n, n, &c_b79, &a[a_offset], lda, & work[iu], &ldwrku, &c_b57, &u[u_offset], ldu);
 ...
 /* (Workspace: need 3*N + M, prefer 3*N + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dormbr("Q", "R", "N", m, n, n, &vt[vt_offset], ldvt, &work[itauq], &u[u_offset], ldu, &work[iwork], &i__2, &ierr);
 /* Generate right bidiagonalizing vectors in VT */
 /* (Workspace: need 4*N-1, prefer 3*N + (N-1)*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("P", n, n, n, &vt[vt_offset], ldvt, &work[ itaup], &work[iwork], &i__2, &ierr) ;
 ...
 /* singular vectors of A in VT */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", n, n, m, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &u[u_offset], ldu, dum, & c__1, &work[iwork], info);
 }
 }
 }
 else if (wntua) {
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dorgqr(m, m, n, &u[u_offset], ldu, &work[itau], & work[iwork], &i__2, &ierr);
 ie = itau;
 itauq = ie + *n;
 itaup = itauq + *n;
 iwork = itaup + *n;
 ...
 /* (Workspace: need N*N) */
 dgemm_("N", "N", m, n, n, &c_b79, &u[u_offset], ldu, & work[ir], &ldwrkr, &c_b57, &a[a_offset], lda);
 ...
 /* (Workspace: need N*N) */
 dgemm_("N", "N", m, n, n, &c_b79, &u[u_offset], ldu, & work[iu], &ldwrku, &c_b57, &a[a_offset], lda);
 /* Copy left singular vectors of A from A to U */
 dlacpy_("F", m, n, &a[a_offset], lda, &u[u_offset], ldu);
 ...
 /* (Workspace: need 3*N + M, prefer 3*N + (M + N)*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dgebrd(m, n, &a[a_offset], lda, &s[1], &work[ie], &work[itauq], & work[itaup], &work[iwork], &i__2, &ierr);
 if (wntuas) {
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, &ncu, n, &u[u_offset], ldu, &work[itauq], & work[iwork], &i__2, &ierr);
 }
 if (wntvas) {
 ...
 /* (Workspace: need 4*N, prefer 3*N + N*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, n, n, &a[a_offset], lda, &work[itauq], &work[ iwork], &i__2, &ierr);
 }
 if (wntvo) {
 ...
 /* vectors in VT */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", n, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &u[u_offset], ldu, dum, &c__1, & work[iwork], info);
 }
 else if (! wntuo && wntvo) {
 /* Perform bidiagonal QR iteration, if desired, computing */
 /* left singular vectors in U and computing right singular */
 /* vectors in A */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", n, &ncvt, &nru, &c__0, &s[1], &work[ie], &a[ a_offset], lda, &u[u_offset], ldu, dum, &c__1, &work[ iwork], info);
 }
 else {
 /* Perform bidiagonal QR iteration, if desired, computing */
 ...
 /* vectors in VT */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", n, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &a[a_offset], lda, dum, &c__1, & work[iwork], info);
 }
 }
 }
 else {
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dgelqf(m, n, &a[a_offset], lda, &work[itau], &work[iwork], & i__2, &ierr);
 /* Zero out above L */
 i__2 = *m - 1;
 i__3 = *m - 1;
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dgebrd(m, m, &a[a_offset], lda, &s[1], &work[ie], &work[ itauq], &work[itaup], &work[iwork], &i__2, &ierr);
 if (wntuo || wntuas) {
 /* If left singular vectors desired, generate Q */
 /* (Workspace: need 4*M, prefer 3*M + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, m, m, &a[a_offset], lda, &work[itauq], & work[iwork], &i__2, &ierr);
 }
 iwork = ie + *m;
 nru = 0;
 if (wntuo || wntuas) {
 ...
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", m, &c__0, &nru, &c__0, &s[1], &work[ie], dum, & c__1, &a[a_offset], lda, dum, &c__1, &work[iwork], info);
 ...
 i__2 = *m - 1;
 i__3 = *m - 1;
 dlaset_("U", &i__2, &i__3, &c_b57, &c_b57, &work[ir + ldwrkr], &ldwrkr);
 /* Generate Q in A */
 /* (Workspace: need M*M + 2*M, prefer M*M + M + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorglq(m, n, m, &a[a_offset], lda, &work[itau], &work[ iwork], &i__2, &ierr);
 ie = itau;
 itauq = ie + *m;
 itaup = itauq + *m;
 iwork = itaup + *m;
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dgebrd(m, m, &work[ir], &ldwrkr, &s[1], &work[ie], &work[ itauq], &work[itaup], &work[iwork], &i__2, &ierr);
 /* Generate right vectors bidiagonalizing L */
 /* (Workspace: need M*M + 4*M-1, prefer M*M + 3*M + (M-1)*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("P", m, m, m, &work[ir], &ldwrkr, &work[itaup], & work[iwork], &i__2, &ierr);
 iwork = ie + *m;
 /* Perform bidiagonal QR iteration, computing right */
 /* singular vectors of L in WORK(IR) */
 /* (Workspace: need M*M + BDSPAC) */
 lapack_dbdsqr("U", m, m, &c__0, &c__0, &s[1], &work[ie], &work[ ir], &ldwrkr, dum, &c__1, dum, &c__1, &work[iwork] , info);
 iu = ie + *m;
 ...
 /* (Workspace: need 4*M, prefer 3*M + M*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dorgbr("P", m, n, m, &a[a_offset], lda, &work[itaup], & work[iwork], &i__3, &ierr);
 iwork = ie + *m;
 /* Perform bidiagonal QR iteration, computing right */
 /* singular vectors of A in A */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("L", m, n, &c__0, &c__0, &s[1], &work[ie], &a[ a_offset], lda, dum, &c__1, dum, &c__1, &work[ iwork], info);
 }
 }
 else if (wntvo && wntuas) {
 ...
 /* (Workspace: need M*M + 2*M, prefer M*M + M + M*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dgelqf(m, n, &a[a_offset], lda, &work[itau], &work[iwork] , &i__3, &ierr);
 /* Copy L to U, zeroing about above it */
 dlacpy_("L", m, m, &a[a_offset], lda, &u[u_offset], ldu);
 i__3 = *m - 1;
 i__2 = *m - 1;
 dlaset_("U", &i__3, &i__2, &c_b57, &c_b57, &u[(u_dim1 << 1) + 1], ldu);
 /* Generate Q in A */
 /* (Workspace: need M*M + 2*M, prefer M*M + M + M*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dorglq(m, n, m, &a[a_offset], lda, &work[itau], &work[ iwork], &i__3, &ierr);
 ie = itau;
 itauq = ie + *m;
 itaup = itauq + *m;
 iwork = itaup + *m;
 ...
 /* (Workspace: need M*M + 4*M, prefer M*M + 3*M + 2*M*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dgebrd(m, m, &u[u_offset], ldu, &s[1], &work[ie], &work[ itauq], &work[itaup], &work[iwork], &i__3, &ierr);
 dlacpy_("U", m, m, &u[u_offset], ldu, &work[ir], &ldwrkr);
 /* Generate right vectors bidiagonalizing L in WORK(IR) */
 /* (Workspace: need M*M + 4*M-1, prefer M*M + 3*M + (M-1)*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dorgbr("P", m, m, m, &work[ir], &ldwrkr, &work[itaup], & work[iwork], &i__3, &ierr);
 /* Generate left vectors bidiagonalizing L in U */
 /* (Workspace: need M*M + 4*M, prefer M*M + 3*M + M*NB) */
 i__3 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, m, m, &u[u_offset], ldu, &work[itauq], & work[iwork], &i__3, &ierr);
 iwork = ie + *m;
 /* Perform bidiagonal QR iteration, computing left */
 /* singular vectors of L in U, and computing right */
 /* singular vectors of L in WORK(IR) */
 /* (Workspace: need M*M + BDSPAC) */
 lapack_dbdsqr("U", m, m, m, &c__0, &s[1], &work[ie], &work[ir], &ldwrkr, &u[u_offset], ldu, dum, &c__1, &work[ iwork], info);
 iu = ie + *m;
 /* Multiply right singular vectors of L in WORK(IR) by Q */
 /* in A, storing result in WORK(IU) and copying to A */
 /* (Workspace: need M*M + 2*M, prefer M*M + M*N + M)) */
 ...
 i__2 = *m - 1;
 i__3 = *m - 1;
 dlaset_("U", &i__2, &i__3, &c_b57, &c_b57, &u[(u_dim1 << 1) + 1], ldu);
 /* Generate Q in A */
 /* (Workspace: need 2*M, prefer M + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorglq(m, n, m, &a[a_offset], lda, &work[itau], &work[ iwork], &i__2, &ierr);
 ...
 /* (Workspace: need 4*M, prefer 3*M + 2*M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dgebrd(m, m, &u[u_offset], ldu, &s[1], &work[ie], &work[ itauq], &work[itaup], &work[iwork], &i__2, &ierr);
 /* Multiply right vectors bidiagonalizing L by Q in A */
 /* (Workspace: need 3*M + N, prefer 3*M + N*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dormbr("P", "L", "T", m, n, m, &u[u_offset], ldu, &work[ itaup], &a[a_offset], lda, &work[iwork], &i__2, & ierr);
 /* Generate left vectors bidiagonalizing L in U */
 /* (Workspace: need 4*M, prefer 3*M + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, m, m, &u[u_offset], ldu, &work[itauq], & work[iwork], &i__2, &ierr);
 iwork = ie + *m;
 /* Perform bidiagonal QR iteration, computing left */
 /* singular vectors of A in U and computing right */
 /* singular vectors of A in A */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &a[ a_offset], lda, &u[u_offset], ldu, dum, &c__1, & work[iwork], info);
 }
 }
 else if (wntvs) {
 if (wntun) {
 ...
 /* (Workspace: need M*M) */
 dgemm_("N", "N", m, n, m, &c_b79, &work[ir], &ldwrkr, &a[a_offset], lda, &c_b57, &vt[vt_offset], ldvt);
 }
 else {
 /* Insufficient workspace for a fast algorithm */
 itau = 1;
 ...
 /* (Workspace: need 2*M, prefer M + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorglq(m, n, m, &vt[vt_offset], ldvt, &work[itau], & work[iwork], &i__2, &ierr);
 ie = itau;
 itauq = ie + *m;
 itaup = itauq + *m;
 iwork = itaup + *m;
 ...
 /* (Workspace: need 3*M + N, prefer 3*M + N*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dormbr("P", "L", "T", m, n, m, &a[a_offset], lda, & work[itaup], &vt[vt_offset], ldvt, &work[ iwork], &i__2, &ierr);
 iwork = ie + *m;
 /* Perform bidiagonal QR iteration, computing right */
 /* singular vectors of A in VT */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", m, n, &c__0, &c__0, &s[1], &work[ie], & vt[vt_offset], ldvt, dum, &c__1, dum, &c__1, & work[iwork], info);
 }
 }
 else if (wntuo) {
 /* Path 5t(N much larger than M, JOBU='O', JOBVT='S') */
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dgebrd(m, m, &work[iu], &ldwrku, &s[1], &work[ie], & work[itauq], &work[itaup], &work[iwork], & i__2, &ierr);
 dlacpy_("L", m, m, &work[iu], &ldwrku, &work[ir], & ldwrkr);
 /* Generate right bidiagonalizing vectors in WORK(IU) */
 /* (Workspace: need 2*M*M + 4*M-1, */
 /* prefer 2*M*M+3*M+(M-1)*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("P", m, m, m, &work[iu], &ldwrku, &work[itaup] , &work[iwork], &i__2, &ierr);
 /* Generate left bidiagonalizing vectors in WORK(IR) */
 /* (Workspace: need 2*M*M + 4*M, prefer 2*M*M + 3*M + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, m, m, &work[ir], &ldwrkr, &work[itauq] , &work[iwork], &i__2, &ierr);
 iwork = ie + *m;
 /* Perform bidiagonal QR iteration, computing left */
 /* singular vectors of L in WORK(IR) and computing */
 /* right singular vectors of L in WORK(IU) */
 /* (Workspace: need 2*M*M + BDSPAC) */
 lapack_dbdsqr("U", m, m, m, &c__0, &s[1], &work[ie], &work[ iu], &ldwrku, &work[ir], &ldwrkr, dum, &c__1, &work[iwork], info);
 ...
 /* singular vectors of A in VT */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &a[a_offset], lda, dum, & c__1, &work[iwork], info);
 }
 }
 else if (wntuas) {
 /* Path 6t(N much larger than M, JOBU='S' or 'A', */
 ...
 /* (Workspace: need M*M + BDSPAC) */
 lapack_dbdsqr("U", m, m, m, &c__0, &s[1], &work[ie], &work[ iu], &ldwrku, &u[u_offset], ldu, dum, &c__1, & work[iwork], info);
 /* Multiply right singular vectors of L in WORK(IU) by */
 /* Q in A, storing result in VT */
 /* (Workspace: need M*M) */
 dgemm_("N", "N", m, n, m, &c_b79, &work[iu], &ldwrku, &a[a_offset], lda, &c_b57, &vt[vt_offset], ldvt);
 ...
 /* (Workspace: need 3*M + N, prefer 3*M + N*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dormbr("P", "L", "T", m, n, m, &u[u_offset], ldu, & work[itaup], &vt[vt_offset], ldvt, &work[ iwork], &i__2, &ierr);
 /* Generate left bidiagonalizing vectors in U */
 /* (Workspace: need 4*M, prefer 3*M + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, m, m, &u[u_offset], ldu, &work[itauq], &work[iwork], &i__2, &ierr);
 ...
 /* singular vectors of A in VT */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("U", m, n, m, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &u[u_offset], ldu, dum, & c__1, &work[iwork], info);
 }
 }
 }
 else if (wntva) {
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dorglq(n, n, m, &vt[vt_offset], ldvt, &work[itau], & work[iwork], &i__2, &ierr);
 ie = itau;
 itauq = ie + *m;
 itaup = itauq + *m;
 iwork = itaup + *m;
 ...
 /* (Workspace: need M*M) */
 dgemm_("N", "N", m, n, m, &c_b79, &work[ir], &ldwrkr, &vt[vt_offset], ldvt, &c_b57, &a[a_offset], lda);
 ...
 /* Q in VT, storing result in A */
 /* (Workspace: need M*M) */
 dgemm_("N", "N", m, n, m, &c_b79, &work[iu], &ldwrku, &vt[vt_offset], ldvt, &c_b57, &a[a_offset], lda);
 /* Copy right singular vectors of A from A to VT */
 dlacpy_("F", m, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
 ...
 dlacpy_("L", m, m, &a[a_offset], lda, &u[u_offset], ldu);
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, m, n, &u[u_offset], ldu, &work[itauq], &work[ iwork], &i__2, &ierr);
 }
 if (wntvas) {
 /* If right singular vectors desired in VT, copy result to */
 /* VT and generate right bidiagonalizing vectors in VT */
 ...
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("P", &nrvt, n, m, &vt[vt_offset], ldvt, &work[itaup], &work[iwork], &i__2, &ierr);
 }
 if (wntuo) {
 /* If left singular vectors desired in A, generate left */
 /* bidiagonalizing vectors in A */
 /* (Workspace: need 4*M-1, prefer 3*M + (M-1)*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("Q", m, m, n, &a[a_offset], lda, &work[itauq], &work[ iwork], &i__2, &ierr);
 }
 if (wntvo) {
 /* If right singular vectors desired in A, generate right */
 /* bidiagonalizing vectors in A */
 /* (Workspace: need 4*M, prefer 3*M + M*NB) */
 i__2 = *lwork - iwork + 1;
 lapack_dorgbr("P", m, n, m, &a[a_offset], lda, &work[itaup], &work[ iwork], &i__2, &ierr);
 }
 iwork = ie + *m;
 if (wntuas || wntuo) {
 nru = *m;
 ...
 /* vectors in VT */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("L", m, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &u[u_offset], ldu, dum, &c__1, & work[iwork], info);
 }
 else if (! wntuo && wntvo) {
 /* Perform bidiagonal QR iteration, if desired, computing */
 /* left singular vectors in U and computing right singular */
 /* vectors in A */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("L", m, &ncvt, &nru, &c__0, &s[1], &work[ie], &a[ a_offset], lda, &u[u_offset], ldu, dum, &c__1, &work[ iwork], info);
 }
 else {
 /* Perform bidiagonal QR iteration, if desired, computing */
 /* left singular vectors in A and computing right singular */
 /* vectors in VT */
 /* (Workspace: need BDSPAC) */
 lapack_dbdsqr("L", m, &ncvt, &nru, &c__0, &s[1], &work[ie], &vt[ vt_offset], ldvt, &a[a_offset], lda, dum, &c__1, & work[iwork], info);
 }
 }
 }
 ...
 i__2 = minmn - 1;
 dlascl_("G", &c__0, &c__0, &bignum, &anrm, &i__2, &c__1, &work[2], &minmn, &ierr);
 }
 if (anrm < smlnum) {
 ...
 i__2 = minmn - 1;
 dlascl_("G", &c__0, &c__0, &smlnum, &anrm, &i__2, &c__1, &work[2], &minmn, &ierr);
 }
 }
