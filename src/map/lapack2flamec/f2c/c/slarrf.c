/* ../netlib/slarrf.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 ...
 /* Computing MIN */
 r__1 = w[*clstrt]; r__2 = w[*clend]; // , expr subst  
 ...
 /* Computing MAX */
 r__1 = avgap; r__2 = wgap[*clstrt]; // , expr subst  
 ldelta = max(r__1,r__2) / fact;
 /* Computing MAX */
 r__1 = avgap; r__2 = wgap[*clend - 1]; // , expr subst  
 ...
 /* Computing MAX */
 r__2 = max1; r__3 = (r__1 = dplus[i__ + 1], f2c_abs(r__1)); // , expr subst  
 max1 = max(r__2,r__3);
 /* L6: */
 }
 ...
 *sigma = lsigma;
 ...
 /* Computing MAX */
 r__2 = max2; r__3 = (r__1 = work[i__ + 1], f2c_abs(r__1)); // , expr subst  
 max2 = max(r__2,r__3);
 /* L7: */
 }
 ...
 *sigma = rsigma;
 ...
 znm2 += r__1 * r__1;
 /* Computing MAX */
 r__2 = tmp; r__3 = (r__1 = dplus[i__] * prod, f2c_abs(r__1)); // , expr subst  
 tmp = max(r__2,r__3);
 /* L15: */
 }
 ...
 *sigma = lsigma;
 ...
 znm2 += r__1 * r__1;
 /* Computing MAX */
 r__2 = tmp; r__3 = (r__1 = work[i__] * prod, f2c_abs(r__1)); // , expr subst  
 tmp = max(r__2,r__3);
 /* L16: */
 }
 ...
 *sigma = rsigma;
 ...
 /* Computing MAX */
 r__1 = lsigma - ldelta; r__2 = lsigma - ldmax; // , expr subst  
 lsigma = max(r__1,r__2);
 /* Computing MIN */
 r__1 = rsigma + rdelta; r__2 = rsigma + rdmax; // , expr subst  
