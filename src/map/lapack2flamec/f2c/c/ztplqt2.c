 ...
 *info = -9;
 ...
 i__2 = i__ * t_dim1 + 1;
 z__1.r = -t[i__2].r; z__1.i = -t[i__2].i; // , expr subst  
 ...
 i__4 = i__ + j + i__ * a_dim1;
 i__5 = *m + j * t_dim1;
 z__2.r = alpha.r * t[i__5].r - alpha.i * t[i__5].i; z__2.i = alpha.r * t[i__5].i + alpha.i * t[i__5].r; // , expr subst  
 z__1.r = a[i__4].r + z__2.r; z__1.i = a[i__4].i + z__2.i; // , expr subst  
 a[i__3].r = z__1.r; a[i__3].i = z__1.i; // , expr subst  
 }
 i__2 = *m - i__;
 z__1.r = alpha.r; z__1.i = alpha.i; // , expr subst  
 ...
 z__1.r = alpha.r * b[i__4].r - alpha.i * b[i__4].i; z__1.i = alpha.r * b[i__4].i + alpha.i * b[i__4].r; // , expr subst  
