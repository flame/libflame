/* ../netlib/v3.9.0/clahef_rk.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
;
 ...
 /* > \brief \b CLAHEF_RK computes a partial factorization of a complex Hermitian indefinite matrix using bound ed Bunch-Kaufman (rook) diagonal pivoting method. */
 /* =========== DOCUMENTATION =========== */
 /* Online html documentation available at */
 /* http://www.netlib.org/lapack/explore-html/ */
 /* > \htmlonly */
 /* > Download CLAHEF_RK + dependencies */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/clahef_ rk.f"> */
 /* > [TGZ]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/clahef_ rk.f"> */
 /* > [ZIP]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/clahef_ rk.f"> */
 /* > [TXT]</a> */
 /* > \endhtmlonly */
 /* Definition: */
 /* =========== */
 ...
 *info = 0;
 ...
 i__2 = k + k * a_dim1;
 r__1 = a[i__2].r;
 w[i__1].r = r__1; w[i__1].i = 0.f; // , expr subst  
 if (k < *n) {
 i__1 = *n - k;
 ...
 *info = k;
 ...
 i__2 = ii + k * a_dim1;
 i__3 = ii + k * a_dim1;
 q__1.r = a[i__3].r / t; q__1.i = a[i__3].i / t; // , expr subst  
 ...
 */
 ...
 q__1.r = d11.r * d22.r - d11.i * d22.i; q__1.i = d11.r * d22.i + d11.i * d22.r; // , expr subst  
 t = 1.f / (q__1.r - 1.f);
 ...
 i__4 = jj + jj * a_dim1;
 r__1 = a[i__4].r;
 a[i__3].r = r__1; a[i__3].i = 0.f; // , expr subst  
 i__3 = jj - j + 1;
 i__4 = *n - k;
 q__1.r = -1.f; q__1.i = -0.f; // , expr subst  
 ...
 */
 ...
 i__5 = jj + jj * a_dim1;
 r__1 = a[i__5].r;
 a[i__4].r = r__1; a[i__4].i = 0.f; // , expr subst  
 i__4 = j + jb - jj;
 i__5 = k - 1;
 q__1.r = -1.f; q__1.i = -0.f; // , expr subst  
