        ...
        else
        {
                    ...
                    ++j)
            {
                ...
                if (j1 == j2)
                {
                    ...
                    /* Computing MAX */
                    d__2 = xmax;
                    d__3 = (d__1 = x[j1], abs(d__1)); // , expr subst
                    xmax = max(d__2,d__3);
                }
                else
                {
                    ...
                    /* Computing MAX */
                    d__3 = (d__1 = x[j1], abs(d__1));
                    d__4 = (d__2 = x[j2], abs(d__2)); // , expr subst
                    xj = max(d__3,d__4);
                    if (xmax > 1.)
                    {
                        rec = 1. / xmax;
        ...
        if (notran)
        {
                    ...
                    --j)
            {
                ...
                if (j1 == j2)
                {
                    ...
                    if (j1 > 1)
                    {
                                ...
                                ++k)
                        {
                            /* Computing MAX */
                            d__3 = xmax;
                            d__4 = (d__1 = x[k], abs(d__1)) + ( d__2 = x[k + *n], abs(d__2)); // , expr subst
                            xmax = max(d__3,d__4);
                            /* L50: */
                        }
                    }
                ...
                else
                {
                    ...
                    /* Computing MAX */
                    d__1 = abs(v[0]) + abs(v[2]);
                    d__2 = abs(v[1]) + abs(v[3]) ; // , expr subst
                    xj = max(d__1,d__2);
                    if (xj > 1.)
                    {
                        rec = 1. / xj;
        ...
        else
        {
                    ...
                    ++j)
            {
                ...
                else
                {
                    ...
                    /* right-hand side element by inner product. */
                    /* Computing MAX */
                    d__5 = (d__1 = x[j1], abs(d__1)) + (d__2 = x[*n + j1], abs(d__2));
                    d__6 = (d__3 = x[j2], abs(d__3)) + ( d__4 = x[*n + j2], abs(d__4)); // , expr subst
                    xj = max(d__5,d__6);
                    if (xmax > 1.)
                    {
                        rec = 1. / xmax;
                    ...
                    /* Computing MAX */
                    d__5 = (d__1 = x[j1], abs(d__1)) + (d__2 = x[*n + j1], abs(d__2));
                    d__6 = (d__3 = x[j2], abs(d__3)) + ( d__4 = x[*n + j2], abs(d__4));
