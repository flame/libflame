/* ../netlib/slatps.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
if that is less than overflow, STPSV */
...
L135:
                ...
                /* Computing MAX */
                r__2 = xmax;
                r__3 = (r__1 = x[j], abs(r__1)); // , expr subst
                xmax = max(r__2,r__3);
                ++jlen;
                ip += jinc * jlen;
                /* L140: */
