/* ../netlib/csytf2.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > \brief \b CSYTF2 computes the factorization of a real symmetric indefinite matrix, using the diagonal piv oting method (unblocked algorithm). */
/* =========== DOCUMENTATION =========== */
...
int csytf2_(char *uplo, integer *n, complex *a, integer *lda, integer *ipiv, integer *info)
{
    ...
    char buffer[256];
#if FLA_ENABLE_ILP64
    snprintf(buffer, 256,"csytf2 inputs: uplo %c, n %lld, lda %lld",*uplo, *n, *lda);
#else
    snprintf(buffer, 256,"csytf2 inputs: uplo %c, n %d, lda %d",*uplo, *n, *lda);
#endif
                ...
                if (k > 2)
                {
                            ...
                            --j)
                    {
                                ...
                                --i__)
                        {
                            ...
                            q__3.i = a[i__3].r * wk.i + a[i__3].i * wk.r; // , expr subst
                            q__2.r = a[i__2].r - q__3.r;
                            q__2.i = a[i__2].i - q__3.i; // , expr subst
                            i__4 = i__ + (k - 1) * a_dim1;
                            q__4.r = a[i__4].r * wkm1.r - a[i__4].i * wkm1.i;
                            q__4.i = a[i__4].r * wkm1.i + a[i__4].i * wkm1.r; // , expr subst
                ...
                if (k < *n - 1)
                {
                            ...
                            ++j)
                    {
                                ...
                                ++i__)
                        {
                            ...
                            q__3.i = a[i__5].r * wk.i + a[i__5].i * wk.r; // , expr subst
                            q__2.r = a[i__4].r - q__3.r;
                            q__2.i = a[i__4].i - q__3.i; // , expr subst
                            i__6 = i__ + (k + 1) * a_dim1;
                            q__4.r = a[i__6].r * wkp1.r - a[i__6].i * wkp1.i;
                            q__4.i = a[i__6].r * wkp1.i + a[i__6].i * wkp1.r; // , expr subst
                            q__1.r = q__2.r - q__4.r;
                            q__1.i = q__2.i - q__4.i; // , expr subst
                            a[i__3].r = q__1.r;
