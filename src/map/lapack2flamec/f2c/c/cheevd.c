/* ../netlib/v3.9.0/cheevd.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 /* > \brief <b> CHEEVD computes the eigenvalues and, optionally, the left and/or right eigenvectors for HE mat rices</b> */
 /* =========== DOCUMENTATION =========== */
 ...
 */
 ...
 extern /* Subroutine */
 int chetrd_(char *, integer *, complex *, integer *, real *, real *, complex *, complex *, integer *, integer *), clacpy_(char *, integer *, integer *, complex *, integer *, complex *, integer *);
 real safmin;
 ...
 *info = -5;
 ...
 /* Computing MAX */
 i__1 = lwmin; i__2 = *n + ilaenv_(&c__1, "CHETRD", uplo, n, &c_n1, &c_n1, &c_n1); // , expr subst  
 lopt = max(i__1,i__2);
 lropt = lrwmin;
 liopt = liwmin;
 }
 work[1].r = (real) lopt; work[1].i = 0.f; // , expr subst  
 rwork[1] = (real) lropt;
 iwork[1] = liopt;
