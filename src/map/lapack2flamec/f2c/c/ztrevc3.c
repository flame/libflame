        ...
        */
                ...
                ++ki)
        {
                    ...
                    ++k)
            {
                ...
                i__5 = k + k * t_dim1;
                i__6 = ki + ki * t_dim1;
                z__1.r = t[i__5].r - t[i__6].r;
                z__1.i = t[i__5].i - t[i__6] .i; // , expr subst
                t[i__4].r = z__1.r;
