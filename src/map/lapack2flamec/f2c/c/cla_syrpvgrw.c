/* ../netlib/cla_syrpvgrw.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cla_syr pvgrw.f"> */
 /* > [TGZ]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cla_syr pvgrw.f"> */
 /* > [ZIP]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cla_syr pvgrw.f"> */
 /* > [TXT]</a> */
 /* > \endhtmlonly */
 /* Definition: */
 /* =========== */
 ...
 */
 ...
 /* Computing MAX */
 i__3 = i__ + j * a_dim1;
 r__3 = (r__1 = a[i__3].r, f2c_abs(r__1)) + (r__2 = r_imag(&a[i__ + j * a_dim1]), f2c_abs(r__2)); r__4 = work[*n + i__]; // , expr subst  
 work[*n + i__] = max(r__3,r__4);
 /* Computing MAX */
 i__3 = i__ + j * a_dim1;
 r__3 = (r__1 = a[i__3].r, f2c_abs(r__1)) + (r__2 = r_imag(&a[i__ + j * a_dim1]), f2c_abs(r__2)); r__4 = work[*n + j]; // , expr subst  
 ...
 /* Computing MAX */
 i__2 = i__ + k * af_dim1;
 r__3 = (r__1 = af[i__2].r, f2c_abs(r__1)) + (r__2 = r_imag(& af[i__ + k * af_dim1]), f2c_abs(r__2)); r__4 = work[k] ; // , expr subst  
 ...
 r__3 = (r__1 = af[i__2].r, f2c_abs(r__1)) + (r__2 = r_imag(& af[i__ + (k - 1) * af_dim1]), f2c_abs(r__2)); r__4 = work[k - 1]; // , expr subst  
 work[k - 1] = max(r__3,r__4);
 }
 /* Computing MAX */
 i__1 = k + k * af_dim1;
 r__3 = (r__1 = af[i__1].r, f2c_abs(r__1)) + (r__2 = r_imag(&af[k + k * af_dim1]), f2c_abs(r__2)); r__4 = work[k]; // , expr subst  
 work[k] = max(r__3,r__4);
 k += -2;
 }
 }
