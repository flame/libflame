 ...
 *info = 0;
 ...
 i__3 = k + (k - 1) * h_dim1;
 i__4 = k - 1 + k * h_dim1;
 r__5 = (r__1 = h__[i__3].r, f2c_abs(r__1)) + (r__2 = r_imag(&h__[ k + (k - 1) * h_dim1]), f2c_abs(r__2)); r__6 = (r__3 = h__[i__4].r, f2c_abs(r__3)) + (r__4 = r_imag(&h__[k - 1 + k * h_dim1]), f2c_abs(r__4)); // , expr subst  
 ab = max(r__5,r__6);
 /* Computing MIN */
 i__3 = k + (k - 1) * h_dim1;
 i__4 = k - 1 + k * h_dim1;
 ...
 /* Computing MAX */
 i__5 = k + k * h_dim1;
 r__5 = (r__1 = h__[i__5].r, f2c_abs(r__1)) + (r__2 = r_imag(&h__[ k + k * h_dim1]), f2c_abs(r__2)); r__6 = (r__3 = q__1.r, f2c_abs(r__3)) + (r__4 = r_imag(&q__1), f2c_abs(r__4)); // , expr subst  
 aa = max(r__5,r__6);
 i__3 = k - 1 + (k - 1) * h_dim1;
 i__4 = k + k * h_dim1;
 q__2.r = h__[i__3].r - h__[i__4].r; q__2.i = h__[i__3].i - h__[i__4].i; // , expr subst  
 ...
 /* Computing MAX */
 r__3 = s; r__4 = (r__1 = x.r, f2c_abs(r__1)) + (r__2 = r_imag(&x), f2c_abs(r__2)); // , expr subst  
 s = max(r__3,r__4);
