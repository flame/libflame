...
TLS_CLASS_SPEC fla_qr2ut_t*       fla_qr2ut_cntl_unb = NULL;
TLS_CLASS_SPEC fla_qr2ut_t*       fla_qr2ut_cntl_leaf = NULL;
TLS_CLASS_SPEC fla_blocksize_t*   fla_qr2ut_var1_bsize = NULL;
