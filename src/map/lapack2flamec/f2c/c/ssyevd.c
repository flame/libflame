/* ../netlib/v3.9.0/ssyevd.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 /* > \brief <b> SSYEVD computes the eigenvalues and, optionally, the left and/or right eigenvectors for SY mat rices</b> */
 /* =========== DOCUMENTATION =========== */
 ...
 *info = -5;
 ...
 /* Computing MAX */
 i__1 = lwmin; i__2 = (*n << 1) + ilaenv_(&c__1, "SSYTRD", uplo, n, &c_n1, &c_n1, &c_n1); // , expr subst  
 lopt = max(i__1,i__2);
 liopt = liwmin;
 }
 work[1] = (real) lopt;
