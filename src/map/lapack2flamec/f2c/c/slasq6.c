/* ../netlib/v3.9.0/slasq6.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *dmin__ = min(*dmin__,d__);
 /* Computing MIN */
 r__1 = emin; r__2 = z__[j4]; // , expr subst  
 emin = min(r__1,r__2);
 /* L10: */
 }
 }
 ...
 *dmin__ = min(*dmin__,d__);
 /* Computing MIN */
 r__1 = emin; r__2 = z__[j4 - 1]; // , expr subst  
 emin = min(r__1,r__2);
 /* L20: */
 }
 }
