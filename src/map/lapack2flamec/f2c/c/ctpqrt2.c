/* ../netlib/ctpqrt2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
;
 ...
 char buffer[256]; 
#if FLA_ENABLE_ILP64 
 snprintf(buffer, 256,"ctpqrt2 inputs: m %lld, n %lld, l %lld, lda %lld, ldb %lld, ldt %lld",*m, *n, *l, *lda, *ldb, *ldt);
#else 
 snprintf(buffer, 256,"ctpqrt2 inputs: m %d, n %d, l %d, lda %d, ldb %d, ldt %d",*m, *n, *l, *lda, *ldb, *ldt);
#endif
 ...
 *info = -9;
 ...
 q__2.r = alpha.r * q__3.r - alpha.i * q__3.i; q__2.i = alpha.r * q__3.i + alpha.i * q__3.r; // , expr subst  
 q__1.r = a[i__4].r + q__2.r; q__1.i = a[i__4].i + q__2.i; // , expr subst  
 ...
 i__2 = i__ + t_dim1;
 q__1.r = -t[i__2].r; q__1.i = -t[i__2].i; // , expr subst  
 alpha.r = q__1.r; alpha.i = q__1.i; // , expr subst  
 i__2 = i__ - 1;
 for (j = 1;
 j <= i__2;
 ...
 q__1.r = alpha.r * b[i__4].r - alpha.i * b[i__4].i; q__1.i = alpha.r * b[i__4].i + alpha.i * b[i__4].r; // , expr subst  
 t[i__3].r = q__1.r; t[i__3].i = q__1.i; // , expr subst  
 }
 ...
 i__2 = i__ + i__ * t_dim1;
 i__3 = i__ + t_dim1;
 t[i__2].r = t[i__3].r; t[i__2].i = t[i__3].i; // , expr subst  
 i__2 = i__ + t_dim1;
