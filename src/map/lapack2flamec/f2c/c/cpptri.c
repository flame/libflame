/* ../netlib/cpptri.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int cpptri_(char *uplo, integer *n, complex *ap, integer * info)
{
    ...
    logical upper;
    extern /* Subroutine */
    int csscal_(integer *, real *, complex *, integer *), xerbla_(char *, integer *), ctptri_(char *, char *, integer *, complex *, integer *);
    ...
    *info = 0;
    ...
    else
    {
                ...
                ++j)
        {
            ...
            {
                i__2 = *n - j;
                ctpmv_("Lower", "Conjugate transpose", "Non-unit", &i__2, &ap[ jjn], &ap[jj + 1], &c__1);
            }
            jj = jjn;
            /* L20: */
        }
