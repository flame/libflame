/* ../netlib/zlanhf.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 on Linux or Unix systems, link with .../path/to/libf2c.a -lm or, if you install libf2c.a in a standard place, with -lf2c -lm -- in that order, at the end of the command line, as in cc *.o -lf2c -lm Source for libf2c is in /netlib/f2c/libf2c.zip, e.g., http://www.netlib.org/f2c/libf2c.zip */
#include "FLA_f2c.h" /* Table of constant values */
static integer c__1 = 1;
/* > \brief \b ZLANHF returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the ele ment of largest absolute value of a Hermitian matrix in RFP format. */
/* =========== DOCUMENTATION =========== */
...
/* > \verbatim */
/* > */
/* > ZLANHF = ( max(f2c_dabs(A(i,j))), NORM = 'M' or 'm' */
/* > ( */
        ...
        if (noe == 1)
        {
            ...
            if (ifm == 1)
            {
                ...
                if (ilu == 1)
                {
                    ...
                    /* -> L(0,0) */
                    i__1 = j + j * lda;
                    temp = (d__1 = a[i__1].r, f2c_dabs(d__1));
                            ...
                            ++j)
                    {
                        ...
                        /* L(k+j,k+j) */
                        i__2 = i__ + j * lda;
                        temp = (d__1 = a[i__2].r, f2c_dabs(d__1));
                        if (value < temp || disnan_(&temp))
                        {
                            value = temp;
                        }
            ...
            if (noe == 1)
            {
                ...
                if (ilu == 0)
                {
                            ...
                            ++j)
                    {
                        ...
                        i__2 = i__ + j * lda;
                        aa = (d__1 = a[i__2].r, f2c_dabs(d__1));
                        /* -> A(j+k,j+k) */
                        work[j + k] = s + aa;
                        if (i__ == k + k)
                        {
...
L10:
                ...
                else
                {
                            ...
                            --j)
                    {
                        ...
                        {
                            i__1 = i__ + j * lda;
                            aa = (d__1 = a[i__1].r, f2c_dabs(d__1));
                            /* -> A(j+k,j+k) */
                            s += aa;
                            work[i__ + k] += s;
                            /* i=j */
