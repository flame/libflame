/* dorgqr.f -- translated by f2c (version 20000121). You must link the resulting object file with the libraries: -lf2c -lm (in that order) */
/*
...
#include "FLAME.h"
 ...
 /* ===================================================================== */
 /* Subroutine */
 int lapack_dorgqr(integer *m, integer *n, integer *k, doublereal * a, integer *lda, doublereal *tau, doublereal *work, integer *lwork, integer *info) {
 /* System generated locals */
 integer a_dim1, a_offset, i__1, i__2, i__3;
 /* Local variables */
 integer i__, j, l, nbmin, iinfo;
 extern /* Subroutine */
 int lapack_dorg2r(integer *, integer *, integer *, doublereal *, integer *, doublereal *, doublereal *, integer *);
 integer ib, nb, ki, kk;
 extern /* Subroutine */
 ...
 *info = -8;
 ...
 i__2 = *n - kk;
 i__3 = *k - kk;
 lapack_dorg2r(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, & tau[kk + 1], &work[1], &iinfo);
 }
 if (kk > 0) {
 /* Use blocked code */
 i__1 = -nb;
 ...
 i__2 = *m - i__ + 1;
 lapack_dorg2r(&i__2, &ib, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], & work[1], &iinfo);
