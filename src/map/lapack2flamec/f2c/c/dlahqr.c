/* ../netlib/v3.9.0/dlahqr.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 ...
 /* Computing MAX */
 d__3 = (d__1 = h__[k + (k - 1) * h_dim1], abs(d__1)); d__4 = ( d__2 = h__[k - 1 + k * h_dim1], abs(d__2)); // , expr subst  
 ab = max(d__3,d__4);
 /* Computing MIN */
 d__3 = (d__1 = h__[k + (k - 1) * h_dim1], abs(d__1)); d__4 = ( d__2 = h__[k - 1 + k * h_dim1], abs(d__2)); // , expr subst  
 ba = min(d__3,d__4);
 /* Computing MAX */
 d__3 = (d__1 = h__[k + k * h_dim1], abs(d__1)); d__4 = (d__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], abs(d__2)); // , expr subst  
 aa = max(d__3,d__4);
 /* Computing MIN */
 d__3 = (d__1 = h__[k + k * h_dim1], abs(d__1)); d__4 = (d__2 = h__[k - 1 + (k - 1) * h_dim1] - h__[k + k * h_dim1], abs(d__2)); // , expr subst  
 bb = min(d__3,d__4);
 ...
 /* Computing MIN */
 i__3 = 3; i__4 = i__ - k + 1; // , expr subst  
 nr = min(i__3,i__4);
 if (k > m) {
