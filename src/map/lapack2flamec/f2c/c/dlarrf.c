...
L5:
            ...
            ++i__)
    {
        ...
        /* Computing MAX */
        d__2 = max1;
        d__3 = (d__1 = dplus[i__ + 1], abs(d__1)); // , expr subst
        max1 = max(d__2,d__3);
        /* L6: */
    }
            ...
            ++i__)
    {
        ...
        /* Computing MAX */
        d__2 = max2;
        d__3 = (d__1 = work[i__ + 1], abs(d__1)); // , expr subst
        max2 = max(d__2,d__3);
        /* L7: */
    }
    ...
    if (tryrrr1 && dorrr1)
    {
        if (indx == 1)
        {
                    ...
                    --i__)
            {
                ...
                /* Computing MAX */
                d__2 = tmp;
                d__3 = (d__1 = dplus[i__] * prod, abs(d__1)); // , expr subst
                tmp = max(d__2,d__3);
                /* L15: */
            }
        ...
        else if (indx == 2)
        {
                    ...
                    --i__)
            {
                ...
                /* Computing MAX */
                d__2 = tmp;
                d__3 = (d__1 = work[i__] * prod, abs(d__1)); // , expr subst
                tmp = max(d__2,d__3);
                /* L16: */
            }
