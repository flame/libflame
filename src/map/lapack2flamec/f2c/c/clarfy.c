...
;
 ...
 q__3.r = -.5f; q__3.i = -0.f; // , expr subst  
 q__2.r = q__3.r * tau->r - q__3.i * tau->i; q__2.i = q__3.r * tau->i + q__3.i * tau->r; // , expr subst  
 cdotc_f2c_(&q__4, n, &work[1], &c__1, &v[1], incv);
 q__1.r = q__2.r * q__4.r - q__2.i * q__4.i; q__1.i = q__2.r * q__4.i + q__2.i * q__4.r; // , expr subst  
