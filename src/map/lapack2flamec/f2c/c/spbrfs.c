        ...
        if (upper)
        {
                    ...
                    ++k)
            {
                ...
                for (i__ = max(i__3,i__4);
                        ...
                        ++i__)
                {
                    work[i__] += (r__1 = ab[l + i__ + k * ab_dim1], abs(r__1)) * xk;
                    s += (r__1 = ab[l + i__ + k * ab_dim1], abs(r__1)) * ( r__2 = x[i__ + j * x_dim1], abs(r__2));
                    /* L40: */
                }
                work[k] = work[k] + (r__1 = ab[*kd + 1 + k * ab_dim1], abs( r__1)) * xk + s;
                /* L50: */
            }
        }
        else
