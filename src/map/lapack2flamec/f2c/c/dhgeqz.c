...
L200:
        ...
        else
        {
                    ...
                    ++j)
            {
                ...
                ilpivt = FALSE_;
                /* Computing MAX */
                d__3 = (d__1 = t[j + 1 + (j + 1) * t_dim1], abs(d__1));
                d__4 = (d__2 = t[j + 1 + (j + 2) * t_dim1], abs(d__2)); // , expr subst
                temp = max(d__3,d__4);
                /* Computing MAX */
                d__3 = (d__1 = t[j + 2 + (j + 1) * t_dim1], abs(d__1));
                d__4 = (d__2 = t[j + 2 + (j + 2) * t_dim1], abs(d__2)); // , expr subst
                temp2 = max(d__3,d__4);
                ...
                if (abs(w11) < abs(u1))
                {
                    /* Computing MIN */
                    d__2 = scale;
                    d__3 = (d__1 = w11 / u1, abs(d__1)); // , expr subst
                    scale = min(d__2,d__3);
                }
                /* Solve */
                u2 = scale * u2 / w22;
