/* ../netlib/chpsv.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int chpsv_(char *uplo, integer *n, integer *nrhs, complex * ap, integer *ipiv, complex *b, integer *ldb, integer *info)
{
    ...
    char buffer[256]; 
    snprintf(buffer, 256,"chpsv inputs: uplo %c, n %d, nrhs %d, ldb %d\n",*uplo, *n, *nrhs, *ldb);
    ...
    extern /* Subroutine */
    int xerbla_(char *, integer *), chptrf_( char *, integer *, complex *, integer *, integer *), chptrs_(char *, integer *, integer *, complex *, integer *, complex *, integer *, integer *);
