...
FLA_Error FLA_Apply_pivots_check_ts( FLA_cntl_init_s *FLA_cntl_init_i, FLA_Side side, FLA_Trans trans, FLA_Obj p, FLA_Obj A )
{
  FLA_Error    e_val;
  ...
  e_val = FLA_Check_nonconstant_object_ts( FLA_cntl_init_i, p );
  FLA_Check_error_code( e_val );
