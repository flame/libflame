 ...
 *info = -25;
 ...
 i__2 = i__;
 i__3 = i__;
 z__1.r = alpha[i__3].r / scale; z__1.i = alpha[i__3].i / scale; // , expr subst  
 alpha[i__2].r = z__1.r; alpha[i__2].i = z__1.i; // , expr subst  
 i__2 = i__;
 i__3 = i__;
 z__1.r = beta[i__3].r / scale; z__1.i = beta[i__3].i / scale; // , expr subst  
 beta[i__2].r = z__1.r; beta[i__2].i = z__1.i; // , expr subst  
 }
 i__2 = i__;
 i__3 = *ilo + *ilo * a_dim1;
 z__2.r = beta[i__2].r * a[i__3].r - beta[i__2].i * a[i__3].i; z__2.i = beta[i__2].r * a[i__3].i + beta[i__2].i * a[i__3].r; // , expr subst  
 i__4 = i__;
 i__5 = *ilo + *ilo * b_dim1;
 z__3.r = alpha[i__4].r * b[i__5].r - alpha[i__4].i * b[i__5].i; z__3.i = alpha[i__4].r * b[i__5].i + alpha[i__4].i * b[i__5] .r; // , expr subst  
 z__1.r = z__2.r - z__3.r; z__1.i = z__2.i - z__3.i; // , expr subst  
 temp2.r = z__1.r; temp2.i = z__1.i; // , expr subst  
 i__2 = i__;
 i__3 = *ilo + 1 + *ilo * a_dim1;
 z__1.r = beta[i__2].r * a[i__3].r - beta[i__2].i * a[i__3].i; z__1.i = beta[i__2].r * a[i__3].i + beta[i__2].i * a[i__3].r; // , expr subst  
 temp3.r = z__1.r; temp3.i = z__1.i; // , expr subst  
 if (z_abs(&temp2) > safmax || z_abs(&temp3) > safmax) {
 temp2.r = 1.; temp2.i = 0.; // , expr subst  
 temp3.r = 0.; temp3.i = 0.; // , expr subst  
 }
