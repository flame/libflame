/* ../netlib/v3.9.0/zhgeqz.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -18;
 ...
 /* Computing MAX */
 d__1 = safmin; d__2 = ulp * anorm; // , expr subst  
 atol = max(d__1,d__2);
 /* Computing MAX */
 d__1 = safmin; d__2 = ulp * bnorm; // , expr subst  
 btol = max(d__1,d__2);
 ...
 if (absb > safmin) {
 i__2 = j + j * t_dim1;
 z__2.r = t[i__2].r / absb; z__2.i = t[i__2].i / absb; // , expr subst  
 d_cnjg(&z__1, &z__2);
 signbc.r = z__1.r; signbc.i = z__1.i; // , expr subst  
 i__2 = j + j * t_dim1;
 t[i__2].r = absb; t[i__2].i = 0.; // , expr subst  
 if (ilschr) {
 i__2 = j - 1;
 ...
 */
 ...
 h__[i__4].r = 0.; h__[i__4].i = 0.; // , expr subst  
 i__4 = ilastm - jch;
 ...
 z__1.r = c__ * h__[i__5].r; z__1.i = c__ * h__[ i__5].i; // , expr subst  
 ...
 i__4 = jch + 1 + (jch + 1) * t_dim1;
 t[i__4].r = 0.; t[i__4].i = 0.; // , expr subst  
 /* L20: */
 }
 goto L50;
 }
 ...
 *info = (*n << 1) + 1;
 ...
 L60: absb = z_abs(&t[ilast + ilast * t_dim1]);
 if (absb > safmin) {
 i__2 = ilast + ilast * t_dim1;
 z__2.r = t[i__2].r / absb; z__2.i = t[i__2].i / absb; // , expr subst  
 d_cnjg(&z__1, &z__2);
 ...
 z__2.r = bscale * t[i__2].r; z__2.i = bscale * t[i__2].i; // , expr subst  
 i__3 = ilast + ilast * t_dim1;
 z__3.r = bscale * t[i__3].r; z__3.i = bscale * t[i__3].i; // , expr subst  
 z_div(&z__1, &z__2, &z__3);
 u12.r = z__1.r; u12.i = z__1.i; // , expr subst  
 i__2 = ilast - 1 + (ilast - 1) * h_dim1;
 z__2.r = ascale * h__[i__2].r; z__2.i = ascale * h__[i__2].i; // , expr subst  
 i__3 = ilast - 1 + (ilast - 1) * t_dim1;
 z__3.r = bscale * t[i__3].r; z__3.i = bscale * t[i__3].i; // , expr subst  
 z_div(&z__1, &z__2, &z__3);
 ad11.r = z__1.r; ad11.i = z__1.i; // , expr subst  
 i__2 = ilast + (ilast - 1) * h_dim1;
 z__2.r = ascale * h__[i__2].r; z__2.i = ascale * h__[i__2].i; // , expr subst  
 i__3 = ilast - 1 + (ilast - 1) * t_dim1;
 z__3.r = bscale * t[i__3].r; z__3.i = bscale * t[i__3].i; // , expr subst  
 z_div(&z__1, &z__2, &z__3);
 ad21.r = z__1.r; ad21.i = z__1.i; // , expr subst  
 i__2 = ilast - 1 + ilast * h_dim1;
 z__2.r = ascale * h__[i__2].r; z__2.i = ascale * h__[i__2].i; // , expr subst  
 i__3 = ilast + ilast * t_dim1;
 z__3.r = bscale * t[i__3].r; z__3.i = bscale * t[i__3].i; // , expr subst  
 z_div(&z__1, &z__2, &z__3);
 ad12.r = z__1.r; ad12.i = z__1.i; // , expr subst  
 i__2 = ilast + ilast * h_dim1;
 z__2.r = ascale * h__[i__2].r; z__2.i = ascale * h__[i__2].i; // , expr subst  
 i__3 = ilast + ilast * t_dim1;
 z__3.r = bscale * t[i__3].r; z__3.i = bscale * t[i__3].i; // , expr subst  
 z_div(&z__1, &z__2, &z__3);
 ad22.r = z__1.r; ad22.i = z__1.i; // , expr subst  
 ...
 istart = j;
 i__3 = j + j * h_dim1;
 z__2.r = ascale * h__[i__3].r; z__2.i = ascale * h__[i__3].i; // , expr subst  
 i__4 = j + j * t_dim1;
 z__4.r = bscale * t[i__4].r; z__4.i = bscale * t[i__4].i; // , expr subst  
 z__3.r = shift.r * z__4.r - shift.i * z__4.i; z__3.i = shift.r * z__4.i + shift.i * z__4.r; // , expr subst  
 ...
 z__1.r = ascale * h__[i__2].r; z__1.i = ascale * h__[i__2].i; // , expr subst  
 ctemp2.r = z__1.r; ctemp2.i = z__1.i; // , expr subst  
 ...
 ++jc) {
 i__4 = j + jc * h_dim1;
 z__2.r = c__ * h__[i__4].r; z__2.i = c__ * h__[i__4].i; // , expr subst  
 i__5 = j + 1 + jc * h_dim1;
 z__3.r = s.r * h__[i__5].r - s.i * h__[i__5].i; z__3.i = s.r * h__[i__5].i + s.i * h__[i__5].r; // , expr subst  
 z__1.r = z__2.r + z__3.r; z__1.i = z__2.i + z__3.i; // , expr subst  
 ctemp.r = z__1.r; ctemp.i = z__1.i; // , expr subst  
 i__4 = j + 1 + jc * h_dim1;
 d_cnjg(&z__4, &s);
 ...
 i__5 = j + jc * h_dim1;
 z__2.r = z__3.r * h__[i__5].r - z__3.i * h__[i__5].i; z__2.i = z__3.r * h__[i__5].i + z__3.i * h__[i__5].r; // , expr subst  
 i__6 = j + 1 + jc * h_dim1;
 z__5.r = c__ * h__[i__6].r; z__5.i = c__ * h__[i__6].i; // , expr subst  
 z__1.r = z__2.r + z__5.r; z__1.i = z__2.i + z__5.i; // , expr subst  
 h__[i__4].r = z__1.r; h__[i__4].i = z__1.i; // , expr subst  
 i__4 = j + jc * h_dim1;
 h__[i__4].r = ctemp.r; h__[i__4].i = ctemp.i; // , expr subst  
 i__4 = j + jc * t_dim1;
 z__2.r = c__ * t[i__4].r; z__2.i = c__ * t[i__4].i; // , expr subst  
 i__5 = j + 1 + jc * t_dim1;
 z__3.r = s.r * t[i__5].r - s.i * t[i__5].i; z__3.i = s.r * t[ i__5].i + s.i * t[i__5].r; // , expr subst  
 z__1.r = z__2.r + z__3.r; z__1.i = z__2.i + z__3.i; // , expr subst  
 ctemp2.r = z__1.r; ctemp2.i = z__1.i; // , expr subst  
 i__4 = j + 1 + jc * t_dim1;
 d_cnjg(&z__4, &s);
 z__3.r = -z__4.r; z__3.i = -z__4.i; // , expr subst  
 i__5 = j + jc * t_dim1;
 z__2.r = z__3.r * t[i__5].r - z__3.i * t[i__5].i; z__2.i = z__3.r * t[i__5].i + z__3.i * t[i__5].r; // , expr subst  
 i__6 = j + 1 + jc * t_dim1;
 z__5.r = c__ * t[i__6].r; z__5.i = c__ * t[i__6].i; // , expr subst  
 z__1.r = z__2.r + z__5.r; z__1.i = z__2.i + z__5.i; // , expr subst  
 ...
 ++jr) {
 i__4 = jr + j * q_dim1;
 z__2.r = c__ * q[i__4].r; z__2.i = c__ * q[i__4].i; // , expr subst  
 d_cnjg(&z__4, &s);
 i__5 = jr + (j + 1) * q_dim1;
 z__3.r = z__4.r * q[i__5].r - z__4.i * q[i__5].i; z__3.i = z__4.r * q[i__5].i + z__4.i * q[i__5].r; // , expr subst  
 z__1.r = z__2.r + z__3.r; z__1.i = z__2.i + z__3.i; // , expr subst  
 ctemp.r = z__1.r; ctemp.i = z__1.i; // , expr subst  
 i__4 = jr + (j + 1) * q_dim1;
 z__3.r = -s.r; z__3.i = -s.i; // , expr subst  
 i__5 = jr + j * q_dim1;
 z__2.r = z__3.r * q[i__5].r - z__3.i * q[i__5].i; z__2.i = z__3.r * q[i__5].i + z__3.i * q[i__5].r; // , expr subst  
 i__6 = jr + (j + 1) * q_dim1;
 z__4.r = c__ * q[i__6].r; z__4.i = c__ * q[i__6].i; // , expr subst  
 z__1.r = z__2.r + z__4.r; z__1.i = z__2.i + z__4.i; // , expr subst  
 q[i__4].r = z__1.r; q[i__4].i = z__1.i; // , expr subst  
 i__4 = jr + j * q_dim1;
 ...
 ++jr) {
 i__4 = jr + (j + 1) * z_dim1;
 z__2.r = c__ * z__[i__4].r; z__2.i = c__ * z__[i__4].i; // , expr subst  
 i__5 = jr + j * z_dim1;
 z__3.r = s.r * z__[i__5].r - s.i * z__[i__5].i; z__3.i = s.r * z__[i__5].i + s.i * z__[i__5].r; // , expr subst  
 z__1.r = z__2.r + z__3.r; z__1.i = z__2.i + z__3.i; // , expr subst  
 ctemp.r = z__1.r; ctemp.i = z__1.i; // , expr subst  
 i__4 = jr + j * z_dim1;
 d_cnjg(&z__4, &s);
 z__3.r = -z__4.r; z__3.i = -z__4.i; // , expr subst  
 i__5 = jr + (j + 1) * z_dim1;
 z__2.r = z__3.r * z__[i__5].r - z__3.i * z__[i__5].i; z__2.i = z__3.r * z__[i__5].i + z__3.i * z__[i__5] .r; // , expr subst  
 i__6 = jr + j * z_dim1;
 z__5.r = c__ * z__[i__6].r; z__5.i = c__ * z__[i__6].i; // , expr subst  
 z__1.r = z__2.r + z__5.r; z__1.i = z__2.i + z__5.i; // , expr subst  
 ...
 *info = 0;
 ...
 L210: z__1.r = (doublereal) (*n); z__1.i = 0.; // , expr subst  
