 ...
 *info = 0;
 ...
 work[1].r = (real) lworkreq; work[1].i = 0.f; // , expr subst  
 return 0;
 }
 ...
 *nd = 0;
 /* Computing MAX */
 r__1 = smlnum; r__2 = ulp * c_abs(&a[kwtop + kwtop * a_dim1]); // , expr subst  
 ...
 *ns = jw - qz_small_info__;
 ...
 q__1.r = s.r * qc[i__1].r - s.i * qc[i__1].i; q__1.i = s.r * qc[ i__1].i + s.i * qc[i__1].r; // , expr subst  
 /* Computing MAX */
 r__1 = ulp * tempr;
 ...
 *ns = jw - *nd;
 ...
 q__1.r = a[i__4].r * q__2.r - a[i__4].i * q__2.i; q__1.i = a[ i__4].r * q__2.i + a[i__4].i * q__2.r; // , expr subst  
