 ...
 *info = -17;
 ...
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *n * (*n + 5) + (*n << 1) * ilaenv_( &c__1, "DGEBRD", " ", n, n, &c_n1, &c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 if (wantu) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *n * (*n * 3 + 6) + *n * ilaenv_(&c__1, "DORMQR", " ", n, n, &c_n1, & c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 if (wantvt) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *n * (*n * 3 + 6) + *n * ilaenv_(&c__1, "DORMLQ", " ", n, n, &c_n1, & c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 minwrk = *n * (*n * 3 + 20);
 }
 ...
 if (wantu) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *n * ((*n << 1) + 5) + *n * ilaenv_(&c__1, "DORMQR", " ", n, n, &c_n1, & c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 if (wantvt) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *n * ((*n << 1) + 5) + *n * ilaenv_(&c__1, "DORMLQ", " ", n, n, &c_n1, & c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 /* Computing MAX */
 ...
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *m * (*m + 5) + (*m << 1) * ilaenv_( &c__1, "DGEBRD", " ", m, m, &c_n1, &c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 if (wantu) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *m * (*m * 3 + 6) + *m * ilaenv_(&c__1, "DORMQR", " ", m, m, &c_n1, & c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 if (wantvt) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *m * (*m * 3 + 6) + *m * ilaenv_(&c__1, "DORMLQ", " ", m, m, &c_n1, & c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 minwrk = *m * (*m * 3 + 20);
 }
 ...
 if (wantu) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *m * ((*m << 1) + 5) + *m * ilaenv_(&c__1, "DORMQR", " ", m, m, &c_n1, & c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 if (wantvt) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *m * ((*m << 1) + 5) + *m * ilaenv_(&c__1, "DORMLQ", " ", m, m, &c_n1, & c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 /* Computing MAX */
