 ...
 *info = -17;
 ...
 if (conda) {
 /* Computing MAX */
 i__1 = *n + lwrk_sgeqp3__; i__2 = *n + lwcon; i__1 = max( i__1,i__2); // ; expr subst  
 optwrk = max(i__1,lwrk_sgesvd__);
 }
 else {
 /* Computing MAX */
 ...
 if (conda) {
 /* Computing MAX */
 i__1 = max(lwrk_sgeqp3__,lwcon); i__1 = max(i__1, lwrk_sgesvd__); // , expr subst  
 optwrk = *n + max(i__1,lwrk_sormqr__);
 }
 else {
 /* Computing MAX */
 i__1 = max(lwrk_sgeqp3__,lwrk_sgesvd__);
 optwrk = *n + max(i__1,lwrk_sormqr__);
 }
 }
 }
 ...
 if (conda) {
 /* Computing MAX */
 i__1 = max(lwrk_sgeqp3__,lwcon);
 optwrk = *n + max(i__1,lwrk_sgesvd__);
 }
 else {
 optwrk = *n + max(lwrk_sgeqp3__,lwrk_sgesvd__);
 }
 }
 }
 else {
 ...
 /* Computing MAX */
 i__1 = lwrk_sgeqp3__, i__2 = *n / 2 + lwrk_sgeqrf__, i__1 = max(i__1,i__2), i__2 = *n / 2 + lwrk_sgesvd2__; i__1 = max(i__1,i__2); i__2 = *n / 2 + lwrk_sormqr2__; // ; expr subst  
 ...
 /* Computing MAX */
 i__1 = lwrk_sgeqp3__, i__2 = *n / 2 + lwrk_sgelqf__, i__1 = max(i__1,i__2), i__2 = *n / 2 + lwrk_sgesvd2__; i__1 = max(i__1,i__2); i__2 = *n / 2 + lwrk_sormlq__; // ; expr subst  
 optwrk2 = max(i__1,i__2);
 if (conda) {
 optwrk2 = max(optwrk2,lwcon);
 }
