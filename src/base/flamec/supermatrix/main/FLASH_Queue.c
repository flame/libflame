...
----------------------------------------------------------------------------*/
{
   ...
   if ( FLA_cntl_init_i->flash_queue_stack == 0 )
   {
      // Save the starting time for the total execution time.
      FLA_cntl_init_i->flash_queue_total_time = FLA_Clock();
   }
#endif

   // Push onto the stack.
   FLA_cntl_init_i->flash_queue_stack++;
...
----------------------------------------------------------------------------*/
{
   ...
   if ( FLA_cntl_init_i->flash_queue_stack == 0 )
   {
      ...
      FLA_cntl_init_i->flash_queue_total_time = FLA_Clock() - FLA_cntl_init_i->flash_queue_total_time;
   }
#endif
...
----------------------------------------------------------------------------*/
{
   return FLA_cntl_init_i->flash_queue_stack;
}
...
----------------------------------------------------------------------------*/
{
   ...
   if ( FLA_cntl_init_i->flash_queue_stack == 0 )
   {
      ...
      FLA_cntl_init_i->flash_queue_enabled = TRUE;   
      return FLA_SUCCESS;
   }
   else
   {
...
----------------------------------------------------------------------------*/
{
   ...
   if ( FLA_cntl_init_i->flash_queue_stack == 0 )
   {
      ...
      FLA_cntl_init_i->flash_queue_enabled = FALSE;   
      return FLA_SUCCESS;      
   }
   else
   {
...
#ifdef FLA_ENABLE_SUPERMATRIX
   return FLA_cntl_init_i->flash_queue_enabled;
#else
   return FALSE;
#endif
}
...
----------------------------------------------------------------------------*/
{
   ...
   FLA_cntl_init_i->flash_queue_n_threads = n_threads;
...
----------------------------------------------------------------------------*/
{
   return FLA_cntl_init_i->flash_queue_n_threads;
}
#endif /* FLA_ENABLE_THREAD_SAFE_INTERFACES */
