...
extern TLS_CLASS_SPEC fla_gemm_t*  flash_gemm_cntl_bp_bb;
extern TLS_CLASS_SPEC fla_trsm_t*  flash_trsm_cntl_bp;
extern TLS_CLASS_SPEC fla_appiv_t* flash_appiv_cntl_bp;

TLS_CLASS_SPEC fla_lu_t*           flash_lu_incpiv_cntl_leaf = NULL;
TLS_CLASS_SPEC fla_lu_t*           flash_lu_incpiv_cntl = NULL;
TLS_CLASS_SPEC fla_blocksize_t*    flash_lu_incpiv_bsize = NULL;
