/* ../netlib/v3.9.0/zsytrs_aa_2stage.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zsytrs_ aa_2stage.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zsytrs_ aa_2stage.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zsytrs_ aa_2stage.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
/* =========== */
    ...
    *info = 0;
    ...
    if (upper)
    {
        ...
        if (*n > nb)
        {
            ...
            i__1 = *n - nb;
            ztrsm_("L", "U", "T", "U", &i__1, nrhs, &c_b11, &a[(nb + 1) * a_dim1 + 1], lda, &b[nb + 1 + b_dim1], ldb);
        }
        ...
        if (*n > nb)
        {
            ...
            i__1 = *n - nb;
            ztrsm_("L", "U", "N", "U", &i__1, nrhs, &c_b11, &a[(nb + 1) * a_dim1 + 1], lda, &b[nb + 1 + b_dim1], ldb);
    ...
    else
    {
        ...
        if (*n > nb)
        {
            ...
            i__1 = *n - nb;
            ztrsm_("L", "L", "N", "U", &i__1, nrhs, &c_b11, &a[nb + 1 + a_dim1], lda, &b[nb + 1 + b_dim1], ldb);
        }
        ...
        if (*n > nb)
        {
            ...
            i__1 = *n - nb;
            ztrsm_("L", "L", "T", "U", &i__1, nrhs, &c_b11, &a[nb + 1 + a_dim1], lda, &b[nb + 1 + b_dim1], ldb);
