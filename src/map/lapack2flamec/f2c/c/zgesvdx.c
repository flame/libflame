 ...
 *info = -17;
 ...
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *n * *n + (*n << 1) + (*n << 1) * ilaenv_(&c__1, "ZGEBRD", " ", n, n, &c_n1, &c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 if (wantu || wantvt) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *n * *n + (*n << 1) + *n * ilaenv_(&c__1, "ZUNMQR", "LN", n, n, n, &c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 }
 else {
 ...
 if (wantu || wantvt) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*n << 1) + *n * ilaenv_(&c__1, "ZUNMQR", "LN", n, n, n, &c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 }
 }
 ...
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *m * *m + (*m << 1) + (*m << 1) * ilaenv_(&c__1, "ZGEBRD", " ", m, m, &c_n1, &c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 if (wantu || wantvt) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = *m * *m + (*m << 1) + *m * ilaenv_(&c__1, "ZUNMQR", "LN", m, m, m, &c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 }
 else {
 ...
 if (wantu || wantvt) {
 /* Computing MAX */
 i__2 = maxwrk; i__3 = (*m << 1) + *m * ilaenv_(&c__1, "ZUNMQR", "LN", m, m, m, &c_n1); // , expr subst  
 maxwrk = max(i__2,i__3);
 }
 }
 }
 ...
 *(unsigned char *)rngtgk = 'V';
 ...
 i__4 = j + i__ * u_dim1;
 i__5 = k;
 z__1.r = rwork[i__5]; z__1.i = 0.; // , expr subst  
 u[i__4].r = z__1.r; u[i__4].i = z__1.i; // , expr subst  
 ++k;
 }
 k += *n;
 }
 ...
 i__5 = k;
 z__1.r = rwork[i__5]; z__1.i = 0.; // , expr subst  
 vt[i__4].r = z__1.r; vt[i__4].i = z__1.i; // , expr subst  
 ++k;
 }
 k += *n;
 }
