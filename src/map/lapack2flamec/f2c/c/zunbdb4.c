/* ../netlib/zunbdb4.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
    ...
    *info = 0;
            ...
            ++i__)
    {
        ...
        if (i__ < *m - *q)
        {
            ...
            i__3 = *m - *p - i__;
            /* Computing 2nd power */
            d__2 = dznrm2_(&i__3, &x21[i__ + 1 + i__ * x21_dim1], &c__1, &x21[ i__ + 1 + i__ * x21_dim1], &c__1);
