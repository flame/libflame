 ...
 */
 ...
 char buffer[256]; 
#if FLA_ENABLE_ILP64 
 snprintf(buffer, 256,"csytri_3 inputs: uplo %c, n %lld, lda %lld, ipiv %lld, lwork %lld",*uplo, *n, *lda, *ipiv, *lwork);
#else 
 snprintf(buffer, 256,"csytri_3 inputs: uplo %c, n %d, lda %d, ipiv %d, lwork %d",*uplo, *n, *lda, *ipiv, *lwork);
#endif
