/* ../netlib/v3.9.0/zheequb.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *amax = 0.;
 ...
 /* Computing MAX */
 i__3 = i__ + j * a_dim1;
 d__3 = s[i__]; d__4 = (d__1 = a[i__3].r, abs(d__1)) + (d__2 = d_imag(&a[i__ + j * a_dim1]), abs(d__2)); // , expr subst  
 s[i__] = max(d__3,d__4);
 /* Computing MAX */
 i__3 = i__ + j * a_dim1;
 d__3 = s[j]; d__4 = (d__1 = a[i__3].r, abs(d__1)) + (d__2 = d_imag(&a[i__ + j * a_dim1]), abs(d__2)); // , expr subst  
 s[j] = max(d__3,d__4);
 /* Computing MAX */
 i__3 = i__ + j * a_dim1;
 d__3 = *amax; d__4 = (d__1 = a[i__3].r, abs(d__1)) + (d__2 = d_imag(&a[i__ + j * a_dim1]), abs(d__2)); // , expr subst  
 *amax = max(d__3,d__4);
 }
 /* Computing MAX */
 i__2 = j + j * a_dim1;
 d__3 = s[j]; d__4 = (d__1 = a[i__2].r, abs(d__1)) + (d__2 = d_imag(&a[j + j * a_dim1]), abs(d__2)); // , expr subst  
 s[j] = max(d__3,d__4);
 /* Computing MAX */
 i__2 = j + j * a_dim1;
 d__3 = *amax; d__4 = (d__1 = a[i__2].r, abs(d__1)) + (d__2 = d_imag(&a[j + j * a_dim1]), abs(d__2)); // , expr subst  
 *amax = max(d__3,d__4);
 }
 }
 else {
