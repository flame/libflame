/* ../netlib/v3.9.0/slarrf.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = 0;
 ...
 /* Computing MAX */
 r__2 = max1; r__3 = (r__1 = dplus[i__ + 1], abs(r__1)); // , expr subst  
 max1 = max(r__2,r__3);
 /* L6: */
 }
 ...
 *sigma = lsigma;
 ...
 /* Computing MAX */
 r__2 = max2; r__3 = (r__1 = work[i__ + 1], abs(r__1)); // , expr subst  
 max2 = max(r__2,r__3);
 /* L7: */
 }
 ...
 *sigma = rsigma;
 ...
 znm2 += r__1 * r__1;
 /* Computing MAX */
 r__2 = tmp; r__3 = (r__1 = dplus[i__] * prod, abs(r__1)); // , expr subst  
 tmp = max(r__2,r__3);
 /* L15: */
 }
 ...
 *sigma = lsigma;
 ...
 znm2 += r__1 * r__1;
 /* Computing MAX */
 r__2 = tmp; r__3 = (r__1 = work[i__] * prod, abs(r__1)); // , expr subst  
 tmp = max(r__2,r__3);
 /* L16: */
 }
