/* ../netlib/dlangb.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > \verbatim */
/* > */
/* > DLANGB = ( max(f2c_dabs(A(i,j))), NORM = 'M' or 'm' */
/* > ( */
    ...
    else if (lsame_(norm, "M"))
    {
                ...
                ++j)
        {
            ...
            for (i__ = max(i__2,1);
                    ...
                    ++i__)
            {
                temp = (d__1 = ab[i__ + j * ab_dim1], f2c_dabs(d__1));
    ...
    else if (lsame_(norm, "I"))
    {
                ...
                ++j)
        {
            ...
            for (i__ = max(i__2,i__3);
                    ...
                    ++i__)
            {
                work[i__] += (d__1 = ab[k + i__ + j * ab_dim1], f2c_dabs(d__1));
                /* L60: */
            }
            /* L70: */
        }
