/* ../netlib/dsptri.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
L60: /* If K < 1, exit from loop. */
        ...
        if (ipiv[k] > 0)
        {
            ...
            if (k < *n)
            {
                ...
                i__1 = *n - k;
                dspmv_(uplo, &i__1, &c_b11, &ap[kc + *n - k + 1], &work[1], & c__1, &c_b13, &ap[kc + 1], &c__1);
                i__1 = *n - k;
        ...
        else
        {
            ...
            if (k < *n)
            {
                ...
                ap[kc] -= ddot_(&i__1, &work[1], &c__1, &ap[kc + 1], &c__1);
                i__1 = *n - k;
                ap[kcnext + 1] -= ddot_(&i__1, &ap[kc + 1], &c__1, &ap[kcnext + 2], &c__1);
                i__1 = *n - k;
                dcopy_(&i__1, &ap[kcnext + 2], &c__1, &work[1], &c__1);
                i__1 = *n - k;
                dspmv_(uplo, &i__1, &c_b11, &ap[kc + (*n - k + 1)], &work[1], &c__1, &c_b13, &ap[kcnext + 2], &c__1);
                i__1 = *n - k;
