/* ../netlib/v3.9.0/sladiv.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 dd = *d__;
 /* Computing MAX */
 r__1 = abs(*a); r__2 = abs(*b); // , expr subst  
 ab = max(r__1,r__2);
 /* Computing MAX */
 r__1 = abs(*c__); r__2 = abs(*d__); // , expr subst  
 cd = max(r__1,r__2);
 s = 1.f;
