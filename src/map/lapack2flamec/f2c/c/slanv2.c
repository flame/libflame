/* ../netlib/v3.9.0/slanv2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *sn = 0.f;
 ...
 p = temp * .5f;
 /* Computing MAX */
 r__1 = abs(*b); r__2 = abs(*c__); // , expr subst  
 bcmax = max(r__1,r__2);
 /* Computing MIN */
 r__1 = abs(*b); r__2 = abs(*c__); // , expr subst  
