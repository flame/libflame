/* ../netlib/v3.9.0/dlasq1.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 doublereal safmin;
 extern /* Subroutine */
 int xerbla_(char *, integer *), dlasrt_( char *, integer *, doublereal *, integer *);
 ...
 *info = -1;
 ...
 /* Computing MAX */
 d__2 = sigmx; d__3 = (d__1 = e[i__], abs(d__1)); // , expr subst  
 sigmx = max(d__2,d__3);
 /* L10: */
 }
 ...
 ++i__) {
 /* Computing MAX */
 d__1 = sigmx; d__2 = d__[i__]; // , expr subst  
 sigmx = max(d__1,d__2);
 /* L20: */
 }
