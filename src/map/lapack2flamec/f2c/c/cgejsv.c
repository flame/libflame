 ...
 */
 ...
 integer lrwqp3;
 extern /* Subroutine */
 int clacgv_(integer *, complex *, integer *), cgelqf_(integer *, integer *, complex *, integer *, complex *, complex *, integer *, integer *);
 ...
 real aatmax;
 extern /* Subroutine */
 int cgeqrf_(integer *, integer *, complex *, integer *, complex *, complex *, integer *, integer *), clacpy_( char *, integer *, integer *, complex *, integer *, complex *, integer *), clapmr_(logical *, integer *, integer *, complex *, integer *, integer *);
 logical noscal;
 extern /* Subroutine */
 ...
 *info = 0;
 ...
 /* Computing 2nd power */
 i__3 = *n;
 i__1 = *n + lwqp3, i__2 = i__3 * i__3 + lwcon, i__1 = max( i__1,i__2); i__2 = *n + lwqrf; i__1 = max(i__1,i__2); // ; expr subst  
 minwrk = max(i__1,lwsvdj);
 }
 else {
 /* Computing MAX */
 i__1 = *n + lwqp3; i__2 = *n + lwqrf; i__1 = max(i__1,i__2); // ; expr subst  
 minwrk = max(i__1,lwsvdj);
 }
 if (lquery) {
 ...
 /* Computing 2nd power */
 i__3 = *n;
 i__1 = *n + lwrk_cgeqp3__, i__2 = i__3 * i__3 + lwcon, i__1 = max(i__1,i__2); i__2 = *n + lwrk_cgeqrf__; i__1 = max(i__1,i__2); // ; expr subst  
 optwrk = max(i__1,lwrk_cgesvj__);
 }
 else {
 /* Computing MAX */
 i__1 = *n + lwrk_cgeqp3__; i__2 = *n + lwrk_cgeqrf__; i__1 = max(i__1,i__2); // ; expr subst  
 optwrk = max(i__1,lwrk_cgesvj__);
 }
 }
 if (l2tran || rowpiv) {
 if (errest) {
 /* Computing MAX */
 i__1 = 7, i__2 = *m << 1, i__1 = max(i__1,i__2); i__1 = max(i__1,lrwqp3); i__1 = max(i__1,lrwcon); // ; expr subst  
 minrwrk = max(i__1,lrwsvdj);
 }
 else {
 /* Computing MAX */
 i__1 = 7, i__2 = *m << 1; i__1 = max(i__1,i__2); i__1 = max(i__1,lrwqp3); // ; expr subst  
 minrwrk = max(i__1,lrwsvdj);
 }
 }
 else {
 if (errest) {
 /* Computing MAX */
 i__1 = max(7,lrwqp3); i__1 = max(i__1,lrwcon); // , expr subst  
 minrwrk = max(i__1,lrwsvdj);
 }
 else {
 /* Computing MAX */
 ...
 if (errest) {
 /* Computing MAX */
 i__1 = *n + lwqp3, i__1 = max(i__1,lwcon), i__1 = max(i__1, lwsvdj), i__2 = *n + lwlqf, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwqrf, i__1 = max(i__1,i__2), i__2 = *n + lwsvdj; i__1 = max(i__1,i__2); i__2 = *n + lwunmlq; // ; expr subst  
 minwrk = max(i__1,i__2);
 }
 else {
 /* Computing MAX */
 i__1 = *n + lwqp3, i__1 = max(i__1,lwsvdj), i__2 = *n + lwlqf, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwqrf, i__1 = max(i__1,i__2), i__2 = *n + lwsvdj; i__1 = max( i__1,i__2); i__2 = *n + lwunmlq; // ; expr subst  
 minwrk = max(i__1,i__2);
 }
 if (lquery) {
 ...
 if (errest) {
 /* Computing MAX */
 i__1 = *n + lwrk_cgeqp3__, i__1 = max(i__1,lwcon), i__1 = max(i__1,lwrk_cgesvj__), i__2 = *n + lwrk_cgelqf__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwrk_cgeqrf__, i__1 = max(i__1,i__2), i__2 = *n + lwrk_cgesvj__; i__1 = max(i__1,i__2); i__2 = *n + lwrk_cunmlq__; // ; expr subst  
 optwrk = max(i__1,i__2);
 }
 else {
 /* Computing MAX */
 i__1 = *n + lwrk_cgeqp3__, i__1 = max(i__1,lwrk_cgesvj__), i__2 = *n + lwrk_cgelqf__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwrk_cgeqrf__, i__1 = max( i__1,i__2), i__2 = *n + lwrk_cgesvj__; i__1 = max( i__1,i__2); i__2 = *n + lwrk_cunmlq__; // ; expr subst  
 optwrk = max(i__1,i__2);
 }
 }
 if (l2tran || rowpiv) {
 if (errest) {
 /* Computing MAX */
 i__1 = 7, i__2 = *m << 1, i__1 = max(i__1,i__2); i__1 = max(i__1,lrwqp3); i__1 = max(i__1,lrwsvdj); // ; expr subst  
 minrwrk = max(i__1,lrwcon);
 }
 else {
 /* Computing MAX */
 i__1 = 7, i__2 = *m << 1; i__1 = max(i__1,i__2); i__1 = max(i__1,lrwqp3); // ; expr subst  
 ...
 if (errest) {
 /* Computing MAX */
 i__1 = max(7,lrwqp3); i__1 = max(i__1,lrwsvdj); // , expr subst  
 minrwrk = max(i__1,lrwcon);
 }
 else {
 /* Computing MAX */
 ...
 if (errest) {
 /* Computing MAX */
 i__1 = max(lwqp3,lwcon), i__2 = *n + lwqrf; i__1 = max(i__1, i__2); i__1 = max(i__1,lwsvdj); // ; expr subst  
 minwrk = *n + max(i__1,lwunmqrm);
 }
 else {
 /* Computing MAX */
 i__1 = lwqp3, i__2 = *n + lwqrf; i__1 = max(i__1,i__2); i__1 = max(i__1,lwsvdj); // ; expr subst  
 minwrk = *n + max(i__1,lwunmqrm);
 }
 if (lquery) {
 cgesvj_("L", "U", "N", n, n, &u[u_offset], ldu, &sva[1], n, & a[a_offset], lda, cdummy, &c_n1, rdummy, &c_n1, &ierr);
 ...
 if (errest) {
 /* Computing MAX */
 i__1 = max(lwrk_cgeqp3__,lwcon), i__2 = *n + lwrk_cgeqrf__; i__1 = max(i__1,i__2); i__1 = max( i__1,lwrk_cgesvj__); // ; expr subst  
 optwrk = *n + max(i__1,lwrk_cunmqrm__);
 }
 else {
 /* Computing MAX */
 i__1 = lwrk_cgeqp3__, i__2 = *n + lwrk_cgeqrf__; i__1 = max(i__1,i__2); i__1 = max(i__1,lwrk_cgesvj__); // ; expr subst  
 optwrk = *n + max(i__1,lwrk_cunmqrm__);
 }
 }
 if (l2tran || rowpiv) {
 ...
 /* Computing 2nd power */
 i__11 = *n;
 i__1 = *n + lwqp3, i__2 = *n + lwcon, i__1 = max(i__1, i__2), i__2 = (*n << 1) + i__3 * i__3 + lwcon, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwqrf, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwqp3, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + *n + lwlqf, i__1 = max(i__1,i__2), i__2 = ( *n << 1) + i__5 * i__5 + *n + i__6 * i__6 + lwcon, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__7 * i__7 + *n + lwsvdj, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__8 * i__8 + *n + lwsvdjv, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__9 * i__9 + * n + lwunmqr, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__10 * i__10 + *n + lwunmlq, i__1 = max( i__1,i__2), i__2 = *n + i__11 * i__11 + lwsvdj; i__1 = max(i__1,i__2); i__2 = *n + lwunmqrm; // ; expr subst  
 minwrk = max(i__1,i__2);
 }
 else {
 /* Computing MAX */
 ...
 /* Computing 2nd power */
 i__11 = *n;
 i__1 = *n + lwqp3, i__2 = (*n << 1) + i__3 * i__3 + lwcon, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwqrf, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwqp3, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + *n + lwlqf, i__1 = max(i__1,i__2), i__2 = ( *n << 1) + i__5 * i__5 + *n + i__6 * i__6 + lwcon, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__7 * i__7 + *n + lwsvdj, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__8 * i__8 + *n + lwsvdjv, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__9 * i__9 + * n + lwunmqr, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__10 * i__10 + *n + lwunmlq, i__1 = max( i__1,i__2), i__2 = *n + i__11 * i__11 + lwsvdj; i__1 = max(i__1,i__2); i__2 = *n + lwunmqrm; // ; expr subst  
 minwrk = max(i__1,i__2);
 }
 miniwrk += *n;
 if (rowpiv || l2tran) {
 ...
 /* Computing 2nd power */
 i__4 = *n;
 i__1 = *n + lwqp3, i__2 = *n + lwcon, i__1 = max(i__1, i__2), i__2 = (*n << 1) + lwqrf, i__1 = max(i__1, i__2), i__2 = (*n << 1) + i__3 * i__3 + lwsvdjv, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + *n + lwunmqr; i__1 = max(i__1,i__2); i__2 = *n + lwunmqrm; // ; expr subst  
 minwrk = max(i__1,i__2);
 }
 else {
 /* Computing MAX */
 ...
 /* Computing 2nd power */
 i__4 = *n;
 i__1 = *n + lwqp3, i__2 = (*n << 1) + lwqrf, i__1 = max( i__1,i__2), i__2 = (*n << 1) + i__3 * i__3 + lwsvdjv, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + *n + lwunmqr; i__1 = max(i__1, i__2); i__2 = *n + lwunmqrm; // ; expr subst  
 minwrk = max(i__1,i__2);
 }
 if (rowpiv || l2tran) {
 miniwrk += *m;
 ...
 /* Computing 2nd power */
 i__11 = *n;
 i__1 = *n + lwrk_cgeqp3__, i__2 = *n + lwcon, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__3 * i__3 + lwcon, i__1 = max(i__1,i__2), i__2 = (* n << 1) + lwrk_cgeqrf__, i__1 = max(i__1,i__2) , i__2 = (*n << 1) + lwrk_cgeqp3n__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + *n + lwrk_cgelqf__, i__1 = max(i__1, i__2), i__2 = (*n << 1) + i__5 * i__5 + *n + i__6 * i__6 + lwcon, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__7 * i__7 + *n + lwrk_cgesvj__, i__1 = max(i__1,i__2), i__2 = ( *n << 1) + i__8 * i__8 + *n + lwrk_cgesvjv__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__9 * i__9 + *n + lwrk_cunmqr__, i__1 = max( i__1,i__2), i__2 = (*n << 1) + i__10 * i__10 + *n + lwrk_cunmlq__, i__1 = max(i__1,i__2), i__2 = *n + i__11 * i__11 + lwrk_cgesvju__; i__1 = max(i__1,i__2); i__2 = *n + lwrk_cunmqrm__; // ; expr subst  
 optwrk = max(i__1,i__2);
 }
 else {
 /* Computing MAX */
 ...
 /* Computing 2nd power */
 i__11 = *n;
 i__1 = *n + lwrk_cgeqp3__, i__2 = (*n << 1) + i__3 * i__3 + lwcon, i__1 = max(i__1,i__2), i__2 = (* n << 1) + lwrk_cgeqrf__, i__1 = max(i__1,i__2) , i__2 = (*n << 1) + lwrk_cgeqp3n__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + *n + lwrk_cgelqf__, i__1 = max(i__1, i__2), i__2 = (*n << 1) + i__5 * i__5 + *n + i__6 * i__6 + lwcon, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__7 * i__7 + *n + lwrk_cgesvj__, i__1 = max(i__1,i__2), i__2 = ( *n << 1) + i__8 * i__8 + *n + lwrk_cgesvjv__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__9 * i__9 + *n + lwrk_cunmqr__, i__1 = max( i__1,i__2), i__2 = (*n << 1) + i__10 * i__10 + *n + lwrk_cunmlq__, i__1 = max(i__1,i__2), i__2 = *n + i__11 * i__11 + lwrk_cgesvju__; i__1 = max(i__1,i__2); i__2 = *n + lwrk_cunmqrm__; // ; expr subst  
 optwrk = max(i__1,i__2);
 }
 }
 else {
 ...
 /* Computing 2nd power */
 i__5 = *n;
 i__1 = *n + lwrk_cgeqp3__, i__2 = *n + lwcon, i__1 = max(i__1,i__2), i__2 = (*n << 1) + lwrk_cgeqrf__, i__1 = max(i__1,i__2), i__2 = ( *n << 1) + i__3 * i__3, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + lwrk_cgesvjv__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__5 * i__5 + *n + lwrk_cunmqr__; i__1 = max(i__1,i__2); i__2 = *n + lwrk_cunmqrm__; // ; expr subst  
 optwrk = max(i__1,i__2);
 }
 else {
 /* Computing MAX */
 ...
 /* Computing 2nd power */
 i__5 = *n;
 i__1 = *n + lwrk_cgeqp3__, i__2 = (*n << 1) + lwrk_cgeqrf__, i__1 = max(i__1,i__2), i__2 = ( *n << 1) + i__3 * i__3, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__4 * i__4 + lwrk_cgesvjv__, i__1 = max(i__1,i__2), i__2 = (*n << 1) + i__5 * i__5 + *n + lwrk_cunmqr__; i__1 = max(i__1,i__2); i__2 = *n + lwrk_cunmqrm__; // ; expr subst  
 optwrk = max(i__1,i__2);
 }
 }
 }
 ...
 *info = -9;
 ...
 if (rsvec) {
 i__1 = v_dim1 + 1;
 v[i__1].r = 1.f; v[i__1].i = 0.f; // , expr subst  
 }
 if (sva[1] < big * scalem) {
 sva[1] /= scalem;
 scalem = 1.f;
 ...
 /* Computing MAX */
 r__1 = aatmax; r__2 = rwork[p]; // , expr subst  
 aatmax = max(r__1,r__2);
 if (rwork[p] != 0.f) {
 /* Computing MIN */
 r__1 = aatmin; r__2 = rwork[p]; // , expr subst  
 ...
 /* Computing MAX */
 r__1 = aatmax; r__2 = rwork[*m + p]; // , expr subst  
 aatmax = max(r__1,r__2);
 /* Computing MIN */
 r__1 = aatmin; r__2 = rwork[*m + p]; // , expr subst  
 aatmin = min(r__1,r__2);
 /* L1904: */
 }
 }
 ...
 i__3 = p + q * a_dim1;
 a[i__3].r = ctemp.r; a[i__3].i = ctemp.i; // , expr subst  
 /* L1116: */
 }
 /* L1115: */
 }
 ...
 p <= i__1;
 ++p) {
 if (c_abs(&a[p + p * a_dim1]) < epsln * c_abs(&a[p - 1 + (p - 1) * a_dim1]) || c_abs(&a[p + p * a_dim1]) < small || l2kill && c_abs(&a[p + p * a_dim1]) < temp1) {
 goto L3402;
 }
 ++nr;
 /* L3401: */
 ...
 p <= i__1;
 ++p) {
 if (c_abs(&a[p + p * a_dim1]) < small || l2kill && c_abs(&a[p + p * a_dim1]) < temp1) {
 goto L3302;
 }
 ++nr;
 /* L3301: */
 ...
 if (lsvec) {
 cpocon_("U", n, &v[v_offset], ldv, &c_b141, &temp1, & cwork[*n + 1], &rwork[1], &ierr);
 }
 else {
 cpocon_("U", n, &v[v_offset], ldv, &c_b141, &temp1, & cwork[1], &rwork[1], &ierr);
 }
 }
 else if (lsvec) {
 ...
 cpocon_("U", n, &u[u_offset], ldu, &c_b141, &temp1, &cwork[*n + 1], &rwork[1], &ierr);
 }
 else {
 ...
 cpocon_("U", n, &cwork[1], n, &c_b141, &temp1, &cwork[*n * *n + 1], &rwork[1], &ierr);
 }
 if (temp1 != 0.f) {
 ...
 cgesvj_("L", "N", "N", &nr, &nr, &a[a_offset], lda, &sva[1], n, &v[ v_offset], ldv, &cwork[1], lwork, &rwork[1], lrwork, info);
 scalem = rwork[1];
 ...
 cgesvj_("L", "U", "N", n, &nr, &v[v_offset], ldv, &sva[1], &nr, & a[a_offset], lda, &cwork[1], lwork, &rwork[1], lrwork, info);
 scalem = rwork[1];
 numrank = i_nint(&rwork[2]);
 }
 else {
 ...
 claset_("U", &i__1, &i__2, &c_b1, &c_b1, &v[(v_dim1 << 1) + 1], ldv);
 i__1 = *lwork - (*n << 1);
 cgeqrf_(&nr, &nr, &v[v_offset], ldv, &cwork[*n + 1], &cwork[(*n << 1) + 1], &i__1, &ierr);
 i__1 = nr;
 for (p = 1;
 p <= i__1;
 ++p) {
 ...
 claset_("U", &i__1, &i__2, &c_b1, &c_b1, &v[(v_dim1 << 1) + 1], ldv);
 i__1 = *lwork - *n;
 cgesvj_("L", "U", "N", &nr, &nr, &v[v_offset], ldv, &sva[1], &nr, &u[u_offset], ldu, &cwork[*n + 1], &i__1, &rwork[1], lrwork, info);
 scalem = rwork[1];
 numrank = i_nint(&rwork[2]);
 if (nr < *n) {
 i__1 = *n - nr;
 ...
 i__1 = *lwork - *n;
 cunmlq_("L", "C", n, n, &nr, &a[a_offset], lda, &cwork[1], &v[ v_offset], ldv, &cwork[*n + 1], &i__1, &ierr);
 }
 ...
 i__2 = *n - 1;
 claset_("L", &i__1, &i__2, &c_b1, &c_b1, &a[a_dim1 + 2], lda);
 cgesvj_("U", "N", "V", n, n, &a[a_offset], lda, &sva[1], n, &v[ v_offset], ldv, &cwork[1], lwork, &rwork[1], lrwork, info);
 scalem = rwork[1];
 numrank = i_nint(&rwork[2]);
 clapmr_(&c_false, n, n, &v[v_offset], ldv, &iwork[1]);
 }
 ...
 claset_("U", &i__1, &i__2, &c_b1, &c_b1, &u[(u_dim1 << 1) + 1], ldu);
 i__1 = *lwork - *n;
 cgesvj_("L", "U", "N", &nr, &nr, &u[u_offset], ldu, &sva[1], &nr, &a[ a_offset], lda, &cwork[*n + 1], &i__1, &rwork[1], lrwork, info);
 scalem = rwork[1];
 numrank = i_nint(&rwork[2]);
 if (nr < *m) {
 i__1 = *m - nr;
 ...
 i__3 = p + q * v_dim1;
 v[i__3].r = ctemp.r; v[i__3].i = ctemp.i; // , expr subst  
 }
 /* $ V(p,q) = TEMP1 * ( V(p,q) / ABS(V(p,q)) ) */
 if (p < q) {
 i__3 = p + q * v_dim1;
 i__4 = p + q * v_dim1;
 q__1.r = -v[i__4].r; q__1.i = -v[i__4].i; // , expr subst  
 ...
 cpocon_("L", &nr, &cwork[(*n << 1) + 1], &nr, &c_b141, &temp1, &cwork[(*n << 1) + nr * nr + 1], &rwork[1], &ierr);
 ...
 ++q) {
 /* Computing MIN */
 r__2 = c_abs(&v[p + p * v_dim1]); r__3 = c_abs(&v[q + q * v_dim1]); // , expr subst  
 r__1 = xsc * min(r__2,r__3);
 q__1.r = r__1; q__1.i = 0.f; // , expr subst  
 ctemp.r = q__1.r; ctemp.i = q__1.i; // , expr subst  
 ...
 v[i__1].r = q__1.r; v[i__1].i = q__1.i; // , expr subst  
 condr2 = condr1;
 }
 else {
 ...
 i__1 = *lwork - (*n << 1);
 cgeqp3_(n, &nr, &v[v_offset], ldv, &iwork[*n + 1], &cwork[ *n + 1], &cwork[(*n << 1) + 1], &i__1, &rwork[1], &ierr);
 ...
 i__3 = p + q * v_dim1;
 q__1.r = -ctemp.r; q__1.i = -ctemp.i; // , expr subst  
 v[i__3].r = q__1.r; v[i__3].i = q__1.i; // , expr subst  
 /* L8971: */
 }
 /* L8970: */
 ...
 cgelqf_(&nr, &nr, &v[v_offset], ldv, &cwork[(*n << 1) + * n * nr + 1], &cwork[(*n << 1) + *n * nr + nr + 1], &i__1, &ierr);
 /* .. and estimate the condition number */
 clacpy_("L", &nr, &nr, &v[v_offset], ldv, &cwork[(*n << 1) + *n * nr + nr + 1], &nr);
 i__1 = nr;
 for (p = 1;
 p <= i__1;
 ++p) {
 ...
 cpocon_("L", &nr, &cwork[(*n << 1) + *n * nr + nr + 1], & nr, &c_b141, &temp1, &cwork[(*n << 1) + *n * nr + nr + nr * nr + 1], &rwork[1], &ierr);
 ...
 ++q) {
 i__2 = q + q * v_dim1;
 q__1.r = xsc * v[i__2].r; q__1.i = xsc * v[i__2].i; // , expr subst  
 ctemp.r = q__1.r; ctemp.i = q__1.i; // , expr subst  
 i__2 = q - 1;
 for (p = 1;
 p <= i__2;
 ...
 if (condr1 < cond_ok__) {
 i__1 = *lwork - (*n << 1) - *n * nr - nr;
 cgesvj_("L", "U", "N", &nr, &nr, &v[v_offset], ldv, &sva[ 1], &nr, &u[u_offset], ldu, &cwork[(*n << 1) + *n * nr + nr + 1], &i__1, &rwork[1], lrwork, info);
 scalem = rwork[1];
 numrank = i_nint(&rwork[2]);
 i__1 = nr;
 for (p = 1;
 ...
 ctrsm_("L", "U", "N", "N", &nr, &nr, &c_b2, &a[ a_offset], lda, &v[v_offset], ldv);
 }
 else {
 ...
 ctrsm_("L", "U", "C", "N", &nr, &nr, &c_b2, &cwork[(* n << 1) + 1], n, &v[v_offset], ldv);
 if (nr < *n) {
 i__1 = *n - nr;
 claset_("A", &i__1, &nr, &c_b1, &c_b1, &v[nr + 1 + v_dim1], ldv);
 i__1 = *n - nr;
 ...
 i__1 = *lwork - (*n << 1) - *n * nr - nr;
 cunmqr_("L", "N", n, n, &nr, &cwork[(*n << 1) + 1], n, &cwork[*n + 1], &v[v_offset], ldv, &cwork[(* n << 1) + *n * nr + nr + 1], &i__1, &ierr);
 }
 }
 ...
 ctrsm_("L", "U", "N", "N", &nr, &nr, &c_b2, &cwork[(*n << 1) + 1], n, &u[u_offset], ldu);
 ...
 i__4 = p + q * u_dim1;
 cwork[i__3].r = u[i__4].r; cwork[i__3].i = u[i__4] .i; // , expr subst  
 /* L872: */
 }
 i__2 = nr;
 for (p = 1;
 ...
 i__3 = p + q * u_dim1;
 i__4 = (*n << 1) + *n * nr + nr + p;
 u[i__3].r = cwork[i__4].r; u[i__3].i = cwork[i__4] .i; // , expr subst  
 /* L874: */
 }
 /* L873: */
 }
 ...
 i__1 = *lwork - (*n << 1) - *n * nr - nr;
 cgesvj_("L", "U", "V", &nr, &nr, &v[v_offset], ldv, &sva[ 1], &nr, &u[u_offset], ldu, &cwork[(*n << 1) + *n * nr + nr + 1], &i__1, &rwork[1], lrwork, info);
 scalem = rwork[1];
 numrank = i_nint(&rwork[2]);
 if (nr < *n) {
 i__1 = *n - nr;
 ...
 cunmqr_("L", "N", n, n, &nr, &cwork[(*n << 1) + 1], n, & cwork[*n + 1], &v[v_offset], ldv, &cwork[(*n << 1) + *n * nr + nr + 1], &i__1, &ierr);
 i__1 = *lwork - (*n << 1) - *n * nr - nr;
 cunmlq_("L", "C", &nr, &nr, &nr, &cwork[(*n << 1) + 1], n, &cwork[(*n << 1) + *n * nr + 1], &u[u_offset], ldu, &cwork[(*n << 1) + *n * nr + nr + 1], &i__1, &ierr);
 i__1 = nr;
 for (q = 1;
 q <= i__1;
 ++q) {
 ...
 i__4 = p + q * v_dim1;
 cwork[i__3].r = v[i__4].r; cwork[i__3].i = v[i__4].i; // , expr subst  
 /* L972: */
 }
 i__2 = *n;
 for (p = 1;
 ...
 i__3 = p + q * v_dim1;
 i__4 = (*n << 1) + *n * nr + nr + p;
 v[i__3].r = cwork[i__4].r; v[i__3].i = cwork[i__4].i; // , expr subst  
 /* L973: */
 }
 ...
 ++p) {
 i__2 = *n + (p - 1) * *n + p;
 q__1.r = xsc * cwork[i__2].r; q__1.i = xsc * cwork[ i__2].i; // , expr subst  
 ctemp.r = q__1.r; ctemp.i = q__1.i; // , expr subst  
 i__2 = p - 1;
 for (q = 1;
 q <= i__2;
 ...
 i__3 = *n + (q - 1) * *n + p;
 q__1.r = -ctemp.r; q__1.i = -ctemp.i; // , expr subst  
 cwork[i__3].r = q__1.r; cwork[i__3].i = q__1.i; // , expr subst  
 /* L5971: */
 }
 /* L5970: */
 }
 ...
 i__1 = *lwork - *n - *n * *n;
 cgesvj_("U", "U", "N", n, n, &cwork[*n + 1], n, &sva[1], n, & u[u_offset], ldu, &cwork[*n + *n * *n + 1], &i__1, & rwork[1], lrwork, info);
 scalem = rwork[1];
 numrank = i_nint(&rwork[2]);
 i__1 = *n;
 for (p = 1;
 ...
 ++p) {
 /* Computing MIN */
 r__2 = c_abs(&u[p + p * u_dim1]); r__3 = c_abs(&u[q + q * u_dim1]); // , expr subst  
 r__1 = xsc * min(r__2,r__3);
 q__1.r = r__1; q__1.i = 0.f; // , expr subst  
 ctemp.r = q__1.r; ctemp.i = q__1.i; // , expr subst  
 ...
 i__1 = *lwork - (*n << 1) - *n * nr;
 cgesvj_("L", "U", "V", &nr, &nr, &u[u_offset], ldu, &sva[1], n, & v[v_offset], ldv, &cwork[(*n << 1) + *n * nr + 1], &i__1, &rwork[1], lrwork, info);
 scalem = rwork[1];
 numrank = i_nint(&rwork[2]);
 if (nr < *n) {
 i__1 = *n - nr;
