...
void FLASH_Symm_cntl_init_ts(FLA_Cntl_init_flash_s *FLA_cntl_flash_init_i)
{
	// Set symm blocksize for hierarchical storage.
	FLA_cntl_flash_init_i->flash_symm_bsize      = FLA_Blocksize_create( 1, 1, 1, 1 );

	// Create a control tree that assumes A and B are b x b blocks.
	FLA_cntl_flash_init_i->flash_symm_cntl_blas  = FLA_Cntl_symm_obj_create( FLA_HIER, 
	                                                  FLA_SUBPROBLEM,
	                                                  NULL,
	                                                  NULL,
	                                                  NULL,
	...
	FLA_cntl_flash_init_i->flash_symm_cntl_bp    = FLA_Cntl_symm_obj_create( FLA_HIER,
	                                                  FLA_BLOCKED_VARIANT9,
	                                                  FLA_cntl_flash_init_i->flash_symm_bsize,
	                                                  FLA_cntl_flash_init_i->flash_scal_cntl,
	                                                  FLA_cntl_flash_init_i->flash_symm_cntl_blas,
	                                                  NULL,
	                                                  NULL );

	// Create a control tree that assumes A is large and B is a panel.
	FLA_cntl_flash_init_i->flash_symm_cntl_mp    = FLA_Cntl_symm_obj_create( FLA_HIER,
	                                                  FLA_BLOCKED_VARIANT1,
	                                                  FLA_cntl_flash_init_i->flash_symm_bsize,
	                                                  FLA_cntl_flash_init_i->flash_scal_cntl,
	                                                  FLA_cntl_flash_init_i->flash_symm_cntl_blas,
	                                                  FLA_cntl_flash_init_i->flash_gemm_cntl_op_bp,
	                                                  FLA_cntl_flash_init_i->flash_gemm_cntl_mm_mp );

	// Create a control tree that assumes A and B are both large.
	FLA_cntl_flash_init_i->flash_symm_cntl_mm    = FLA_Cntl_symm_obj_create( FLA_HIER,
	                                                  FLA_BLOCKED_VARIANT9,
	                                                  FLA_cntl_flash_init_i->flash_symm_bsize,
	                                                  FLA_cntl_flash_init_i->flash_scal_cntl,
	                                                  FLA_cntl_flash_init_i->flash_symm_cntl_mp,
	                                                  NULL,
	                                                  NULL );
}

void FLASH_Symm_cntl_finalize_ts(FLA_Cntl_init_flash_s *FLA_cntl_flash_init_i)
{
	FLA_Cntl_obj_free( FLA_cntl_flash_init_i->flash_symm_cntl_blas );

	FLA_Cntl_obj_free( FLA_cntl_flash_init_i->flash_symm_cntl_bp );
	FLA_Cntl_obj_free( FLA_cntl_flash_init_i->flash_symm_cntl_mp );
	FLA_Cntl_obj_free( FLA_cntl_flash_init_i->flash_symm_cntl_mm );

	FLA_Blocksize_free( FLA_cntl_flash_init_i->flash_symm_bsize );
}
