/* ../netlib/zlatbs.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 */
 ...
 if that is less than overflow, ZTBSV */
 ...
 *scale = 1.;
 ...
 /* Computing MAX */
 i__2 = j;
 d__3 = xmax; d__4 = (d__1 = x[i__2].r / 2., f2c_abs(d__1)) + (d__2 = d_imag(&x[j]) / 2., f2c_abs(d__2)); // , expr subst  
 xmax = max(d__3,d__4);
 /* L30: */
 }
 xbnd = xmax;
...
. */
 ...
 tjjs.r = ab[i__3].r; tjjs.i = ab[i__3].i; // , expr subst  
 tjj = (d__1 = tjjs.r, f2c_abs(d__1)) + (d__2 = d_imag(&tjjs), f2c_abs( d__2));
 if (tjj >= smlnum) {
 /* M(j) = G(j-1) / f2c_abs(A(j,j)) */
 /* Computing MIN */
 d__1 = xbnd; d__2 = min(1.,tjj) * grow; // , expr subst  
 xbnd = min(d__1,d__2);
 }
 else {
...
. */
 /* Computing MIN */
 d__1 = 1.; d__2 = .5 / max(xbnd,smlnum); // , expr subst  
 grow = min(d__1,d__2);
 i__2 = jlast;
 i__1 = jinc;
 for (j = jfirst;
...
. */
 ...
 xj = cnorm[j] + 1.;
 /* Computing MIN */
 d__1 = grow; d__2 = xbnd / xj; // , expr subst  
 grow = min(d__1,d__2);
 i__3 = maind + j * ab_dim1;
 tjjs.r = ab[i__3].r; tjjs.i = ab[i__3].i; // , expr subst  
 tjj = (d__1 = tjjs.r, f2c_abs(d__1)) + (d__2 = d_imag(&tjjs), f2c_abs( d__2));
 ...
 *scale = bignum * .5 / xmax;
 ...
 if (nounit) {
 i__3 = maind + j * ab_dim1;
 z__1.r = tscal * ab[i__3].r; z__1.i = tscal * ab[i__3].i; // , expr subst  
 tjjs.r = z__1.r; tjjs.i = z__1.i; // , expr subst  
 }
 else {
 tjjs.r = tscal; tjjs.i = 0.; // , expr subst  
 if (tscal == 1.) {
 goto L110;
 }
 }
 ...
 *scale *= rec;
 ...
 ++i__) {
 i__4 = i__;
 x[i__4].r = 0.; x[i__4].i = 0.; // , expr subst  
 /* L100: */
 }
 i__3 = j;
 x[i__3].r = 1.; x[i__3].i = 0.; // , expr subst  
 xj = 1.;
 *scale = 0.;
 xmax = 0.;
 }
 ...
 *scale *= .5;
 ...
 /* Computing MIN */
 i__3 = *kd; i__4 = j - 1; // , expr subst  
 jlen = min(i__3,i__4);
 i__3 = j;
 z__2.r = -x[i__3].r; z__2.i = -x[i__3].i; // , expr subst  
 z__1.r = tscal * z__2.r; z__1.i = tscal * z__2.i; // , expr subst  
 ...
 i__3 = j;
 xj = (d__1 = x[i__3].r, f2c_abs(d__1)) + (d__2 = d_imag(&x[j]), f2c_abs(d__2));
 uscal.r = tscal; uscal.i = 0.; // , expr subst  
 rec = 1. / max(xmax,1.);
 ...
 *scale *= rec;
 ...
 csumj.r = 0.; csumj.i = 0.; // , expr subst  
 ...
 csumj.r = z__1.r; csumj.i = z__1.i; // , expr subst  
 }
 else {
 /* Computing MIN */
 i__3 = *kd; i__4 = *n - j; // , expr subst  
 ...
 z__3.r = ab[i__4].r * uscal.r - ab[i__4].i * uscal.i; z__3.i = ab[i__4].r * uscal.i + ab[i__4].i * uscal.r; // , expr subst  
 i__5 = j - jlen - 1 + i__;
 z__2.r = z__3.r * x[i__5].r - z__3.i * x[i__5].i; z__2.i = z__3.r * x[i__5].i + z__3.i * x[ i__5].r; // , expr subst  
 z__1.r = csumj.r + z__2.r; z__1.i = csumj.i + z__2.i; // , expr subst  
 csumj.r = z__1.r; csumj.i = z__1.i; // , expr subst  
 /* L130: */
 }
 }
 ...
 z__1.r = tscal; z__1.i = 0.; // , expr subst  
 if (uscal.r == z__1.r && uscal.i == z__1.i) {
 /* Compute x(j) := ( x(j) - CSUMJ ) / A(j,j) if 1/A(j,j) */
 /* was not used to scale the dotproduct. */
 i__3 = j;
 i__4 = j;
 z__1.r = x[i__4].r - csumj.r; z__1.i = x[i__4].i - csumj.i; // , expr subst  
 x[i__3].r = z__1.r; x[i__3].i = z__1.i; // , expr subst  
 i__3 = j;
 xj = (d__1 = x[i__3].r, f2c_abs(d__1)) + (d__2 = d_imag(&x[j]) , f2c_abs(d__2));
 if (nounit) {
 ...
 *scale = 0.;
 ...
 /* Computing MAX */
 i__3 = j;
 d__3 = xmax; d__4 = (d__1 = x[i__3].r, f2c_abs(d__1)) + (d__2 = d_imag(&x[j]), f2c_abs(d__2)); // , expr subst  
 xmax = max(d__3,d__4);
 /* L170: */
 }
 }
 ...
 *scale *= rec;
 ...
 z__3.r = z__4.r * uscal.r - z__4.i * uscal.i; z__3.i = z__4.r * uscal.i + z__4.i * uscal.r; // , expr subst  
 i__4 = j - jlen - 1 + i__;
 z__2.r = z__3.r * x[i__4].r - z__3.i * x[i__4].i; z__2.i = z__3.r * x[i__4].i + z__3.i * x[ i__4].r; // , expr subst  
 z__1.r = csumj.r + z__2.r; z__1.i = csumj.i + z__2.i; // , expr subst  
 csumj.r = z__1.r; csumj.i = z__1.i; // , expr subst  
 /* L180: */
 }
