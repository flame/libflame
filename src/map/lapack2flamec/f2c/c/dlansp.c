/* ../netlib/dlansp.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
doublereal dlansp_(char *norm, char *uplo, integer *n, doublereal *ap, doublereal *work)
{
    ...
    char buffer[256];
    snprintf(buffer, 256,"dlansp inputs: norm %c, uplo %c, n %" FLA_IS "",*norm, *uplo, *n);
