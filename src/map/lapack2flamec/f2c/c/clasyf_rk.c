/* ../netlib/v3.9.0/clasyf_rk.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
;
 ...
 /* > \brief \b CLASYF_RK computes a partial factorization of a complex symmetric indefinite matrix using bound ed Bunch-Kaufman (rook) diagonal pivoting method. */
 /* =========== DOCUMENTATION =========== */
 /* Online html documentation available at */
 /* http://www.netlib.org/lapack/explore-html/ */
 /* > \htmlonly */
 /* > Download CLASYF_RK + dependencies */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/clasyf_ rk.f"> */
 /* > [TGZ]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/clasyf_ rk.f"> */
 /* > [ZIP]</a> */
 /* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/clasyf_ rk.f"> */
 /* > [TXT]</a> */
 /* > \endhtmlonly */
 /* Definition: */
 /* =========== */
 ...
 */
 ...
 /* ===================================================================== */
 /* Subroutine */
 int clasyf_rk_(char *uplo, integer *n, integer *nb, integer *kb, complex *a, integer *lda, complex *e, integer *ipiv, complex *w, integer *ldw, integer *info) {
 ...
 *info = 0;
 ...
 i__1 = k + kw * w_dim1;
 absakk = (r__1 = w[i__1].r, abs(r__1)) + (r__2 = r_imag(&w[k + kw * w_dim1]), abs(r__2));
 ...
 *info = k;
 ...
 if (! ((r__1 = w[i__1].r, abs(r__1)) + (r__2 = r_imag(&w[imax + (kw - 1) * w_dim1]), abs(r__2)) < alpha * rowmax)) {
 ...
 r1.r = q__1.r; r1.i = q__1.i; // , expr subst  
 i__1 = k - 1;
 ...
 i__2 = j + (k - 1) * a_dim1;
 i__3 = j + (kw - 1) * w_dim1;
 q__4.r = d11.r * w[i__3].r - d11.i * w[i__3].i; q__4.i = d11.r * w[i__3].i + d11.i * w[i__3] .r; // , expr subst  
 i__4 = j + kw * w_dim1;
 q__3.r = q__4.r - w[i__4].r; q__3.i = q__4.i - w[i__4] .i; // , expr subst  
 c_div(&q__2, &q__3, &d12);
 q__1.r = t.r * q__2.r - t.i * q__2.i; q__1.i = t.r * q__2.i + t.i * q__2.r; // , expr subst  
 a[i__2].r = q__1.r; a[i__2].i = q__1.i; // , expr subst  
 i__2 = j + k * a_dim1;
 i__3 = j + kw * w_dim1;
 q__4.r = d22.r * w[i__3].r - d22.i * w[i__3].i; q__4.i = d22.r * w[i__3].i + d22.i * w[i__3] .r; // , expr subst  
 i__4 = j + (kw - 1) * w_dim1;
 q__3.r = q__4.r - w[i__4].r; q__3.i = q__4.i - w[i__4] .i; // , expr subst  
 c_div(&q__2, &q__3, &d12);
 q__1.r = t.r * q__2.r - t.i * q__2.i; q__1.i = t.r * q__2.i + t.i * q__2.r; // , expr subst  
 ...
 *kb = *n - k;
 ...
 /* a 1-by-1 or 2-by-2 pivot block will be used */
 i__1 = k + k * w_dim1;
 absakk = (r__1 = w[i__1].r, abs(r__1)) + (r__2 = r_imag(&w[k + k * w_dim1]), abs(r__2));
 /* IMAX is the row-index of the largest off-diagonal element in */
 /* column K, and COLMAX is its absolute value. */
 /* Determine both COLMAX and IMAX. */
 if (k < *n) {
 ...
 *info = k;
 ...
 if (! ((r__1 = w[i__1].r, abs(r__1)) + (r__2 = r_imag(&w[imax + (k + 1) * w_dim1]), abs(r__2)) < alpha * rowmax)) {
 /* interchange rows and columns K and IMAX, */
 /* use 1-by-1 pivot block */
 kp = imax;
