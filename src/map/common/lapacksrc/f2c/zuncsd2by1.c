/* ../netlib/zuncsd2by1.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
int zuncsd2by1_(char *jobu1, char *jobu2, char *jobv1t, integer *m, integer *p, integer *q, doublecomplex *x11, integer * ldx11, doublecomplex *x21, integer *ldx21, doublereal *theta, doublecomplex *u1, integer *ldu1, doublecomplex *u2, integer *ldu2, doublecomplex *v1t, integer *ldv1t, doublecomplex *work, integer * lwork, doublereal *rwork, integer *lrwork, integer *iwork, integer * info)
{
    ...
    extern /* Subroutine */
    int zbbcsd_(), xerbla_(char *, integer *);
    ...
    logical lquery;
    extern /* Subroutine */
    int zunglq_(), zungqr_(), zunbdb1_(), zunbdb2_(), zunbdb3_(), zunbdb4_();
    logical wantv1t;
    ...
    *info = 0;
    ...
    if (*info == 0)
    {
        ...
        if (r__ == *q)
        {
            zunbdb1_(m, p, q, &x11[x11_offset], ldx11, &x21[x21_offset], ldx21, &theta[1], &c__0, &c__0, &c__0, &c__0, &work[1], & c_n1, &childinfo);
            lorbdb = (integer) work[1].r;
            if (*p >= *m - *p)
            {
                zungqr_(p, p, q, &u1[u1_offset], ldu1, &c__0, &work[1], &c_n1, &childinfo);
                lorgqrmin = max(1,*p);
            ...
            else
            {
                i__1 = *m - *p;
                i__2 = *m - *p;
                zungqr_(&i__1, &i__2, q, &u2[u2_offset], ldu2, &c__0, &work[1] , &c_n1, &childinfo);
                /* Computing MAX */
                i__1 = 1;
                i__2 = *m - *p; // , expr subst
            ...
            i__9 = *q - 1; // , expr subst
            i__7 = max(i__8,i__9);
            zunglq_(&i__1, &i__4, &i__7, &v1t[v1t_offset], ldv1t, &c__0, & work[1], &c_n1, &childinfo);
            /* Computing MAX */
            i__1 = 1;
            i__2 = *q - 1; // , expr subst
            lorglqmin = max(i__1,i__2);
            lorglqopt = (integer) work[1].r;
            zbbcsd_(jobu1, jobu2, jobv1t, "N", "N", m, p, q, &theta[1], &c__0, &u1[u1_offset], ldu1, &u2[u2_offset], ldu2, &v1t[ v1t_offset], ldv1t, &c__0, &c__1, &c__0, &c__0, &c__0, & c__0, &c__0, &c__0, &c__0, &c__0, &rwork[1], &c_n1, & childinfo);
            lbbcsd = (integer) rwork[1];
        }
        else if (r__ == *p)
        {
            zunbdb2_(m, p, q, &x11[x11_offset], ldx11, &x21[x21_offset], ldx21, &theta[1], &c__0, &c__0, &c__0, &c__0, &work[1], & c_n1, &childinfo);
            lorbdb = (integer) work[1].r;
            if (*p - 1 >= *m - *p)
            {
                i__1 = *p - 1;
                i__2 = *p - 1;
                i__3 = *p - 1;
                zungqr_(&i__1, &i__2, &i__3, &u1[(u1_dim1 << 1) + 2], ldu1, & c__0, &work[1], &c_n1, &childinfo);
                /* Computing MAX */
                i__1 = 1;
                i__2 = *p - 1; // , expr subst
                lorgqrmin = max(i__1,i__2);
            ...
            zunglq_(q, q, &r__, &v1t[v1t_offset], ldv1t, &c__0, &work[1], & c_n1, &childinfo);
            lorglqmin = max(1,*q);
            lorglqopt = (integer) work[1].r;
            zbbcsd_(jobv1t, "N", jobu1, jobu2, "T", m, q, p, &theta[1], &c__0, &v1t[v1t_offset], ldv1t, &c__0, &c__1, &u1[u1_offset], ldu1, &u2[u2_offset], ldu2, &c__0, &c__0, &c__0, &c__0, & c__0, &c__0, &c__0, &c__0, &rwork[1], &c_n1, &childinfo);
            lbbcsd = (integer) rwork[1];
        }
        else if (r__ == *m - *p)
        {
            zunbdb3_(m, p, q, &x11[x11_offset], ldx11, &x21[x21_offset], ldx21, &theta[1], &c__0, &c__0, &c__0, &c__0, &work[1], & c_n1, &childinfo);
            lorbdb = (integer) work[1].r;
            if (*p >= *m - *p - 1)
            {
                zungqr_(p, p, q, &u1[u1_offset], ldu1, &c__0, &work[1], &c_n1, &childinfo);
            ...
            else
            {
                ...
                i__2 = *m - *p - 1;
                i__3 = *m - *p - 1;
                zungqr_(&i__1, &i__2, &i__3, &u2[(u2_dim1 << 1) + 2], ldu2, & c__0, &work[1], &c_n1, &childinfo);
                /* Computing MAX */
                i__1 = 1;
            ...
            i__1 = *m - *q;
            i__2 = *m - *p;
            zbbcsd_("N", jobv1t, jobu2, jobu1, "T", m, &i__1, &i__2, &theta[1] , &c__0, &c__0, &c__1, &v1t[v1t_offset], ldv1t, &u2[ u2_offset], ldu2, &u1[u1_offset], ldu1, &c__0, &c__0, & c__0, &c__0, &c__0, &c__0, &c__0, &c__0, &rwork[1], &c_n1, &childinfo);
            lbbcsd = (integer) rwork[1];
        }
        else
        {
            zunbdb4_(m, p, q, &x11[x11_offset], ldx11, &x21[x21_offset], ldx21, &theta[1], &c__0, &c__0, &c__0, &c__0, &c__0, & work[1], &c_n1, &childinfo);
            lorbdb = *m + (integer) work[1].r;
            if (*p >= *m - *p)
            {
                i__1 = *m - *q;
                zungqr_(p, p, &i__1, &u1[u1_offset], ldu1, &c__0, &work[1], & c_n1, &childinfo);
                lorgqrmin = max(1,*p);
                lorgqropt = (integer) work[1].r;
            }
            else
            {
                ...
                i__2 = *m - *p;
                i__3 = *m - *q;
                zungqr_(&i__1, &i__2, &i__3, &u2[u2_offset], ldu2, &c__0, & work[1], &c_n1, &childinfo);
                /* Computing MAX */
                i__1 = 1;
                i__2 = *m - *p; // , expr subst
                lorgqrmin = max(i__1,i__2);
            ...
            zunglq_(q, q, q, &v1t[v1t_offset], ldv1t, &c__0, &work[1], &c_n1, &childinfo);
            lorglqmin = max(1,*q);
            lorglqopt = (integer) work[1].r;
            i__1 = *m - *p;
            i__2 = *m - *q;
            zbbcsd_(jobu2, jobu1, "N", jobv1t, "N", m, &i__1, &i__2, &theta[1] , &c__0, &u2[u2_offset], ldu2, &u1[u1_offset], ldu1, & c__0, &c__1, &v1t[v1t_offset], ldv1t, &c__0, &c__0, &c__0, &c__0, &c__0, &c__0, &c__0, &c__0, &rwork[1], &c_n1, & childinfo);
            lbbcsd = (integer) rwork[1];
        }
    ...
    if (r__ == *q)
    {
        ...
        zbbcsd_(jobu1, jobu2, jobv1t, "N", "N", m, p, q, &theta[1], &rwork[ iphi], &u1[u1_offset], ldu1, &u2[u2_offset], ldu2, &v1t[ v1t_offset], ldv1t, &c__0, &c__1, &rwork[ib11d], &rwork[ib11e] , &rwork[ib12d], &rwork[ib12e], &rwork[ib21d], &rwork[ib21e], &rwork[ib22d], &rwork[ib22e], &rwork[ibbcsd], &lbbcsd, & childinfo);
    ...
    else if (r__ == *p)
    {
        ...
        /* Simultaneously diagonalize X11 and X21. */
        zbbcsd_(jobv1t, "N", jobu1, jobu2, "T", m, q, p, &theta[1], &rwork[ iphi], &v1t[v1t_offset], ldv1t, &c__0, &c__1, &u1[u1_offset], ldu1, &u2[u2_offset], ldu2, &rwork[ib11d], &rwork[ib11e], & rwork[ib12d], &rwork[ib12e], &rwork[ib21d], &rwork[ib21e], & rwork[ib22d], &rwork[ib22e], &rwork[ibbcsd], &lbbcsd, & childinfo);
    ...
    else if (r__ == *m - *p)
    {
        ...
        i__1 = *m - *q;
        i__2 = *m - *p;
        zbbcsd_("N", jobv1t, jobu2, jobu1, "T", m, &i__1, &i__2, &theta[1], & rwork[iphi], &c__0, &c__1, &v1t[v1t_offset], ldv1t, &u2[ u2_offset], ldu2, &u1[u1_offset], ldu1, &rwork[ib11d], &rwork[ ib11e], &rwork[ib12d], &rwork[ib12e], &rwork[ib21d], &rwork[ ib21e], &rwork[ib22d], &rwork[ib22e], &rwork[ibbcsd], &lbbcsd, &childinfo);
        /* Permute rows and columns to place identity submatrices in */
        /* preferred positions */
        if (*q > r__)
        {
    ...
    else
    {
        ...
        i__1 = *m - *p;
        i__2 = *m - *q;
        zbbcsd_(jobu2, jobu1, "N", jobv1t, "N", m, &i__1, &i__2, &theta[1], & rwork[iphi], &u2[u2_offset], ldu2, &u1[u1_offset], ldu1, & c__0, &c__1, &v1t[v1t_offset], ldv1t, &rwork[ib11d], &rwork[ ib11e], &rwork[ib12d], &rwork[ib12e], &rwork[ib21d], &rwork[ ib21e], &rwork[ib22d], &rwork[ib22e], &rwork[ibbcsd], &lbbcsd, &childinfo);
        /* Permute rows and columns to place identity submatrices in */
        /* preferred positions */
        if (*p > r__)
        {
