...
, and we */
 ...
 char buffer[256]; 
 snprintf(buffer, 256,"zlatrs inputs: uplo %c, trans %c, diag %c, normin %c, n %d, lda %d",*uplo, *trans, *diag, *normin, *n, *lda);
...
. */
 ...
 i__3 = j + j * a_dim1;
 tjjs.r = a[i__3].r; tjjs.i = a[i__3].i; // , expr subst  
 ...
 *scale = bignum * .5 / xmax;
 ...
 if (nounit) {
 i__3 = j + j * a_dim1;
 z__1.r = tscal * a[i__3].r; z__1.i = tscal * a[i__3].i; // , expr subst  
 ...
 *scale *= .5;
 ...
 i__3 = j - 1;
 i__4 = j;
 z__2.r = -x[i__4].r; z__2.i = -x[i__4].i; // , expr subst  
 ...
 *scale *= rec;
 ...
 ++i__) {
 i__4 = i__ + j * a_dim1;
 z__3.r = a[i__4].r * uscal.r - a[i__4].i * uscal.i; z__3.i = a[i__4].r * uscal.i + a[ i__4].i * uscal.r; // , expr subst  
 i__5 = i__;
