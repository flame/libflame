/* ../netlib/v3.9.0/ztgsen.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *pr = dscale / (sqrt(dscale * dscale / *pr + *pr) * sqrt(*pr));
 ...
 L40: zlacn2_(&mn2, &work[mn2 + 1], &work[1], &dif[1], &kase, isave);
 if (kase != 0) {
 if (kase == 1) {
 ...
 L50: zlacn2_(&mn2, &work[mn2 + 1], &work[1], &dif[2], &kase, isave);
 if (kase != 0) {
 if (kase == 1) {
 /* Solve generalized Sylvester equation */
 i__1 = *lwork - (n1 << 1) * n2;
 ...
 if (dscale > safmin) {
 i__2 = k + k * b_dim1;
 z__2.r = b[i__2].r / dscale; z__2.i = b[i__2].i / dscale; // , expr subst  
 d_cnjg(&z__1, &z__2);
 temp1.r = z__1.r; temp1.i = z__1.i; // , expr subst  
 i__2 = k + k * b_dim1;
 z__1.r = b[i__2].r / dscale; z__1.i = b[i__2].i / dscale; // , expr subst  
 temp2.r = z__1.r; temp2.i = z__1.i; // , expr subst  
 i__2 = k + k * b_dim1;
 b[i__2].r = dscale; b[i__2].i = 0.; // , expr subst  
 i__2 = *n - k;
 ...
 i__2 = k + k * b_dim1;
 b[i__2].r = 0.; b[i__2].i = 0.; // , expr subst  
 }
 i__2 = k;
 i__3 = k + k * a_dim1;
 alpha[i__2].r = a[i__3].r; alpha[i__2].i = a[i__3].i; // , expr subst  
