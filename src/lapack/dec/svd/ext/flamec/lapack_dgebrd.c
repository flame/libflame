...
/* Subroutine */ int lapack_dgebrd(integer *m, integer *n, doublereal *a, integer *
...
/*    
   ...
   /* System generated locals */
    ...
    extern /* Subroutine */ int lapack_dgebd2(integer *, integer *, doublereal *, 
...
/*     Use unblocked code to reduce the remainder of the matrix */
    ...
    i__2 = *m - i__ + 1;
    i__1 = *n - i__ + 1;
    lapack_dgebd2(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[i__], &
