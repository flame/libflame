/* ../netlib/v3.9.0/ztpqrt2.f -- translated by f2c (version 20160102). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 *info = -9;
 ...
 z__2.r = alpha.r * z__3.r - alpha.i * z__3.i; z__2.i = alpha.r * z__3.i + alpha.i * z__3.r; // , expr subst  
