...
cmake_path(GET LIBAOCLUTILS_LIBRARY_PATH PARENT_PATH AOCLUTILS_LIB_DIR_PATH)
...
add_test(netlib-test bash ${NETLIB_BASH_SCRIPT} BLAS_LIB_PATH=${CMAKE_EXT_BLAS_LIBRARY_DEPENDENCY_PATH} BLAS_LIB=${EXT_BLAS_LIBNAME}
	LAPACK_LIB_PATH=${EXT_LAPACK_LIBRARY_PATH} LAPACK_LIB=${EXT_LAPACK_LIBNAME} AOCLUTILS_LIB_PATH=${AOCLUTILS_LIB_DIR_PATH} ILP64=${ENABLE_ILP64} GCOV=${ENABLE_GCOV})
