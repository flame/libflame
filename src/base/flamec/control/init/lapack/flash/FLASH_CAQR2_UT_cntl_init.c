...
__thread fla_caqr2ut_t*   flash_caqr2ut_cntl_leaf = NULL;
__thread fla_caqr2ut_t*   flash_caqr2ut_cntl = NULL;
__thread fla_blocksize_t* flash_caqr2ut_var2_bsize = NULL;
