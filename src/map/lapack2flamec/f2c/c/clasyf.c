/* ../netlib/clasyf.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
/* > \brief \b CLASYF computes a partial factorization of a complex symmetric matrix using the Bunch-Kaufman d iagonal pivoting method. */
/* =========== DOCUMENTATION =========== */
        ...
        else
        {
            ...
            else
            {
                ...
                if (imax > 1)
                {
                    ...
                    i__1 = jmax + (kw - 1) * w_dim1;
                    r__3 = rowmax;
                    r__4 = (r__1 = w[i__1].r, abs(r__1)) + ( r__2 = r_imag(&w[jmax + (kw - 1) * w_dim1]), abs( r__2)); // , expr subst
        ...
        else
        {
            ...
            else
            {
                ...
                if (imax < *n)
                {
                    ...
                    i__1 = jmax + (k + 1) * w_dim1;
                    r__3 = rowmax;
                    r__4 = (r__1 = w[i__1].r, abs(r__1)) + ( r__2 = r_imag(&w[jmax + (k + 1) * w_dim1]), abs( r__2)); // , expr subst
                    rowmax = max(r__3,r__4);
                }
                if (absakk >= alpha * colmax * (colmax / rowmax))
                {
